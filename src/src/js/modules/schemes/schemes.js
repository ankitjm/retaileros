        ...
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            <header class="p-4 sm:p-8 pb-4 shrink-0">
                <div class="flex items-center justify-between mb-6">
                    ${isMobile && !isBrandTab ? `
                        <button type="button" onclick="setSchemesTab('brands')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
                    ...
                    <div class="text-center">
                        <h1 class="text-xl font-black tracking-tighter text-slate-900">Schemes</h1>
                        <p class="text-[9px] font-bold text-slate-300 uppercase tracking-[0.2em] -mt-1">Incentives & Claims</p>
                    </div>
                    <button type="button" class="p-2 text-slate-400 hover:text-slate-900"><span class="material-symbols-outlined text-xl">search</span></button>
                </div>
