            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar text-left">
                ...
                <div class="p-6 space-y-4 border-b border-dashed border-slate-200 text-left">
                    ...
                    <div class="card p-5 text-left">
                        ...
                        <input type="range" data-field="font_size" min="90" max="110" value="${settings.font_size}" class="w-full h-1.5 bg-slate-200 rounded-full appearance-none cursor-pointer accent-slate-900">
