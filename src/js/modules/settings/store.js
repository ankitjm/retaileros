            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar text-left">
                ...
                ${isEditMode ? `
                    ...
                    <div class="p-6 border-t border-slate-200 text-left">
                        <button onclick="window.toast.info('Contact support to update store details')" class="w-full py-4 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl hover:scale-[1.02] transition-transform text-center">
                            Request Update
                        </button>
                    </div>
                ` : ''}
