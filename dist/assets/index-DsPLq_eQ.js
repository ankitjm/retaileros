var ur=Object.defineProperty;var Zn=e=>{throw TypeError(e)};var xr=(e,t,s)=>t in e?ur(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var q=(e,t,s)=>xr(e,typeof t!="symbol"?t+"":t,s),Wa=(e,t,s)=>t.has(e)||Zn("Cannot "+s);var d=(e,t,s)=>(Wa(e,t,"read from private field"),s?s.call(e):t.get(e)),_=(e,t,s)=>t.has(e)?Zn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),h=(e,t,s,a)=>(Wa(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),S=(e,t,s)=>(Wa(e,t,"access private method"),s);var es=(e,t,s,a)=>({set _(n){h(e,t,n,s)},get _(){return d(e,t,a)}});(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();const fr=localStorage.getItem("retaileros_logged_in")==="true",mr=localStorage.getItem("retaileros_retailer_id")||null,br=localStorage.getItem("retaileros_retailer_code")||null,hr=localStorage.getItem("retaileros_retailer_name")||null,gr=localStorage.getItem("retaileros_push_notifications")!=="false";window._pushNotificationsEnabled=gr;const p={retailerId:mr,retailerCode:br,retailerName:hr,currentApp:window.innerWidth<768?"launcher":"sales",currentTab:"new-sale",salesMode:"default",salesHistoryId:"ORD-99281",historyViewMode:"completed",historyDateFilter:"today",historyFromDate:"",historyToDate:"",showMobileReceipt:!1,reportsTab:"sales",repairTab:"active",repairViewMode:"search",selectedRepairDevice:null,activeRepairId:null,repairContext:null,selectedClient:null,selectedClientId:null,clientViewMode:"directory",clientSearchQuery:"",clientInvoiceId:null,selectedGroupId:null,groupViewMode:"list",groupSearchQuery:"",promoterViewMode:"performance",inventoryTab:"brands",inventoryMode:"details",activeCategory:null,settingsView:null,viewportWidth:window.innerWidth,gridCols:window.innerWidth<768?4:3,schemesTab:"list",activeSchemeBrand:"Apple",activeScheme:"June Activation Bonus",showSchemeDetails:!1,marketplaceTab:"browse",marketplaceViewMode:"list",myStoreTab:"dashboard",myStoreViewMode:"list",activeStoreOrderId:null,activeListingId:null,isLoggedIn:fr,authMode:"login",registrationStep:1,inquiryViewMode:"list",activeInquiry:null,preBookingViewMode:"dashboard",activeCampaign:null,automationViewMode:"dashboard",activeAutomationId:null},Nl=[],ql=e=>{Nl.push(e)},D=(e=!0)=>{Nl.forEach(t=>t(e))};function wr(e){p.currentApp=e,e==="clients"&&(p.clientViewMode="directory"),D()}function vr(e){p.currentTab=e,D()}function yr(e){p.salesHistoryId=e,e&&window.innerWidth<768&&(p.showMobileReceipt=!0),D()}function kr(e){p.showMobileReceipt=e,D()}function _r(e){p.reportsTab=e,D()}function Sr(e){p.repairTab=e,D()}function $r(e,t=null){p.repairViewMode=e,t&&(p.selectedRepairDevice=t),D()}function Er(e){p.gridCols=e,D()}function Bl(e,t=null,s=null){p.clientViewMode=e,t&&(p.selectedClient=t),s&&(p.selectedClientId=s),e!=="invoice"&&(p.clientInvoiceId=null),D()}function Ir(e){p.clientInvoiceId=e,p.clientViewMode="invoice",D()}function Cr(e){p.schemesTab=e,D()}function Rr(e){p.activeSchemeBrand=e,D()}function Ar(e){p.activeScheme=e,D()}function Tr(e){p.showSchemeDetails=e,D()}function Mr(e){p.marketplaceTab=e,D()}function Dr(e){p.marketplaceViewMode=e,D()}function Lr(e,t,s){p.retailerId=e,p.retailerCode=t,p.retailerName=s,localStorage.setItem("retaileros_retailer_id",e),localStorage.setItem("retaileros_retailer_code",t),localStorage.setItem("retaileros_retailer_name",s)}function Fl(){p.retailerId=null,p.retailerCode=null,p.retailerName=null,localStorage.removeItem("retaileros_retailer_id"),localStorage.removeItem("retaileros_retailer_code"),localStorage.removeItem("retaileros_retailer_name")}function Or(){return p.retailerId}function jr(e){p.isLoggedIn=e,e?localStorage.setItem("retaileros_logged_in","true"):(localStorage.removeItem("retaileros_logged_in"),Fl());const t=window.innerWidth<768;p.currentApp=e?t?"launcher":"sales":"launcher",D()}function Pr(e){p.authMode=e,p.registrationStep=1,D()}function Nr(e){p.registrationStep=e,window.updateAuthContent?window.updateAuthContent():D()}function qr(e){p.inquiryViewMode=e,D()}function Br(e){p.activeInquiry=e,D()}function Fr(e){p.preBookingViewMode=e,D()}function Vr(e){p.activeCampaign=e,D()}function Ur(e){p.automationViewMode=e,D()}function Hr(e){p.activeAutomationId=e,D()}window.triggerRender=D;window.setApp=wr;window.setTab=vr;window.setSalesHistoryId=yr;window.toggleMobileReceipt=kr;window.setReportsTab=_r;window.setRepairTab=Sr;function Vl(e){p.salesMode=e,D()}window.setSalesMode=Vl;function Gr(e){p.historyViewMode=e,D()}function Wr(e){p.historyDateFilter=e,e!=="custom"&&(p.historyFromDate="",p.historyToDate=""),D()}function zr(e,t){p.historyFromDate=e,p.historyToDate=t,p.historyDateFilter="custom",D()}window.setHistoryViewMode=Gr;window.setHistoryDateFilter=Wr;window.setHistoryCustomDates=zr;window.setRepairMode=$r;window.setGridCols=Er;window.setClientMode=Bl;window.viewClientInvoice=Ir;window.setSchemesTab=Cr;window.setSchemeBrand=Rr;window.setScheme=Ar;window.toggleSchemeDetails=Tr;window.setMarketplaceTab=Mr;window.setMarketplaceViewMode=Dr;function Yr(e){p.myStoreTab=e,p.myStoreViewMode="list",D()}function Jr(e){p.myStoreViewMode=e,D()}function Kr(e){p.activeStoreOrderId=e,p.myStoreViewMode="order-detail",D()}function Qr(e){p.activeListingId=e,D()}window.setMyStoreTab=Yr;window.setMyStoreViewMode=Jr;window.setActiveStoreOrder=Kr;window.setActiveListing=Qr;window.setRetailer=Lr;window.clearRetailer=Fl;window.getRetailerId=Or;window.setLoginStatus=jr;window.setAuthMode=Pr;window.setRegistrationStep=Nr;window.setInquiryViewMode=qr;window.setActiveInquiry=Br;window.setPreBookingViewMode=Fr;window.setActiveCampaign=Vr;window.setAutomationViewMode=Ur;window.setActiveAutomation=Hr;function Xr(e){p.groupViewMode=e,D()}function Zr(e){p.selectedGroupId=e,D()}window.setGroupViewMode=Xr;window.setSelectedGroup=Zr;function eo(){const e=window._pushNotificationsEnabled!==!1;window._pushNotificationsEnabled=!e,localStorage.setItem("retaileros_push_notifications",e?"false":"true"),D()}window.togglePushNotifications=eo;const to="modulepreload",so=function(e){return"/"+e},el={},Ys=function(t,s,a){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=Promise.allSettled(s.map(c=>{if(c=so(c),c in el)return;el[c]=!0;const o=c.endsWith(".css"),u=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const m=document.createElement("link");if(m.rel=o?"stylesheet":to,o||(m.as="script"),m.crossOrigin="",m.href=c,r&&m.setAttribute("nonce",r),document.head.appendChild(m),o)return new Promise((b,y)=>{m.addEventListener("load",b),m.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function l(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return n.then(i=>{for(const r of i||[])r.status==="rejected"&&l(r.reason);return t().catch(l)})};function Ul(e){const t=e==="mobile";return`
    ...
    `}function no(){return p.registrationStep<3?`
    ...
    `}function lo(){const e=p.registrationStep;return`
...
Error: `+s.message)}};window.verifyOtp=function(){const e=[];for(let a=0;a<6;a++){const n=document.getElementById(`otp-${a}`);n&&e.push(n.value)}const t=e.join("");if(t.length!==6){alert("Please enter all 6 digits");return}const s="444619";console.log("Verifying OTP:",t),t===s?console.log("✅ Default OTP accepted:",s):console.log("ℹ️  Development mode: Any OTP accepted"),window.setRegistrationStep(3)};window.resendOtp=function(){for(let t=0;t<6;t++){const s=document.getElementById(`otp-${t}`);s&&(s.value="")}const e=document.getElementById("otp-0");e&&e.focus(),console.log("Resending OTP..."),alert("OTP has been resent successfully!")};window.finalizeRegistration=async function(){try{const e=window._approvedRetailerData;if(!e){alert("Session expired. Please start registration again."),window.setRegistrationStep(1);return}const{db:t}=await Ys(async()=>{const{db:n}=await Promise.resolve().then(()=>Mn);return{db:n}},void 0),s=await t.retailers.add(e);window.setRetailer(s.id,s.retailerCode,e.RetailerName),localStorage.setItem("retaileros_logged_in","true"),delete window._approvedRetailerData;const{syncData:a}=await Ys(async()=>{const{syncData:n}=await Promise.resolve().then(()=>Qi);return{syncData:n}},void 0);await a(),window.setLoginStatus(!0),console.log("Registration completed successfully:",s)}catch(e){console.error("Registration failed:",e),alert("Registration failed. Please try again.")}};function Hl(){return p.authMode==="register"?Js("mobile"):Ul("mobile")}const io=[{n:"ALERTS",i:"notifications",k:"notifications"},{n:"SALES DESK",i:"account_balance_wallet",k:"sales"},{n:"CLIENTS",i:"group",k:"clients"},{n:"INQUIRIES",i:"help_outline",k:"inquiries"},{n:"PROMOTERS",i:"business_center",k:"promoters"},{n:"MY STORE",i:"storefront",k:"mystore"},{n:"INVENTORY",i:"inventory_2",k:"inventory"},{n:"REPAIRS",i:"build",k:"repairs"},{n:"MARKETPLACE",i:"swap_horizontal_circle",k:"marketplace"},{n:"CLAIMS",i:"verified_user"},{n:"SCHEMES",i:"percent",k:"schemes"},{n:"MARKETING",i:"campaign",k:"marketing"},{n:"AUTOMATION",i:"smart_toy",s:!0,k:"automation"},{n:"PRE-BOOKING",i:"rocket_launch",k:"prebooking"},{n:"REPORTS",i:"bar_chart",k:"reports"},{n:"SETTINGS",i:"settings",k:"settings"}];function ro(e){const t=e?p.gridCols:4,s=e&&{2:"grid-cols-2",3:"grid-cols-3",4:"grid-cols-4"}[t]||"grid-cols-4",a=window.getNotificationCount?window.getNotificationCount():0;return`
    ...
    `}function Gl(e){const t=e==="mobile";return`
    ...
    `}class F extends Error{constructor(s,a,n,l,i){a!==void 0&&(s=`${a}: ${s}`);super(s,{cause:i});q(this,"code");q(this,"extendedCode");q(this,"rawCode");this.code=a,this.extendedCode=n,this.rawCode=l,this.name="LibsqlError"}}class ls extends F{constructor(s,a,n,l,i,r){super(s,n,l,i,r);q(this,"statementIndex");this.statementIndex=a,this.name="LibsqlBatchError"}}function co(e){const t=po.exec(e);if(t===null)throw new F(`The URL '${e}' is not in a valid format`,"URL_INVALID");const s=t.groups,a=s.scheme,n=s.authority!==void 0?uo(s.authority):void 0,l=Qt(s.path),i=s.query!==void 0?fo(s.query):void 0,r=s.fragment!==void 0?Qt(s.fragment):void 0;return{scheme:a,authority:n,path:l,query:i,fragment:r}}const po=(()=>{const e="(?<scheme>[A-Za-z][A-Za-z.+-]*)",t="(?<authority>[^/?#]*)",s="(?<path>[^?#]*)",a="(?<query>[^#]*)",n="(?<fragment>.*)";return new RegExp(`^${e}:(//${t})?${s}(\\?${a})?(#${n})?$`,"su")})();function uo(e){const t=xo.exec(e);if(t===null)throw new F("The authority part of the URL is not in a valid format","URL_INVALID");const s=t.groups,a=Qt(s.host_br??s.host),n=s.port?parseInt(s.port,10):void 0,l=s.username!==void 0?{username:Qt(s.username),password:s.password!==void 0?Qt(s.password):void 0}:void 0;return{host:a,port:n,userinfo:l}}const xo=new RegExp("^((?<username>[^:]*)(:(?<password>.*))?@)?((?<host>[^:\\[\\]]*)|(\\[(?<host_br>[^\\[\\]]*)\\]))(:(?<port>[0-9]*))?$","su");function fo(e){const t=e.split("&"),s=[];for(const a of t){if(a==="")continue;let n,l;const i=a.indexOf("=");i<0?(n=a,l=""):(n=a.substring(0,i),l=a.substring(i+1)),s.push({key:Qt(n.replaceAll("+"," ")),value:Qt(l.replaceAll("+"," "))})}return{pairs:s}}function Qt(e){try{return decodeURIComponent(e)}catch(t){throw t instanceof URIError?new F(`URL component has invalid percent encoding: ${t}`,"URL_INVALID",void 0,void 0,t):t}}function Qa(e,t,s){if(t===void 0)throw new F(`URL with scheme ${JSON.stringify(e+":")} requires authority (the "//" part)`,"URL_INVALID");const a=`${e}:`,n=mo(t.host),l=bo(t.port),r=`//${ho(t.userinfo)}${n}${l}`;let c=s.split("/").map(encodeURIComponent).join("/");return c!==""&&!c.startsWith("/")&&(c="/"+c),new URL(`${a}${r}${c}`)}function mo(e){return e.includes(":")?`[${encodeURI(e)}]`:encodeURI(e)}function bo(e){return e!==void 0?`:${e}`:""}function ho(e){if(e===void 0)return"";const t=encodeURIComponent(e.username),s=e.password!==void 0?`:${encodeURIComponent(e.password)}`:"";return`${t}${s}@`}const Wl="3.7.8",go=Wl,Ds=typeof Buffer=="function",tl=typeof TextDecoder=="function"?new TextDecoder:void 0,sl=typeof TextEncoder=="function"?new TextEncoder:void 0,wo="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",js=Array.prototype.slice.call(wo),ha=(e=>{let t={};return e.forEach((s,a)=>t[s]=a),t})(js),vo=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,le=String.fromCharCode.bind(String),al=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),zl=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),Yl=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),Jl=e=>{let t,s,a,n,l="";const i=e.length%3;for(let r=0;r<e.length;){if((s=e.charCodeAt(r++))>255||(a=e.charCodeAt(r++))>255||(n=e.charCodeAt(r++))>255)throw new TypeError("invalid character found");t=s<<16|a<<8|n,l+=js[t>>18&63]+js[t>>12&63]+js[t>>6&63]+js[t&63]}return i?l.slice(0,i-3)+"===".substring(i):l},kn=typeof btoa=="function"?e=>btoa(e):Ds?e=>Buffer.from(e,"binary").toString("base64"):Jl,Xa=Ds?e=>Buffer.from(e).toString("base64"):e=>{let s=[];for(let a=0,n=e.length;a<n;a+=4096)s.push(le.apply(null,e.subarray(a,a+4096)));return kn(s.join(""))},va=(e,t=!1)=>t?zl(Xa(e)):Xa(e),yo=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?le(192|t>>>6)+le(128|t&63):le(224|t>>>12&15)+le(128|t>>>6&63)+le(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return le(240|t>>>18&7)+le(128|t>>>12&63)+le(128|t>>>6&63)+le(128|t&63)}},ko=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Kl=e=>e.replace(ko,yo),nl=Ds?e=>Buffer.from(e,"utf8").toString("base64"):sl?e=>Xa(sl.encode(e)):e=>kn(Kl(e)),is=(e,t=!1)=>t?zl(nl(e)):nl(e),ll=e=>is(e,!0),_o=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,So=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),s=t-65536;return le((s>>>10)+55296)+le((s&1023)+56320);case 3:return le((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return le((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},Ql=e=>e.replace(_o,So),Xl=e=>{if(e=e.replace(/\s+/g,""),!vo.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,s,a,n=[];for(let l=0;l<e.length;)t=ha[e.charAt(l++)]<<18|ha[e.charAt(l++)]<<12|(s=ha[e.charAt(l++)])<<6|(a=ha[e.charAt(l++)]),s===64?n.push(le(t>>16&255)):a===64?n.push(le(t>>16&255,t>>8&255)):n.push(le(t>>16&255,t>>8&255,t&255));return n.join("")},_n=typeof atob=="function"?e=>atob(Yl(e)):Ds?e=>Buffer.from(e,"base64").toString("binary"):Xl,Zl=Ds?e=>al(Buffer.from(e,"base64")):e=>al(_n(e).split("").map(t=>t.charCodeAt(0))),ei=e=>Zl(ti(e)),$o=Ds?e=>Buffer.from(e,"base64").toString("utf8"):tl?e=>tl.decode(Zl(e)):e=>Ql(_n(e)),ti=e=>Yl(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),Za=e=>$o(ti(e)),Eo=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},si=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),ai=function(){const e=(t,s)=>Object.defineProperty(String.prototype,t,si(s));e("fromBase64",function(){return Za(this)}),e("toBase64",function(t){return is(this,t)}),e("toBase64URI",function(){return is(this,!0)}),e("toBase64URL",function(){return is(this,!0)}),e("toUint8Array",function(){return ei(this)})},ni=function(){const e=(t,s)=>Object.defineProperty(Uint8Array.prototype,t,si(s));e("toBase64",function(t){return va(this,t)}),e("toBase64URI",function(){return va(this,!0)}),e("toBase64URL",function(){return va(this,!0)})},Io=()=>{ai(),ni()},Sn={version:Wl,VERSION:go,atob:_n,atobPolyfill:Xl,btoa:kn,btoaPolyfill:Jl,fromBase64:Za,toBase64:is,encode:is,encodeURI:ll,encodeURL:ll,utob:Kl,btou:Ql,decode:Za,isValid:Eo,fromUint8Array:va,toUint8Array:ei,extendString:ai,extendUint8Array:ni,extendBuiltins:Io},Ks="https://github.com/libsql/libsql-client-ts#supported-urls";function en(e){if(e==="write")return"BEGIN IMMEDIATE";if(e==="read")return"BEGIN TRANSACTION READONLY";if(e==="deferred")return"BEGIN DEFERRED";throw RangeError('Unknown transaction mode, supported values are "write", "read" and "deferred"')}class Co{constructor(t,s,a,n,l){q(this,"columns");q(this,"columnTypes");q(this,"rows");q(this,"rowsAffected");q(this,"lastInsertRowid");this.columns=t,this.columnTypes=s,this.rows=a,this.rowsAffected=n,this.lastInsertRowid=l}toJSON(){return{columns:this.columns,columnTypes:this.columnTypes,rows:this.rows.map(Ro),rowsAffected:this.rowsAffected,lastInsertRowid:this.lastInsertRowid!==void 0?""+this.lastInsertRowid:null}}}function Ro(e){return Array.prototype.map.call(e,Ao)}function Ao(e){return typeof e=="bigint"?""+e:e instanceof ArrayBuffer?Sn.fromUint8Array(new Uint8Array(e)):e}const il=":memory:";function To(e,t){var f,x;if(typeof e!="object")throw new TypeError(`Expected client configuration as object, got ${typeof e}`);let{url:s,authToken:a,tls:n,intMode:l,concurrency:i}=e;i=Math.max(0,i||20),l??(l="number");let r=[];s===il&&(s="file::memory:");const c=co(s),o=c.scheme.toLowerCase(),u=o==="file"&&c.path===il&&c.authority===void 0;let m;u?m={cache:{values:["shared","private"],update:(g,$)=>r.push(`${g}=${$}`)}}:m={tls:{values:["0","1"],update:(g,$)=>n=$==="1"},authToken:{update:(g,$)=>a=$}};for(const{key:g,value:$}of((f=c.query)==null?void 0:f.pairs)??[]){if(!Object.hasOwn(m,g))throw new F(`Unsupported URL query parameter ${JSON.stringify(g)}`,"URL_PARAM_NOT_SUPPORTED");const C=m[g];if(C.values!==void 0&&!C.values.includes($))throw new F(`Unknown value for the "${g}" query argument: ${JSON.stringify($)}. Supported values are: [${C.values.map(E=>'"'+E+'"').join(", ")}]`,"URL_INVALID");C.update!==void 0&&(C==null||C.update(g,$))}const b=r.length===0?"":`?${r.join("&")}`,y=c.path+b;let w;if(o==="libsql")if(n===!1){if(((x=c.authority)==null?void 0:x.port)===void 0)throw new F('A "libsql:" URL with ?tls=0 must specify an explicit port',"URL_INVALID");w="http"}else w="https";else w=o;if(w==="http"||w==="ws"?n??(n=!1):n??(n=!0),w!=="http"&&w!=="ws"&&w!=="https"&&w!=="wss"&&w!=="file")throw new F(`The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${JSON.stringify(c.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(l!=="number"&&l!=="bigint"&&l!=="string")throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(l)}`);if(c.fragment!==void 0)throw new F(`URL fragments are not supported: ${JSON.stringify("#"+c.fragment)}`,"URL_INVALID");return u?{scheme:"file",tls:!1,path:y,intMode:l,concurrency:i,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch,authToken:void 0,encryptionKey:void 0,remoteEncryptionKey:void 0,authority:void 0}:{scheme:w,tls:n,authority:c.authority,path:y,authToken:a,intMode:l,concurrency:i,encryptionKey:e.encryptionKey,remoteEncryptionKey:e.remoteEncryptionKey,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch}}let as;typeof WebSocket<"u"?as=WebSocket:typeof global<"u"?as=global.WebSocket:typeof window<"u"?as=window.WebSocket:typeof self<"u"&&(as=self.WebSocket);class li{constructor(){q(this,"intMode");this.intMode="number"}}class K extends Error{constructor(t){super(t),this.name="ClientError"}}class j extends K{constructor(t){super(t),this.name="ProtoError"}}class ii extends K{constructor(s,a){super(s);q(this,"code");q(this,"proto");this.name="ResponseError",this.code=a.code,this.proto=a,this.stack=void 0}}class Ae extends K{constructor(t,s){s!==void 0?(super(`${t}: ${s}`),this.cause=s):super(t),this.name="ClosedError"}}class ri extends K{constructor(t){super(t),this.name="WebSocketUnsupportedError"}}class tn extends K{constructor(t){super(t),this.name="WebSocketError"}}class ya extends K{constructor(s,a){super(s);q(this,"status");this.status=a,this.name="HttpServerError"}}class Rs extends K{constructor(t){super(t),this.name="ProtocolVersionError"}}class At extends K{constructor(t){super(t),this.name="InternalError"}}class Ls extends K{constructor(t){super(t),this.name="MisuseError"}}function qe(e){if(typeof e=="string")return e;throw Os(e,"string")}function Fe(e){if(e!=null){if(typeof e=="string")return e;throw Os(e,"string or null")}}function Xt(e){if(typeof e=="number")return e;throw Os(e,"number")}function Qs(e){if(typeof e=="boolean")return e;throw Os(e,"boolean")}function Ia(e){if(Array.isArray(e))return e;throw Os(e,"array")}function ie(e){if(e!==null&&typeof e=="object"&&!Array.isArray(e))return e;throw Os(e,"object")}function Tt(e,t){return Ia(e).map(s=>t(ie(s)))}function Os(e,t){if(e===void 0)return new j(`Expected ${t}, but the property was missing`);let s=typeof e;return e===null?s="null":Array.isArray(e)&&(s="array"),new j(`Expected ${t}, received ${s}`)}function $n(e,t){return t(ie(e))}var X,gt,Ze,Ot;class Mo{constructor(t){_(this,Ze);_(this,X);_(this,gt);h(this,X,t),h(this,gt,!1)}begin(){d(this,X).push("{"),h(this,gt,!0)}end(){d(this,X).push("}"),h(this,gt,!1)}string(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(JSON.stringify(s))}stringRaw(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push('"'),d(this,X).push(s),d(this,X).push('"')}number(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(""+s)}boolean(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(s?"true":"false")}object(t,s,a){S(this,Ze,Ot).call(this,t),this.begin(),a(this,s),this.end()}arrayObjects(t,s,a){S(this,Ze,Ot).call(this,t),d(this,X).push("[");for(let n=0;n<s.length;++n)n!==0&&d(this,X).push(","),this.begin(),a(this,s[n]),this.end();d(this,X).push("]")}}X=new WeakMap,gt=new WeakMap,Ze=new WeakSet,Ot=function(t){d(this,gt)?(d(this,X).push('"'),h(this,gt,!1)):d(this,X).push(',"'),d(this,X).push(t),d(this,X).push('":')};function oi(e,t){const s=[],a=new Mo(s);return a.begin(),t(a,e),a.end(),s.join("")}const Ws=0,sn=1,an=2,Do=5;var Ue,Xs,_e;class Lo{constructor(t){_(this,Ue);_(this,Xs);_(this,_e);h(this,Ue,t),h(this,Xs,new DataView(t.buffer,t.byteOffset,t.byteLength)),h(this,_e,0)}varint(){let t=0;for(let s=0;;s+=7){const a=d(this,Ue)[es(this,_e)._++];if(t|=(a&127)<<s,!(a&128))break}return t}varintBig(){let t=0n;for(let s=0n;;s+=7n){const a=d(this,Ue)[es(this,_e)._++];if(t|=BigInt(a&127)<<s,!(a&128))break}return t}bytes(t){const s=new Uint8Array(d(this,Ue).buffer,d(this,Ue).byteOffset+d(this,_e),t);return h(this,_e,d(this,_e)+t),s}double(){const t=d(this,Xs).getFloat64(d(this,_e),!0);return h(this,_e,d(this,_e)+8),t}skipVarint(){for(;d(this,Ue)[es(this,_e)._++]&128;);}skip(t){h(this,_e,d(this,_e)+t)}eof(){return d(this,_e)>=d(this,Ue).byteLength}}Ue=new WeakMap,Xs=new WeakMap,_e=new WeakMap;var me,ce,Bt,Ps;class Oo{constructor(t){_(this,Bt);_(this,me);_(this,ce);h(this,me,t),h(this,ce,-1)}setup(t){h(this,ce,t)}bytes(){S(this,Bt,Ps).call(this,an);const t=d(this,me).varint();return d(this,me).bytes(t)}string(){return new TextDecoder().decode(this.bytes())}message(t){return qa(this.bytes(),t)}int32(){return S(this,Bt,Ps).call(this,Ws),d(this,me).varint()}uint32(){return this.int32()}bool(){return this.int32()!==0}uint64(){return S(this,Bt,Ps).call(this,Ws),d(this,me).varintBig()}sint64(){const t=this.uint64();return t>>1n^-(t&1n)}double(){return S(this,Bt,Ps).call(this,sn),d(this,me).double()}maybeSkip(){if(!(d(this,ce)<0)){if(d(this,ce)===Ws)d(this,me).skipVarint();else if(d(this,ce)===sn)d(this,me).skip(8);else if(d(this,ce)===an){const t=d(this,me).varint();d(this,me).skip(t)}else if(d(this,ce)===Do)d(this,me).skip(4);else throw new j(`Unexpected wire type ${d(this,ce)}`);h(this,ce,-1)}}}me=new WeakMap,ce=new WeakMap,Bt=new WeakSet,Ps=function(t){if(d(this,ce)!==t)throw new j(`Expected wire type ${t}, got ${d(this,ce)}`);h(this,ce,-1)};function qa(e,t){const s=new Lo(e),a=new Oo(s);let n=t.default();for(;!s.eof();){const l=s.varint(),i=l>>3,r=l&7;a.setup(r);const c=t[i];if(c!==void 0){const o=c(a,n);o!==void 0&&(n=o)}a.maybeSkip()}return n}var Te,wt,cs,be,se,Ns,ka,ci,qs;const Kn=class Kn{constructor(){_(this,se);_(this,Te);_(this,wt);_(this,cs);_(this,be);h(this,Te,new ArrayBuffer(256)),h(this,wt,new Uint8Array(d(this,Te))),h(this,cs,new DataView(d(this,Te))),h(this,be,0)}bytes(t,s){S(this,se,qs).call(this,t,an),S(this,se,ka).call(this,s.byteLength),S(this,se,Ns).call(this,s.byteLength),d(this,wt).set(s,d(this,be)),h(this,be,d(this,be)+s.byteLength)}string(t,s){this.bytes(t,new TextEncoder().encode(s))}message(t,s,a){const n=new Kn;a(n,s),this.bytes(t,n.data())}int32(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,ka).call(this,s)}uint32(t,s){this.int32(t,s)}bool(t,s){this.int32(t,s?1:0)}sint64(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,ci).call(this,s<<1n^s>>63n)}double(t,s){S(this,se,qs).call(this,t,sn),S(this,se,Ns).call(this,8),d(this,cs).setFloat64(d(this,be),s,!0),h(this,be,d(this,be)+8)}data(){return new Uint8Array(d(this,Te),0,d(this,be))}};Te=new WeakMap,wt=new WeakMap,cs=new WeakMap,be=new WeakMap,se=new WeakSet,Ns=function(t){if(d(this,be)+t<=d(this,Te).byteLength)return;let s=d(this,Te).byteLength;for(;s<d(this,be)+t;)s*=2;const a=new ArrayBuffer(s),n=new Uint8Array(a),l=new DataView(a);n.set(new Uint8Array(d(this,Te),0,d(this,be))),h(this,Te,a),h(this,wt,n),h(this,cs,l)},ka=function(t){S(this,se,Ns).call(this,5),t=0|t;do{let s=t&127;t>>>=7,s|=t?128:0,d(this,wt)[es(this,be)._++]=s}while(t)},ci=function(t){S(this,se,Ns).call(this,10),t=t&0xffffffffffffffffn;do{let s=Number(t&0x7fn);t>>=7n,s|=t?128:0,d(this,wt)[es(this,be)._++]=s}while(t)},qs=function(t,s){S(this,se,ka).call(this,t<<3|s)};let nn=Kn;function di(e,t){const s=new nn;return t(s,e),s.data()}var Se,et;class Bs{constructor(){_(this,Se);_(this,et);h(this,Se,new Set),h(this,et,new Set)}alloc(){for(const s of d(this,et))return d(this,et).delete(s),d(this,Se).add(s),d(this,Se).has(d(this,Se).size-1)||d(this,et).add(d(this,Se).size-1),s;const t=d(this,Se).size;return d(this,Se).add(t),t}free(t){if(!d(this,Se).delete(t))throw new At("Freeing an id that is not allocated");d(this,et).delete(d(this,Se).size),t<d(this,Se).size&&d(this,et).add(t)}}Se=new WeakMap,et=new WeakMap;function Q(e,t){throw new At(t)}function zs(e){if(e===null)return null;if(typeof e=="string")return e;if(typeof e=="number"){if(!Number.isFinite(e))throw new RangeError("Only finite numbers (not Infinity or NaN) can be passed as arguments");return e}else if(typeof e=="bigint"){if(e<jo||e>Po)throw new RangeError("This bigint value is too large to be represented as a 64-bit integer and passed as argument");return e}else{if(typeof e=="boolean")return e?1n:0n;if(e instanceof ArrayBuffer)return new Uint8Array(e);if(e instanceof Uint8Array)return e;if(e instanceof Date)return+e.valueOf();if(typeof e=="object")return""+e.toString();throw new TypeError("Unsupported type of value")}}const jo=-9223372036854775808n,Po=9223372036854775807n;function pi(e,t){if(e===null)return null;if(typeof e=="number")return e;if(typeof e=="string")return e;if(typeof e=="bigint")if(t==="number"){const s=Number(e);if(!Number.isSafeInteger(s))throw new RangeError("Received integer which is too large to be safely represented as a JavaScript number");return s}else{if(t==="bigint")return e;if(t==="string")return""+e;throw new Ls("Invalid value for IntMode")}else{if(e instanceof Uint8Array)return e.slice().buffer;throw e===void 0?new j("Received unrecognized type of Value"):Q(e,"Impossible type of Value")}}function fa(e){return{affectedRowCount:e.affectedRowCount,lastInsertRowid:e.lastInsertRowid,columnNames:e.cols.map(t=>t.name),columnDecltypes:e.cols.map(t=>t.decltype)}}function ui(e,t){const s=fa(e),a=e.rows.map(n=>mi(s.columnNames,n,t));return{...s,rows:a}}function xi(e,t){const s=fa(e);let a;return e.rows.length>0&&(a=mi(s.columnNames,e.rows[0],t)),{...s,row:a}}function fi(e,t){const s=fa(e);let a;return e.rows.length>0&&s.columnNames.length>0&&(a=pi(e.rows[0][0],t)),{...s,value:a}}function mi(e,t,s){const a={};Object.defineProperty(a,"length",{value:t.length});for(let n=0;n<t.length;++n){const l=pi(t[n],s);Object.defineProperty(a,n,{value:l});const i=e[n];i!==void 0&&!Object.hasOwn(a,i)&&Object.defineProperty(a,i,{value:l,enumerable:!0,configurable:!0,writable:!0})}return a}function As(e){return new ii(e.message,e)}var ds,ps,tt;class En{constructor(t,s){_(this,ds);_(this,ps);_(this,tt);h(this,ds,t),h(this,ps,s),h(this,tt,void 0)}_getSqlId(t){if(d(this,ds)!==t)throw new Ls("Attempted to use SQL text opened with other object");if(d(this,tt)!==void 0)throw new Ae("SQL text is closed",d(this,tt));return d(this,ps)}close(){this._setClosed(new K("SQL text was manually closed"))}_setClosed(t){d(this,tt)===void 0&&(h(this,tt,t),d(this,ds)._closeSql(d(this,ps)))}get closed(){return d(this,tt)!==void 0}}ds=new WeakMap,ps=new WeakMap,tt=new WeakMap;function ln(e,t){return t instanceof En?{sqlId:t._getSqlId(e)}:{sql:""+t}}var He,Me;class Ca{constructor(){_(this,He);_(this,Me);h(this,He,[]),h(this,Me,[])}get length(){return d(this,He).length+d(this,Me).length}push(t){d(this,He).push(t)}shift(){return d(this,Me).length===0&&d(this,He).length>0&&(h(this,Me,d(this,He).reverse()),h(this,He,[])),d(this,Me).pop()}first(){return d(this,Me).length!==0?d(this,Me)[d(this,Me).length-1]:d(this,He)[0]}}He=new WeakMap,Me=new WeakMap;let bi=class{constructor(t){q(this,"sql");q(this,"_args");q(this,"_namedArgs");this.sql=t,this._args=[],this._namedArgs=new Map}bindIndexes(t){this._args.length=0;for(const s of t)this._args.push(zs(s));return this}bindIndex(t,s){if(t!==(t|0)||t<=0)throw new RangeError("Index of a positional argument must be positive integer");for(;this._args.length<t;)this._args.push(null);return this._args[t-1]=zs(s),this}bindName(t,s){return this._namedArgs.set(t,zs(s)),this}unbindAll(){return this._args.length=0,this._namedArgs.clear(),this}};function hi(e,t,s){let a,n=[],l=[];if(t instanceof bi){a=t.sql,n=t._args;for(const[c,o]of t._namedArgs.entries())l.push({name:c,value:o})}else Array.isArray(t)?(a=t[0],Array.isArray(t[1])?n=t[1].map(c=>zs(c)):l=Object.entries(t[1]).map(([c,o])=>({name:c,value:zs(o)}))):a=t;const{sql:i,sqlId:r}=ln(e,a);return{sql:i,sqlId:r,args:n,namedArgs:l,wantRows:s}}var Zs,us,Ll;let No=(Ll=class{constructor(t,s){q(this,"_stream");_(this,Zs);q(this,"_steps");_(this,us);this._stream=t,h(this,Zs,s),this._steps=[],h(this,us,!1)}step(){return new Fo(this)}execute(){if(d(this,us))throw new Ls("This batch has already been executed");h(this,us,!0);const t={steps:this._steps.map(s=>s.proto)};return d(this,Zs)?Bo(this._stream,this._steps,t):qo(this._stream,this._steps,t)}},Zs=new WeakMap,us=new WeakMap,Ll);function qo(e,t,s){return e._batch(s).then(a=>{for(let n=0;n<t.length;++n){const l=a.stepResults.get(n),i=a.stepErrors.get(n);t[n].callback(l,i)}})}async function Bo(e,t,s){const a=await e._openCursor(s);try{let n=0,l,i=[];for(;;){const r=await a.next();if(r===void 0)break;if(r.type==="step_begin"){if(r.step<n||r.step>=t.length)throw new j("Server produced StepBeginEntry for unexpected step");if(l!==void 0)throw new j("Server produced StepBeginEntry before terminating previous step");for(let c=n;c<r.step;++c)t[c].callback(void 0,void 0);n=r.step+1,l=r,i=[]}else if(r.type==="step_end"){if(l===void 0)throw new j("Server produced StepEndEntry but no step is active");const c={cols:l.cols,rows:i,affectedRowCount:r.affectedRowCount,lastInsertRowid:r.lastInsertRowid};t[l.step].callback(c,void 0),l=void 0,i=[]}else if(r.type==="step_error"){if(l===void 0){if(r.step>=t.length)throw new j("Server produced StepErrorEntry for unexpected step");for(let c=n;c<r.step;++c)t[c].callback(void 0,void 0)}else{if(r.step!==l.step)throw new j("Server produced StepErrorEntry for unexpected step");l=void 0,i=[]}t[r.step].callback(void 0,r.error),n=r.step+1}else if(r.type==="row"){if(l===void 0)throw new j("Server produced RowEntry but no step is active");i.push(r.row)}else throw r.type==="error"?As(r.error):r.type==="none"?new j("Server produced unrecognized CursorEntry"):Q(r,"Impossible CursorEntry")}if(l!==void 0)throw new j("Server closed Cursor before terminating active step");for(let r=n;r<t.length;++r)t[r].callback(void 0,void 0)}finally{a.close()}}var st,Ft,Fs,Ol;let Fo=(Ol=class{constructor(t){_(this,Ft);q(this,"_batch");_(this,st);q(this,"_index");this._batch=t,h(this,st,[]),this._index=void 0}condition(t){return d(this,st).push(t._proto),this}query(t){return S(this,Ft,Fs).call(this,t,!0,ui)}queryRow(t){return S(this,Ft,Fs).call(this,t,!0,xi)}queryValue(t){return S(this,Ft,Fs).call(this,t,!0,fi)}run(t){return S(this,Ft,Fs).call(this,t,!1,fa)}},st=new WeakMap,Ft=new WeakSet,Fs=function(t,s,a){if(this._index!==void 0)throw new Ls("This BatchStep has already been added to the batch");const n=hi(this._batch._stream._sqlOwner(),t,s);let l;d(this,st).length===0?l=void 0:d(this,st).length===1?l=d(this,st)[0]:l={type:"and",conds:d(this,st).slice()};const i={stmt:n,condition:l};return new Promise((r,c)=>{const o=(u,m)=>{u!==void 0&&m!==void 0?c(new j("Server returned both result and error")):m!==void 0?c(As(m)):r(u!==void 0?a(u,this._batch._stream.intMode):void 0)};this._index=this._batch._steps.length,this._batch._steps.push({proto:i,callback:o})})},Ol),ve=class jt{constructor(t,s){q(this,"_batch");q(this,"_proto");this._batch=t,this._proto=s}static ok(t){return new jt(t._batch,{type:"ok",step:rl(t)})}static error(t){return new jt(t._batch,{type:"error",step:rl(t)})}static not(t){return new jt(t._batch,{type:"not",cond:t._proto})}static and(t,s){for(const a of s)ol(t,a);return new jt(t,{type:"and",conds:s.map(a=>a._proto)})}static or(t,s){for(const a of s)ol(t,a);return new jt(t,{type:"or",conds:s.map(a=>a._proto)})}static isAutocommit(t){return t._stream.client()._ensureVersion(3,"BatchCond.isAutocommit()"),new jt(t,{type:"is_autocommit"})}};function rl(e){if(e._index===void 0)throw new Ls("Cannot add a condition referencing a step that has not been added to the batch");return e._index}function ol(e,t){if(t._batch!==e)throw new Ls("Cannot mix BatchCond objects for different Batch objects")}function Vo(e){return{paramNames:e.params.map(t=>t.name),columns:e.cols,isExplain:e.isExplain,isReadonly:e.isReadonly}}var Vt,Vs;class gi{constructor(t){_(this,Vt);q(this,"intMode");this.intMode=t}query(t){return S(this,Vt,Vs).call(this,t,!0,ui)}queryRow(t){return S(this,Vt,Vs).call(this,t,!0,xi)}queryValue(t){return S(this,Vt,Vs).call(this,t,!0,fi)}run(t){return S(this,Vt,Vs).call(this,t,!1,fa)}batch(t=!1){return new No(this,t)}describe(t){const s=ln(this._sqlOwner(),t);return this._describe(s).then(Vo)}sequence(t){const s=ln(this._sqlOwner(),t);return this._sequence(s)}}Vt=new WeakSet,Vs=function(t,s,a){const n=hi(this._sqlOwner(),t,s);return this._execute(n).then(l=>a(l,this.intMode))};class wi{}const Uo=1e3,Ho=10;var ja,Ut,xs,fs,Ht,at,Gt,Pa,vi;class Go extends wi{constructor(s,a,n){super();_(this,Pa);_(this,ja);_(this,Ut);_(this,xs);_(this,fs);_(this,Ht);_(this,at);_(this,Gt);h(this,ja,s),h(this,Ut,a),h(this,xs,n),h(this,fs,new Ca),h(this,Ht,new Ca),h(this,at,void 0),h(this,Gt,!1)}async next(){for(;;){if(d(this,at)!==void 0)throw new Ae("Cursor is closed",d(this,at));for(;!d(this,Gt)&&d(this,Ht).length<Ho;)d(this,Ht).push(S(this,Pa,vi).call(this));const s=d(this,fs).shift();if(d(this,Gt)||s!==void 0)return s;await d(this,Ht).shift().then(a=>{if(a!==void 0){for(const n of a.entries)d(this,fs).push(n);d(this,Gt)||h(this,Gt,a.done)}})}}_setClosed(s){d(this,at)===void 0&&(h(this,at,s),d(this,Ut)._sendCursorRequest(this,{type:"close_cursor",cursorId:d(this,xs)}).catch(()=>{}),d(this,Ut)._cursorClosed(this))}close(){this._setClosed(new K("Cursor was manually closed"))}get closed(){return d(this,at)!==void 0}}ja=new WeakMap,Ut=new WeakMap,xs=new WeakMap,fs=new WeakMap,Ht=new WeakMap,at=new WeakMap,Gt=new WeakMap,Pa=new WeakSet,vi=function(){return d(this,Ut)._sendCursorRequest(this,{type:"fetch_cursor",cursorId:d(this,xs),maxCount:Uo}).then(s=>s,s=>{this._setClosed(s)})};var ne,Ce,nt,$e,vt,De,Z,ts,on,_a,Sa;const Qn=class Qn extends gi{constructor(s,a){super(s.intMode);_(this,Z);_(this,ne);_(this,Ce);_(this,nt);_(this,$e);_(this,vt);_(this,De);h(this,ne,s),h(this,Ce,a),h(this,nt,new Ca),h(this,$e,void 0),h(this,vt,!1),h(this,De,void 0)}static open(s){const a=s._streamIdAlloc.alloc(),n=new Qn(s,a),l=()=>{},i=c=>{var o;return S(o=n,Z,Sa).call(o,c)},r={type:"open_stream",streamId:a};return s._sendRequest(r,{responseCallback:l,errorCallback:i}),n}client(){return d(this,ne)}_sqlOwner(){return d(this,ne)}_execute(s){return S(this,Z,ts).call(this,{type:"execute",streamId:d(this,Ce),stmt:s}).then(a=>a.result)}_batch(s){return S(this,Z,ts).call(this,{type:"batch",streamId:d(this,Ce),batch:s}).then(a=>a.result)}_describe(s){return d(this,ne)._ensureVersion(2,"describe()"),S(this,Z,ts).call(this,{type:"describe",streamId:d(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return d(this,ne)._ensureVersion(2,"sequence()"),S(this,Z,ts).call(this,{type:"sequence",streamId:d(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return d(this,ne)._ensureVersion(3,"getAutocommit()"),S(this,Z,ts).call(this,{type:"get_autocommit",streamId:d(this,Ce)}).then(s=>s.isAutocommit)}_openCursor(s){return d(this,ne)._ensureVersion(3,"cursor"),new Promise((a,n)=>{S(this,Z,on).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_sendCursorRequest(s,a){if(s!==d(this,$e))throw new At("Cursor not associated with the stream attempted to execute a request");return new Promise((n,l)=>{d(this,De)!==void 0?l(new Ae("Stream is closed",d(this,De))):d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})})}_cursorClosed(s){if(s!==d(this,$e))throw new At("Cursor was closed, but it was not associated with the stream");h(this,$e,void 0),S(this,Z,_a).call(this)}close(){S(this,Z,Sa).call(this,new K("Stream was manually closed"))}closeGracefully(){h(this,vt,!0),S(this,Z,_a).call(this)}get closed(){return d(this,De)!==void 0||d(this,vt)}};ne=new WeakMap,Ce=new WeakMap,nt=new WeakMap,$e=new WeakMap,vt=new WeakMap,De=new WeakMap,Z=new WeakSet,ts=function(s){return new Promise((a,n)=>{S(this,Z,on).call(this,{type:"request",request:s,responseCallback:a,errorCallback:n})})},on=function(s){d(this,De)!==void 0?s.errorCallback(new Ae("Stream is closed",d(this,De))):d(this,vt)?s.errorCallback(new Ae("Stream is closing",void 0)):(d(this,nt).push(s),S(this,Z,_a).call(this))},_a=function(){for(;;){const s=d(this,nt).first();if(s===void 0&&d(this,$e)===void 0&&d(this,vt)){S(this,Z,Sa).call(this,new K("Stream was gracefully closed"));break}else if((s==null?void 0:s.type)==="request"&&d(this,$e)===void 0){const{request:a,responseCallback:n,errorCallback:l}=s;d(this,nt).shift(),d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})}else if((s==null?void 0:s.type)==="cursor"&&d(this,$e)===void 0){const{batch:a,cursorCallback:n}=s;d(this,nt).shift();const l=d(this,ne)._cursorIdAlloc.alloc(),i=new Go(d(this,ne),this,l),r={type:"open_cursor",streamId:d(this,Ce),cursorId:l,batch:a},c=()=>{},o=u=>i._setClosed(u);d(this,ne)._sendRequest(r,{responseCallback:c,errorCallback:o}),h(this,$e,i),n(i)}else break}},Sa=function(s){if(d(this,De)!==void 0)return;for(h(this,De,s),d(this,$e)!==void 0&&d(this,$e)._setClosed(s);;){const i=d(this,nt).shift();if(i!==void 0)i.errorCallback(s);else break}const a={type:"close_stream",streamId:d(this,Ce)},n=()=>d(this,ne)._streamIdAlloc.free(d(this,Ce)),l=()=>{};d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})};let rn=Qn;function In(e,t){t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId),e.arrayObjects("args",t.args,yi),e.arrayObjects("named_args",t.namedArgs,Wo),e.boolean("want_rows",t.wantRows)}function Wo(e,t){e.string("name",t.name),e.object("value",t.value,yi)}function Ra(e,t){e.arrayObjects("steps",t.steps,zo)}function zo(e,t){t.condition!==void 0&&e.object("condition",t.condition,cn),e.object("stmt",t.stmt,In)}function cn(e,t){if(e.stringRaw("type",t.type),t.type==="ok"||t.type==="error")e.number("step",t.step);else if(t.type==="not")e.object("cond",t.cond,cn);else if(t.type==="and"||t.type==="or")e.arrayObjects("conds",t.conds,cn);else if(t.type!=="is_autocommit")throw Q(t,"Impossible type of BatchCond")}function yi(e,t){if(t===null)e.stringRaw("type","null");else if(typeof t=="bigint")e.stringRaw("type","integer"),e.stringRaw("value",""+t);else if(typeof t=="number")e.stringRaw("type","float"),e.number("value",t);else if(typeof t=="string")e.stringRaw("type","text"),e.string("value",t);else if(t instanceof Uint8Array)e.stringRaw("type","blob"),e.stringRaw("base64",Sn.fromUint8Array(t));else if(t!==void 0)throw Q(t,"Impossible type of Value")}function Yo(e,t){if(e.stringRaw("type",t.type),t.type==="hello")t.jwt!==void 0&&e.string("jwt",t.jwt);else if(t.type==="request")e.number("request_id",t.requestId),e.object("request",t.request,Jo);else throw Q(t,"Impossible type of ClientMsg")}function Jo(e,t){if(e.stringRaw("type",t.type),t.type==="open_stream")e.number("stream_id",t.streamId);else if(t.type==="close_stream")e.number("stream_id",t.streamId);else if(t.type==="execute")e.number("stream_id",t.streamId),e.object("stmt",t.stmt,In);else if(t.type==="batch")e.number("stream_id",t.streamId),e.object("batch",t.batch,Ra);else if(t.type==="open_cursor")e.number("stream_id",t.streamId),e.number("cursor_id",t.cursorId),e.object("batch",t.batch,Ra);else if(t.type==="close_cursor")e.number("cursor_id",t.cursorId);else if(t.type==="fetch_cursor")e.number("cursor_id",t.cursorId),e.number("max_count",t.maxCount);else if(t.type==="sequence")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type==="get_autocommit")e.number("stream_id",t.streamId);else throw Q(t,"Impossible type of Request")}function Cn(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId);for(const s of t.args)e.message(3,s,ki);for(const s of t.namedArgs)e.message(4,s,Ko);e.bool(5,t.wantRows)}function Ko(e,t){e.string(1,t.name),e.message(2,t.value,ki)}function Ba(e,t){for(const s of t.steps)e.message(1,s,Qo)}function Qo(e,t){t.condition!==void 0&&e.message(1,t.condition,Rn),e.message(2,t.stmt,Cn)}function Rn(e,t){if(t.type==="ok")e.uint32(1,t.step);else if(t.type==="error")e.uint32(2,t.step);else if(t.type==="not")e.message(3,t.cond,Rn);else if(t.type==="and")e.message(4,t.conds,cl);else if(t.type==="or")e.message(5,t.conds,cl);else if(t.type==="is_autocommit")e.message(6,void 0,_i);else throw Q(t,"Impossible type of BatchCond")}function cl(e,t){for(const s of t)e.message(1,s,Rn)}function ki(e,t){if(t===null)e.message(1,void 0,_i);else if(typeof t=="bigint")e.sint64(2,t);else if(typeof t=="number")e.double(3,t);else if(typeof t=="string")e.string(4,t);else if(t instanceof Uint8Array)e.bytes(5,t);else if(t!==void 0)throw Q(t,"Impossible type of Value")}function _i(e,t){}function Xo(e,t){if(t.type==="hello")e.message(1,t,Zo);else if(t.type==="request")e.message(2,t,ec);else throw Q(t,"Impossible type of ClientMsg")}function Zo(e,t){t.jwt!==void 0&&e.string(1,t.jwt)}function ec(e,t){e.int32(1,t.requestId);const s=t.request;if(s.type==="open_stream")e.message(2,s,tc);else if(s.type==="close_stream")e.message(3,s,sc);else if(s.type==="execute")e.message(4,s,ac);else if(s.type==="batch")e.message(5,s,nc);else if(s.type==="open_cursor")e.message(6,s,lc);else if(s.type==="close_cursor")e.message(7,s,ic);else if(s.type==="fetch_cursor")e.message(8,s,rc);else if(s.type==="sequence")e.message(9,s,oc);else if(s.type==="describe")e.message(10,s,cc);else if(s.type==="store_sql")e.message(11,s,dc);else if(s.type==="close_sql")e.message(12,s,pc);else if(s.type==="get_autocommit")e.message(13,s,uc);else throw Q(s,"Impossible type of Request")}function tc(e,t){e.int32(1,t.streamId)}function sc(e,t){e.int32(1,t.streamId)}function ac(e,t){e.int32(1,t.streamId),e.message(2,t.stmt,Cn)}function nc(e,t){e.int32(1,t.streamId),e.message(2,t.batch,Ba)}function lc(e,t){e.int32(1,t.streamId),e.int32(2,t.cursorId),e.message(3,t.batch,Ba)}function ic(e,t){e.int32(1,t.cursorId)}function rc(e,t){e.int32(1,t.cursorId),e.uint32(2,t.maxCount)}function oc(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function cc(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function dc(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function pc(e,t){e.int32(1,t.sqlId)}function uc(e,t){e.int32(1,t.streamId)}function Ts(e){const t=qe(e.message),s=Fe(e.code);return{message:t,code:s}}function An(e){const t=Tt(e.cols,Si),s=Ia(e.rows).map(i=>Tt(i,Ci)),a=Xt(e.affected_row_count),n=Fe(e.last_insert_rowid),l=n!==void 0?BigInt(n):void 0;return{cols:t,rows:s,affectedRowCount:a,lastInsertRowid:l}}function Si(e){const t=Fe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function $i(e){const t=new Map;Ia(e.step_results).forEach((a,n)=>{a!==null&&t.set(n,An(ie(a)))});const s=new Map;return Ia(e.step_errors).forEach((a,n)=>{a!==null&&s.set(n,Ts(ie(a)))}),{stepResults:t,stepErrors:s}}function Ei(e){const t=qe(e.type);if(t==="step_begin"){const s=Xt(e.step),a=Tt(e.cols,Si);return{type:"step_begin",step:s,cols:a}}else if(t==="step_end"){const s=Xt(e.affected_row_count),a=Fe(e.last_insert_rowid),n=a!==void 0?BigInt(a):void 0;return{type:"step_end",affectedRowCount:s,lastInsertRowid:n}}else if(t==="step_error"){const s=Xt(e.step),a=Ts(ie(e.error));return{type:"step_error",step:s,error:a}}else{if(t==="row")return{type:"row",row:Tt(e.row,Ci)};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of CursorEntry")}}function Ii(e){const t=Tt(e.params,xc),s=Tt(e.cols,fc),a=Qs(e.is_explain),n=Qs(e.is_readonly);return{params:t,cols:s,isExplain:a,isReadonly:n}}function xc(e){return{name:Fe(e.name)}}function fc(e){const t=qe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function Ci(e){const t=qe(e.type);if(t==="null")return null;if(t==="integer"){const s=qe(e.value);return BigInt(s)}else{if(t==="float")return Xt(e.value);if(t==="text")return qe(e.value);if(t==="blob")return Sn.toUint8Array(qe(e.base64));throw new j("Unexpected type of Value")}}function mc(e){const t=qe(e.type);if(t==="hello_ok")return{type:"hello_ok"};if(t==="hello_error")return{type:"hello_error",error:Ts(ie(e.error))};if(t==="response_ok"){const s=Xt(e.request_id),a=bc(ie(e.response));return{type:"response_ok",requestId:s,response:a}}else if(t==="response_error"){const s=Xt(e.request_id),a=Ts(ie(e.error));return{type:"response_error",requestId:s,error:a}}else throw new j("Unexpected type of ServerMsg")}function bc(e){const t=qe(e.type);if(t==="open_stream")return{type:"open_stream"};if(t==="close_stream")return{type:"close_stream"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:$i(ie(e.result))};if(t==="open_cursor")return{type:"open_cursor"};if(t==="close_cursor")return{type:"close_cursor"};if(t==="fetch_cursor"){const s=Tt(e.entries,Ei),a=Qs(e.done);return{type:"fetch_cursor",entries:s,done:a}}else{if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:Ii(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of Response")}}const Je={default(){return{message:"",code:void 0}},1(e,t){t.message=e.string()},2(e,t){t.code=e.string()}},Ms={default(){return{cols:[],rows:[],affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.cols.push(e.message(Ri))},2(e,t){t.rows.push(e.message(Ai))},3(e,t){t.affectedRowCount=Number(e.uint64())},4(e,t){t.lastInsertRowid=e.sint64()}},Ri={default(){return{name:void 0,decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},Ai={default(){return[]},1(e,t){t.push(e.message(Sc))}},Aa={default(){return{stepResults:new Map,stepErrors:new Map}},1(e,t){const[s,a]=e.message(hc);t.stepResults.set(s,a)},2(e,t){const[s,a]=e.message(gc);t.stepErrors.set(s,a)}},hc={default(){return[0,Ms.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Ms)}},gc={default(){return[0,Je.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Je)}},Ti={default(){return{type:"none"}},1(e){return e.message(wc)},2(e){return e.message(vc)},3(e){return e.message(yc)},4(e){return{type:"row",row:e.message(Ai)}},5(e){return{type:"error",error:e.message(Je)}}},wc={default(){return{type:"step_begin",step:0,cols:[]}},1(e,t){t.step=e.uint32()},2(e,t){t.cols.push(e.message(Ri))}},vc={default(){return{type:"step_end",affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.affectedRowCount=e.uint32()},2(e,t){t.lastInsertRowid=e.uint64()}},yc={default(){return{type:"step_error",step:0,error:Je.default()}},1(e,t){t.step=e.uint32()},2(e,t){t.error=e.message(Je)}},Ta={default(){return{params:[],cols:[],isExplain:!1,isReadonly:!1}},1(e,t){t.params.push(e.message(kc))},2(e,t){t.cols.push(e.message(_c))},3(e,t){t.isExplain=e.bool()},4(e,t){t.isReadonly=e.bool()}},kc={default(){return{name:void 0}},1(e,t){t.name=e.string()}},_c={default(){return{name:"",decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},Sc={default(){},1(e){return null},2(e){return e.sint64()},3(e){return e.double()},4(e){return e.string()},5(e){return e.bytes()}},$c={default(){return{type:"none"}},1(e){return{type:"hello_ok"}},2(e){return e.message(Ec)},3(e){return e.message(Cc)},4(e){return e.message(Ic)}},Ec={default(){return{type:"hello_error",error:Je.default()}},1(e,t){t.error=e.message(Je)}},Ic={default(){return{type:"response_error",requestId:0,error:Je.default()}},1(e,t){t.requestId=e.int32()},2(e,t){t.error=e.message(Je)}},Cc={default(){return{type:"response_ok",requestId:0,response:{type:"none"}}},1(e,t){t.requestId=e.int32()},2(e,t){t.response={type:"open_stream"}},3(e,t){t.response={type:"close_stream"}},4(e,t){t.response=e.message(Rc)},5(e,t){t.response=e.message(Ac)},6(e,t){t.response={type:"open_cursor"}},7(e,t){t.response={type:"close_cursor"}},8(e,t){t.response=e.message(Tc)},9(e,t){t.response={type:"sequence"}},10(e,t){t.response=e.message(Mc)},11(e,t){t.response={type:"store_sql"}},12(e,t){t.response={type:"close_sql"}},13(e,t){t.response=e.message(Dc)}},Rc={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},Ac={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},Tc={default(){return{type:"fetch_cursor",entries:[],done:!1}},1(e,t){t.entries.push(e.message(Ti))},2(e,t){t.done=e.bool()}},Mc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Dc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Lc=new Map([["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]),Mi=new Map([["hrana3-protobuf",{version:3,encoding:"protobuf"}],["hrana3",{version:3,encoding:"json"}],["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]);var re,Ge,Wt,he,zt,ge,ms,Le,yt,bs,V,dn,Di,pn,Li,Oi,Ve,ji,Pi,jl;let Oc=(jl=class extends li{constructor(s,a){super();_(this,V);_(this,re);_(this,Ge);_(this,Wt);_(this,he);_(this,zt);_(this,ge);_(this,ms);_(this,Le);_(this,yt);q(this,"_streamIdAlloc");q(this,"_cursorIdAlloc");_(this,bs);h(this,re,s),h(this,Ge,[]),h(this,Wt,!1),h(this,he,void 0),h(this,zt,!1),h(this,ge,void 0),h(this,ms,!1),h(this,Le,new Map),h(this,yt,new Bs),this._streamIdAlloc=new Bs,this._cursorIdAlloc=new Bs,h(this,bs,new Bs),d(this,re).binaryType="arraybuffer",d(this,re).addEventListener("open",()=>S(this,V,Di).call(this)),d(this,re).addEventListener("close",n=>S(this,V,Oi).call(this,n)),d(this,re).addEventListener("error",n=>S(this,V,Li).call(this,n)),d(this,re).addEventListener("message",n=>S(this,V,ji).call(this,n)),S(this,V,dn).call(this,{type:"hello",jwt:a})}getVersion(){return new Promise((s,a)=>{if(h(this,ms,!0),d(this,he)!==void 0)a(d(this,he));else if(d(this,Wt))s(d(this,ge).version);else{const n=()=>s(d(this,ge).version);d(this,Ge).push({openCallback:n,errorCallback:a})}})}_ensureVersion(s,a){if(d(this,ge)===void 0||!d(this,ms))throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the WebSocket server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(d(this,ge).version<s)throw new Rs(`${a} is supported on protocol version ${s} and higher, but the WebSocket server only supports version ${d(this,ge).version}`)}_sendRequest(s,a){if(d(this,he)!==void 0){a.errorCallback(new Ae("Client is closed",d(this,he)));return}const n=d(this,yt).alloc();d(this,Le).set(n,{...a,type:s.type}),S(this,V,dn).call(this,{type:"request",requestId:n,request:s})}openStream(){return rn.open(this)}storeSql(s){this._ensureVersion(2,"storeSql()");const a=d(this,bs).alloc(),n=new En(this,a),l=()=>{},i=c=>n._setClosed(c),r={type:"store_sql",sqlId:a,sql:s};return this._sendRequest(r,{responseCallback:l,errorCallback:i}),n}_closeSql(s){if(d(this,he)!==void 0)return;const a=()=>d(this,bs).free(s),n=i=>S(this,V,Ve).call(this,i),l={type:"close_sql",sqlId:s};this._sendRequest(l,{responseCallback:a,errorCallback:n})}close(){S(this,V,Ve).call(this,new K("Client was manually closed"))}get closed(){return d(this,he)!==void 0}},re=new WeakMap,Ge=new WeakMap,Wt=new WeakMap,he=new WeakMap,zt=new WeakMap,ge=new WeakMap,ms=new WeakMap,Le=new WeakMap,yt=new WeakMap,bs=new WeakMap,V=new WeakSet,dn=function(s){if(d(this,he)!==void 0)throw new At("Trying to send a message on a closed client");if(d(this,Wt))S(this,V,pn).call(this,s);else{const a=()=>S(this,V,pn).call(this,s),n=()=>{};d(this,Ge).push({openCallback:a,errorCallback:n})}},Di=function(){const s=d(this,re).protocol;if(s===void 0){S(this,V,Ve).call(this,new K("The `WebSocket.protocol` property is undefined. This most likely means that the WebSocket implementation provided by the environment is broken. If you are using Miniflare 2, please update to Miniflare 3, which fixes this problem."));return}else if(s==="")h(this,ge,{version:1,encoding:"json"});else if(h(this,ge,Mi.get(s)),d(this,ge)===void 0){S(this,V,Ve).call(this,new j(`Unrecognized WebSocket subprotocol: ${JSON.stringify(s)}`));return}for(const a of d(this,Ge))a.openCallback();d(this,Ge).length=0,h(this,Wt,!0)},pn=function(s){const a=d(this,ge).encoding;if(a==="json"){const n=oi(s,Yo);d(this,re).send(n)}else if(a==="protobuf"){const n=di(s,Xo);d(this,re).send(n)}else throw Q(a,"Impossible encoding")},Li=function(s){const n=s.message??"WebSocket was closed due to an error";S(this,V,Ve).call(this,new tn(n))},Oi=function(s){let a=`WebSocket was closed with code ${s.code}`;s.reason&&(a+=`: ${s.reason}`),S(this,V,Ve).call(this,new tn(a))},Ve=function(s){if(d(this,he)===void 0){h(this,he,s);for(const a of d(this,Ge))a.errorCallback(s);d(this,Ge).length=0;for(const[a,n]of d(this,Le).entries())n.errorCallback(s),d(this,yt).free(a);d(this,Le).clear(),d(this,re).close()}},ji=function(s){if(d(this,he)===void 0)try{let a;const n=d(this,ge).encoding;if(n==="json"){if(typeof s.data!="string"){d(this,re).close(3003,"Only text messages are accepted with JSON encoding"),S(this,V,Ve).call(this,new j("Received non-text message from server with JSON encoding"));return}a=$n(JSON.parse(s.data),mc)}else if(n==="protobuf"){if(!(s.data instanceof ArrayBuffer)){d(this,re).close(3003,"Only binary messages are accepted with Protobuf encoding"),S(this,V,Ve).call(this,new j("Received non-binary message from server with Protobuf encoding"));return}a=qa(new Uint8Array(s.data),$c)}else throw Q(n,"Impossible encoding");S(this,V,Pi).call(this,a)}catch(a){d(this,re).close(3007,"Could not handle message"),S(this,V,Ve).call(this,a)}},Pi=function(s){if(s.type==="none")throw new j("Received an unrecognized ServerMsg");if(s.type==="hello_ok"||s.type==="hello_error"){if(d(this,zt))throw new j("Received a duplicated hello response");if(h(this,zt,!0),s.type==="hello_error")throw As(s.error);return}else if(!d(this,zt))throw new j("Received a non-hello message before a hello response");if(s.type==="response_ok"){const a=s.requestId,n=d(this,Le).get(a);if(d(this,Le).delete(a),n===void 0)throw new j("Received unexpected OK response");d(this,yt).free(a);try{if(n.type!==s.response.type)throw console.dir({responseState:n,msg:s}),new j("Received unexpected type of response");n.responseCallback(s.response)}catch(l){throw n.errorCallback(l),l}}else if(s.type==="response_error"){const a=s.requestId,n=d(this,Le).get(a);if(d(this,Le).delete(a),n===void 0)throw new j("Received unexpected error response");d(this,yt).free(a),n.errorCallback(As(s.error))}else throw Q(s,"Impossible ServerMsg type")},jl);var ga=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function jc(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var un={exports:{}};(function(e,t){var s=typeof globalThis<"u"&&globalThis||typeof self<"u"&&self||typeof ga<"u"&&ga,a=function(){function l(){this.fetch=!1,this.DOMException=s.DOMException}return l.prototype=s,new l}();(function(l){(function(i){var r=typeof l<"u"&&l||typeof self<"u"&&self||typeof ga<"u"&&ga||{},c={searchParams:"URLSearchParams"in r,iterable:"Symbol"in r&&"iterator"in Symbol,blob:"FileReader"in r&&"Blob"in r&&function(){try{return new Blob,!0}catch{return!1}}(),formData:"FormData"in r,arrayBuffer:"ArrayBuffer"in r};function o(k){return k&&DataView.prototype.isPrototypeOf(k)}if(c.arrayBuffer)var u=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]"],m=ArrayBuffer.isView||function(k){return k&&u.indexOf(Object.prototype.toString.call(k))>-1};function b(k){if(typeof k!="string"&&(k=String(k)),/[^a-z0-9\-#$%&'*+.^_`|~!]/i.test(k)||k==="")throw new TypeError('Invalid character in header field name: "'+k+'"');return k.toLowerCase()}function y(k){return typeof k!="string"&&(k=String(k)),k}function w(k){var I={next:function(){var O=k.shift();return{done:O===void 0,value:O}}};return c.iterable&&(I[Symbol.iterator]=function(){return I}),I}function f(k){this.map={},k instanceof f?k.forEach(function(I,O){this.append(O,I)},this):Array.isArray(k)?k.forEach(function(I){if(I.length!=2)throw new TypeError("Headers constructor: expected name/value pair to be length 2, found"+I.length);this.append(I[0],I[1])},this):k&&Object.getOwnPropertyNames(k).forEach(function(I){this.append(I,k[I])},this)}f.prototype.append=function(k,I){k=b(k),I=y(I);var O=this.map[k];this.map[k]=O?O+", "+I:I},f.prototype.delete=function(k){delete this.map[b(k)]},f.prototype.get=function(k){return k=b(k),this.has(k)?this.map[k]:null},f.prototype.has=function(k){return this.map.hasOwnProperty(b(k))},f.prototype.set=function(k,I){this.map[b(k)]=y(I)},f.prototype.forEach=function(k,I){for(var O in this.map)this.map.hasOwnProperty(O)&&k.call(I,this.map[O],O,this)},f.prototype.keys=function(){var k=[];return this.forEach(function(I,O){k.push(O)}),w(k)},f.prototype.values=function(){var k=[];return this.forEach(function(I){k.push(I)}),w(k)},f.prototype.entries=function(){var k=[];return this.forEach(function(I,O){k.push([O,I])}),w(k)},c.iterable&&(f.prototype[Symbol.iterator]=f.prototype.entries);function x(k){if(!k._noBody){if(k.bodyUsed)return Promise.reject(new TypeError("Already read"));k.bodyUsed=!0}}function g(k){return new Promise(function(I,O){k.onload=function(){I(k.result)},k.onerror=function(){O(k.error)}})}function $(k){var I=new FileReader,O=g(I);return I.readAsArrayBuffer(k),O}function C(k){var I=new FileReader,O=g(I),U=/charset=([A-Za-z0-9_-]+)/.exec(k.type),G=U?U[1]:"utf-8";return I.readAsText(k,G),O}function E(k){for(var I=new Uint8Array(k),O=new Array(I.length),U=0;U<I.length;U++)O[U]=String.fromCharCode(I[U]);return O.join("")}function L(k){if(k.slice)return k.slice(0);var I=new Uint8Array(k.byteLength);return I.set(new Uint8Array(k)),I.buffer}function J(){return this.bodyUsed=!1,this._initBody=function(k){this.bodyUsed=this.bodyUsed,this._bodyInit=k,k?typeof k=="string"?this._bodyText=k:c.blob&&Blob.prototype.isPrototypeOf(k)?this._bodyBlob=k:c.formData&&FormData.prototype.isPrototypeOf(k)?this._bodyFormData=k:c.searchParams&&URLSearchParams.prototype.isPrototypeOf(k)?this._bodyText=k.toString():c.arrayBuffer&&c.blob&&o(k)?(this._bodyArrayBuffer=L(k.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):c.arrayBuffer&&(ArrayBuffer.prototype.isPrototypeOf(k)||m(k))?this._bodyArrayBuffer=L(k):this._bodyText=k=Object.prototype.toString.call(k):(this._noBody=!0,this._bodyText=""),this.headers.get("content-type")||(typeof k=="string"?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):c.searchParams&&URLSearchParams.prototype.isPrototypeOf(k)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},c.blob&&(this.blob=function(){var k=x(this);if(k)return k;if(this._bodyBlob)return Promise.resolve(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]));if(this._bodyFormData)throw new Error("could not read FormData body as blob");return Promise.resolve(new Blob([this._bodyText]))}),this.arrayBuffer=function(){if(this._bodyArrayBuffer){var k=x(this);return k||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer))}else{if(c.blob)return this.blob().then($);throw new Error("could not read as ArrayBuffer")}},this.text=function(){var k=x(this);if(k)return k;if(this._bodyBlob)return C(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(E(this._bodyArrayBuffer));if(this._bodyFormData)throw new Error("could not read FormData body as text");return Promise.resolve(this._bodyText)},c.formData&&(this.formData=function(){return this.text().then(M)}),this.json=function(){return this.text().then(JSON.parse)},this}var mt=["CONNECT","DELETE","GET","HEAD","OPTIONS","PATCH","POST","PUT","TRACE"];function Xe(k){var I=k.toUpperCase();return mt.indexOf(I)>-1?I:k}function xe(k,I){if(!(this instanceof xe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');I=I||{};var O=I.body;if(k instanceof xe){if(k.bodyUsed)throw new TypeError("Already read");this.url=k.url,this.credentials=k.credentials,I.headers||(this.headers=new f(k.headers)),this.method=k.method,this.mode=k.mode,this.signal=k.signal,!O&&k._bodyInit!=null&&(O=k._bodyInit,k.bodyUsed=!0)}else this.url=String(k);if(this.credentials=I.credentials||this.credentials||"same-origin",(I.headers||!this.headers)&&(this.headers=new f(I.headers)),this.method=Xe(I.method||this.method||"GET"),this.mode=I.mode||this.mode||null,this.signal=I.signal||this.signal||function(){if("AbortController"in r){var P=new AbortController;return P.signal}}(),this.referrer=null,(this.method==="GET"||this.method==="HEAD")&&O)throw new TypeError("Body not allowed for GET or HEAD requests");if(this._initBody(O),(this.method==="GET"||this.method==="HEAD")&&(I.cache==="no-store"||I.cache==="no-cache")){var U=/([?&])_=[^&]*/;if(U.test(this.url))this.url=this.url.replace(U,"$1_="+new Date().getTime());else{var G=/\?/;this.url+=(G.test(this.url)?"&":"?")+"_="+new Date().getTime()}}}xe.prototype.clone=function(){return new xe(this,{body:this._bodyInit})};function M(k){var I=new FormData;return k.trim().split("&").forEach(function(O){if(O){var U=O.split("="),G=U.shift().replace(/\+/g," "),P=U.join("=").replace(/\+/g," ");I.append(decodeURIComponent(G),decodeURIComponent(P))}}),I}function Dt(k){var I=new f,O=k.replace(/\r?\n[\t ]+/g," ");return O.split("\r").map(function(U){return U.indexOf(`
`)===0?U.substr(1,U.length):U}).forEach(function(U){var G=U.split(":"),P=G.shift().trim();if(P){var ba=G.join(":").trim();try{I.append(P,ba)}catch(Ga){console.warn("Response "+Ga.message)}}}),I}J.call(xe.prototype);function fe(k,I){if(!(this instanceof fe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');if(I||(I={}),this.type="default",this.status=I.status===void 0?200:I.status,this.status<200||this.status>599)throw new RangeError("Failed to construct 'Response': The status provided (0) is outside the range [200, 599].");this.ok=this.status>=200&&this.status<300,this.statusText=I.statusText===void 0?"":""+I.statusText,this.headers=new f(I.headers),this.url=I.url||"",this._initBody(k)}J.call(fe.prototype),fe.prototype.clone=function(){return new fe(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new f(this.headers),url:this.url})},fe.error=function(){var k=new fe(null,{status:200,statusText:""});return k.ok=!1,k.status=0,k.type="error",k};var pr=[301,302,303,307,308];fe.redirect=function(k,I){if(pr.indexOf(I)===-1)throw new RangeError("Invalid status code");return new fe(null,{status:I,headers:{location:k}})},i.DOMException=r.DOMException;try{new i.DOMException}catch{i.DOMException=function(I,O){this.message=I,this.name=O;var U=Error(I);this.stack=U.stack},i.DOMException.prototype=Object.create(Error.prototype),i.DOMException.prototype.constructor=i.DOMException}function Ha(k,I){return new Promise(function(O,U){var G=new xe(k,I);if(G.signal&&G.signal.aborted)return U(new i.DOMException("Aborted","AbortError"));var P=new XMLHttpRequest;function ba(){P.abort()}P.onload=function(){var ae={statusText:P.statusText,headers:Dt(P.getAllResponseHeaders()||"")};G.url.indexOf("file://")===0&&(P.status<200||P.status>599)?ae.status=200:ae.status=P.status,ae.url="responseURL"in P?P.responseURL:ae.headers.get("X-Request-URL");var Lt="response"in P?P.response:P.responseText;setTimeout(function(){O(new fe(Lt,ae))},0)},P.onerror=function(){setTimeout(function(){U(new TypeError("Network request failed"))},0)},P.ontimeout=function(){setTimeout(function(){U(new TypeError("Network request timed out"))},0)},P.onabort=function(){setTimeout(function(){U(new i.DOMException("Aborted","AbortError"))},0)};function Ga(ae){try{return ae===""&&r.location.href?r.location.href:ae}catch{return ae}}if(P.open(G.method,Ga(G.url),!0),G.credentials==="include"?P.withCredentials=!0:G.credentials==="omit"&&(P.withCredentials=!1),"responseType"in P&&(c.blob?P.responseType="blob":c.arrayBuffer&&(P.responseType="arraybuffer")),I&&typeof I.headers=="object"&&!(I.headers instanceof f||r.Headers&&I.headers instanceof r.Headers)){var Xn=[];Object.getOwnPropertyNames(I.headers).forEach(function(ae){Xn.push(b(ae)),P.setRequestHeader(ae,y(I.headers[ae]))}),G.headers.forEach(function(ae,Lt){Xn.indexOf(Lt)===-1&&P.setRequestHeader(Lt,ae)})}else G.headers.forEach(function(ae,Lt){P.setRequestHeader(Lt,ae)});G.signal&&(G.signal.addEventListener("abort",ba),P.onreadystatechange=function(){P.readyState===4&&G.signal.removeEventListener("abort",ba)}),P.send(typeof G._bodyInit>"u"?null:G._bodyInit)})}return Ha.polyfill=!0,r.fetch||(r.fetch=Ha,r.Headers=f,r.Request=xe,r.Response=fe),i.Headers=f,i.Request=xe,i.Response=fe,i.fetch=Ha,i})({})})(a),a.fetch.ponyfill=!0,delete a.fetch.polyfill;var n=s.fetch?s:a;t=n.fetch,t.default=n.fetch,t.fetch=n.fetch,t.Headers=n.Headers,t.Request=n.Request,t.Response=n.Response,e.exports=t})(un,un.exports);var Ma=un.exports;let ns;if(typeof queueMicrotask<"u")ns=queueMicrotask;else{const e=Promise.resolve();ns=t=>{e.then(t)}}var Ee,Oe,we,Na,Ni;class Pc{constructor(t){_(this,Na);_(this,Ee);_(this,Oe);_(this,we);h(this,Ee,new Uint8Array(new ArrayBuffer(t))),h(this,Oe,0),h(this,we,0)}get length(){return d(this,we)-d(this,Oe)}data(){return d(this,Ee).slice(d(this,Oe),d(this,we))}push(t){S(this,Na,Ni).call(this,t.byteLength),d(this,Ee).set(t,d(this,we)),h(this,we,d(this,we)+t.byteLength)}shift(t){h(this,Oe,d(this,Oe)+t)}}Ee=new WeakMap,Oe=new WeakMap,we=new WeakMap,Na=new WeakSet,Ni=function(t){if(d(this,we)+t<=d(this,Ee).byteLength)return;const s=d(this,we)-d(this,Oe);if(s+t<=d(this,Ee).byteLength&&2*d(this,we)>=d(this,Ee).byteLength)d(this,Ee).copyWithin(0,d(this,Oe),d(this,we));else{let a=d(this,Ee).byteLength;do a*=2;while(s+t>a);const n=new Uint8Array(new ArrayBuffer(a));n.set(d(this,Ee).slice(d(this,Oe),d(this,we)),0),h(this,Ee,n)}h(this,we,s),h(this,Oe,0)};function Nc(e){const t=Fe(e.baton),s=Fe(e.base_url),a=Tt(e.results,qc);return{baton:t,baseUrl:s,results:a}}function qc(e){const t=qe(e.type);if(t==="ok")return{type:"ok",response:Bc(ie(e.response))};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of StreamResult")}function Bc(e){const t=qe(e.type);if(t==="close")return{type:"close"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:$i(ie(e.result))};if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:Ii(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of StreamResponse")}function Fc(e){const t=Fe(e.baton),s=Fe(e.base_url);return{baton:t,baseUrl:s}}const Vc={default(){return{baton:void 0,baseUrl:void 0,results:[]}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()},3(e,t){t.results.push(e.message(Uc))}},Uc={default(){return{type:"none"}},1(e){return{type:"ok",response:e.message(Hc)}},2(e){return{type:"error",error:e.message(Je)}}},Hc={default(){return{type:"none"}},1(e){return{type:"close"}},2(e){return e.message(Gc)},3(e){return e.message(Wc)},4(e){return{type:"sequence"}},5(e){return e.message(zc)},6(e){return{type:"store_sql"}},7(e){return{type:"close_sql"}},8(e){return e.message(Yc)}},Gc={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},Wc={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},zc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Yc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Jc={default(){return{baton:void 0,baseUrl:void 0}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()}};var ea,Yt,lt,We,it,hs,ft,xn,qi,Bi;class Kc extends wi{constructor(s,a){super();_(this,ft);_(this,ea);_(this,Yt);_(this,lt);_(this,We);_(this,it);_(this,hs);h(this,ea,s),h(this,Yt,a),h(this,lt,void 0),h(this,We,new Pc(16*1024)),h(this,it,void 0),h(this,hs,!1)}async open(s){if(s.body===null)throw new j("No response body for cursor request");h(this,lt,s.body[Symbol.asyncIterator]());const a=await S(this,ft,xn).call(this,Fc,Jc);if(a===void 0)throw new j("Empty response to cursor request");return a}next(){return S(this,ft,xn).call(this,Ei,Ti)}close(){this._setClosed(new K("Cursor was manually closed"))}_setClosed(s){d(this,it)===void 0&&(h(this,it,s),d(this,ea)._cursorClosed(this),d(this,lt)!==void 0&&d(this,lt).return())}get closed(){return d(this,it)!==void 0}}ea=new WeakMap,Yt=new WeakMap,lt=new WeakMap,We=new WeakMap,it=new WeakMap,hs=new WeakMap,ft=new WeakSet,xn=async function(s,a){for(;;){if(d(this,hs))return;if(d(this,it)!==void 0)throw new Ae("Cursor is closed",d(this,it));if(d(this,Yt)==="json"){const i=S(this,ft,qi).call(this);if(i!==void 0){const r=new TextDecoder().decode(i),c=JSON.parse(r);return $n(c,s)}}else if(d(this,Yt)==="protobuf"){const i=S(this,ft,Bi).call(this);if(i!==void 0)return qa(i,a)}else throw Q(d(this,Yt),"Impossible encoding");if(d(this,lt)===void 0)throw new At("Attempted to read from HTTP cursor before it was opened");const{value:n,done:l}=await d(this,lt).next();if(l&&d(this,We).length===0)h(this,hs,!0);else{if(l)throw new j("Unexpected end of cursor stream");d(this,We).push(n)}}},qi=function(){const s=d(this,We).data(),n=s.indexOf(10);if(n<0)return;const l=s.slice(0,n);return d(this,We).shift(n+1),l},Bi=function(){const s=d(this,We).data();let a=0,n=0;for(;;){if(n>=s.byteLength)return;const i=s[n];if(a|=(i&127)<<7*n,n+=1,!(i&128))break}if(s.byteLength<n+a)return;const l=s.slice(n,n+a);return d(this,We).shift(n+a),l};function Qc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.arrayObjects("requests",t.requests,Xc)}function Xc(e,t){if(e.stringRaw("type",t.type),t.type!=="close"){if(t.type==="execute")e.object("stmt",t.stmt,In);else if(t.type==="batch")e.object("batch",t.batch,Ra);else if(t.type==="sequence")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type!=="get_autocommit")throw Q(t,"Impossible type of StreamRequest")}}function Zc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.object("batch",t.batch,Ra)}function ed(e,t){t.baton!==void 0&&e.string(1,t.baton);for(const s of t.requests)e.message(2,s,td)}function td(e,t){if(t.type==="close")e.message(1,t,sd);else if(t.type==="execute")e.message(2,t,ad);else if(t.type==="batch")e.message(3,t,nd);else if(t.type==="sequence")e.message(4,t,ld);else if(t.type==="describe")e.message(5,t,id);else if(t.type==="store_sql")e.message(6,t,rd);else if(t.type==="close_sql")e.message(7,t,od);else if(t.type==="get_autocommit")e.message(8,t,cd);else throw Q(t,"Impossible type of StreamRequest")}function sd(e,t){}function ad(e,t){e.message(1,t.stmt,Cn)}function nd(e,t){e.message(1,t.batch,Ba)}function ld(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function id(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function rd(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function od(e,t){e.int32(1,t.sqlId)}function cd(e,t){}function dd(e,t){t.baton!==void 0&&e.string(1,t.baton),e.message(2,t.batch,Ba)}var rt,kt,gs,ta,ws,_t,je,St,ot,ct,$t,ze,vs,N,bt,fn,Pt,Fi,Vi,mn,Ui,Hi,bn;class pd extends gi{constructor(s,a,n,l,i){super(s.intMode);_(this,N);_(this,rt);_(this,kt);_(this,gs);_(this,ta);_(this,ws);_(this,_t);_(this,je);_(this,St);_(this,ot);_(this,ct);_(this,$t);_(this,ze);_(this,vs);h(this,rt,s),h(this,kt,a.toString()),h(this,gs,n),h(this,ta,l),h(this,ws,i),h(this,_t,void 0),h(this,je,new Ca),h(this,St,!1),h(this,ct,!1),h(this,$t,!1),h(this,ze,void 0),h(this,vs,new Bs)}client(){return d(this,rt)}_sqlOwner(){return this}storeSql(s){const a=d(this,vs).alloc();return S(this,N,bt).call(this,{type:"store_sql",sqlId:a,sql:s}).then(()=>{},n=>this._setClosed(n)),new En(this,a)}_closeSql(s){d(this,ze)===void 0&&S(this,N,bt).call(this,{type:"close_sql",sqlId:s}).then(()=>d(this,vs).free(s),a=>this._setClosed(a))}_execute(s){return S(this,N,bt).call(this,{type:"execute",stmt:s}).then(a=>a.result)}_batch(s){return S(this,N,bt).call(this,{type:"batch",batch:s}).then(a=>a.result)}_describe(s){return S(this,N,bt).call(this,{type:"describe",sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return S(this,N,bt).call(this,{type:"sequence",sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return d(this,rt)._ensureVersion(3,"getAutocommit()"),S(this,N,bt).call(this,{type:"get_autocommit"}).then(s=>s.isAutocommit)}_openCursor(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_cursorClosed(s){if(s!==d(this,ot))throw new At("Cursor was closed, but it was not associated with the stream");h(this,ot,void 0),ns(()=>S(this,N,Pt).call(this))}close(){this._setClosed(new K("Stream was manually closed"))}closeGracefully(){h(this,ct,!0),ns(()=>S(this,N,Pt).call(this))}get closed(){return d(this,ze)!==void 0||d(this,ct)}_setClosed(s){if(d(this,ze)===void 0){for(h(this,ze,s),d(this,ot)!==void 0&&d(this,ot)._setClosed(s),d(this,rt)._streamClosed(this);;){const a=d(this,je).shift();if(a!==void 0)a.errorCallback(s);else break}(d(this,_t)!==void 0||d(this,St))&&!d(this,$t)&&(d(this,je).push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),h(this,$t,!0),ns(()=>S(this,N,Pt).call(this)))}}}rt=new WeakMap,kt=new WeakMap,gs=new WeakMap,ta=new WeakMap,ws=new WeakMap,_t=new WeakMap,je=new WeakMap,St=new WeakMap,ot=new WeakMap,ct=new WeakMap,$t=new WeakMap,ze=new WeakMap,vs=new WeakMap,N=new WeakSet,bt=function(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"pipeline",request:s,responseCallback:a,errorCallback:n})})},fn=function(s){if(d(this,ze)!==void 0)throw new Ae("Stream is closed",d(this,ze));if(d(this,ct))throw new Ae("Stream is closing",void 0);d(this,je).push(s),ns(()=>S(this,N,Pt).call(this))},Pt=function(){if(d(this,St)||d(this,ot)!==void 0)return;if(d(this,ct)&&d(this,je).length===0){this._setClosed(new K("Stream was gracefully closed"));return}const s=d(this,rt)._endpoint;if(s===void 0){d(this,rt)._endpointPromise.then(()=>S(this,N,Pt).call(this),n=>this._setClosed(n));return}const a=d(this,je).shift();if(a!==void 0)if(a.type==="pipeline"){const n=[a];for(;;){const l=d(this,je).first();if(l!==void 0&&l.type==="pipeline")n.push(l),d(this,je).shift();else if(l===void 0&&d(this,ct)&&!d(this,$t)){n.push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),h(this,$t,!0);break}else break}S(this,N,Fi).call(this,s,n)}else if(a.type==="cursor")S(this,N,Vi).call(this,s,a);else throw Q(a,"Impossible type of QueueEntry")},Fi=function(s,a){S(this,N,mn).call(this,()=>S(this,N,Ui).call(this,a,s),n=>xd(n,s.encoding),n=>n.baton,n=>n.baseUrl,n=>ud(a,n),n=>a.forEach(l=>l.errorCallback(n)))},Vi=function(s,a){const n=new Kc(this,s.encoding);h(this,ot,n),S(this,N,mn).call(this,()=>S(this,N,Hi).call(this,a,s),l=>n.open(l),l=>l.baton,l=>l.baseUrl,l=>a.cursorCallback(n),l=>a.errorCallback(l))},mn=function(s,a,n,l,i,r){let c;try{const o=s();c=d(this,ta)(o)}catch(o){c=Promise.reject(o)}h(this,St,!0),c.then(o=>o.ok?a(o):fd(o).then(u=>{throw u})).then(o=>{h(this,_t,n(o)),h(this,kt,l(o)??d(this,kt)),i(o)}).catch(o=>{this._setClosed(o),r(o)}).finally(()=>{h(this,St,!1),S(this,N,Pt).call(this)})},Ui=function(s,a){return S(this,N,bn).call(this,new URL(a.pipelinePath,d(this,kt)),{baton:d(this,_t),requests:s.map(n=>n.request)},a.encoding,Qc,ed)},Hi=function(s,a){if(a.cursorPath===void 0)throw new Rs(`Cursors are supported only on protocol version 3 and higher, but the HTTP server only supports version ${a.version}.`);return S(this,N,bn).call(this,new URL(a.cursorPath,d(this,kt)),{baton:d(this,_t),batch:s.batch},a.encoding,Zc,dd)},bn=function(s,a,n,l,i){let r,c;if(n==="json")r=oi(a,l),c="application/json";else if(n==="protobuf")r=di(a,i),c="application/x-protobuf";else throw Q(n,"Impossible encoding");const o=new Ma.Headers;return o.set("content-type",c),d(this,gs)!==void 0&&o.set("authorization",`Bearer ${d(this,gs)}`),d(this,ws)!==void 0&&o.set("x-turso-encryption-key",d(this,ws)),new Ma.Request(s.toString(),{method:"POST",headers:o,body:r})};function ud(e,t){if(t.results.length!==e.length)throw new j("Server returned unexpected number of pipeline results");for(let s=0;s<e.length;++s){const a=t.results[s],n=e[s];if(a.type==="ok"){if(a.response.type!==n.request.type)throw new j("Received unexpected type of response");n.responseCallback(a.response)}else if(a.type==="error")n.errorCallback(As(a.error));else throw a.type==="none"?new j("Received unrecognized type of StreamResult"):Q(a,"Received impossible type of StreamResult")}}async function xd(e,t){var s;if(t==="json"){const a=await e.json();return $n(a,Nc)}if(t==="protobuf"){const a=await e.arrayBuffer();return qa(new Uint8Array(a),Vc)}throw await((s=e.body)==null?void 0:s.cancel()),Q(t,"Impossible encoding")}async function fd(e){var a;const t=e.headers.get("content-type")??"text/plain";let s=`Server returned HTTP status ${e.status}`;if(t==="application/json"){const n=await e.json();return"message"in n?As(n):new ya(s,e.status)}if(t==="text/plain"){const n=(await e.text()).trim();return n!==""&&(s+=`: ${n}`),new ya(s,e.status)}return await((a=e.body)==null?void 0:a.cancel()),new ya(s,e.status)}const md=[{versionPath:"v3-protobuf",pipelinePath:"v3-protobuf/pipeline",cursorPath:"v3-protobuf/cursor",version:3,encoding:"protobuf"}],hn={versionPath:"v2",pipelinePath:"v2/pipeline",cursorPath:void 0,version:2,encoding:"json"};var ys,sa,ks,aa,dt,Jt,_s,$a,Pl;let bd=(Pl=class extends li{constructor(s,a,n,l,i=2){super();_(this,_s);_(this,ys);_(this,sa);_(this,ks);_(this,aa);_(this,dt);_(this,Jt);q(this,"_endpointPromise");q(this,"_endpoint");h(this,ys,s),h(this,sa,a),h(this,ks,n??Ma.fetch),h(this,aa,l),h(this,dt,void 0),h(this,Jt,new Set),i==3?(this._endpointPromise=hd(d(this,ks),d(this,ys)),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r))):(this._endpointPromise=Promise.resolve(hn),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r)))}async getVersion(){return this._endpoint!==void 0?this._endpoint.version:(await this._endpointPromise).version}_ensureVersion(s,a){if(!(s<=hn.version)){if(this._endpoint===void 0)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the HTTP server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(this._endpoint.version<s)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the HTTP server only supports version ${this._endpoint.version}.`)}}openStream(){if(d(this,dt)!==void 0)throw new Ae("Client is closed",d(this,dt));const s=new pd(this,d(this,ys),d(this,sa),d(this,ks),d(this,aa));return d(this,Jt).add(s),s}_streamClosed(s){d(this,Jt).delete(s)}close(){S(this,_s,$a).call(this,new K("Client was manually closed"))}get closed(){return d(this,dt)!==void 0}},ys=new WeakMap,sa=new WeakMap,ks=new WeakMap,aa=new WeakMap,dt=new WeakMap,Jt=new WeakMap,_s=new WeakSet,$a=function(s){if(d(this,dt)===void 0){h(this,dt,s);for(const a of Array.from(d(this,Jt)))a._setClosed(new Ae("Client was closed",s))}},Pl);async function hd(e,t){const s=e;for(const a of md){const n=new URL(a.versionPath,t),l=new Ma.Request(n.toString(),{method:"GET"}),i=await s(l);if(await i.arrayBuffer(),i.ok)return a}return hn}function Gi(e,t,s=2){if(typeof as>"u")throw new ri("WebSockets are not supported in this environment");var a=void 0;s==3?a=Array.from(Mi.keys()):a=Array.from(Lc.keys());const n=new as(e,a);return new Oc(n,t)}function dl(e,t,s,a,n=2){return new bd(e instanceof URL?e:new URL(e),t,s,a,n)}var Ss,pt,de;class Wi{constructor(t,s){_(this,Ss);_(this,pt);_(this,de);h(this,Ss,t),h(this,pt,s),h(this,de,void 0)}execute(t){return this.batch([t]).then(s=>s[0])}async batch(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{const a=t.map(Zt);let n;if(d(this,de)===void 0){this._getSqlCache().apply(a);const i=s.batch(d(this,pt)>=3),r=i.step(),c=r.run(en(d(this,Ss)));let o=r;n=a.map(u=>{const m=i.step().condition(ve.ok(o));d(this,pt)>=3&&m.condition(ve.not(ve.isAutocommit(i)));const b=m.query(u);return b.catch(()=>{}),o=m,b}),h(this,de,i.execute().then(()=>c).then(()=>{}));try{await d(this,de)}catch(u){throw this.close(),u}}else{d(this,pt)<3&&await d(this,de),this._getSqlCache().apply(a);const i=s.batch(d(this,pt)>=3);let r;n=a.map(c=>{const o=i.step();r!==void 0&&o.condition(ve.ok(r)),d(this,pt)>=3&&o.condition(ve.not(ve.isAutocommit(i)));const u=o.query(c);return u.catch(()=>{}),r=o,u}),await i.execute()}const l=[];for(let i=0;i<n.length;i++)try{const r=await n[i];if(r===void 0)throw new ls("Statement in a transaction was not executed, probably because the transaction has been rolled back",i,"TRANSACTION_CLOSED");l.push(Fa(r))}catch(r){if(r instanceof ls)throw r;const c=z(r);throw c instanceof F?new ls(c.message,i,c.code,c.extendedCode,c.rawCode,c.cause instanceof Error?c.cause:void 0):c}return l}catch(a){throw z(a)}}async executeMultiple(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{if(d(this,de)===void 0){h(this,de,s.run(en(d(this,Ss))).then(()=>{}));try{await d(this,de)}catch(a){throw this.close(),a}}else await d(this,de);await s.sequence(t)}catch(a){throw z(a)}}async rollback(){try{const t=this._getStream();if(t.closed||d(this,de)===void 0)return;const s=t.run("ROLLBACK").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}async commit(){try{const t=this._getStream();if(t.closed)throw new F("Cannot commit the transaction because it is already closed","TRANSACTION_CLOSED");if(d(this,de)!==void 0)await d(this,de);else return;const s=t.run("COMMIT").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}}Ss=new WeakMap,pt=new WeakMap,de=new WeakMap;async function Da(e,t,s,a,n=!1){n&&s.step().run("PRAGMA foreign_keys=off");const l=s.step(),i=l.run(en(e));let r=l;const c=a.map(y=>{const w=s.step().condition(ve.ok(r));t>=3&&w.condition(ve.not(ve.isAutocommit(s)));const f=w.query(y);return r=w,f}),o=s.step().condition(ve.ok(r));t>=3&&o.condition(ve.not(ve.isAutocommit(s)));const u=o.run("COMMIT");s.step().condition(ve.not(ve.ok(o))).run("ROLLBACK").catch(y=>{}),n&&s.step().run("PRAGMA foreign_keys=on"),await s.execute();const b=[];await i;for(let y=0;y<c.length;y++)try{const w=await c[y];if(w===void 0)throw new ls("Statement in a batch was not executed, probably because the transaction has been rolled back",y,"TRANSACTION_CLOSED");b.push(Fa(w))}catch(w){if(w instanceof ls)throw w;const f=z(w);throw f instanceof F?new ls(f.message,y,f.code,f.extendedCode,f.rawCode,f.cause instanceof Error?f.cause:void 0):f}return await u,b}function Zt(e){let t,s;Array.isArray(e)?[t,s]=e:typeof e=="string"?t=e:(t=e.sql,s=e.args);const a=new bi(t);if(s)if(Array.isArray(s))a.bindIndexes(s);else for(const[n,l]of Object.entries(s))a.bindName(n,l);return a}function Fa(e){const t=e.columnNames.map(i=>i??""),s=e.columnDecltypes.map(i=>i??""),a=e.rows,n=e.affectedRowCount,l=e.lastInsertRowid!==void 0?e.lastInsertRowid:void 0;return new Co(t,s,a,n,l)}function z(e){if(e instanceof K){const t=zi(e);return new F(e.message,t,void 0,void 0,e)}return e}function zi(e){return e instanceof ii&&e.code!==void 0?e.code:e instanceof j?"HRANA_PROTO_ERROR":e instanceof Ae?e.cause instanceof K?zi(e.cause):"HRANA_CLOSED_ERROR":e instanceof tn?"HRANA_WEBSOCKET_ERROR":e instanceof ya?"SERVER_ERROR":e instanceof Rs?"PROTOCOL_VERSION_ERROR":e instanceof At?"INTERNAL_ERROR":"UNKNOWN"}var na,Ye;class Tn{constructor(t,s){_(this,na);_(this,Ye);q(this,"capacity");h(this,na,t),h(this,Ye,new gd),this.capacity=s}apply(t){if(this.capacity<=0)return;const s=new Set;for(const a of t){if(typeof a.sql!="string")continue;const n=a.sql;if(n.length>=5e3)continue;let l=d(this,Ye).get(n);if(l===void 0){for(;d(this,Ye).size+1>this.capacity;){const[i,r]=d(this,Ye).peekLru();if(s.has(r))break;r.close(),d(this,Ye).delete(i)}d(this,Ye).size+1<=this.capacity&&(l=d(this,na).storeSql(n),d(this,Ye).set(n,l))}l!==void 0&&(a.sql=l,s.add(l))}}}na=new WeakMap,Ye=new WeakMap;var Pe;class gd{constructor(){_(this,Pe);h(this,Pe,new Map)}get(t){const s=d(this,Pe).get(t);return s!==void 0&&(d(this,Pe).delete(t),d(this,Pe).set(t,s)),s}set(t,s){d(this,Pe).set(t,s)}peekLru(){for(const t of d(this,Pe).entries())return t}delete(t){d(this,Pe).delete(t)}get size(){return d(this,Pe).size}}Pe=new WeakMap;function wd(e){var t=0,s=[];function a(){t--,t<e&&n()}function n(){var c=s.shift();r.queue=s.length,c&&i(c.fn).then(c.resolve).catch(c.reject)}function l(c){return new Promise(function(o,u){s.push({fn:c,resolve:o,reject:u}),r.queue=s.length})}function i(c){t++;try{return Promise.resolve(c()).then(function(o){return a(),o},function(o){throw a(),o})}catch(o){return a(),Promise.reject(o)}}var r=function(c){return t>=e?l(c):i(c)};return r}function vd(e,t){var s=!1,a=this;return Promise.all(e.map(function(){var n=arguments;return a(function(){if(!s)return t.apply(void 0,n).catch(function(l){throw s=!0,l})})}))}function pl(e){return e.queue=0,e.map=vd,e}var yd=function(e){return pl(e?wd(e):function(t){return t()})};const Yi=jc(yd);function kd(e){if(e.scheme!=="wss"&&e.scheme!=="ws")throw new F(`The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="ws"&&e.tls)throw new F('A "ws:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="wss"&&!e.tls)throw new F('A "wss:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);let s;try{s=Gi(t,e.authToken)}catch(a){if(a instanceof ri){const n=e.scheme==="wss"?"https":"http",l=Qa(n,e.authority,e.path);throw new F(`This environment does not support WebSockets, please switch to the HTTP client by using a "${n}:" URL (${JSON.stringify(l)}). For more information, please read ${Ks}`,"WEBSOCKETS_NOT_SUPPORTED")}throw z(a)}return new Sd(s,t,e.authToken,e.intMode,e.concurrency)}const _d=60*1e3,ul=100;var la,ia,ra,ee,oe,vn,oa,Ie,ss,Us;class Sd{constructor(t,s,a,n,l){_(this,Ie);_(this,la);_(this,ia);_(this,ra);_(this,ee);_(this,oe);q(this,"closed");q(this,"protocol");_(this,vn);_(this,oa);h(this,la,s),h(this,ia,a),h(this,ra,n),h(this,ee,S(this,Ie,Us).call(this,t)),h(this,oe,void 0),this.closed=!1,this.protocol="ws",h(this,oa,Yi(l))}async limit(t){return d(this,oa).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{const n=await S(this,Ie,ss).call(this);try{const l=Zt(a);n.conn.sqlCache.apply([l]);const i=n.stream.query(l);n.stream.closeGracefully();const r=await i;return Fa(r)}catch(l){throw z(l)}finally{this._closeStream(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{const a=await S(this,Ie,ss).call(this);try{const l=t.map(u=>Array.isArray(u)?{sql:u[0],args:u[1]||[]}:u).map(Zt),i=await a.conn.client.getVersion();a.conn.sqlCache.apply(l);const r=a.stream.batch(i>=3);return await Da(s,i,r,l)}catch(n){throw z(n)}finally{this._closeStream(a)}})}async migrate(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=t.map(Zt),n=await s.conn.client.getVersion(),l=s.stream.batch(n>=3);return await Da("deferred",n,l,a,!0)}catch(a){throw z(a)}finally{this._closeStream(s)}})}async transaction(t="write"){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=await s.conn.client.getVersion();return new $d(this,s,t,a)}catch(a){throw this._closeStream(s),z(a)}})}async executeMultiple(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=s.stream.sequence(t);s.stream.closeGracefully(),await a}catch(a){throw z(a)}finally{this._closeStream(s)}})}sync(){throw new F("sync not supported in ws mode","SYNC_NOT_SUPPORTED")}async reconnect(){try{for(const a of Array.from(d(this,ee).streamStates))try{a.stream.close()}catch{}d(this,ee).client.close()}catch{}if(d(this,oe)){try{d(this,oe).client.close()}catch{}h(this,oe,void 0)}const t=S(this,Ie,Us).call(this),s=await t.client.getVersion();t.useSqlCache=s>=2,t.useSqlCache&&(t.sqlCache.capacity=ul),h(this,ee,t),this.closed=!1}_closeStream(t){t.stream.close();const s=t.conn;s.streamStates.delete(t),s.streamStates.size===0&&s!==d(this,ee)&&s.client.close()}close(){if(d(this,ee).client.close(),this.closed=!0,d(this,oe)){try{d(this,oe).client.close()}catch{}h(this,oe,void 0)}this.closed=!0}}la=new WeakMap,ia=new WeakMap,ra=new WeakMap,ee=new WeakMap,oe=new WeakMap,vn=new WeakMap,oa=new WeakMap,Ie=new WeakSet,ss=async function(){if(this.closed)throw new F("The client is closed","CLIENT_CLOSED");if(new Date().valueOf()-d(this,ee).openTime.valueOf()>_d&&d(this,oe)===void 0){const n=S(this,Ie,Us).call(this);h(this,oe,n),n.client.getVersion().then(l=>{d(this,ee)!==n&&d(this,ee).streamStates.size===0&&d(this,ee).client.close(),h(this,ee,n),h(this,oe,void 0)},l=>{h(this,oe,void 0)})}if(d(this,ee).client.closed)try{d(this,oe)!==void 0?h(this,ee,d(this,oe)):h(this,ee,S(this,Ie,Us).call(this))}catch(n){throw z(n)}const a=d(this,ee);try{a.useSqlCache===void 0&&(a.useSqlCache=await a.client.getVersion()>=2,a.useSqlCache&&(a.sqlCache.capacity=ul));const n=a.client.openStream();n.intMode=d(this,ra);const l={conn:a,stream:n};return a.streamStates.add(l),l}catch(n){throw z(n)}},Us=function(t){try{return t??(t=Gi(d(this,la),d(this,ia))),{client:t,useSqlCache:void 0,sqlCache:new Tn(t,0),openTime:new Date,streamStates:new Set}}catch(s){throw z(s)}};var ca,Et;class $d extends Wi{constructor(s,a,n,l){super(n,l);_(this,ca);_(this,Et);h(this,ca,s),h(this,Et,a)}_getStream(){return d(this,Et).stream}_getSqlCache(){return d(this,Et).conn.sqlCache}close(){d(this,ca)._closeStream(d(this,Et))}get closed(){return d(this,Et).stream.closed}}ca=new WeakMap,Et=new WeakMap;function Ed(e){if(e.scheme!=="https"&&e.scheme!=="http")throw new F(`The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="http"&&e.tls)throw new F('A "http:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="https"&&!e.tls)throw new F('A "https:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);return new Id(t,e.authToken,e.intMode,e.fetch,e.concurrency,e.remoteEncryptionKey)}const Ji=30;var te,$s,Es,Is,da,Cs,pa,ua;class Id{constructor(t,s,a,n,l,i){_(this,te);q(this,"protocol");_(this,$s);_(this,Es);_(this,Is);_(this,da);_(this,Cs);_(this,pa);_(this,ua);h(this,$s,t),h(this,Cs,s),h(this,Es,a),h(this,Is,n),h(this,da,l),h(this,pa,i),h(this,te,dl(d(this,$s),d(this,Cs),d(this,Is),i)),d(this,te).intMode=d(this,Es),this.protocol="http",h(this,ua,Yi(d(this,da)))}async limit(t){return d(this,ua).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{try{const n=Zt(a);let l;const i=d(this,te).openStream();try{l=i.query(n)}finally{i.closeGracefully()}const r=await l;return Fa(r)}catch(n){throw z(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{try{const n=t.map(o=>Array.isArray(o)?{sql:o[0],args:o[1]||[]}:o).map(Zt),l=await d(this,te).getVersion();let i;const r=d(this,te).openStream();try{new Tn(r,Ji).apply(n);const u=r.batch(!1);i=Da(s,l,u,n)}finally{r.closeGracefully()}return await i}catch(a){throw z(a)}})}async migrate(t){return this.limit(async()=>{try{const s=t.map(Zt),a=await d(this,te).getVersion();let n;const l=d(this,te).openStream();try{const r=l.batch(!1);n=Da("deferred",a,r,s,!0)}finally{l.closeGracefully()}return await n}catch(s){throw z(s)}})}async transaction(t="write"){return this.limit(async()=>{try{const s=await d(this,te).getVersion();return new Cd(d(this,te).openStream(),t,s)}catch(s){throw z(s)}})}async executeMultiple(t){return this.limit(async()=>{try{let s;const a=d(this,te).openStream();try{s=a.sequence(t)}finally{a.closeGracefully()}await s}catch(s){throw z(s)}})}sync(){throw new F("sync not supported in http mode","SYNC_NOT_SUPPORTED")}close(){d(this,te).close()}async reconnect(){try{this.closed||d(this,te).close()}finally{h(this,te,dl(d(this,$s),d(this,Cs),d(this,Is),d(this,pa))),d(this,te).intMode=d(this,Es)}}get closed(){return d(this,te).closed}}te=new WeakMap,$s=new WeakMap,Es=new WeakMap,Is=new WeakMap,da=new WeakMap,Cs=new WeakMap,pa=new WeakMap,ua=new WeakMap;var Kt,xa;class Cd extends Wi{constructor(s,a,n){super(a,n);_(this,Kt);_(this,xa);h(this,Kt,s),h(this,xa,new Tn(s,Ji))}_getStream(){return d(this,Kt)}_getSqlCache(){return d(this,xa)}close(){d(this,Kt).close()}get closed(){return d(this,Kt).closed}}Kt=new WeakMap,xa=new WeakMap;function Ki(e){return Rd(To(e))}function Rd(e){if(e.scheme==="ws"||e.scheme==="wss")return kd(e);if(e.scheme==="http"||e.scheme==="https")return Ed(e);throw new F(`The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED")}const Ad={url:"libsql://retailer-os-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAxODY2NzMsImlkIjoiNDcwMDliODAtYmJlYS00YzQ3LTk1MzQtY2NlYjg4OWUzYjFjIiwicmlkIjoiNTk1ODMwNWEtMjlkNy00OGU5LWJkNTctN2FiZWVjNzVjMWYwIn0.381aJkYkBtcCsSDyQkFNLZud9lOPi9TuT3uRZgLYS9BqrjLFb0Zc7P1qRWN0k16XkHQ7raDwhCUE9H1G8Q80BA"},Td={url:"libsql://retailer-data-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAyODMwNTgsImlkIjoiZTVmNzQ5MjMtMDFiMi00YzkxLTlmMjEtZTJhZDIxMzBmMmZmIiwicmlkIjoiZjQzNTc5NTMtN2E2OS00M2UzLWE3MWUtNDcyYzk1MWM1NTRiIn0.8dOIX1XeNnJswuRGhacgPypg_h_9_-bRAwBxtKhBX7rJ4bQuEtSz9Z6igZsvGrWxDlsYlHMo4V3KKIuIZRSuBA"},Nt=Ki(Ad),xl=Ki(Td);async function v(e,t=[]){try{return(await Nt.execute({sql:e,args:t})).rows}catch(s){throw console.error("DB Query Error:",s.message,"SQL:",e,"Params:",t),s}}async function Md(e){try{return await Nt.batch(e)}catch(t){throw console.error("DB Transaction Error:",t),t}}function R(){return localStorage.getItem("retaileros_retailer_id")}const A={clients:{getAll:()=>{const e=R();return e?v("SELECT * FROM customers WHERE retailer_id = ?",[e]):v("SELECT * FROM customers")},add:e=>{const t=R();return v("INSERT INTO customers (id, name, phone, email, joined_at, dob, location, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.name,e.phone||"",e.email||"",new Date().toISOString(),e.dob||null,e.location||"",t])},getById:e=>{const t=R();return t?v("SELECT * FROM customers WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM customers WHERE id = ?",[e])}},companies:{getAll:()=>{const e=R();return e?v("SELECT * FROM companies WHERE retailer_id = ?",[e]):v("SELECT * FROM companies")},add:e=>{const t=R();return v("INSERT INTO companies (id, name, gst_number, customer_id, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?)",[e.id,e.name,e.gst_number,e.customer_id,new Date().toISOString(),t])},getByCustomerId:e=>{const t=R();return t?v("SELECT * FROM companies WHERE customer_id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM companies WHERE customer_id = ?",[e])},getById:e=>{const t=R();return t?v("SELECT * FROM companies WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM companies WHERE id = ?",[e])}},sales:{getAll:()=>{const e=R();return e?v("SELECT * FROM sales WHERE retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM sales ORDER BY date DESC")},getById:e=>{const t=R();return t?v("SELECT * FROM sales WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM sales WHERE id = ?",[e])},getDrafts:()=>{const e=R();return e?v("SELECT * FROM sales WHERE status = 'draft' AND retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM sales WHERE status = 'draft' ORDER BY date DESC")},add:e=>{const t=R();return v(`INSERT INTO sales (id, customer_id, customer_name, date, total_amount, status, payment_mode, payment_reference, gst_required, company_id, installation_required, installation_date, retailer_id)
...
`,t+="Powered by RetailerOS",t}function Ud(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Hd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function nr(){const e=p.currentTab==="history",t=Va();if(!t)return`<div class="p-10 text-center opacity-40 flex flex-col items-center justify-center h-full">
                ...
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <span class="material-icons-outlined text-sm">${Ud(t.paymentMode)}</span>
                        </div>
                        <div class="text-left">
    ...
    `}window.updateClientSearch=e=>{const t=document.getElementById("client-search-input"),s=(t==null?void 0:t.selectionStart)||e.length;p.clientSearchQuery=e,window.triggerRender(!1),setTimeout(()=>{const a=document.getElementById("client-search-input");a&&(a.focus(),a.setSelectionRange(s,s))},0)};async function Gd(){const e=document.getElementById("client-name"),t=document.getElementById("client-phone"),s=document.getElementById("client-email"),a=document.getElementById("client-location");if(!e||!t){console.error("Form inputs not found"),window.toast.error("Form error. Please try again.");return}const n=e.value.trim(),l=t.value.trim(),i=s.value.trim(),r=a?a.value.trim():"";if(!n||!l){window.toast.warning("Name and Phone are required");return}const c=document.getElementById("save-client-btn");let o="";c&&(o=c.innerHTML,c.innerHTML='<span class="material-icons-outlined animate-spin text-xs">sync</span> Saving...',c.disabled=!0);try{const u="CL-"+Math.random().toString(36).substr(2,6).toUpperCase();console.log("Saving client:",{id:u,name:n,phone:l,email:i,location:r}),await A.clients.add({id:u,name:n,phone:l,email:i,location:r}),console.log("Client saved successfully"),await Y(),window.toast.success("Client added successfully!"),p.currentApp==="sales"?(Zi(u,n),Vl("default")):Bl("directory")}catch(u){console.error("Error saving client:",u),window.toast.error("Error saving client: "+u.message),c&&(c.innerHTML=o,c.disabled=!1)}}window.saveClient=Gd;function gn(e){const t=e==="desktop";return`
    ...
    `}function hl(e){var f;const t=e==="desktop",s=window.getCache(),a=((f=s.customers)==null?void 0:f.find(x=>x.id===p.selectedClientId||x.name===p.selectedClient))||{name:p.selectedClient||"Unknown",joined_at:new Date().toISOString()},n=a.name?a.name.split(" ").map(x=>x[0]).join("").toUpperCase():"?",l=(s.sales||[]).filter(x=>x.customer_id===a.id&&x.status!=="draft").sort((x,g)=>new Date(g.date)-new Date(x.date)),i=s.saleItems||[],r=(s.inquiries||[]).filter(x=>x.customer_id===a.id||x.customer_name===a.name),c=(s.repairs||[]).filter(x=>x.customer_id===a.id||x.customer_name===a.name),o=(s.automations||[]).filter(x=>x.customer_id===a.id),u=s.automationMessages||[],m=(s.communications||[]).filter(x=>x.customer_id===a.id),b=l.reduce((x,g)=>x+(g.total_amount||0),0),y=l.length,w=[...l.map(x=>({type:"sale",date:x.date,data:x,items:i.filter(g=>g.sale_id===x.id)})),...c.map(x=>({type:"repair",date:x.created_at||x.date,data:x})),...r.map(x=>({type:"inquiry",date:x.date||x.created_at,data:x})),...o.map(x=>({type:"automation",date:x.created_at,data:x,messages:u.filter(g=>g.automation_id===x.id)})),...m.map(x=>({type:"communication",date:x.sent_at,data:x}))].sort((x,g)=>new Date(g.date)-new Date(x.date));return`
    ...
    `}function Jd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=e.sales||[],l=t.find(u=>u.id===p.selectedGroupId);if(!l)return`
    ...
    `}function Kd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=t.find(r=>r.id===p.selectedGroupId);if(!n)return p.groupViewMode="list","";const l=s.filter(r=>r.group_id===n.id).map(r=>r.customer_id),i=a.filter(r=>!l.includes(r.id));return`
        <div class="h-full flex flex-col overflow-hidden">
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0">
                <div class="flex items-center gap-4">
    ...
    `}function gl(){return zd()}function wl(){switch(p.groupViewMode){case"create":return Yd();case"detail":return Jd();case"add-members":return Kd();default:return`
                <div class="h-full flex items-center justify-center text-slate-300 text-center p-8">
                    <div class="text-center">
            ...
            `}}function Qd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Xd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function vl(e="desktop"){var u,m;const t=window.getCache(),s=p.clientInvoiceId,a=(t.sales||[]).find(b=>b.id===s);if(!a)return`
                ...
                <div class="card p-6 sm:p-8 bg-white text-slate-900 leading-relaxed shadow-sm border border-slate-100">
                    ...
                    ${o.paymentMode?`
                        <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <span class="material-icons-outlined text-sm">${Qd(o.paymentMode)}</span>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest">Paid via ${Xd(o.paymentMode)}</p>
...
`;window.setRepairCustomer=(e,t)=>{p.repairContext={customer_name:e,customer_phone:t},D()};function ap(){const e=document.getElementById("repair-search-input"),t=e?e.value.trim():"",s=window.getCache?window.getCache():{customers:[]},a=t?s.customers.filter(n=>n.name.toLowerCase().includes(t.toLowerCase())||n.phone.includes(t)):[];return`
    ...
    `}async function ip(e){if(p.activeRepairId)try{await A.repairs.updateStatus(p.activeRepairId,e),await Y()}catch(t){alert("Update failed: "+t.message)}}window.updateRepairStatus=ip;window._showReassignPicker||(window._showReassignPicker=!1);window._toggleReassignPicker=()=>{window._showReassignPicker=!window._showReassignPicker,window.triggerRender()};window._reassignRepair=async e=>{window._showReassignPicker=!1,window.toast&&window.toast.success(`Reassigned to ${e}`),window.triggerRender()};function rp(){const e=window.getCache(),t=e.repairs.find(n=>n.id===p.activeRepairId)||e.repairs[0];if(!t)return'<div class="p-20 text-center opacity-30 text-[10px] font-black uppercase">No active job selected</div>';const s=[{l:"Collected",s:"COLLECTED",i:"done"},{l:"Sent to Brand",s:"SENT_TO_BRAND",i:"shipping"},{l:"At Service Center",s:"IN_REPAIR",i:"build"},{l:"Ready for Pickup",s:"READY",i:"check_circle"},{l:"Handed Over",s:"COMPLETED",i:"person"}],a=s.findIndex(n=>n.s===t.status);return`
    ...
    `}function Pn(e){const t={search:{t:"RetailerOS",s:"Repairs Management",txn:null},intake:{t:"Device Intake",s:"Repair Management",txn:"TXN-4920"},status:{t:"Job ID: #REP-2024",s:"Repair Assignment",badge:"ACTIVE"},history:{t:"Job History",s:"Service Records",badge:null}},s={search:ap(),intake:lp(),status:rp()};if(e==="desktop-primary")return`
    ...
    `}if(!window._promoterCheckIns)try{window._promoterCheckIns=JSON.parse(localStorage.getItem("promoter_checkins")||"{}")}catch{window._promoterCheckIns={}}window._togglePromoterCheckIn=(e,t)=>{t&&t.stopPropagation(),window._promoterCheckIns[e]=!window._promoterCheckIns[e],localStorage.setItem("promoter_checkins",JSON.stringify(window._promoterCheckIns)),window.toast&&window.toast.success(window._promoterCheckIns[e]?"Checked in":"Checked out"),window.triggerRender()};const xp=[{id:"P1",initials:"RS",name:"Rohan S.",role:"PREMIUM BRAND"},{id:"P2",initials:"AK",name:"Ananya K.",role:"STORE STAFF"},{id:"P3",initials:"VM",name:"Vikram M.",role:"ELECTRONICS PRO"},{id:"P4",initials:"SD",name:"Sarah D.",role:"AUDIO SPECIALIST"}];function fp(){const t=(window.getCache().teamMembers||[]).filter(n=>n.status==="active"),s=[...xp,...t.map(n=>({id:n.id,initials:n.name.split(" ").map(l=>l[0]).join("").slice(0,2).toUpperCase(),name:n.name,role:(n.role||"STAFF").toUpperCase()}))],a=s.filter(n=>window._promoterCheckIns[n.id]).length;return`
        ${up()}
    ...
    `}function qn(e){const t=e==="desktop-secondary";if(window.setPromoterViewMode=s=>{p.promoterViewMode=s,D()},t)return p.promoterViewMode==="onboarding"?Sl():$l();if(e==="mobile"){if(p.promoterViewMode==="onboarding")return Sl();if(p.promoterViewMode==="performance")return $l()}return fp()}function mp(){return`
    ...
    `}function Bn(e){const t=e==="desktop-secondary";if(window.setInventoryTab=s=>{p.inventoryTab=s,D()},window.setInventoryMode=s=>{p.inventoryMode=s,D()},t)return p.inventoryMode==="inward"?El():Il();if(e==="mobile"){if(p.inventoryMode==="inward")return El();if(p.inventoryMode==="details")return Il()}return`
        <div class="h-full flex flex-col relative bg-white">
            ${mp()}
            ${p.inventoryTab==="brands"?bp():hp()}
        </div>
    ...
    `}function vp(){const e=p.settingsSubView==="add",t=p.settingsActiveRole||"Store Manager";return`
         <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
    ...
    `}function $p(){var n;const e=p.settingsSubView==="edit",t=window.getCache(),s=localStorage.getItem("retaileros_retailer_id"),a=((n=t.retailers)==null?void 0:n.find(l=>l.id===s))||null;return a?`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
    ...
    `}function Ep(){var l;const e=(()=>{var c;const i=window.getCache(),r=localStorage.getItem("retaileros_retailer_id");return((c=i.retailers)==null?void 0:c.find(o=>o.id===r))||{}})(),s=((l=window.getCache().retailerSettings)==null?void 0:l.security)||{},a={otp_on_login:s.otp_on_login??!0,email_verification:s.email_verification??!1,auto_logout_timer:s.auto_logout_timer??"30 min",remember_device:s.remember_device??!0},n=["15 min","30 min","1 hour","4 hours","Never"];return`
    ...
    `}function Fn(e){const t=e==="mobile",s=e==="desktop-secondary";if(window.setSettingsView=a=>{p.settingsView=a,p.settingsSubView=null,D()},window.setSettingsSubView=a=>{p.settingsSubView=a,D()},window.setSettingsRole=a=>{p.settingsActiveRole=a,p.settingsSubView="detail",D()},window.saveNewRole=()=>{const a=document.querySelector('input[placeholder="e.g. Floor Supervisor"]');a&&a.value?(p.settingsActiveRole=a.value,p.settingsSubView="detail",window.toast.success(`Role "${a.value}" created successfully!`),D()):window.toast.warning("Please enter a role name")},window.updateRole=()=>{window.toast.success("Role profile updated successfully!"),window.setSettingsSubView("detail")},s||t&&p.settingsView){if(p.settingsView==="roles")return vp();if(p.settingsView==="accounting")return yp();if(p.settingsView==="ledger")return kp();if(p.settingsView==="ai")return Sp();if(p.settingsView==="store")return $p();if(p.settingsView==="security")return Ep();if(p.settingsView==="alerts")return Ip();if(p.settingsView==="taxes")return Cp();if(p.settingsView==="plugins")return Rp();if(p.settingsView==="teams")return Ap();if(p.settingsView==="logs")return Tp();if(p.settingsView==="lang")return Mp();if(p.settingsView==="backup")return Dp();if(p.settingsView==="updates")return Lp();if(p.settingsView==="theme")return Op();if(p.settingsView==="help")return jp();if(s)return""}return wp(e)}function Pp(){return`
        <div class="space-y-4 text-left">
    ...
    `}window.setSchemeViewMode=e=>{p.showSchemeDetails=e==="details",D()};window.setActiveScheme=e=>{p.activeScheme=e,D()};function Np(){const t=(window.getCache?window.getCache():{schemes:[]}).schemes||[];return`
...
`),i=new Blob([l],{type:"text/csv"}),r=URL.createObjectURL(i),c=document.createElement("a");c.href=r,c.download=`${e}_scheme_transactions.csv`,c.click(),URL.revokeObjectURL(r),window.toast&&window.toast.success("CSV downloaded")};function qp(e){const t=e==="mobile",s=p.activeScheme;if(!s)return'<div class="p-10 text-center">Select a scheme to view details</div>';const n=((window.getCache?window.getCache():{sales:[]}).sales||[]).filter(u=>{const m=u.product_name||"",b=typeof s=="object"&&s.brand?s.brand:"";return m.includes(b)||u.items&&u.items.some(y=>(y.name||"").includes(b))}),l=typeof s=="object"&&s.brand?s.brand:s,i=typeof s=="object"&&s.name?s.name:"Scheme",r=typeof s=="object"&&s.payout?s.payout:"0",c=typeof s=="object"&&s.end_date?s.end_date:new Date,o={count:n.length,growth:"+0%",color:"bg-slate-950"};return`
    ...
    `}function Bp(){const e=p.marketplaceTab==="browse";return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
            <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function Fp(){const t=window.getCache().marketplace||[];return`
    ...
    `}window._setOfferStatus=async(e,t)=>{try{window.toast&&window.toast.success(`Listing ${t==="paused"?"paused":t==="sold"?"marked as sold":"updated"}`),window.triggerRender()}catch{window.toast&&window.toast.error("Failed to update")}};function Vp(){return`
        <div class="space-y-4 animate-slide-up text-left">
    ...
    `}function Un(e){if(e==="desktop-secondary"||e==="mobile"&&p.marketplaceViewMode==="add")return Up(e);const a=p.marketplaceTab==="browse";return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Bp()}
    ...
    `}async function Jp(e){var t;if((t=p.activeInquiry)!=null&&t.id)try{await A.inquiries.updateStatus(p.activeInquiry.id,e),await Y(),window.setInquiryViewMode("list")}catch(s){alert("Update failed: "+s.message)}}window.updateInquiryStatus=Jp;function Kp(){const e=p.activeInquiry;return e?`
    ...
    `:'<div class="p-20 text-center uppercase text-[10px] font-black opacity-30">No inquiry selected</div>'}window._inquiriesShowAll===void 0&&(window._inquiriesShowAll=!1);window._toggleShowAllInquiries=()=>{window._inquiriesShowAll=!window._inquiriesShowAll,window.triggerRender()};function Hn(e){return e==="desktop-secondary"||e==="mobile"&&p.inquiryViewMode==="add"?Yp():p.inquiryViewMode==="resolve"&&p.activeInquiry?Kp():`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Hp()}
            <div class="px-8 text-left">
                ${window._inquiriesShowAll?"":Gp()}
    ...
    `}function Qp(){const t=window.getCache().campaigns||[];return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
                    <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
    ...
    `}window._convertBookingToSale=e=>{window.setTab&&window.setTab("new-sale"),window.setApp("sales"),window.toast&&window.toast.success(`Starting sale for ${e}`)};function Zp(e){const t=p.activeCampaign;return t?`
    ...
    `}function Gn(e){return e==="desktop-secondary"||e==="mobile"&&p.preBookingViewMode==="create"?Xp():p.preBookingViewMode==="details"&&p.activeCampaign?Zp():p.preBookingViewMode==="public"?eu():Qp()}function tu(){const e=window.getCache(),t=e.automations||[],s=e.automationMessages||[],a=t.filter(i=>i.status==="active").length;t.filter(i=>i.status==="completed").length,s.length;const n=s.filter(i=>i.status==="sent").length,l=s.filter(i=>i.status==="pending").length;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
             <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function Wn(e){const t=e==="mobile",s=e==="desktop-secondary";return window.setAutomationMode=(a,n=null)=>{p.automationViewMode=a,n!==null&&(p.activeAutomationId=n),D()},s?p.automationViewMode==="create"?Cl():p.automationViewMode==="details"&&p.activeAutomationId?Rl(p.activeAutomationId):`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:t&&p.automationViewMode==="create"?Cl(!0):t&&p.automationViewMode==="details"?Rl(p.activeAutomationId,!0):tu()}function su(){const t=window.getCache().storeOrders||[],s=t.filter(n=>n.order_status==="pending"||n.order_status==="confirmed").length,a=t.filter(n=>n.order_status==="confirmed").length;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
            <div class="flex items-center justify-between mb-6">
                <button type="button" onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
                    <span class="material-icons-outlined">chevron_left</span>
    ...
    `}function lu(){const e=window.getCache(),s=(e.storeListings||[]).find(o=>o.id===p.activeListingId);if(!s)return`<div class="h-full flex items-center justify-center text-slate-300">
            <div class="text-center">
    ...
    `}function iu(e){const t=window.getCache(),s=t.storeOrders||[],a=t.storeOrderItems||[];window._storeOrderFilter=window._storeOrderFilter||"all",window._setOrderFilter=u=>{window._storeOrderFilter=u,window.triggerRender()};const n=window._storeOrderFilter,l=n==="all"?s:s.filter(u=>u.order_status===n),i={all:s.length,pending:s.filter(u=>u.order_status==="pending").length,confirmed:s.filter(u=>u.order_status==="confirmed").length,shipped:s.filter(u=>u.order_status==="shipped").length,delivered:s.filter(u=>u.order_status==="delivered").length,cancelled:s.filter(u=>u.order_status==="cancelled").length},r=u=>{switch(u){case"pending":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-200 text-slate-600">Pending</span>';case"confirmed":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-300 text-slate-700">Confirmed</span>';case"shipped":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-300 text-slate-700">Shipped</span>';case"delivered":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-900 text-white">Delivered</span>';case"cancelled":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-100 text-slate-400">Cancelled</span>';default:return""}},c=u=>u==="paid"?'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-900 text-white">Paid</span>':u==="failed"?'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-100 text-slate-400">Failed</span>':'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-200 text-slate-600">COD</span>';return window._createTestOrder=async()=>{const m=(window.getCache().storeListings||[]).filter(C=>C.status==="active");if(m.length===0){window.toast&&window.toast.error("No active listings to order from");return}const b=m[0],y=`so_${Date.now()}_${Math.random().toString(36).substr(2,6)}`,w=`WEB-${new Date().toISOString().slice(0,10).replace(/-/g,"")}-${String(s.length+1).padStart(4,"0")}`,f=["Aarav Patel","Sneha Gupta","Rohan Mehta","Kavya Sharma","Vikram Singh"],x=["Mumbai","Delhi","Bangalore","Pune","Chennai"],g=f[Math.floor(Math.random()*f.length)],$=x[Math.floor(Math.random()*x.length)];try{const C={id:y,order_number:w,customer_name:g,customer_phone:"98"+Math.floor(1e7+Math.random()*9e7),customer_email:g.split(" ")[0].toLowerCase()+"@gmail.com",shipping_address_line1:Math.floor(100+Math.random()*900)+", Sector "+Math.floor(1+Math.random()*30),shipping_city:$,shipping_state:$==="Mumbai"?"Maharashtra":$==="Delhi"?"Delhi":$==="Bangalore"?"Karnataka":$==="Pune"?"Maharashtra":"Tamil Nadu",shipping_pincode:String(1e5+Math.floor(Math.random()*5e5)),order_date:new Date().toISOString(),total_amount:b.listing_price,order_status:"pending",payment_status:Math.random()>.3?"paid":"pending",payment_mode:Math.random()>.5?"online":"cod"};await A.storeOrders.add(C);const E=`soi_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;await A.storeOrders.addItem({id:E,order_id:y,listing_id:b.id,product_id:b.product_id,product_name:b.product_name,category:b.category,quantity:1,unit_price:b.listing_price,final_price:b.listing_price}),window._db_cache.storeOrders||(window._db_cache.storeOrders=[]),window._db_cache.storeOrders.unshift(C),window._db_cache.storeOrderItems||(window._db_cache.storeOrderItems=[]),window._db_cache.storeOrderItems.push({id:E,order_id:y,listing_id:b.id,product_id:b.product_id,product_name:b.product_name,category:b.category,quantity:1,unit_price:b.listing_price,discount_amount:0,final_price:b.listing_price}),A.activityLogs.add({action:"store",detail:`New online order ${w} from ${g}`,user_name:"System",icon:"shopping_bag",color:"blue"}),window.toast&&window.toast.success(`Test order ${w} created`),window.triggerRender()}catch(C){console.error("Create test order failed:",C),window.toast&&window.toast.error("Failed to create test order")}},`
        ...
        `:""}
    `}function ru(e){switch(e){case"cash":case"cod":return"payments";case"card":return"credit_card";case"upi":return"qr_code";case"online":return"language";default:return"account_balance_wallet"}}function ou(e){switch(e){case"cash":case"cod":return"Cash on Delivery";case"card":return"Card";case"upi":return"UPI";case"online":return"Online Payment";default:return"Payment"}}function Tl(){const e=window.getCache(),t=e.storeOrders||[],s=e.storeOrderItems||[],a=t.find(f=>f.id===p.activeStoreOrderId);if(!a)return`<div class="h-full flex items-center justify-center text-slate-300">
            <div class="text-center">
...
Powered by RetailerOS`,window.open(`https://wa.me/?text=${encodeURIComponent(f)}`,"_blank")},window._printOrder=()=>{window.print()},`
        <div id="order-detail" class="bg-white text-slate-900 leading-relaxed relative h-full flex flex-col print:shadow-none print:border-0">
            ...
            ${r?`
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <span class="material-icons-outlined text-sm">${ru(a.payment_mode)}</span>
                        </div>
                        <div class="text-left">
                            <p class="text-[9px] font-black uppercase tracking-widest text-left">Paid via ${ou(a.payment_mode)}</p>
    ...
    `}function cu(e){const t=window.getCache(),s=t.storeOrders||[],a=t.storeOrderItems||[],n=s.filter(c=>c.order_status==="confirmed"),l=s.filter(c=>c.order_status==="shipped"),i=s.filter(c=>c.order_status==="delivered"),r=(c,o)=>{const u=a.filter(b=>b.order_id===c.id),m=u[0]?u[0].product_name:"Order items";return`
    ...
    `}function zn(e){const t=e==="mobile";if(e==="desktop-secondary"){if(p.myStoreViewMode==="order-detail"&&p.activeStoreOrderId)return Tl();if(p.myStoreViewMode==="add-listing")return Al();if(p.activeListingId&&p.myStoreTab==="listings")return lu();if(p.myStoreTab==="dashboard"){const l=window.getCache().storeListings||[];return`<div class="h-full flex flex-col p-6 sm:p-8 text-left">
                <div class="text-center border-b border-dashed border-slate-200 pb-6 mb-6">
    ...
    `}function pu(e){return e.length===0?"":`
    ...
    `}function xu(e,t){const s=window._notifExpanded[e.key]||!1;return`
        <section id="notif-group-${e.key}" class="text-left">
            ...
            ${s?`
                <div class="bg-slate-50 border border-t-0 border-slate-300 rounded-b-2xl p-3 space-y-2.5">
                    ${e.items.map((a,n)=>{const l=t+e.items.slice(0,n).reduce((i,r)=>i+(r.actions?r.actions.length:0),0);return uu(a,l)}).join("")}
                </div>
            `:""}
        </section>
    `}function fu(){return`
    ...
    `}function mu(){const e=Yn(),t=e.reduce((s,a)=>s+a.items.length,0);return`
    ...
    `}function Jn(e){if(e==="desktop-secondary")return mu();const t=Yn();window._notifActions=[],t.forEach(n=>n.items.forEach(l=>{l.actions&&l.actions.forEach(i=>window._notifActions.push(i.handler))}));let s=0;const a=t.map(n=>{const l=xu(n,s);return s+=n.items.reduce((i,r)=>i+(r.actions?r.actions.length:0),0),l}).join("");return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            ${du()}
    ...
    `,(t==="error"||e.length>50)&&(n.innerHTML+=`
        ...
        `),qt.innerHTML="",qt.appendChild(n),requestAnimationFrame(()=>{n.classList.remove("opacity-0","translate-y-[-20px]","scale-95"),n.classList.add("opacity-100","translate-y-0","scale-100")}),Ka=setTimeout(()=>{Su(n)},s),n}function Su(e){!e||!e.parentElement||(e.classList.remove("opacity-100","translate-y-0","scale-100"),e.classList.add("opacity-0","translate-y-[-20px]","scale-95"),setTimeout(()=>{e.remove()},300))}function La(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const $u={success:(e,t)=>Gs(e,"success",t),error:(e,t)=>Gs(e,"error",t||5e3),warning:(e,t)=>Gs(e,"warning",t||4e3),info:(e,t)=>Gs(e,"info",t)};function Eu(e,t,s){const a=document.createElement("div");a.className="fixed inset-0 z-[9998] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4",a.innerHTML=`
    ...
    `,document.body.appendChild(n);const l=n.querySelector("div > div"),i=n.querySelector("#prompt-input");requestAnimationFrame(()=>{l.classList.remove("scale-95","opacity-0"),l.classList.add("scale-100","opacity-100"),i.focus(),i.select()}),i.onkeydown=r=>{if(r.key==="Enter"){const c=i.value.trim();ht(n),c&&s&&s(c)}else r.key==="Escape"&&(ht(n),a&&a())},n.querySelector("#prompt-cancel").onclick=()=>{ht(n),a&&a()},n.querySelector("#prompt-ok").onclick=()=>{const r=i.value.trim();ht(n),r&&s&&s(r)},n.onclick=r=>{r.target===n&&(ht(n),a&&a())}}window.toast=$u;window.showToast=Gs;window.showConfirm=Eu;window.showPrompt=Iu;function Cu(){return p.currentApp==="sales"?p.currentTab==="new-sale"?tr():sr():p.currentApp==="clients"?On("desktop-primary"):p.currentApp==="reports"?jn("desktop-primary"):p.currentApp==="repairs"?Pn("desktop-primary"):p.currentApp==="marketing"?Nn("desktop-primary"):p.currentApp==="promoters"?qn("desktop-primary"):p.currentApp==="inventory"?Bn("desktop-primary"):p.currentApp==="settings"?Fn("desktop-primary"):p.currentApp==="schemes"?Vn("desktop-primary"):p.currentApp==="marketplace"?Un("desktop-primary"):p.currentApp==="inquiries"?Hn("desktop-primary"):p.currentApp==="prebooking"?Gn("desktop-primary"):p.currentApp==="automation"?Wn("desktop-primary"):p.currentApp==="mystore"?zn("desktop-primary"):p.currentApp==="notifications"?Jn("desktop-primary"):'<div class="p-10 flex items-center justify-center h-full text-slate-300 font-bold uppercase tracking-widest">App Module Not Found</div>'}function Ru(){return p.currentApp==="sales"?p.salesMode==="add-customer"?gn("desktop"):nr():p.currentApp==="clients"?On("desktop-secondary"):p.currentApp==="reports"?jn("desktop-secondary"):p.currentApp==="repairs"?Pn("desktop-secondary"):p.currentApp==="marketing"?Nn("desktop-secondary"):p.currentApp==="promoters"?qn("desktop-secondary"):p.currentApp==="inventory"?Bn("desktop-secondary"):p.currentApp==="settings"?Fn("desktop-secondary"):p.currentApp==="schemes"?Vn("desktop-secondary"):p.currentApp==="marketplace"?Un("desktop-secondary"):p.currentApp==="inquiries"?Hn("desktop-secondary"):p.currentApp==="prebooking"?Gn("desktop-secondary"):p.currentApp==="automation"?Wn("desktop-secondary"):p.currentApp==="mystore"?zn("desktop-secondary"):p.currentApp==="notifications"?Jn("desktop-secondary"):'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">Select an app to view details</p></div></div>'}function or(){return Gl("desktop")}function Au(){return`
    ...
    `}function Tu(){return`
        <div class="h-full flex flex-row divide-x divide-slate-200 bg-white">
            ...
            <div class="flex-1 bg-white h-full overflow-hidden flex flex-col relative">
                ${p.isLoggedIn?p.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-4 opacity-20">arrow_back</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Select an App from the Menu</p></div></div>':cr():'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'}
            </div>
        </div>
    `}function dr(){return p.isLoggedIn?p.currentApp==="launcher"?Gl("mobile"):cr():`
            <div class="h-full w-full bg-white">
                ${Hl()}
            </div>
        `}function Oa(){const e=document.getElementById("app");if(e)try{const t=window.innerWidth;t<768?e.innerHTML=dr():t>=768&&t<1024?e.innerHTML=Tu():e.innerHTML=Au()}catch(t){console.error(t),e.innerHTML=`<div class="p-4 text-slate-500 font-bold">Error: ${t.message}<br><small>${t.stack}</small></div>`}}function Mu(){const e=window.innerWidth;if(e<768){const t=document.getElementById("app");t&&(t.innerHTML=dr())}else{const t=document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10")||document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative"),s=document.querySelector(".w-\\[30\\%\\].shrink-0.bg-slate-50\\/50.h-full.overflow-hidden.flex.flex-col.relative.dot-grid.border-l.border-slate-200");t&&(t.innerHTML=p.authMode==="register"?Js("desktop-primary"):'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'),s&&e>=1024&&(s.innerHTML=p.authMode==="register"?Js("desktop-secondary"):'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>')}}window.updateAuthContent=Mu;ql(Oa);ql(bu);hu();window.addEventListener("resize",()=>{window.innerWidth!==p.viewportWidth&&(p.viewportWidth=window.innerWidth,p.gridCols=window.innerWidth<768?4:3,Oa())});Y().then(()=>{console.log("Initial data sync complete"),Oa()}).catch(e=>{console.error("Initial sync failed:",e),Oa()});
