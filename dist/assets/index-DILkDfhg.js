var Vi=Object.defineProperty;var Un=e=>{throw TypeError(e)};var Gi=(e,t,s)=>t in e?Vi(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var D=(e,t,s)=>Gi(e,typeof t!="symbol"?t+"":t,s),Oa=(e,t,s)=>t.has(e)||Un("Cannot "+s);var i=(e,t,s)=>(Oa(e,t,"read from private field"),s?s.call(e):t.get(e)),b=(e,t,s)=>t.has(e)?Un("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),x=(e,t,s,a)=>(Oa(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),g=(e,t,s)=>(Oa(e,t,"access private method"),s);var Ht=(e,t,s,a)=>({set _(n){x(e,t,n,s)},get _(){return i(e,t,a)}});(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();const Hi=localStorage.getItem("retaileros_logged_in")==="true",c={currentApp:window.innerWidth<768?"launcher":"sales",currentTab:"new-sale",salesMode:"default",salesHistoryId:"ORD-99281",historyViewMode:"completed",historyDateFilter:"today",historyFromDate:"",historyToDate:"",showMobileReceipt:!1,reportsTab:"sales",repairTab:"active",repairViewMode:"search",selectedRepairDevice:null,activeRepairId:null,repairContext:null,selectedClient:null,selectedClientId:null,clientViewMode:"directory",clientSearchQuery:"",clientInvoiceId:null,selectedGroupId:null,groupViewMode:"list",groupSearchQuery:"",promoterViewMode:"performance",inventoryTab:"brands",inventoryMode:"details",activeCategory:null,settingsView:"roles",viewportWidth:window.innerWidth,gridCols:window.innerWidth<768?4:3,schemesTab:"list",activeSchemeBrand:"Apple",activeScheme:"June Activation Bonus",showSchemeDetails:!1,marketplaceTab:"browse",marketplaceViewMode:"list",isLoggedIn:Hi,authMode:"login",registrationStep:1,inquiryViewMode:"list",activeInquiry:null,preBookingViewMode:"dashboard",activeCampaign:null,automationViewMode:"dashboard",activeAutomationId:null},gl=[],wl=e=>{gl.push(e)},C=(e=!0)=>{gl.forEach(t=>t(e))};function Wi(e){c.currentApp=e,e==="clients"&&(c.clientViewMode="directory"),C()}function zi(e){c.currentTab=e,C()}function Ji(e){c.salesHistoryId=e,e&&window.innerWidth<768&&(c.showMobileReceipt=!0),C()}function Yi(e){c.showMobileReceipt=e,C()}function Ki(e){c.reportsTab=e,C()}function Qi(e){c.repairTab=e,C()}function Xi(e,t=null){c.repairViewMode=e,t&&(c.selectedRepairDevice=t),C()}function Zi(e){c.gridCols=e,C()}function vl(e,t=null,s=null){c.clientViewMode=e,t&&(c.selectedClient=t),s&&(c.selectedClientId=s),e!=="invoice"&&(c.clientInvoiceId=null),C()}function er(e){c.clientInvoiceId=e,c.clientViewMode="invoice",C()}function tr(e){c.schemesTab=e,C()}function sr(e){c.activeSchemeBrand=e,C()}function ar(e){c.activeScheme=e,C()}function nr(e){c.showSchemeDetails=e,C()}function lr(e){c.marketplaceTab=e,C()}function ir(e){c.marketplaceViewMode=e,C()}function rr(e){c.isLoggedIn=e,e?localStorage.setItem("retaileros_logged_in","true"):localStorage.removeItem("retaileros_logged_in");const t=window.innerWidth<768;c.currentApp=e?t?"launcher":"sales":"launcher",C()}function or(e){c.authMode=e,c.registrationStep=1,C()}function cr(e){c.registrationStep=e,window.updateAuthContent?window.updateAuthContent():C()}function dr(e){c.inquiryViewMode=e,C()}function pr(e){c.activeInquiry=e,C()}function ur(e){c.preBookingViewMode=e,C()}function xr(e){c.activeCampaign=e,C()}function fr(e){c.automationViewMode=e,C()}function br(e){c.activeAutomationId=e,C()}window.triggerRender=C;window.setApp=Wi;window.setTab=zi;window.setSalesHistoryId=Ji;window.toggleMobileReceipt=Yi;window.setReportsTab=Ki;window.setRepairTab=Qi;function yl(e){c.salesMode=e,C()}window.setSalesMode=yl;function hr(e){c.historyViewMode=e,C()}function mr(e){c.historyDateFilter=e,e!=="custom"&&(c.historyFromDate="",c.historyToDate=""),C()}function gr(e,t){c.historyFromDate=e,c.historyToDate=t,c.historyDateFilter="custom",C()}window.setHistoryViewMode=hr;window.setHistoryDateFilter=mr;window.setHistoryCustomDates=gr;window.setRepairMode=Xi;window.setGridCols=Zi;window.setClientMode=vl;window.viewClientInvoice=er;window.setSchemesTab=tr;window.setSchemeBrand=sr;window.setScheme=ar;window.toggleSchemeDetails=nr;window.setMarketplaceTab=lr;window.setMarketplaceViewMode=ir;window.setLoginStatus=rr;window.setAuthMode=or;window.setRegistrationStep=cr;window.setInquiryViewMode=dr;window.setActiveInquiry=pr;window.setPreBookingViewMode=ur;window.setActiveCampaign=xr;window.setAutomationViewMode=fr;window.setActiveAutomation=br;function wr(e){c.groupViewMode=e,C()}function vr(e){c.selectedGroupId=e,C()}window.setGroupViewMode=wr;window.setSelectedGroup=vr;function kl(){return`
    ...
    `}function Bs(e="mobile"){return e==="desktop-primary"?yr():e==="desktop-secondary"?kr():_r()}function yr(){const e=c.registrationStep;return e===3?`
    ...
    `}function kr(){return c.registrationStep<3?`
    ...
    `}function _r(){const e=c.registrationStep;return`
    ...
    `}function un(e){let t="";return e===1?t=`
                    ...
                    <div class="grid grid-cols-6 gap-2 md:gap-2 mb-6 md:mb-8" id="otp-container">
                        ${[0,1,2,3,4,5].map(s=>`
                            <input
                                ...
                                onkeydown="window.handleOtpKeydown(event, ${s})"
                                oninput="window.handleOtpInput(event, ${s})"
                    ...
                    ${[{l:"STORE NAME",v:"Luxe Retail Collective"},{l:"OWNER NAME",v:"Alexander Sterling"},{l:"MOBILE NUMBER",v:"+1 (555) 012-3456"},{l:"GSTIN",v:"22AAAAA0000A1Z5"}].map(s=>`
                        <div class="card p-4 border-slate-100 flex items-center justify-between">
                            <div class="text-left flex-1 min-w-0">
                                ...
                                <p class="text-[11px] md:text-[11px] font-black text-slate-900 truncate">${s.v}</p>
                            </div>
        ...
        `),t}window.handleOtpInput=function(e,t){const s=e.target.value;if(s&&!/^\d$/.test(s)){e.target.value="";return}if(s&&t<5){const a=document.getElementById(`otp-${t+1}`);a&&a.focus()}};window.handleOtpKeydown=function(e,t){if(e.key==="Backspace"){if(!document.getElementById(`otp-${t}`).value&&t>0){const a=document.getElementById(`otp-${t-1}`);a&&(a.focus(),a.select())}}else if(e.key==="ArrowLeft"&&t>0){e.preventDefault();const s=document.getElementById(`otp-${t-1}`);s&&s.focus()}else if(e.key==="ArrowRight"&&t<5){e.preventDefault();const s=document.getElementById(`otp-${t+1}`);s&&s.focus()}else e.key==="Enter"&&(e.preventDefault(),window.verifyOtp())};window.handleOtpPaste=function(e){e.preventDefault();const t=e.clipboardData.getData("text").trim();if(/^\d{6}$/.test(t)){for(let a=0;a<6;a++){const n=document.getElementById(`otp-${a}`);n&&(n.value=t[a])}const s=document.getElementById("otp-5");s&&s.focus()}};window.requestOtp=function(){const e=document.getElementById("mobile-input"),t=e?e.value.trim():"";if(!t||t.length!==10){alert("Please enter a valid 10-digit mobile number");return}console.log("Sending OTP to:",t),window.setRegistrationStep(2),setTimeout(()=>{const s=document.getElementById("otp-0");s&&s.focus()},100)};window.verifyOtp=function(){const e=[];for(let s=0;s<6;s++){const a=document.getElementById(`otp-${s}`);a&&e.push(a.value)}const t=e.join("");if(t.length!==6){alert("Please enter all 6 digits");return}console.log("Verifying OTP:",t),window.setRegistrationStep(3)};window.resendOtp=function(){for(let t=0;t<6;t++){const s=document.getElementById(`otp-${t}`);s&&(s.value="")}const e=document.getElementById("otp-0");e&&e.focus(),console.log("Resending OTP..."),alert("OTP has been resent successfully!")};function _l(){return c.authMode==="register"?Bs():kl()}const Sr=[{n:"SALES DESK",i:"account_balance_wallet",k:"sales"},{n:"CLIENTS",i:"group",k:"clients"},{n:"INQUIRIES",i:"help_outline",k:"inquiries"},{n:"PROMOTERS",i:"business_center",k:"promoters"},{n:"INTERNAL STORE",i:"storefront"},{n:"INVENTORY",i:"inventory_2",k:"inventory"},{n:"REPAIRS",i:"build",k:"repairs"},{n:"MARKETPLACE",i:"swap_horizontal_circle",k:"marketplace"},{n:"CLAIMS",i:"verified_user"},{n:"SCHEMES",i:"percent",k:"schemes"},{n:"MARKETING",i:"campaign",k:"marketing"},{n:"AUTOMATION",i:"smart_toy",s:!0,k:"automation"},{n:"PRE-BOOKING",i:"rocket_launch",k:"prebooking"},{n:"REPORTS",i:"bar_chart",k:"reports"},{n:"SETTINGS",i:"settings",k:"settings"}];function Ir(e){const t=e?c.gridCols:4;return`
    ...
    `}function Fa(e){const t=e==="mobile";return`
    ...
    `}class j extends Error{constructor(s,a,n,l,d){a!==void 0&&(s=`${a}: ${s}`);super(s,{cause:d});D(this,"code");D(this,"extendedCode");D(this,"rawCode");this.code=a,this.extendedCode=n,this.rawCode=l,this.name="LibsqlError"}}class Kt extends j{constructor(s,a,n,l,d,r){super(s,n,l,d,r);D(this,"statementIndex");this.statementIndex=a,this.name="LibsqlBatchError"}}function Cr(e){const t=Ar.exec(e);if(t===null)throw new j(`The URL '${e}' is not in a valid format`,"URL_INVALID");const s=t.groups,a=s.scheme,n=s.authority!==void 0?Rr(s.authority):void 0,l=Ft(s.path),d=s.query!==void 0?Tr(s.query):void 0,r=s.fragment!==void 0?Ft(s.fragment):void 0;return{scheme:a,authority:n,path:l,query:d,fragment:r}}const Ar=(()=>{const e="(?<scheme>[A-Za-z][A-Za-z.+-]*)",t="(?<authority>[^/?#]*)",s="(?<path>[^?#]*)",a="(?<query>[^#]*)",n="(?<fragment>.*)";return new RegExp(`^${e}:(//${t})?${s}(\\?${a})?(#${n})?$`,"su")})();function Rr(e){const t=Er.exec(e);if(t===null)throw new j("The authority part of the URL is not in a valid format","URL_INVALID");const s=t.groups,a=Ft(s.host_br??s.host),n=s.port?parseInt(s.port,10):void 0,l=s.username!==void 0?{username:Ft(s.username),password:s.password!==void 0?Ft(s.password):void 0}:void 0;return{host:a,port:n,userinfo:l}}const Er=new RegExp("^((?<username>[^:]*)(:(?<password>.*))?@)?((?<host>[^:\\[\\]]*)|(\\[(?<host_br>[^\\[\\]]*)\\]))(:(?<port>[0-9]*))?$","su");function Tr(e){const t=e.split("&"),s=[];for(const a of t){if(a==="")continue;let n,l;const d=a.indexOf("=");d<0?(n=a,l=""):(n=a.substring(0,d),l=a.substring(d+1)),s.push({key:Ft(n.replaceAll("+"," ")),value:Ft(l.replaceAll("+"," "))})}return{pairs:s}}function Ft(e){try{return decodeURIComponent(e)}catch(t){throw t instanceof URIError?new j(`URL component has invalid percent encoding: ${t}`,"URL_INVALID",void 0,void 0,t):t}}function Ua(e,t,s){if(t===void 0)throw new j(`URL with scheme ${JSON.stringify(e+":")} requires authority (the "//" part)`,"URL_INVALID");const a=`${e}:`,n=Mr(t.host),l=Dr(t.port),r=`//${Lr(t.userinfo)}${n}${l}`;let p=s.split("/").map(encodeURIComponent).join("/");return p!==""&&!p.startsWith("/")&&(p="/"+p),new URL(`${a}${r}${p}`)}function Mr(e){return e.includes(":")?`[${encodeURI(e)}]`:encodeURI(e)}function Dr(e){return e!==void 0?`:${e}`:""}function Lr(e){if(e===void 0)return"";const t=encodeURIComponent(e.username),s=e.password!==void 0?`:${encodeURIComponent(e.password)}`:"";return`${t}${s}@`}const Sl="3.7.8",jr=Sl,Ss=typeof Buffer=="function",Vn=typeof TextDecoder=="function"?new TextDecoder:void 0,Gn=typeof TextEncoder=="function"?new TextEncoder:void 0,qr="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",As=Array.prototype.slice.call(qr),oa=(e=>{let t={};return e.forEach((s,a)=>t[s]=a),t})(As),Or=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,Z=String.fromCharCode.bind(String),Hn=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),Il=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),$l=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),Cl=e=>{let t,s,a,n,l="";const d=e.length%3;for(let r=0;r<e.length;){if((s=e.charCodeAt(r++))>255||(a=e.charCodeAt(r++))>255||(n=e.charCodeAt(r++))>255)throw new TypeError("invalid character found");t=s<<16|a<<8|n,l+=As[t>>18&63]+As[t>>12&63]+As[t>>6&63]+As[t&63]}return d?l.slice(0,d-3)+"===".substring(d):l},xn=typeof btoa=="function"?e=>btoa(e):Ss?e=>Buffer.from(e,"binary").toString("base64"):Cl,Va=Ss?e=>Buffer.from(e).toString("base64"):e=>{let s=[];for(let a=0,n=e.length;a<n;a+=4096)s.push(Z.apply(null,e.subarray(a,a+4096)));return xn(s.join(""))},pa=(e,t=!1)=>t?Il(Va(e)):Va(e),Pr=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?Z(192|t>>>6)+Z(128|t&63):Z(224|t>>>12&15)+Z(128|t>>>6&63)+Z(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return Z(240|t>>>18&7)+Z(128|t>>>12&63)+Z(128|t>>>6&63)+Z(128|t&63)}},Nr=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Al=e=>e.replace(Nr,Pr),Wn=Ss?e=>Buffer.from(e,"utf8").toString("base64"):Gn?e=>Va(Gn.encode(e)):e=>xn(Al(e)),Qt=(e,t=!1)=>t?Il(Wn(e)):Wn(e),zn=e=>Qt(e,!0),Br=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,Fr=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),s=t-65536;return Z((s>>>10)+55296)+Z((s&1023)+56320);case 3:return Z((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return Z((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},Rl=e=>e.replace(Br,Fr),El=e=>{if(e=e.replace(/\s+/g,""),!Or.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,s,a,n=[];for(let l=0;l<e.length;)t=oa[e.charAt(l++)]<<18|oa[e.charAt(l++)]<<12|(s=oa[e.charAt(l++)])<<6|(a=oa[e.charAt(l++)]),s===64?n.push(Z(t>>16&255)):a===64?n.push(Z(t>>16&255,t>>8&255)):n.push(Z(t>>16&255,t>>8&255,t&255));return n.join("")},fn=typeof atob=="function"?e=>atob($l(e)):Ss?e=>Buffer.from(e,"base64").toString("binary"):El,Tl=Ss?e=>Hn(Buffer.from(e,"base64")):e=>Hn(fn(e).split("").map(t=>t.charCodeAt(0))),Ml=e=>Tl(Dl(e)),Ur=Ss?e=>Buffer.from(e,"base64").toString("utf8"):Vn?e=>Vn.decode(Tl(e)):e=>Rl(fn(e)),Dl=e=>$l(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),Ga=e=>Ur(Dl(e)),Vr=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},Ll=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),jl=function(){const e=(t,s)=>Object.defineProperty(String.prototype,t,Ll(s));e("fromBase64",function(){return Ga(this)}),e("toBase64",function(t){return Qt(this,t)}),e("toBase64URI",function(){return Qt(this,!0)}),e("toBase64URL",function(){return Qt(this,!0)}),e("toUint8Array",function(){return Ml(this)})},ql=function(){const e=(t,s)=>Object.defineProperty(Uint8Array.prototype,t,Ll(s));e("toBase64",function(t){return pa(this,t)}),e("toBase64URI",function(){return pa(this,!0)}),e("toBase64URL",function(){return pa(this,!0)})},Gr=()=>{jl(),ql()},bn={version:Sl,VERSION:jr,atob:fn,atobPolyfill:El,btoa:xn,btoaPolyfill:Cl,fromBase64:Ga,toBase64:Qt,encode:Qt,encodeURI:zn,encodeURL:zn,utob:Al,btou:Rl,decode:Ga,isValid:Vr,fromUint8Array:pa,toUint8Array:Ml,extendString:jl,extendUint8Array:ql,extendBuiltins:Gr},Fs="https://github.com/libsql/libsql-client-ts#supported-urls";function Ha(e){if(e==="write")return"BEGIN IMMEDIATE";if(e==="read")return"BEGIN TRANSACTION READONLY";if(e==="deferred")return"BEGIN DEFERRED";throw RangeError('Unknown transaction mode, supported values are "write", "read" and "deferred"')}class Hr{constructor(t,s,a,n,l){D(this,"columns");D(this,"columnTypes");D(this,"rows");D(this,"rowsAffected");D(this,"lastInsertRowid");this.columns=t,this.columnTypes=s,this.rows=a,this.rowsAffected=n,this.lastInsertRowid=l}toJSON(){return{columns:this.columns,columnTypes:this.columnTypes,rows:this.rows.map(Wr),rowsAffected:this.rowsAffected,lastInsertRowid:this.lastInsertRowid!==void 0?""+this.lastInsertRowid:null}}}function Wr(e){return Array.prototype.map.call(e,zr)}function zr(e){return typeof e=="bigint"?""+e:e instanceof ArrayBuffer?bn.fromUint8Array(new Uint8Array(e)):e}const Jn=":memory:";function Jr(e,t){var S,_;if(typeof e!="object")throw new TypeError(`Expected client configuration as object, got ${typeof e}`);let{url:s,authToken:a,tls:n,intMode:l,concurrency:d}=e;d=Math.max(0,d||20),l??(l="number");let r=[];s===Jn&&(s="file::memory:");const p=Cr(s),o=p.scheme.toLowerCase(),u=o==="file"&&p.path===Jn&&p.authority===void 0;let h;u?h={cache:{values:["shared","private"],update:(k,P)=>r.push(`${k}=${P}`)}}:h={tls:{values:["0","1"],update:(k,P)=>n=P==="1"},authToken:{update:(k,P)=>a=P}};for(const{key:k,value:P}of((S=p.query)==null?void 0:S.pairs)??[]){if(!Object.hasOwn(h,k))throw new j(`Unsupported URL query parameter ${JSON.stringify(k)}`,"URL_PARAM_NOT_SUPPORTED");const G=h[k];if(G.values!==void 0&&!G.values.includes(P))throw new j(`Unknown value for the "${k}" query argument: ${JSON.stringify(P)}. Supported values are: [${G.values.map(Cs=>'"'+Cs+'"').join(", ")}]`,"URL_INVALID");G.update!==void 0&&(G==null||G.update(k,P))}const w=r.length===0?"":`?${r.join("&")}`,v=p.path+w;let m;if(o==="libsql")if(n===!1){if(((_=p.authority)==null?void 0:_.port)===void 0)throw new j('A "libsql:" URL with ?tls=0 must specify an explicit port',"URL_INVALID");m="http"}else m="https";else m=o;if(m==="http"||m==="ws"?n??(n=!1):n??(n=!0),m!=="http"&&m!=="ws"&&m!=="https"&&m!=="wss"&&m!=="file")throw new j(`The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${JSON.stringify(p.scheme+":")}. For more information, please read ${Fs}`,"URL_SCHEME_NOT_SUPPORTED");if(l!=="number"&&l!=="bigint"&&l!=="string")throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(l)}`);if(p.fragment!==void 0)throw new j(`URL fragments are not supported: ${JSON.stringify("#"+p.fragment)}`,"URL_INVALID");return u?{scheme:"file",tls:!1,path:v,intMode:l,concurrency:d,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch,authToken:void 0,encryptionKey:void 0,remoteEncryptionKey:void 0,authority:void 0}:{scheme:m,tls:n,authority:p.authority,path:v,authToken:a,intMode:l,concurrency:d,encryptionKey:e.encryptionKey,remoteEncryptionKey:e.remoteEncryptionKey,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch}}let Jt;typeof WebSocket<"u"?Jt=WebSocket:typeof global<"u"?Jt=global.WebSocket:typeof window<"u"?Jt=window.WebSocket:typeof self<"u"&&(Jt=self.WebSocket);class Ol{constructor(){D(this,"intMode");this.intMode="number"}}class U extends Error{constructor(t){super(t),this.name="ClientError"}}class R extends U{constructor(t){super(t),this.name="ProtoError"}}class Pl extends U{constructor(s,a){super(s);D(this,"code");D(this,"proto");this.name="ResponseError",this.code=a.code,this.proto=a,this.stack=void 0}}class ke extends U{constructor(t,s){s!==void 0?(super(`${t}: ${s}`),this.cause=s):super(t),this.name="ClosedError"}}class Nl extends U{constructor(t){super(t),this.name="WebSocketUnsupportedError"}}class Wa extends U{constructor(t){super(t),this.name="WebSocketError"}}class ua extends U{constructor(s,a){super(s);D(this,"status");this.status=a,this.name="HttpServerError"}}class vs extends U{constructor(t){super(t),this.name="ProtocolVersionError"}}class kt extends U{constructor(t){super(t),this.name="InternalError"}}class Is extends U{constructor(t){super(t),this.name="MisuseError"}}function Me(e){if(typeof e=="string")return e;throw $s(e,"string")}function Le(e){if(e!=null){if(typeof e=="string")return e;throw $s(e,"string or null")}}function Ut(e){if(typeof e=="number")return e;throw $s(e,"number")}function Us(e){if(typeof e=="boolean")return e;throw $s(e,"boolean")}function ga(e){if(Array.isArray(e))return e;throw $s(e,"array")}function ee(e){if(e!==null&&typeof e=="object"&&!Array.isArray(e))return e;throw $s(e,"object")}function _t(e,t){return ga(e).map(s=>t(ee(s)))}function $s(e,t){if(e===void 0)return new R(`Expected ${t}, but the property was missing`);let s=typeof e;return e===null?s="null":Array.isArray(e)&&(s="array"),new R(`Expected ${t}, received ${s}`)}function hn(e,t){return t(ee(e))}var H,dt,He,$t;class Yr{constructor(t){b(this,He);b(this,H);b(this,dt);x(this,H,t),x(this,dt,!1)}begin(){i(this,H).push("{"),x(this,dt,!0)}end(){i(this,H).push("}"),x(this,dt,!1)}string(t,s){g(this,He,$t).call(this,t),i(this,H).push(JSON.stringify(s))}stringRaw(t,s){g(this,He,$t).call(this,t),i(this,H).push('"'),i(this,H).push(s),i(this,H).push('"')}number(t,s){g(this,He,$t).call(this,t),i(this,H).push(""+s)}boolean(t,s){g(this,He,$t).call(this,t),i(this,H).push(s?"true":"false")}object(t,s,a){g(this,He,$t).call(this,t),this.begin(),a(this,s),this.end()}arrayObjects(t,s,a){g(this,He,$t).call(this,t),i(this,H).push("[");for(let n=0;n<s.length;++n)n!==0&&i(this,H).push(","),this.begin(),a(this,s[n]),this.end();i(this,H).push("]")}}H=new WeakMap,dt=new WeakMap,He=new WeakSet,$t=function(t){i(this,dt)?(i(this,H).push('"'),x(this,dt,!1)):i(this,H).push(',"'),i(this,H).push(t),i(this,H).push('":')};function Bl(e,t){const s=[],a=new Yr(s);return a.begin(),t(a,e),a.end(),s.join("")}const Ps=0,za=1,Ja=2,Kr=5;var qe,Vs,be;class Qr{constructor(t){b(this,qe);b(this,Vs);b(this,be);x(this,qe,t),x(this,Vs,new DataView(t.buffer,t.byteOffset,t.byteLength)),x(this,be,0)}varint(){let t=0;for(let s=0;;s+=7){const a=i(this,qe)[Ht(this,be)._++];if(t|=(a&127)<<s,!(a&128))break}return t}varintBig(){let t=0n;for(let s=0n;;s+=7n){const a=i(this,qe)[Ht(this,be)._++];if(t|=BigInt(a&127)<<s,!(a&128))break}return t}bytes(t){const s=new Uint8Array(i(this,qe).buffer,i(this,qe).byteOffset+i(this,be),t);return x(this,be,i(this,be)+t),s}double(){const t=i(this,Vs).getFloat64(i(this,be),!0);return x(this,be,i(this,be)+8),t}skipVarint(){for(;i(this,qe)[Ht(this,be)._++]&128;);}skip(t){x(this,be,i(this,be)+t)}eof(){return i(this,be)>=i(this,qe).byteLength}}qe=new WeakMap,Vs=new WeakMap,be=new WeakMap;var re,ae,Et,Rs;class Xr{constructor(t){b(this,Et);b(this,re);b(this,ae);x(this,re,t),x(this,ae,-1)}setup(t){x(this,ae,t)}bytes(){g(this,Et,Rs).call(this,Ja);const t=i(this,re).varint();return i(this,re).bytes(t)}string(){return new TextDecoder().decode(this.bytes())}message(t){return Ea(this.bytes(),t)}int32(){return g(this,Et,Rs).call(this,Ps),i(this,re).varint()}uint32(){return this.int32()}bool(){return this.int32()!==0}uint64(){return g(this,Et,Rs).call(this,Ps),i(this,re).varintBig()}sint64(){const t=this.uint64();return t>>1n^-(t&1n)}double(){return g(this,Et,Rs).call(this,za),i(this,re).double()}maybeSkip(){if(!(i(this,ae)<0)){if(i(this,ae)===Ps)i(this,re).skipVarint();else if(i(this,ae)===za)i(this,re).skip(8);else if(i(this,ae)===Ja){const t=i(this,re).varint();i(this,re).skip(t)}else if(i(this,ae)===Kr)i(this,re).skip(4);else throw new R(`Unexpected wire type ${i(this,ae)}`);x(this,ae,-1)}}}re=new WeakMap,ae=new WeakMap,Et=new WeakSet,Rs=function(t){if(i(this,ae)!==t)throw new R(`Expected wire type ${t}, got ${i(this,ae)}`);x(this,ae,-1)};function Ea(e,t){const s=new Qr(e),a=new Xr(s);let n=t.default();for(;!s.eof();){const l=s.varint(),d=l>>3,r=l&7;a.setup(r);const p=t[d];if(p!==void 0){const o=p(a,n);o!==void 0&&(n=o)}a.maybeSkip()}return n}var Se,pt,es,oe,Y,Es,xa,Fl,Ts;const Pn=class Pn{constructor(){b(this,Y);b(this,Se);b(this,pt);b(this,es);b(this,oe);x(this,Se,new ArrayBuffer(256)),x(this,pt,new Uint8Array(i(this,Se))),x(this,es,new DataView(i(this,Se))),x(this,oe,0)}bytes(t,s){g(this,Y,Ts).call(this,t,Ja),g(this,Y,xa).call(this,s.byteLength),g(this,Y,Es).call(this,s.byteLength),i(this,pt).set(s,i(this,oe)),x(this,oe,i(this,oe)+s.byteLength)}string(t,s){this.bytes(t,new TextEncoder().encode(s))}message(t,s,a){const n=new Pn;a(n,s),this.bytes(t,n.data())}int32(t,s){g(this,Y,Ts).call(this,t,Ps),g(this,Y,xa).call(this,s)}uint32(t,s){this.int32(t,s)}bool(t,s){this.int32(t,s?1:0)}sint64(t,s){g(this,Y,Ts).call(this,t,Ps),g(this,Y,Fl).call(this,s<<1n^s>>63n)}double(t,s){g(this,Y,Ts).call(this,t,za),g(this,Y,Es).call(this,8),i(this,es).setFloat64(i(this,oe),s,!0),x(this,oe,i(this,oe)+8)}data(){return new Uint8Array(i(this,Se),0,i(this,oe))}};Se=new WeakMap,pt=new WeakMap,es=new WeakMap,oe=new WeakMap,Y=new WeakSet,Es=function(t){if(i(this,oe)+t<=i(this,Se).byteLength)return;let s=i(this,Se).byteLength;for(;s<i(this,oe)+t;)s*=2;const a=new ArrayBuffer(s),n=new Uint8Array(a),l=new DataView(a);n.set(new Uint8Array(i(this,Se),0,i(this,oe))),x(this,Se,a),x(this,pt,n),x(this,es,l)},xa=function(t){g(this,Y,Es).call(this,5),t=0|t;do{let s=t&127;t>>>=7,s|=t?128:0,i(this,pt)[Ht(this,oe)._++]=s}while(t)},Fl=function(t){g(this,Y,Es).call(this,10),t=t&0xffffffffffffffffn;do{let s=Number(t&0x7fn);t>>=7n,s|=t?128:0,i(this,pt)[Ht(this,oe)._++]=s}while(t)},Ts=function(t,s){g(this,Y,xa).call(this,t<<3|s)};let Ya=Pn;function Ul(e,t){const s=new Ya;return t(s,e),s.data()}var he,We;class Ms{constructor(){b(this,he);b(this,We);x(this,he,new Set),x(this,We,new Set)}alloc(){for(const s of i(this,We))return i(this,We).delete(s),i(this,he).add(s),i(this,he).has(i(this,he).size-1)||i(this,We).add(i(this,he).size-1),s;const t=i(this,he).size;return i(this,he).add(t),t}free(t){if(!i(this,he).delete(t))throw new kt("Freeing an id that is not allocated");i(this,We).delete(i(this,he).size),t<i(this,he).size&&i(this,We).add(t)}}he=new WeakMap,We=new WeakMap;function V(e,t){throw new kt(t)}function Ns(e){if(e===null)return null;if(typeof e=="string")return e;if(typeof e=="number"){if(!Number.isFinite(e))throw new RangeError("Only finite numbers (not Infinity or NaN) can be passed as arguments");return e}else if(typeof e=="bigint"){if(e<Zr||e>eo)throw new RangeError("This bigint value is too large to be represented as a 64-bit integer and passed as argument");return e}else{if(typeof e=="boolean")return e?1n:0n;if(e instanceof ArrayBuffer)return new Uint8Array(e);if(e instanceof Uint8Array)return e;if(e instanceof Date)return+e.valueOf();if(typeof e=="object")return""+e.toString();throw new TypeError("Unsupported type of value")}}const Zr=-9223372036854775808n,eo=9223372036854775807n;function Vl(e,t){if(e===null)return null;if(typeof e=="number")return e;if(typeof e=="string")return e;if(typeof e=="bigint")if(t==="number"){const s=Number(e);if(!Number.isSafeInteger(s))throw new RangeError("Received integer which is too large to be safely represented as a JavaScript number");return s}else{if(t==="bigint")return e;if(t==="string")return""+e;throw new Is("Invalid value for IntMode")}else{if(e instanceof Uint8Array)return e.slice().buffer;throw e===void 0?new R("Received unrecognized type of Value"):V(e,"Impossible type of Value")}}function la(e){return{affectedRowCount:e.affectedRowCount,lastInsertRowid:e.lastInsertRowid,columnNames:e.cols.map(t=>t.name),columnDecltypes:e.cols.map(t=>t.decltype)}}function Gl(e,t){const s=la(e),a=e.rows.map(n=>zl(s.columnNames,n,t));return{...s,rows:a}}function Hl(e,t){const s=la(e);let a;return e.rows.length>0&&(a=zl(s.columnNames,e.rows[0],t)),{...s,row:a}}function Wl(e,t){const s=la(e);let a;return e.rows.length>0&&s.columnNames.length>0&&(a=Vl(e.rows[0][0],t)),{...s,value:a}}function zl(e,t,s){const a={};Object.defineProperty(a,"length",{value:t.length});for(let n=0;n<t.length;++n){const l=Vl(t[n],s);Object.defineProperty(a,n,{value:l});const d=e[n];d!==void 0&&!Object.hasOwn(a,d)&&Object.defineProperty(a,d,{value:l,enumerable:!0,configurable:!0,writable:!0})}return a}function ys(e){return new Pl(e.message,e)}var ts,ss,ze;class mn{constructor(t,s){b(this,ts);b(this,ss);b(this,ze);x(this,ts,t),x(this,ss,s),x(this,ze,void 0)}_getSqlId(t){if(i(this,ts)!==t)throw new Is("Attempted to use SQL text opened with other object");if(i(this,ze)!==void 0)throw new ke("SQL text is closed",i(this,ze));return i(this,ss)}close(){this._setClosed(new U("SQL text was manually closed"))}_setClosed(t){i(this,ze)===void 0&&(x(this,ze,t),i(this,ts)._closeSql(i(this,ss)))}get closed(){return i(this,ze)!==void 0}}ts=new WeakMap,ss=new WeakMap,ze=new WeakMap;function Ka(e,t){return t instanceof mn?{sqlId:t._getSqlId(e)}:{sql:""+t}}var Oe,Ie;class wa{constructor(){b(this,Oe);b(this,Ie);x(this,Oe,[]),x(this,Ie,[])}get length(){return i(this,Oe).length+i(this,Ie).length}push(t){i(this,Oe).push(t)}shift(){return i(this,Ie).length===0&&i(this,Oe).length>0&&(x(this,Ie,i(this,Oe).reverse()),x(this,Oe,[])),i(this,Ie).pop()}first(){return i(this,Ie).length!==0?i(this,Ie)[i(this,Ie).length-1]:i(this,Oe)[0]}}Oe=new WeakMap,Ie=new WeakMap;let Jl=class{constructor(t){D(this,"sql");D(this,"_args");D(this,"_namedArgs");this.sql=t,this._args=[],this._namedArgs=new Map}bindIndexes(t){this._args.length=0;for(const s of t)this._args.push(Ns(s));return this}bindIndex(t,s){if(t!==(t|0)||t<=0)throw new RangeError("Index of a positional argument must be positive integer");for(;this._args.length<t;)this._args.push(null);return this._args[t-1]=Ns(s),this}bindName(t,s){return this._namedArgs.set(t,Ns(s)),this}unbindAll(){return this._args.length=0,this._namedArgs.clear(),this}};function Yl(e,t,s){let a,n=[],l=[];if(t instanceof Jl){a=t.sql,n=t._args;for(const[p,o]of t._namedArgs.entries())l.push({name:p,value:o})}else Array.isArray(t)?(a=t[0],Array.isArray(t[1])?n=t[1].map(p=>Ns(p)):l=Object.entries(t[1]).map(([p,o])=>({name:p,value:Ns(o)}))):a=t;const{sql:d,sqlId:r}=Ka(e,a);return{sql:d,sqlId:r,args:n,namedArgs:l,wantRows:s}}var Gs,as,fl;let to=(fl=class{constructor(t,s){D(this,"_stream");b(this,Gs);D(this,"_steps");b(this,as);this._stream=t,x(this,Gs,s),this._steps=[],x(this,as,!1)}step(){return new no(this)}execute(){if(i(this,as))throw new Is("This batch has already been executed");x(this,as,!0);const t={steps:this._steps.map(s=>s.proto)};return i(this,Gs)?ao(this._stream,this._steps,t):so(this._stream,this._steps,t)}},Gs=new WeakMap,as=new WeakMap,fl);function so(e,t,s){return e._batch(s).then(a=>{for(let n=0;n<t.length;++n){const l=a.stepResults.get(n),d=a.stepErrors.get(n);t[n].callback(l,d)}})}async function ao(e,t,s){const a=await e._openCursor(s);try{let n=0,l,d=[];for(;;){const r=await a.next();if(r===void 0)break;if(r.type==="step_begin"){if(r.step<n||r.step>=t.length)throw new R("Server produced StepBeginEntry for unexpected step");if(l!==void 0)throw new R("Server produced StepBeginEntry before terminating previous step");for(let p=n;p<r.step;++p)t[p].callback(void 0,void 0);n=r.step+1,l=r,d=[]}else if(r.type==="step_end"){if(l===void 0)throw new R("Server produced StepEndEntry but no step is active");const p={cols:l.cols,rows:d,affectedRowCount:r.affectedRowCount,lastInsertRowid:r.lastInsertRowid};t[l.step].callback(p,void 0),l=void 0,d=[]}else if(r.type==="step_error"){if(l===void 0){if(r.step>=t.length)throw new R("Server produced StepErrorEntry for unexpected step");for(let p=n;p<r.step;++p)t[p].callback(void 0,void 0)}else{if(r.step!==l.step)throw new R("Server produced StepErrorEntry for unexpected step");l=void 0,d=[]}t[r.step].callback(void 0,r.error),n=r.step+1}else if(r.type==="row"){if(l===void 0)throw new R("Server produced RowEntry but no step is active");d.push(r.row)}else throw r.type==="error"?ys(r.error):r.type==="none"?new R("Server produced unrecognized CursorEntry"):V(r,"Impossible CursorEntry")}if(l!==void 0)throw new R("Server closed Cursor before terminating active step");for(let r=n;r<t.length;++r)t[r].callback(void 0,void 0)}finally{a.close()}}var Je,Tt,Ds,bl;let no=(bl=class{constructor(t){b(this,Tt);D(this,"_batch");b(this,Je);D(this,"_index");this._batch=t,x(this,Je,[]),this._index=void 0}condition(t){return i(this,Je).push(t._proto),this}query(t){return g(this,Tt,Ds).call(this,t,!0,Gl)}queryRow(t){return g(this,Tt,Ds).call(this,t,!0,Hl)}queryValue(t){return g(this,Tt,Ds).call(this,t,!0,Wl)}run(t){return g(this,Tt,Ds).call(this,t,!1,la)}},Je=new WeakMap,Tt=new WeakSet,Ds=function(t,s,a){if(this._index!==void 0)throw new Is("This BatchStep has already been added to the batch");const n=Yl(this._batch._stream._sqlOwner(),t,s);let l;i(this,Je).length===0?l=void 0:i(this,Je).length===1?l=i(this,Je)[0]:l={type:"and",conds:i(this,Je).slice()};const d={stmt:n,condition:l};return new Promise((r,p)=>{const o=(u,h)=>{u!==void 0&&h!==void 0?p(new R("Server returned both result and error")):h!==void 0?p(ys(h)):r(u!==void 0?a(u,this._batch._stream.intMode):void 0)};this._index=this._batch._steps.length,this._batch._steps.push({proto:d,callback:o})})},bl),ue=class Ct{constructor(t,s){D(this,"_batch");D(this,"_proto");this._batch=t,this._proto=s}static ok(t){return new Ct(t._batch,{type:"ok",step:Yn(t)})}static error(t){return new Ct(t._batch,{type:"error",step:Yn(t)})}static not(t){return new Ct(t._batch,{type:"not",cond:t._proto})}static and(t,s){for(const a of s)Kn(t,a);return new Ct(t,{type:"and",conds:s.map(a=>a._proto)})}static or(t,s){for(const a of s)Kn(t,a);return new Ct(t,{type:"or",conds:s.map(a=>a._proto)})}static isAutocommit(t){return t._stream.client()._ensureVersion(3,"BatchCond.isAutocommit()"),new Ct(t,{type:"is_autocommit"})}};function Yn(e){if(e._index===void 0)throw new Is("Cannot add a condition referencing a step that has not been added to the batch");return e._index}function Kn(e,t){if(t._batch!==e)throw new Is("Cannot mix BatchCond objects for different Batch objects")}function lo(e){return{paramNames:e.params.map(t=>t.name),columns:e.cols,isExplain:e.isExplain,isReadonly:e.isReadonly}}var Mt,Ls;class Kl{constructor(t){b(this,Mt);D(this,"intMode");this.intMode=t}query(t){return g(this,Mt,Ls).call(this,t,!0,Gl)}queryRow(t){return g(this,Mt,Ls).call(this,t,!0,Hl)}queryValue(t){return g(this,Mt,Ls).call(this,t,!0,Wl)}run(t){return g(this,Mt,Ls).call(this,t,!1,la)}batch(t=!1){return new to(this,t)}describe(t){const s=Ka(this._sqlOwner(),t);return this._describe(s).then(lo)}sequence(t){const s=Ka(this._sqlOwner(),t);return this._sequence(s)}}Mt=new WeakSet,Ls=function(t,s,a){const n=Yl(this._sqlOwner(),t,s);return this._execute(n).then(l=>a(l,this.intMode))};class Ql{}const io=1e3,ro=10;var Ca,Dt,ns,ls,Lt,Ye,jt,Aa,Xl;class oo extends Ql{constructor(s,a,n){super();b(this,Aa);b(this,Ca);b(this,Dt);b(this,ns);b(this,ls);b(this,Lt);b(this,Ye);b(this,jt);x(this,Ca,s),x(this,Dt,a),x(this,ns,n),x(this,ls,new wa),x(this,Lt,new wa),x(this,Ye,void 0),x(this,jt,!1)}async next(){for(;;){if(i(this,Ye)!==void 0)throw new ke("Cursor is closed",i(this,Ye));for(;!i(this,jt)&&i(this,Lt).length<ro;)i(this,Lt).push(g(this,Aa,Xl).call(this));const s=i(this,ls).shift();if(i(this,jt)||s!==void 0)return s;await i(this,Lt).shift().then(a=>{if(a!==void 0){for(const n of a.entries)i(this,ls).push(n);i(this,jt)||x(this,jt,a.done)}})}}_setClosed(s){i(this,Ye)===void 0&&(x(this,Ye,s),i(this,Dt)._sendCursorRequest(this,{type:"close_cursor",cursorId:i(this,ns)}).catch(()=>{}),i(this,Dt)._cursorClosed(this))}close(){this._setClosed(new U("Cursor was manually closed"))}get closed(){return i(this,Ye)!==void 0}}Ca=new WeakMap,Dt=new WeakMap,ns=new WeakMap,ls=new WeakMap,Lt=new WeakMap,Ye=new WeakMap,jt=new WeakMap,Aa=new WeakSet,Xl=function(){return i(this,Dt)._sendCursorRequest(this,{type:"fetch_cursor",cursorId:i(this,ns),maxCount:io}).then(s=>s,s=>{this._setClosed(s)})};var X,ve,Ke,me,ut,$e,W,Wt,Xa,fa,ba;const Nn=class Nn extends Kl{constructor(s,a){super(s.intMode);b(this,W);b(this,X);b(this,ve);b(this,Ke);b(this,me);b(this,ut);b(this,$e);x(this,X,s),x(this,ve,a),x(this,Ke,new wa),x(this,me,void 0),x(this,ut,!1),x(this,$e,void 0)}static open(s){const a=s._streamIdAlloc.alloc(),n=new Nn(s,a),l=()=>{},d=p=>{var o;return g(o=n,W,ba).call(o,p)},r={type:"open_stream",streamId:a};return s._sendRequest(r,{responseCallback:l,errorCallback:d}),n}client(){return i(this,X)}_sqlOwner(){return i(this,X)}_execute(s){return g(this,W,Wt).call(this,{type:"execute",streamId:i(this,ve),stmt:s}).then(a=>a.result)}_batch(s){return g(this,W,Wt).call(this,{type:"batch",streamId:i(this,ve),batch:s}).then(a=>a.result)}_describe(s){return i(this,X)._ensureVersion(2,"describe()"),g(this,W,Wt).call(this,{type:"describe",streamId:i(this,ve),sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return i(this,X)._ensureVersion(2,"sequence()"),g(this,W,Wt).call(this,{type:"sequence",streamId:i(this,ve),sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return i(this,X)._ensureVersion(3,"getAutocommit()"),g(this,W,Wt).call(this,{type:"get_autocommit",streamId:i(this,ve)}).then(s=>s.isAutocommit)}_openCursor(s){return i(this,X)._ensureVersion(3,"cursor"),new Promise((a,n)=>{g(this,W,Xa).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_sendCursorRequest(s,a){if(s!==i(this,me))throw new kt("Cursor not associated with the stream attempted to execute a request");return new Promise((n,l)=>{i(this,$e)!==void 0?l(new ke("Stream is closed",i(this,$e))):i(this,X)._sendRequest(a,{responseCallback:n,errorCallback:l})})}_cursorClosed(s){if(s!==i(this,me))throw new kt("Cursor was closed, but it was not associated with the stream");x(this,me,void 0),g(this,W,fa).call(this)}close(){g(this,W,ba).call(this,new U("Stream was manually closed"))}closeGracefully(){x(this,ut,!0),g(this,W,fa).call(this)}get closed(){return i(this,$e)!==void 0||i(this,ut)}};X=new WeakMap,ve=new WeakMap,Ke=new WeakMap,me=new WeakMap,ut=new WeakMap,$e=new WeakMap,W=new WeakSet,Wt=function(s){return new Promise((a,n)=>{g(this,W,Xa).call(this,{type:"request",request:s,responseCallback:a,errorCallback:n})})},Xa=function(s){i(this,$e)!==void 0?s.errorCallback(new ke("Stream is closed",i(this,$e))):i(this,ut)?s.errorCallback(new ke("Stream is closing",void 0)):(i(this,Ke).push(s),g(this,W,fa).call(this))},fa=function(){for(;;){const s=i(this,Ke).first();if(s===void 0&&i(this,me)===void 0&&i(this,ut)){g(this,W,ba).call(this,new U("Stream was gracefully closed"));break}else if((s==null?void 0:s.type)==="request"&&i(this,me)===void 0){const{request:a,responseCallback:n,errorCallback:l}=s;i(this,Ke).shift(),i(this,X)._sendRequest(a,{responseCallback:n,errorCallback:l})}else if((s==null?void 0:s.type)==="cursor"&&i(this,me)===void 0){const{batch:a,cursorCallback:n}=s;i(this,Ke).shift();const l=i(this,X)._cursorIdAlloc.alloc(),d=new oo(i(this,X),this,l),r={type:"open_cursor",streamId:i(this,ve),cursorId:l,batch:a},p=()=>{},o=u=>d._setClosed(u);i(this,X)._sendRequest(r,{responseCallback:p,errorCallback:o}),x(this,me,d),n(d)}else break}},ba=function(s){if(i(this,$e)!==void 0)return;for(x(this,$e,s),i(this,me)!==void 0&&i(this,me)._setClosed(s);;){const d=i(this,Ke).shift();if(d!==void 0)d.errorCallback(s);else break}const a={type:"close_stream",streamId:i(this,ve)},n=()=>i(this,X)._streamIdAlloc.free(i(this,ve)),l=()=>{};i(this,X)._sendRequest(a,{responseCallback:n,errorCallback:l})};let Qa=Nn;function gn(e,t){t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId),e.arrayObjects("args",t.args,Zl),e.arrayObjects("named_args",t.namedArgs,co),e.boolean("want_rows",t.wantRows)}function co(e,t){e.string("name",t.name),e.object("value",t.value,Zl)}function va(e,t){e.arrayObjects("steps",t.steps,po)}function po(e,t){t.condition!==void 0&&e.object("condition",t.condition,Za),e.object("stmt",t.stmt,gn)}function Za(e,t){if(e.stringRaw("type",t.type),t.type==="ok"||t.type==="error")e.number("step",t.step);else if(t.type==="not")e.object("cond",t.cond,Za);else if(t.type==="and"||t.type==="or")e.arrayObjects("conds",t.conds,Za);else if(t.type!=="is_autocommit")throw V(t,"Impossible type of BatchCond")}function Zl(e,t){if(t===null)e.stringRaw("type","null");else if(typeof t=="bigint")e.stringRaw("type","integer"),e.stringRaw("value",""+t);else if(typeof t=="number")e.stringRaw("type","float"),e.number("value",t);else if(typeof t=="string")e.stringRaw("type","text"),e.string("value",t);else if(t instanceof Uint8Array)e.stringRaw("type","blob"),e.stringRaw("base64",bn.fromUint8Array(t));else if(t!==void 0)throw V(t,"Impossible type of Value")}function uo(e,t){if(e.stringRaw("type",t.type),t.type==="hello")t.jwt!==void 0&&e.string("jwt",t.jwt);else if(t.type==="request")e.number("request_id",t.requestId),e.object("request",t.request,xo);else throw V(t,"Impossible type of ClientMsg")}function xo(e,t){if(e.stringRaw("type",t.type),t.type==="open_stream")e.number("stream_id",t.streamId);else if(t.type==="close_stream")e.number("stream_id",t.streamId);else if(t.type==="execute")e.number("stream_id",t.streamId),e.object("stmt",t.stmt,gn);else if(t.type==="batch")e.number("stream_id",t.streamId),e.object("batch",t.batch,va);else if(t.type==="open_cursor")e.number("stream_id",t.streamId),e.number("cursor_id",t.cursorId),e.object("batch",t.batch,va);else if(t.type==="close_cursor")e.number("cursor_id",t.cursorId);else if(t.type==="fetch_cursor")e.number("cursor_id",t.cursorId),e.number("max_count",t.maxCount);else if(t.type==="sequence")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type==="get_autocommit")e.number("stream_id",t.streamId);else throw V(t,"Impossible type of Request")}function wn(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId);for(const s of t.args)e.message(3,s,ei);for(const s of t.namedArgs)e.message(4,s,fo);e.bool(5,t.wantRows)}function fo(e,t){e.string(1,t.name),e.message(2,t.value,ei)}function Ta(e,t){for(const s of t.steps)e.message(1,s,bo)}function bo(e,t){t.condition!==void 0&&e.message(1,t.condition,vn),e.message(2,t.stmt,wn)}function vn(e,t){if(t.type==="ok")e.uint32(1,t.step);else if(t.type==="error")e.uint32(2,t.step);else if(t.type==="not")e.message(3,t.cond,vn);else if(t.type==="and")e.message(4,t.conds,Qn);else if(t.type==="or")e.message(5,t.conds,Qn);else if(t.type==="is_autocommit")e.message(6,void 0,ti);else throw V(t,"Impossible type of BatchCond")}function Qn(e,t){for(const s of t)e.message(1,s,vn)}function ei(e,t){if(t===null)e.message(1,void 0,ti);else if(typeof t=="bigint")e.sint64(2,t);else if(typeof t=="number")e.double(3,t);else if(typeof t=="string")e.string(4,t);else if(t instanceof Uint8Array)e.bytes(5,t);else if(t!==void 0)throw V(t,"Impossible type of Value")}function ti(e,t){}function ho(e,t){if(t.type==="hello")e.message(1,t,mo);else if(t.type==="request")e.message(2,t,go);else throw V(t,"Impossible type of ClientMsg")}function mo(e,t){t.jwt!==void 0&&e.string(1,t.jwt)}function go(e,t){e.int32(1,t.requestId);const s=t.request;if(s.type==="open_stream")e.message(2,s,wo);else if(s.type==="close_stream")e.message(3,s,vo);else if(s.type==="execute")e.message(4,s,yo);else if(s.type==="batch")e.message(5,s,ko);else if(s.type==="open_cursor")e.message(6,s,_o);else if(s.type==="close_cursor")e.message(7,s,So);else if(s.type==="fetch_cursor")e.message(8,s,Io);else if(s.type==="sequence")e.message(9,s,$o);else if(s.type==="describe")e.message(10,s,Co);else if(s.type==="store_sql")e.message(11,s,Ao);else if(s.type==="close_sql")e.message(12,s,Ro);else if(s.type==="get_autocommit")e.message(13,s,Eo);else throw V(s,"Impossible type of Request")}function wo(e,t){e.int32(1,t.streamId)}function vo(e,t){e.int32(1,t.streamId)}function yo(e,t){e.int32(1,t.streamId),e.message(2,t.stmt,wn)}function ko(e,t){e.int32(1,t.streamId),e.message(2,t.batch,Ta)}function _o(e,t){e.int32(1,t.streamId),e.int32(2,t.cursorId),e.message(3,t.batch,Ta)}function So(e,t){e.int32(1,t.cursorId)}function Io(e,t){e.int32(1,t.cursorId),e.uint32(2,t.maxCount)}function $o(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function Co(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function Ao(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function Ro(e,t){e.int32(1,t.sqlId)}function Eo(e,t){e.int32(1,t.streamId)}function ks(e){const t=Me(e.message),s=Le(e.code);return{message:t,code:s}}function yn(e){const t=_t(e.cols,si),s=ga(e.rows).map(d=>_t(d,ii)),a=Ut(e.affected_row_count),n=Le(e.last_insert_rowid),l=n!==void 0?BigInt(n):void 0;return{cols:t,rows:s,affectedRowCount:a,lastInsertRowid:l}}function si(e){const t=Le(e.name),s=Le(e.decltype);return{name:t,decltype:s}}function ai(e){const t=new Map;ga(e.step_results).forEach((a,n)=>{a!==null&&t.set(n,yn(ee(a)))});const s=new Map;return ga(e.step_errors).forEach((a,n)=>{a!==null&&s.set(n,ks(ee(a)))}),{stepResults:t,stepErrors:s}}function ni(e){const t=Me(e.type);if(t==="step_begin"){const s=Ut(e.step),a=_t(e.cols,si);return{type:"step_begin",step:s,cols:a}}else if(t==="step_end"){const s=Ut(e.affected_row_count),a=Le(e.last_insert_rowid),n=a!==void 0?BigInt(a):void 0;return{type:"step_end",affectedRowCount:s,lastInsertRowid:n}}else if(t==="step_error"){const s=Ut(e.step),a=ks(ee(e.error));return{type:"step_error",step:s,error:a}}else{if(t==="row")return{type:"row",row:_t(e.row,ii)};if(t==="error")return{type:"error",error:ks(ee(e.error))};throw new R("Unexpected type of CursorEntry")}}function li(e){const t=_t(e.params,To),s=_t(e.cols,Mo),a=Us(e.is_explain),n=Us(e.is_readonly);return{params:t,cols:s,isExplain:a,isReadonly:n}}function To(e){return{name:Le(e.name)}}function Mo(e){const t=Me(e.name),s=Le(e.decltype);return{name:t,decltype:s}}function ii(e){const t=Me(e.type);if(t==="null")return null;if(t==="integer"){const s=Me(e.value);return BigInt(s)}else{if(t==="float")return Ut(e.value);if(t==="text")return Me(e.value);if(t==="blob")return bn.toUint8Array(Me(e.base64));throw new R("Unexpected type of Value")}}function Do(e){const t=Me(e.type);if(t==="hello_ok")return{type:"hello_ok"};if(t==="hello_error")return{type:"hello_error",error:ks(ee(e.error))};if(t==="response_ok"){const s=Ut(e.request_id),a=Lo(ee(e.response));return{type:"response_ok",requestId:s,response:a}}else if(t==="response_error"){const s=Ut(e.request_id),a=ks(ee(e.error));return{type:"response_error",requestId:s,error:a}}else throw new R("Unexpected type of ServerMsg")}function Lo(e){const t=Me(e.type);if(t==="open_stream")return{type:"open_stream"};if(t==="close_stream")return{type:"close_stream"};if(t==="execute")return{type:"execute",result:yn(ee(e.result))};if(t==="batch")return{type:"batch",result:ai(ee(e.result))};if(t==="open_cursor")return{type:"open_cursor"};if(t==="close_cursor")return{type:"close_cursor"};if(t==="fetch_cursor"){const s=_t(e.entries,ni),a=Us(e.done);return{type:"fetch_cursor",entries:s,done:a}}else{if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:li(ee(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Us(e.is_autocommit)};throw new R("Unexpected type of Response")}}const Ue={default(){return{message:"",code:void 0}},1(e,t){t.message=e.string()},2(e,t){t.code=e.string()}},_s={default(){return{cols:[],rows:[],affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.cols.push(e.message(ri))},2(e,t){t.rows.push(e.message(oi))},3(e,t){t.affectedRowCount=Number(e.uint64())},4(e,t){t.lastInsertRowid=e.sint64()}},ri={default(){return{name:void 0,decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},oi={default(){return[]},1(e,t){t.push(e.message(Uo))}},ya={default(){return{stepResults:new Map,stepErrors:new Map}},1(e,t){const[s,a]=e.message(jo);t.stepResults.set(s,a)},2(e,t){const[s,a]=e.message(qo);t.stepErrors.set(s,a)}},jo={default(){return[0,_s.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(_s)}},qo={default(){return[0,Ue.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Ue)}},ci={default(){return{type:"none"}},1(e){return e.message(Oo)},2(e){return e.message(Po)},3(e){return e.message(No)},4(e){return{type:"row",row:e.message(oi)}},5(e){return{type:"error",error:e.message(Ue)}}},Oo={default(){return{type:"step_begin",step:0,cols:[]}},1(e,t){t.step=e.uint32()},2(e,t){t.cols.push(e.message(ri))}},Po={default(){return{type:"step_end",affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.affectedRowCount=e.uint32()},2(e,t){t.lastInsertRowid=e.uint64()}},No={default(){return{type:"step_error",step:0,error:Ue.default()}},1(e,t){t.step=e.uint32()},2(e,t){t.error=e.message(Ue)}},ka={default(){return{params:[],cols:[],isExplain:!1,isReadonly:!1}},1(e,t){t.params.push(e.message(Bo))},2(e,t){t.cols.push(e.message(Fo))},3(e,t){t.isExplain=e.bool()},4(e,t){t.isReadonly=e.bool()}},Bo={default(){return{name:void 0}},1(e,t){t.name=e.string()}},Fo={default(){return{name:"",decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},Uo={default(){},1(e){return null},2(e){return e.sint64()},3(e){return e.double()},4(e){return e.string()},5(e){return e.bytes()}},Vo={default(){return{type:"none"}},1(e){return{type:"hello_ok"}},2(e){return e.message(Go)},3(e){return e.message(Wo)},4(e){return e.message(Ho)}},Go={default(){return{type:"hello_error",error:Ue.default()}},1(e,t){t.error=e.message(Ue)}},Ho={default(){return{type:"response_error",requestId:0,error:Ue.default()}},1(e,t){t.requestId=e.int32()},2(e,t){t.error=e.message(Ue)}},Wo={default(){return{type:"response_ok",requestId:0,response:{type:"none"}}},1(e,t){t.requestId=e.int32()},2(e,t){t.response={type:"open_stream"}},3(e,t){t.response={type:"close_stream"}},4(e,t){t.response=e.message(zo)},5(e,t){t.response=e.message(Jo)},6(e,t){t.response={type:"open_cursor"}},7(e,t){t.response={type:"close_cursor"}},8(e,t){t.response=e.message(Yo)},9(e,t){t.response={type:"sequence"}},10(e,t){t.response=e.message(Ko)},11(e,t){t.response={type:"store_sql"}},12(e,t){t.response={type:"close_sql"}},13(e,t){t.response=e.message(Qo)}},zo={default(){return{type:"execute",result:_s.default()}},1(e,t){t.result=e.message(_s)}},Jo={default(){return{type:"batch",result:ya.default()}},1(e,t){t.result=e.message(ya)}},Yo={default(){return{type:"fetch_cursor",entries:[],done:!1}},1(e,t){t.entries.push(e.message(ci))},2(e,t){t.done=e.bool()}},Ko={default(){return{type:"describe",result:ka.default()}},1(e,t){t.result=e.message(ka)}},Qo={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Xo=new Map([["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]),di=new Map([["hrana3-protobuf",{version:3,encoding:"protobuf"}],["hrana3",{version:3,encoding:"json"}],["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]);var te,Pe,qt,ce,Ot,de,is,Ce,xt,rs,q,en,pi,tn,ui,xi,je,fi,bi,hl;let Zo=(hl=class extends Ol{constructor(s,a){super();b(this,q);b(this,te);b(this,Pe);b(this,qt);b(this,ce);b(this,Ot);b(this,de);b(this,is);b(this,Ce);b(this,xt);D(this,"_streamIdAlloc");D(this,"_cursorIdAlloc");b(this,rs);x(this,te,s),x(this,Pe,[]),x(this,qt,!1),x(this,ce,void 0),x(this,Ot,!1),x(this,de,void 0),x(this,is,!1),x(this,Ce,new Map),x(this,xt,new Ms),this._streamIdAlloc=new Ms,this._cursorIdAlloc=new Ms,x(this,rs,new Ms),i(this,te).binaryType="arraybuffer",i(this,te).addEventListener("open",()=>g(this,q,pi).call(this)),i(this,te).addEventListener("close",n=>g(this,q,xi).call(this,n)),i(this,te).addEventListener("error",n=>g(this,q,ui).call(this,n)),i(this,te).addEventListener("message",n=>g(this,q,fi).call(this,n)),g(this,q,en).call(this,{type:"hello",jwt:a})}getVersion(){return new Promise((s,a)=>{if(x(this,is,!0),i(this,ce)!==void 0)a(i(this,ce));else if(i(this,qt))s(i(this,de).version);else{const n=()=>s(i(this,de).version);i(this,Pe).push({openCallback:n,errorCallback:a})}})}_ensureVersion(s,a){if(i(this,de)===void 0||!i(this,is))throw new vs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the WebSocket server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(i(this,de).version<s)throw new vs(`${a} is supported on protocol version ${s} and higher, but the WebSocket server only supports version ${i(this,de).version}`)}_sendRequest(s,a){if(i(this,ce)!==void 0){a.errorCallback(new ke("Client is closed",i(this,ce)));return}const n=i(this,xt).alloc();i(this,Ce).set(n,{...a,type:s.type}),g(this,q,en).call(this,{type:"request",requestId:n,request:s})}openStream(){return Qa.open(this)}storeSql(s){this._ensureVersion(2,"storeSql()");const a=i(this,rs).alloc(),n=new mn(this,a),l=()=>{},d=p=>n._setClosed(p),r={type:"store_sql",sqlId:a,sql:s};return this._sendRequest(r,{responseCallback:l,errorCallback:d}),n}_closeSql(s){if(i(this,ce)!==void 0)return;const a=()=>i(this,rs).free(s),n=d=>g(this,q,je).call(this,d),l={type:"close_sql",sqlId:s};this._sendRequest(l,{responseCallback:a,errorCallback:n})}close(){g(this,q,je).call(this,new U("Client was manually closed"))}get closed(){return i(this,ce)!==void 0}},te=new WeakMap,Pe=new WeakMap,qt=new WeakMap,ce=new WeakMap,Ot=new WeakMap,de=new WeakMap,is=new WeakMap,Ce=new WeakMap,xt=new WeakMap,rs=new WeakMap,q=new WeakSet,en=function(s){if(i(this,ce)!==void 0)throw new kt("Trying to send a message on a closed client");if(i(this,qt))g(this,q,tn).call(this,s);else{const a=()=>g(this,q,tn).call(this,s),n=()=>{};i(this,Pe).push({openCallback:a,errorCallback:n})}},pi=function(){const s=i(this,te).protocol;if(s===void 0){g(this,q,je).call(this,new U("The `WebSocket.protocol` property is undefined. This most likely means that the WebSocket implementation provided by the environment is broken. If you are using Miniflare 2, please update to Miniflare 3, which fixes this problem."));return}else if(s==="")x(this,de,{version:1,encoding:"json"});else if(x(this,de,di.get(s)),i(this,de)===void 0){g(this,q,je).call(this,new R(`Unrecognized WebSocket subprotocol: ${JSON.stringify(s)}`));return}for(const a of i(this,Pe))a.openCallback();i(this,Pe).length=0,x(this,qt,!0)},tn=function(s){const a=i(this,de).encoding;if(a==="json"){const n=Bl(s,uo);i(this,te).send(n)}else if(a==="protobuf"){const n=Ul(s,ho);i(this,te).send(n)}else throw V(a,"Impossible encoding")},ui=function(s){const n=s.message??"WebSocket was closed due to an error";g(this,q,je).call(this,new Wa(n))},xi=function(s){let a=`WebSocket was closed with code ${s.code}`;s.reason&&(a+=`: ${s.reason}`),g(this,q,je).call(this,new Wa(a))},je=function(s){if(i(this,ce)===void 0){x(this,ce,s);for(const a of i(this,Pe))a.errorCallback(s);i(this,Pe).length=0;for(const[a,n]of i(this,Ce).entries())n.errorCallback(s),i(this,xt).free(a);i(this,Ce).clear(),i(this,te).close()}},fi=function(s){if(i(this,ce)===void 0)try{let a;const n=i(this,de).encoding;if(n==="json"){if(typeof s.data!="string"){i(this,te).close(3003,"Only text messages are accepted with JSON encoding"),g(this,q,je).call(this,new R("Received non-text message from server with JSON encoding"));return}a=hn(JSON.parse(s.data),Do)}else if(n==="protobuf"){if(!(s.data instanceof ArrayBuffer)){i(this,te).close(3003,"Only binary messages are accepted with Protobuf encoding"),g(this,q,je).call(this,new R("Received non-binary message from server with Protobuf encoding"));return}a=Ea(new Uint8Array(s.data),Vo)}else throw V(n,"Impossible encoding");g(this,q,bi).call(this,a)}catch(a){i(this,te).close(3007,"Could not handle message"),g(this,q,je).call(this,a)}},bi=function(s){if(s.type==="none")throw new R("Received an unrecognized ServerMsg");if(s.type==="hello_ok"||s.type==="hello_error"){if(i(this,Ot))throw new R("Received a duplicated hello response");if(x(this,Ot,!0),s.type==="hello_error")throw ys(s.error);return}else if(!i(this,Ot))throw new R("Received a non-hello message before a hello response");if(s.type==="response_ok"){const a=s.requestId,n=i(this,Ce).get(a);if(i(this,Ce).delete(a),n===void 0)throw new R("Received unexpected OK response");i(this,xt).free(a);try{if(n.type!==s.response.type)throw console.dir({responseState:n,msg:s}),new R("Received unexpected type of response");n.responseCallback(s.response)}catch(l){throw n.errorCallback(l),l}}else if(s.type==="response_error"){const a=s.requestId,n=i(this,Ce).get(a);if(i(this,Ce).delete(a),n===void 0)throw new R("Received unexpected error response");i(this,xt).free(a),n.errorCallback(ys(s.error))}else throw V(s,"Impossible ServerMsg type")},hl);var ca=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function ec(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var sn={exports:{}};(function(e,t){var s=typeof globalThis<"u"&&globalThis||typeof self<"u"&&self||typeof ca<"u"&&ca,a=function(){function l(){this.fetch=!1,this.DOMException=s.DOMException}return l.prototype=s,new l}();(function(l){(function(d){var r=typeof l<"u"&&l||typeof self<"u"&&self||typeof ca<"u"&&ca||{},p={searchParams:"URLSearchParams"in r,iterable:"Symbol"in r&&"iterator"in Symbol,blob:"FileReader"in r&&"Blob"in r&&function(){try{return new Blob,!0}catch{return!1}}(),formData:"FormData"in r,arrayBuffer:"ArrayBuffer"in r};function o(f){return f&&DataView.prototype.isPrototypeOf(f)}if(p.arrayBuffer)var u=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]"],h=ArrayBuffer.isView||function(f){return f&&u.indexOf(Object.prototype.toString.call(f))>-1};function w(f){if(typeof f!="string"&&(f=String(f)),/[^a-z0-9\-#$%&'*+.^_`|~!]/i.test(f)||f==="")throw new TypeError('Invalid character in header field name: "'+f+'"');return f.toLowerCase()}function v(f){return typeof f!="string"&&(f=String(f)),f}function m(f){var y={next:function(){var A=f.shift();return{done:A===void 0,value:A}}};return p.iterable&&(y[Symbol.iterator]=function(){return y}),y}function S(f){this.map={},f instanceof S?f.forEach(function(y,A){this.append(A,y)},this):Array.isArray(f)?f.forEach(function(y){if(y.length!=2)throw new TypeError("Headers constructor: expected name/value pair to be length 2, found"+y.length);this.append(y[0],y[1])},this):f&&Object.getOwnPropertyNames(f).forEach(function(y){this.append(y,f[y])},this)}S.prototype.append=function(f,y){f=w(f),y=v(y);var A=this.map[f];this.map[f]=A?A+", "+y:y},S.prototype.delete=function(f){delete this.map[w(f)]},S.prototype.get=function(f){return f=w(f),this.has(f)?this.map[f]:null},S.prototype.has=function(f){return this.map.hasOwnProperty(w(f))},S.prototype.set=function(f,y){this.map[w(f)]=v(y)},S.prototype.forEach=function(f,y){for(var A in this.map)this.map.hasOwnProperty(A)&&f.call(y,this.map[A],A,this)},S.prototype.keys=function(){var f=[];return this.forEach(function(y,A){f.push(A)}),m(f)},S.prototype.values=function(){var f=[];return this.forEach(function(y){f.push(y)}),m(f)},S.prototype.entries=function(){var f=[];return this.forEach(function(y,A){f.push([A,y])}),m(f)},p.iterable&&(S.prototype[Symbol.iterator]=S.prototype.entries);function _(f){if(!f._noBody){if(f.bodyUsed)return Promise.reject(new TypeError("Already read"));f.bodyUsed=!0}}function k(f){return new Promise(function(y,A){f.onload=function(){y(f.result)},f.onerror=function(){A(f.error)}})}function P(f){var y=new FileReader,A=k(y);return y.readAsArrayBuffer(f),A}function G(f){var y=new FileReader,A=k(y),O=/charset=([A-Za-z0-9_-]+)/.exec(f.type),N=O?O[1]:"utf-8";return y.readAsText(f,N),A}function Cs(f){for(var y=new Uint8Array(f),A=new Array(y.length),O=0;O<y.length;O++)A[O]=String.fromCharCode(y[O]);return A.join("")}function Gt(f){if(f.slice)return f.slice(0);var y=new Uint8Array(f.byteLength);return y.set(new Uint8Array(f)),y.buffer}function Bn(){return this.bodyUsed=!1,this._initBody=function(f){this.bodyUsed=this.bodyUsed,this._bodyInit=f,f?typeof f=="string"?this._bodyText=f:p.blob&&Blob.prototype.isPrototypeOf(f)?this._bodyBlob=f:p.formData&&FormData.prototype.isPrototypeOf(f)?this._bodyFormData=f:p.searchParams&&URLSearchParams.prototype.isPrototypeOf(f)?this._bodyText=f.toString():p.arrayBuffer&&p.blob&&o(f)?(this._bodyArrayBuffer=Gt(f.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):p.arrayBuffer&&(ArrayBuffer.prototype.isPrototypeOf(f)||h(f))?this._bodyArrayBuffer=Gt(f):this._bodyText=f=Object.prototype.toString.call(f):(this._noBody=!0,this._bodyText=""),this.headers.get("content-type")||(typeof f=="string"?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):p.searchParams&&URLSearchParams.prototype.isPrototypeOf(f)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},p.blob&&(this.blob=function(){var f=_(this);if(f)return f;if(this._bodyBlob)return Promise.resolve(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]));if(this._bodyFormData)throw new Error("could not read FormData body as blob");return Promise.resolve(new Blob([this._bodyText]))}),this.arrayBuffer=function(){if(this._bodyArrayBuffer){var f=_(this);return f||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer))}else{if(p.blob)return this.blob().then(P);throw new Error("could not read as ArrayBuffer")}},this.text=function(){var f=_(this);if(f)return f;if(this._bodyBlob)return G(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(Cs(this._bodyArrayBuffer));if(this._bodyFormData)throw new Error("could not read FormData body as text");return Promise.resolve(this._bodyText)},p.formData&&(this.formData=function(){return this.text().then(Bi)}),this.json=function(){return this.text().then(JSON.parse)},this}var Pi=["CONNECT","DELETE","GET","HEAD","OPTIONS","PATCH","POST","PUT","TRACE"];function Ni(f){var y=f.toUpperCase();return Pi.indexOf(y)>-1?y:f}function rt(f,y){if(!(this instanceof rt))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');y=y||{};var A=y.body;if(f instanceof rt){if(f.bodyUsed)throw new TypeError("Already read");this.url=f.url,this.credentials=f.credentials,y.headers||(this.headers=new S(f.headers)),this.method=f.method,this.mode=f.mode,this.signal=f.signal,!A&&f._bodyInit!=null&&(A=f._bodyInit,f.bodyUsed=!0)}else this.url=String(f);if(this.credentials=y.credentials||this.credentials||"same-origin",(y.headers||!this.headers)&&(this.headers=new S(y.headers)),this.method=Ni(y.method||this.method||"GET"),this.mode=y.mode||this.mode||null,this.signal=y.signal||this.signal||function(){if("AbortController"in r){var E=new AbortController;return E.signal}}(),this.referrer=null,(this.method==="GET"||this.method==="HEAD")&&A)throw new TypeError("Body not allowed for GET or HEAD requests");if(this._initBody(A),(this.method==="GET"||this.method==="HEAD")&&(y.cache==="no-store"||y.cache==="no-cache")){var O=/([?&])_=[^&]*/;if(O.test(this.url))this.url=this.url.replace(O,"$1_="+new Date().getTime());else{var N=/\?/;this.url+=(N.test(this.url)?"&":"?")+"_="+new Date().getTime()}}}rt.prototype.clone=function(){return new rt(this,{body:this._bodyInit})};function Bi(f){var y=new FormData;return f.trim().split("&").forEach(function(A){if(A){var O=A.split("="),N=O.shift().replace(/\+/g," "),E=O.join("=").replace(/\+/g," ");y.append(decodeURIComponent(N),decodeURIComponent(E))}}),y}function Fi(f){var y=new S,A=f.replace(/\r?\n[\t ]+/g," ");return A.split("\r").map(function(O){return O.indexOf(`
`)===0?O.substr(1,O.length):O}).forEach(function(O){var N=O.split(":"),E=N.shift().trim();if(E){var ra=N.join(":").trim();try{y.append(E,ra)}catch(qa){console.warn("Response "+qa.message)}}}),y}Bn.call(rt.prototype);function _e(f,y){if(!(this instanceof _e))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');if(y||(y={}),this.type="default",this.status=y.status===void 0?200:y.status,this.status<200||this.status>599)throw new RangeError("Failed to construct 'Response': The status provided (0) is outside the range [200, 599].");this.ok=this.status>=200&&this.status<300,this.statusText=y.statusText===void 0?"":""+y.statusText,this.headers=new S(y.headers),this.url=y.url||"",this._initBody(f)}Bn.call(_e.prototype),_e.prototype.clone=function(){return new _e(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new S(this.headers),url:this.url})},_e.error=function(){var f=new _e(null,{status:200,statusText:""});return f.ok=!1,f.status=0,f.type="error",f};var Ui=[301,302,303,307,308];_e.redirect=function(f,y){if(Ui.indexOf(y)===-1)throw new RangeError("Invalid status code");return new _e(null,{status:y,headers:{location:f}})},d.DOMException=r.DOMException;try{new d.DOMException}catch{d.DOMException=function(y,A){this.message=y,this.name=A;var O=Error(y);this.stack=O.stack},d.DOMException.prototype=Object.create(Error.prototype),d.DOMException.prototype.constructor=d.DOMException}function ja(f,y){return new Promise(function(A,O){var N=new rt(f,y);if(N.signal&&N.signal.aborted)return O(new d.DOMException("Aborted","AbortError"));var E=new XMLHttpRequest;function ra(){E.abort()}E.onload=function(){var Q={statusText:E.statusText,headers:Fi(E.getAllResponseHeaders()||"")};N.url.indexOf("file://")===0&&(E.status<200||E.status>599)?Q.status=200:Q.status=E.status,Q.url="responseURL"in E?E.responseURL:Q.headers.get("X-Request-URL");var It="response"in E?E.response:E.responseText;setTimeout(function(){A(new _e(It,Q))},0)},E.onerror=function(){setTimeout(function(){O(new TypeError("Network request failed"))},0)},E.ontimeout=function(){setTimeout(function(){O(new TypeError("Network request timed out"))},0)},E.onabort=function(){setTimeout(function(){O(new d.DOMException("Aborted","AbortError"))},0)};function qa(Q){try{return Q===""&&r.location.href?r.location.href:Q}catch{return Q}}if(E.open(N.method,qa(N.url),!0),N.credentials==="include"?E.withCredentials=!0:N.credentials==="omit"&&(E.withCredentials=!1),"responseType"in E&&(p.blob?E.responseType="blob":p.arrayBuffer&&(E.responseType="arraybuffer")),y&&typeof y.headers=="object"&&!(y.headers instanceof S||r.Headers&&y.headers instanceof r.Headers)){var Fn=[];Object.getOwnPropertyNames(y.headers).forEach(function(Q){Fn.push(w(Q)),E.setRequestHeader(Q,v(y.headers[Q]))}),N.headers.forEach(function(Q,It){Fn.indexOf(It)===-1&&E.setRequestHeader(It,Q)})}else N.headers.forEach(function(Q,It){E.setRequestHeader(It,Q)});N.signal&&(N.signal.addEventListener("abort",ra),E.onreadystatechange=function(){E.readyState===4&&N.signal.removeEventListener("abort",ra)}),E.send(typeof N._bodyInit>"u"?null:N._bodyInit)})}return ja.polyfill=!0,r.fetch||(r.fetch=ja,r.Headers=S,r.Request=rt,r.Response=_e),d.Headers=S,d.Request=rt,d.Response=_e,d.fetch=ja,d})({})})(a),a.fetch.ponyfill=!0,delete a.fetch.polyfill;var n=s.fetch?s:a;t=n.fetch,t.default=n.fetch,t.fetch=n.fetch,t.Headers=n.Headers,t.Request=n.Request,t.Response=n.Response,e.exports=t})(sn,sn.exports);var _a=sn.exports;let Yt;if(typeof queueMicrotask<"u")Yt=queueMicrotask;else{const e=Promise.resolve();Yt=t=>{e.then(t)}}var ge,Ae,pe,Ra,hi;class tc{constructor(t){b(this,Ra);b(this,ge);b(this,Ae);b(this,pe);x(this,ge,new Uint8Array(new ArrayBuffer(t))),x(this,Ae,0),x(this,pe,0)}get length(){return i(this,pe)-i(this,Ae)}data(){return i(this,ge).slice(i(this,Ae),i(this,pe))}push(t){g(this,Ra,hi).call(this,t.byteLength),i(this,ge).set(t,i(this,pe)),x(this,pe,i(this,pe)+t.byteLength)}shift(t){x(this,Ae,i(this,Ae)+t)}}ge=new WeakMap,Ae=new WeakMap,pe=new WeakMap,Ra=new WeakSet,hi=function(t){if(i(this,pe)+t<=i(this,ge).byteLength)return;const s=i(this,pe)-i(this,Ae);if(s+t<=i(this,ge).byteLength&&2*i(this,pe)>=i(this,ge).byteLength)i(this,ge).copyWithin(0,i(this,Ae),i(this,pe));else{let a=i(this,ge).byteLength;do a*=2;while(s+t>a);const n=new Uint8Array(new ArrayBuffer(a));n.set(i(this,ge).slice(i(this,Ae),i(this,pe)),0),x(this,ge,n)}x(this,pe,s),x(this,Ae,0)};function sc(e){const t=Le(e.baton),s=Le(e.base_url),a=_t(e.results,ac);return{baton:t,baseUrl:s,results:a}}function ac(e){const t=Me(e.type);if(t==="ok")return{type:"ok",response:nc(ee(e.response))};if(t==="error")return{type:"error",error:ks(ee(e.error))};throw new R("Unexpected type of StreamResult")}function nc(e){const t=Me(e.type);if(t==="close")return{type:"close"};if(t==="execute")return{type:"execute",result:yn(ee(e.result))};if(t==="batch")return{type:"batch",result:ai(ee(e.result))};if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:li(ee(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Us(e.is_autocommit)};throw new R("Unexpected type of StreamResponse")}function lc(e){const t=Le(e.baton),s=Le(e.base_url);return{baton:t,baseUrl:s}}const ic={default(){return{baton:void 0,baseUrl:void 0,results:[]}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()},3(e,t){t.results.push(e.message(rc))}},rc={default(){return{type:"none"}},1(e){return{type:"ok",response:e.message(oc)}},2(e){return{type:"error",error:e.message(Ue)}}},oc={default(){return{type:"none"}},1(e){return{type:"close"}},2(e){return e.message(cc)},3(e){return e.message(dc)},4(e){return{type:"sequence"}},5(e){return e.message(pc)},6(e){return{type:"store_sql"}},7(e){return{type:"close_sql"}},8(e){return e.message(uc)}},cc={default(){return{type:"execute",result:_s.default()}},1(e,t){t.result=e.message(_s)}},dc={default(){return{type:"batch",result:ya.default()}},1(e,t){t.result=e.message(ya)}},pc={default(){return{type:"describe",result:ka.default()}},1(e,t){t.result=e.message(ka)}},uc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},xc={default(){return{baton:void 0,baseUrl:void 0}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()}};var Hs,Pt,Qe,Ne,Xe,os,it,an,mi,gi;class fc extends Ql{constructor(s,a){super();b(this,it);b(this,Hs);b(this,Pt);b(this,Qe);b(this,Ne);b(this,Xe);b(this,os);x(this,Hs,s),x(this,Pt,a),x(this,Qe,void 0),x(this,Ne,new tc(16*1024)),x(this,Xe,void 0),x(this,os,!1)}async open(s){if(s.body===null)throw new R("No response body for cursor request");x(this,Qe,s.body[Symbol.asyncIterator]());const a=await g(this,it,an).call(this,lc,xc);if(a===void 0)throw new R("Empty response to cursor request");return a}next(){return g(this,it,an).call(this,ni,ci)}close(){this._setClosed(new U("Cursor was manually closed"))}_setClosed(s){i(this,Xe)===void 0&&(x(this,Xe,s),i(this,Hs)._cursorClosed(this),i(this,Qe)!==void 0&&i(this,Qe).return())}get closed(){return i(this,Xe)!==void 0}}Hs=new WeakMap,Pt=new WeakMap,Qe=new WeakMap,Ne=new WeakMap,Xe=new WeakMap,os=new WeakMap,it=new WeakSet,an=async function(s,a){for(;;){if(i(this,os))return;if(i(this,Xe)!==void 0)throw new ke("Cursor is closed",i(this,Xe));if(i(this,Pt)==="json"){const d=g(this,it,mi).call(this);if(d!==void 0){const r=new TextDecoder().decode(d),p=JSON.parse(r);return hn(p,s)}}else if(i(this,Pt)==="protobuf"){const d=g(this,it,gi).call(this);if(d!==void 0)return Ea(d,a)}else throw V(i(this,Pt),"Impossible encoding");if(i(this,Qe)===void 0)throw new kt("Attempted to read from HTTP cursor before it was opened");const{value:n,done:l}=await i(this,Qe).next();if(l&&i(this,Ne).length===0)x(this,os,!0);else{if(l)throw new R("Unexpected end of cursor stream");i(this,Ne).push(n)}}},mi=function(){const s=i(this,Ne).data(),n=s.indexOf(10);if(n<0)return;const l=s.slice(0,n);return i(this,Ne).shift(n+1),l},gi=function(){const s=i(this,Ne).data();let a=0,n=0;for(;;){if(n>=s.byteLength)return;const d=s[n];if(a|=(d&127)<<7*n,n+=1,!(d&128))break}if(s.byteLength<n+a)return;const l=s.slice(n,n+a);return i(this,Ne).shift(n+a),l};function bc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.arrayObjects("requests",t.requests,hc)}function hc(e,t){if(e.stringRaw("type",t.type),t.type!=="close"){if(t.type==="execute")e.object("stmt",t.stmt,gn);else if(t.type==="batch")e.object("batch",t.batch,va);else if(t.type==="sequence")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type!=="get_autocommit")throw V(t,"Impossible type of StreamRequest")}}function mc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.object("batch",t.batch,va)}function gc(e,t){t.baton!==void 0&&e.string(1,t.baton);for(const s of t.requests)e.message(2,s,wc)}function wc(e,t){if(t.type==="close")e.message(1,t,vc);else if(t.type==="execute")e.message(2,t,yc);else if(t.type==="batch")e.message(3,t,kc);else if(t.type==="sequence")e.message(4,t,_c);else if(t.type==="describe")e.message(5,t,Sc);else if(t.type==="store_sql")e.message(6,t,Ic);else if(t.type==="close_sql")e.message(7,t,$c);else if(t.type==="get_autocommit")e.message(8,t,Cc);else throw V(t,"Impossible type of StreamRequest")}function vc(e,t){}function yc(e,t){e.message(1,t.stmt,wn)}function kc(e,t){e.message(1,t.batch,Ta)}function _c(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function Sc(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function Ic(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function $c(e,t){e.int32(1,t.sqlId)}function Cc(e,t){}function Ac(e,t){t.baton!==void 0&&e.string(1,t.baton),e.message(2,t.batch,Ta)}var Ze,ft,cs,Ws,ds,bt,Re,ht,et,tt,mt,Be,ps,T,ot,nn,At,wi,vi,ln,yi,ki,rn;class Rc extends Kl{constructor(s,a,n,l,d){super(s.intMode);b(this,T);b(this,Ze);b(this,ft);b(this,cs);b(this,Ws);b(this,ds);b(this,bt);b(this,Re);b(this,ht);b(this,et);b(this,tt);b(this,mt);b(this,Be);b(this,ps);x(this,Ze,s),x(this,ft,a.toString()),x(this,cs,n),x(this,Ws,l),x(this,ds,d),x(this,bt,void 0),x(this,Re,new wa),x(this,ht,!1),x(this,tt,!1),x(this,mt,!1),x(this,Be,void 0),x(this,ps,new Ms)}client(){return i(this,Ze)}_sqlOwner(){return this}storeSql(s){const a=i(this,ps).alloc();return g(this,T,ot).call(this,{type:"store_sql",sqlId:a,sql:s}).then(()=>{},n=>this._setClosed(n)),new mn(this,a)}_closeSql(s){i(this,Be)===void 0&&g(this,T,ot).call(this,{type:"close_sql",sqlId:s}).then(()=>i(this,ps).free(s),a=>this._setClosed(a))}_execute(s){return g(this,T,ot).call(this,{type:"execute",stmt:s}).then(a=>a.result)}_batch(s){return g(this,T,ot).call(this,{type:"batch",batch:s}).then(a=>a.result)}_describe(s){return g(this,T,ot).call(this,{type:"describe",sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return g(this,T,ot).call(this,{type:"sequence",sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return i(this,Ze)._ensureVersion(3,"getAutocommit()"),g(this,T,ot).call(this,{type:"get_autocommit"}).then(s=>s.isAutocommit)}_openCursor(s){return new Promise((a,n)=>{g(this,T,nn).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_cursorClosed(s){if(s!==i(this,et))throw new kt("Cursor was closed, but it was not associated with the stream");x(this,et,void 0),Yt(()=>g(this,T,At).call(this))}close(){this._setClosed(new U("Stream was manually closed"))}closeGracefully(){x(this,tt,!0),Yt(()=>g(this,T,At).call(this))}get closed(){return i(this,Be)!==void 0||i(this,tt)}_setClosed(s){if(i(this,Be)===void 0){for(x(this,Be,s),i(this,et)!==void 0&&i(this,et)._setClosed(s),i(this,Ze)._streamClosed(this);;){const a=i(this,Re).shift();if(a!==void 0)a.errorCallback(s);else break}(i(this,bt)!==void 0||i(this,ht))&&!i(this,mt)&&(i(this,Re).push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),x(this,mt,!0),Yt(()=>g(this,T,At).call(this)))}}}Ze=new WeakMap,ft=new WeakMap,cs=new WeakMap,Ws=new WeakMap,ds=new WeakMap,bt=new WeakMap,Re=new WeakMap,ht=new WeakMap,et=new WeakMap,tt=new WeakMap,mt=new WeakMap,Be=new WeakMap,ps=new WeakMap,T=new WeakSet,ot=function(s){return new Promise((a,n)=>{g(this,T,nn).call(this,{type:"pipeline",request:s,responseCallback:a,errorCallback:n})})},nn=function(s){if(i(this,Be)!==void 0)throw new ke("Stream is closed",i(this,Be));if(i(this,tt))throw new ke("Stream is closing",void 0);i(this,Re).push(s),Yt(()=>g(this,T,At).call(this))},At=function(){if(i(this,ht)||i(this,et)!==void 0)return;if(i(this,tt)&&i(this,Re).length===0){this._setClosed(new U("Stream was gracefully closed"));return}const s=i(this,Ze)._endpoint;if(s===void 0){i(this,Ze)._endpointPromise.then(()=>g(this,T,At).call(this),n=>this._setClosed(n));return}const a=i(this,Re).shift();if(a!==void 0)if(a.type==="pipeline"){const n=[a];for(;;){const l=i(this,Re).first();if(l!==void 0&&l.type==="pipeline")n.push(l),i(this,Re).shift();else if(l===void 0&&i(this,tt)&&!i(this,mt)){n.push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),x(this,mt,!0);break}else break}g(this,T,wi).call(this,s,n)}else if(a.type==="cursor")g(this,T,vi).call(this,s,a);else throw V(a,"Impossible type of QueueEntry")},wi=function(s,a){g(this,T,ln).call(this,()=>g(this,T,yi).call(this,a,s),n=>Tc(n,s.encoding),n=>n.baton,n=>n.baseUrl,n=>Ec(a,n),n=>a.forEach(l=>l.errorCallback(n)))},vi=function(s,a){const n=new fc(this,s.encoding);x(this,et,n),g(this,T,ln).call(this,()=>g(this,T,ki).call(this,a,s),l=>n.open(l),l=>l.baton,l=>l.baseUrl,l=>a.cursorCallback(n),l=>a.errorCallback(l))},ln=function(s,a,n,l,d,r){let p;try{const o=s();p=i(this,Ws)(o)}catch(o){p=Promise.reject(o)}x(this,ht,!0),p.then(o=>o.ok?a(o):Mc(o).then(u=>{throw u})).then(o=>{x(this,bt,n(o)),x(this,ft,l(o)??i(this,ft)),d(o)}).catch(o=>{this._setClosed(o),r(o)}).finally(()=>{x(this,ht,!1),g(this,T,At).call(this)})},yi=function(s,a){return g(this,T,rn).call(this,new URL(a.pipelinePath,i(this,ft)),{baton:i(this,bt),requests:s.map(n=>n.request)},a.encoding,bc,gc)},ki=function(s,a){if(a.cursorPath===void 0)throw new vs(`Cursors are supported only on protocol version 3 and higher, but the HTTP server only supports version ${a.version}.`);return g(this,T,rn).call(this,new URL(a.cursorPath,i(this,ft)),{baton:i(this,bt),batch:s.batch},a.encoding,mc,Ac)},rn=function(s,a,n,l,d){let r,p;if(n==="json")r=Bl(a,l),p="application/json";else if(n==="protobuf")r=Ul(a,d),p="application/x-protobuf";else throw V(n,"Impossible encoding");const o=new _a.Headers;return o.set("content-type",p),i(this,cs)!==void 0&&o.set("authorization",`Bearer ${i(this,cs)}`),i(this,ds)!==void 0&&o.set("x-turso-encryption-key",i(this,ds)),new _a.Request(s.toString(),{method:"POST",headers:o,body:r})};function Ec(e,t){if(t.results.length!==e.length)throw new R("Server returned unexpected number of pipeline results");for(let s=0;s<e.length;++s){const a=t.results[s],n=e[s];if(a.type==="ok"){if(a.response.type!==n.request.type)throw new R("Received unexpected type of response");n.responseCallback(a.response)}else if(a.type==="error")n.errorCallback(ys(a.error));else throw a.type==="none"?new R("Received unrecognized type of StreamResult"):V(a,"Received impossible type of StreamResult")}}async function Tc(e,t){var s;if(t==="json"){const a=await e.json();return hn(a,sc)}if(t==="protobuf"){const a=await e.arrayBuffer();return Ea(new Uint8Array(a),ic)}throw await((s=e.body)==null?void 0:s.cancel()),V(t,"Impossible encoding")}async function Mc(e){var a;const t=e.headers.get("content-type")??"text/plain";let s=`Server returned HTTP status ${e.status}`;if(t==="application/json"){const n=await e.json();return"message"in n?ys(n):new ua(s,e.status)}if(t==="text/plain"){const n=(await e.text()).trim();return n!==""&&(s+=`: ${n}`),new ua(s,e.status)}return await((a=e.body)==null?void 0:a.cancel()),new ua(s,e.status)}const Dc=[{versionPath:"v3-protobuf",pipelinePath:"v3-protobuf/pipeline",cursorPath:"v3-protobuf/cursor",version:3,encoding:"protobuf"}],on={versionPath:"v2",pipelinePath:"v2/pipeline",cursorPath:void 0,version:2,encoding:"json"};var us,zs,xs,Js,st,Nt,fs,ha,ml;let Lc=(ml=class extends Ol{constructor(s,a,n,l,d=2){super();b(this,fs);b(this,us);b(this,zs);b(this,xs);b(this,Js);b(this,st);b(this,Nt);D(this,"_endpointPromise");D(this,"_endpoint");x(this,us,s),x(this,zs,a),x(this,xs,n??_a.fetch),x(this,Js,l),x(this,st,void 0),x(this,Nt,new Set),d==3?(this._endpointPromise=jc(i(this,xs),i(this,us)),this._endpointPromise.then(r=>this._endpoint=r,r=>g(this,fs,ha).call(this,r))):(this._endpointPromise=Promise.resolve(on),this._endpointPromise.then(r=>this._endpoint=r,r=>g(this,fs,ha).call(this,r)))}async getVersion(){return this._endpoint!==void 0?this._endpoint.version:(await this._endpointPromise).version}_ensureVersion(s,a){if(!(s<=on.version)){if(this._endpoint===void 0)throw new vs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the HTTP server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(this._endpoint.version<s)throw new vs(`${a} is supported only on protocol version ${s} and higher, but the HTTP server only supports version ${this._endpoint.version}.`)}}openStream(){if(i(this,st)!==void 0)throw new ke("Client is closed",i(this,st));const s=new Rc(this,i(this,us),i(this,zs),i(this,xs),i(this,Js));return i(this,Nt).add(s),s}_streamClosed(s){i(this,Nt).delete(s)}close(){g(this,fs,ha).call(this,new U("Client was manually closed"))}get closed(){return i(this,st)!==void 0}},us=new WeakMap,zs=new WeakMap,xs=new WeakMap,Js=new WeakMap,st=new WeakMap,Nt=new WeakMap,fs=new WeakSet,ha=function(s){if(i(this,st)===void 0){x(this,st,s);for(const a of Array.from(i(this,Nt)))a._setClosed(new ke("Client was closed",s))}},ml);async function jc(e,t){const s=e;for(const a of Dc){const n=new URL(a.versionPath,t),l=new _a.Request(n.toString(),{method:"GET"}),d=await s(l);if(await d.arrayBuffer(),d.ok)return a}return on}function _i(e,t,s=2){if(typeof Jt>"u")throw new Nl("WebSockets are not supported in this environment");var a=void 0;s==3?a=Array.from(di.keys()):a=Array.from(Xo.keys());const n=new Jt(e,a);return new Zo(n,t)}function Xn(e,t,s,a,n=2){return new Lc(e instanceof URL?e:new URL(e),t,s,a,n)}var bs,at,ne;class Si{constructor(t,s){b(this,bs);b(this,at);b(this,ne);x(this,bs,t),x(this,at,s),x(this,ne,void 0)}execute(t){return this.batch([t]).then(s=>s[0])}async batch(t){const s=this._getStream();if(s.closed)throw new j("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{const a=t.map(Vt);let n;if(i(this,ne)===void 0){this._getSqlCache().apply(a);const d=s.batch(i(this,at)>=3),r=d.step(),p=r.run(Ha(i(this,bs)));let o=r;n=a.map(u=>{const h=d.step().condition(ue.ok(o));i(this,at)>=3&&h.condition(ue.not(ue.isAutocommit(d)));const w=h.query(u);return w.catch(()=>{}),o=h,w}),x(this,ne,d.execute().then(()=>p).then(()=>{}));try{await i(this,ne)}catch(u){throw this.close(),u}}else{i(this,at)<3&&await i(this,ne),this._getSqlCache().apply(a);const d=s.batch(i(this,at)>=3);let r;n=a.map(p=>{const o=d.step();r!==void 0&&o.condition(ue.ok(r)),i(this,at)>=3&&o.condition(ue.not(ue.isAutocommit(d)));const u=o.query(p);return u.catch(()=>{}),r=o,u}),await d.execute()}const l=[];for(let d=0;d<n.length;d++)try{const r=await n[d];if(r===void 0)throw new Kt("Statement in a transaction was not executed, probably because the transaction has been rolled back",d,"TRANSACTION_CLOSED");l.push(Ma(r))}catch(r){if(r instanceof Kt)throw r;const p=F(r);throw p instanceof j?new Kt(p.message,d,p.code,p.extendedCode,p.rawCode,p.cause instanceof Error?p.cause:void 0):p}return l}catch(a){throw F(a)}}async executeMultiple(t){const s=this._getStream();if(s.closed)throw new j("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{if(i(this,ne)===void 0){x(this,ne,s.run(Ha(i(this,bs))).then(()=>{}));try{await i(this,ne)}catch(a){throw this.close(),a}}else await i(this,ne);await s.sequence(t)}catch(a){throw F(a)}}async rollback(){try{const t=this._getStream();if(t.closed||i(this,ne)===void 0)return;const s=t.run("ROLLBACK").catch(a=>{throw F(a)});t.closeGracefully(),await s}catch(t){throw F(t)}finally{this.close()}}async commit(){try{const t=this._getStream();if(t.closed)throw new j("Cannot commit the transaction because it is already closed","TRANSACTION_CLOSED");if(i(this,ne)!==void 0)await i(this,ne);else return;const s=t.run("COMMIT").catch(a=>{throw F(a)});t.closeGracefully(),await s}catch(t){throw F(t)}finally{this.close()}}}bs=new WeakMap,at=new WeakMap,ne=new WeakMap;async function Sa(e,t,s,a,n=!1){n&&s.step().run("PRAGMA foreign_keys=off");const l=s.step(),d=l.run(Ha(e));let r=l;const p=a.map(v=>{const m=s.step().condition(ue.ok(r));t>=3&&m.condition(ue.not(ue.isAutocommit(s)));const S=m.query(v);return r=m,S}),o=s.step().condition(ue.ok(r));t>=3&&o.condition(ue.not(ue.isAutocommit(s)));const u=o.run("COMMIT");s.step().condition(ue.not(ue.ok(o))).run("ROLLBACK").catch(v=>{}),n&&s.step().run("PRAGMA foreign_keys=on"),await s.execute();const w=[];await d;for(let v=0;v<p.length;v++)try{const m=await p[v];if(m===void 0)throw new Kt("Statement in a batch was not executed, probably because the transaction has been rolled back",v,"TRANSACTION_CLOSED");w.push(Ma(m))}catch(m){if(m instanceof Kt)throw m;const S=F(m);throw S instanceof j?new Kt(S.message,v,S.code,S.extendedCode,S.rawCode,S.cause instanceof Error?S.cause:void 0):S}return await u,w}function Vt(e){let t,s;Array.isArray(e)?[t,s]=e:typeof e=="string"?t=e:(t=e.sql,s=e.args);const a=new Jl(t);if(s)if(Array.isArray(s))a.bindIndexes(s);else for(const[n,l]of Object.entries(s))a.bindName(n,l);return a}function Ma(e){const t=e.columnNames.map(d=>d??""),s=e.columnDecltypes.map(d=>d??""),a=e.rows,n=e.affectedRowCount,l=e.lastInsertRowid!==void 0?e.lastInsertRowid:void 0;return new Hr(t,s,a,n,l)}function F(e){if(e instanceof U){const t=Ii(e);return new j(e.message,t,void 0,void 0,e)}return e}function Ii(e){return e instanceof Pl&&e.code!==void 0?e.code:e instanceof R?"HRANA_PROTO_ERROR":e instanceof ke?e.cause instanceof U?Ii(e.cause):"HRANA_CLOSED_ERROR":e instanceof Wa?"HRANA_WEBSOCKET_ERROR":e instanceof ua?"SERVER_ERROR":e instanceof vs?"PROTOCOL_VERSION_ERROR":e instanceof kt?"INTERNAL_ERROR":"UNKNOWN"}var Ys,Fe;class kn{constructor(t,s){b(this,Ys);b(this,Fe);D(this,"capacity");x(this,Ys,t),x(this,Fe,new qc),this.capacity=s}apply(t){if(this.capacity<=0)return;const s=new Set;for(const a of t){if(typeof a.sql!="string")continue;const n=a.sql;if(n.length>=5e3)continue;let l=i(this,Fe).get(n);if(l===void 0){for(;i(this,Fe).size+1>this.capacity;){const[d,r]=i(this,Fe).peekLru();if(s.has(r))break;r.close(),i(this,Fe).delete(d)}i(this,Fe).size+1<=this.capacity&&(l=i(this,Ys).storeSql(n),i(this,Fe).set(n,l))}l!==void 0&&(a.sql=l,s.add(l))}}}Ys=new WeakMap,Fe=new WeakMap;var Ee;class qc{constructor(){b(this,Ee);x(this,Ee,new Map)}get(t){const s=i(this,Ee).get(t);return s!==void 0&&(i(this,Ee).delete(t),i(this,Ee).set(t,s)),s}set(t,s){i(this,Ee).set(t,s)}peekLru(){for(const t of i(this,Ee).entries())return t}delete(t){i(this,Ee).delete(t)}get size(){return i(this,Ee).size}}Ee=new WeakMap;function Oc(e){var t=0,s=[];function a(){t--,t<e&&n()}function n(){var p=s.shift();r.queue=s.length,p&&d(p.fn).then(p.resolve).catch(p.reject)}function l(p){return new Promise(function(o,u){s.push({fn:p,resolve:o,reject:u}),r.queue=s.length})}function d(p){t++;try{return Promise.resolve(p()).then(function(o){return a(),o},function(o){throw a(),o})}catch(o){return a(),Promise.reject(o)}}var r=function(p){return t>=e?l(p):d(p)};return r}function Pc(e,t){var s=!1,a=this;return Promise.all(e.map(function(){var n=arguments;return a(function(){if(!s)return t.apply(void 0,n).catch(function(l){throw s=!0,l})})}))}function Zn(e){return e.queue=0,e.map=Pc,e}var Nc=function(e){return Zn(e?Oc(e):function(t){return t()})};const $i=ec(Nc);function Bc(e){if(e.scheme!=="wss"&&e.scheme!=="ws")throw new j(`The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Fs}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new j("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="ws"&&e.tls)throw new j('A "ws:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="wss"&&!e.tls)throw new j('A "wss:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Ua(e.scheme,e.authority,e.path);let s;try{s=_i(t,e.authToken)}catch(a){if(a instanceof Nl){const n=e.scheme==="wss"?"https":"http",l=Ua(n,e.authority,e.path);throw new j(`This environment does not support WebSockets, please switch to the HTTP client by using a "${n}:" URL (${JSON.stringify(l)}). For more information, please read ${Fs}`,"WEBSOCKETS_NOT_SUPPORTED")}throw F(a)}return new Uc(s,t,e.authToken,e.intMode,e.concurrency)}const Fc=60*1e3,el=100;var Ks,Qs,Xs,z,se,pn,Zs,we,zt,js;class Uc{constructor(t,s,a,n,l){b(this,we);b(this,Ks);b(this,Qs);b(this,Xs);b(this,z);b(this,se);D(this,"closed");D(this,"protocol");b(this,pn);b(this,Zs);x(this,Ks,s),x(this,Qs,a),x(this,Xs,n),x(this,z,g(this,we,js).call(this,t)),x(this,se,void 0),this.closed=!1,this.protocol="ws",x(this,Zs,$i(l))}async limit(t){return i(this,Zs).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{const n=await g(this,we,zt).call(this);try{const l=Vt(a);n.conn.sqlCache.apply([l]);const d=n.stream.query(l);n.stream.closeGracefully();const r=await d;return Ma(r)}catch(l){throw F(l)}finally{this._closeStream(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{const a=await g(this,we,zt).call(this);try{const l=t.map(u=>Array.isArray(u)?{sql:u[0],args:u[1]||[]}:u).map(Vt),d=await a.conn.client.getVersion();a.conn.sqlCache.apply(l);const r=a.stream.batch(d>=3);return await Sa(s,d,r,l)}catch(n){throw F(n)}finally{this._closeStream(a)}})}async migrate(t){return this.limit(async()=>{const s=await g(this,we,zt).call(this);try{const a=t.map(Vt),n=await s.conn.client.getVersion(),l=s.stream.batch(n>=3);return await Sa("deferred",n,l,a,!0)}catch(a){throw F(a)}finally{this._closeStream(s)}})}async transaction(t="write"){return this.limit(async()=>{const s=await g(this,we,zt).call(this);try{const a=await s.conn.client.getVersion();return new Vc(this,s,t,a)}catch(a){throw this._closeStream(s),F(a)}})}async executeMultiple(t){return this.limit(async()=>{const s=await g(this,we,zt).call(this);try{const a=s.stream.sequence(t);s.stream.closeGracefully(),await a}catch(a){throw F(a)}finally{this._closeStream(s)}})}sync(){throw new j("sync not supported in ws mode","SYNC_NOT_SUPPORTED")}async reconnect(){try{for(const a of Array.from(i(this,z).streamStates))try{a.stream.close()}catch{}i(this,z).client.close()}catch{}if(i(this,se)){try{i(this,se).client.close()}catch{}x(this,se,void 0)}const t=g(this,we,js).call(this),s=await t.client.getVersion();t.useSqlCache=s>=2,t.useSqlCache&&(t.sqlCache.capacity=el),x(this,z,t),this.closed=!1}_closeStream(t){t.stream.close();const s=t.conn;s.streamStates.delete(t),s.streamStates.size===0&&s!==i(this,z)&&s.client.close()}close(){if(i(this,z).client.close(),this.closed=!0,i(this,se)){try{i(this,se).client.close()}catch{}x(this,se,void 0)}this.closed=!0}}Ks=new WeakMap,Qs=new WeakMap,Xs=new WeakMap,z=new WeakMap,se=new WeakMap,pn=new WeakMap,Zs=new WeakMap,we=new WeakSet,zt=async function(){if(this.closed)throw new j("The client is closed","CLIENT_CLOSED");if(new Date().valueOf()-i(this,z).openTime.valueOf()>Fc&&i(this,se)===void 0){const n=g(this,we,js).call(this);x(this,se,n),n.client.getVersion().then(l=>{i(this,z)!==n&&i(this,z).streamStates.size===0&&i(this,z).client.close(),x(this,z,n),x(this,se,void 0)},l=>{x(this,se,void 0)})}if(i(this,z).client.closed)try{i(this,se)!==void 0?x(this,z,i(this,se)):x(this,z,g(this,we,js).call(this))}catch(n){throw F(n)}const a=i(this,z);try{a.useSqlCache===void 0&&(a.useSqlCache=await a.client.getVersion()>=2,a.useSqlCache&&(a.sqlCache.capacity=el));const n=a.client.openStream();n.intMode=i(this,Xs);const l={conn:a,stream:n};return a.streamStates.add(l),l}catch(n){throw F(n)}},js=function(t){try{return t??(t=_i(i(this,Ks),i(this,Qs))),{client:t,useSqlCache:void 0,sqlCache:new kn(t,0),openTime:new Date,streamStates:new Set}}catch(s){throw F(s)}};var ea,gt;class Vc extends Si{constructor(s,a,n,l){super(n,l);b(this,ea);b(this,gt);x(this,ea,s),x(this,gt,a)}_getStream(){return i(this,gt).stream}_getSqlCache(){return i(this,gt).conn.sqlCache}close(){i(this,ea)._closeStream(i(this,gt))}get closed(){return i(this,gt).stream.closed}}ea=new WeakMap,gt=new WeakMap;function Gc(e){if(e.scheme!=="https"&&e.scheme!=="http")throw new j(`The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Fs}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new j("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="http"&&e.tls)throw new j('A "http:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="https"&&!e.tls)throw new j('A "https:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Ua(e.scheme,e.authority,e.path);return new Hc(t,e.authToken,e.intMode,e.fetch,e.concurrency,e.remoteEncryptionKey)}const Ci=30;var J,hs,ms,gs,ta,ws,sa,aa;class Hc{constructor(t,s,a,n,l,d){b(this,J);D(this,"protocol");b(this,hs);b(this,ms);b(this,gs);b(this,ta);b(this,ws);b(this,sa);b(this,aa);x(this,hs,t),x(this,ws,s),x(this,ms,a),x(this,gs,n),x(this,ta,l),x(this,sa,d),x(this,J,Xn(i(this,hs),i(this,ws),i(this,gs),d)),i(this,J).intMode=i(this,ms),this.protocol="http",x(this,aa,$i(i(this,ta)))}async limit(t){return i(this,aa).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{try{const n=Vt(a);let l;const d=i(this,J).openStream();try{l=d.query(n)}finally{d.closeGracefully()}const r=await l;return Ma(r)}catch(n){throw F(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{try{const n=t.map(o=>Array.isArray(o)?{sql:o[0],args:o[1]||[]}:o).map(Vt),l=await i(this,J).getVersion();let d;const r=i(this,J).openStream();try{new kn(r,Ci).apply(n);const u=r.batch(!1);d=Sa(s,l,u,n)}finally{r.closeGracefully()}return await d}catch(a){throw F(a)}})}async migrate(t){return this.limit(async()=>{try{const s=t.map(Vt),a=await i(this,J).getVersion();let n;const l=i(this,J).openStream();try{const r=l.batch(!1);n=Sa("deferred",a,r,s,!0)}finally{l.closeGracefully()}return await n}catch(s){throw F(s)}})}async transaction(t="write"){return this.limit(async()=>{try{const s=await i(this,J).getVersion();return new Wc(i(this,J).openStream(),t,s)}catch(s){throw F(s)}})}async executeMultiple(t){return this.limit(async()=>{try{let s;const a=i(this,J).openStream();try{s=a.sequence(t)}finally{a.closeGracefully()}await s}catch(s){throw F(s)}})}sync(){throw new j("sync not supported in http mode","SYNC_NOT_SUPPORTED")}close(){i(this,J).close()}async reconnect(){try{this.closed||i(this,J).close()}finally{x(this,J,Xn(i(this,hs),i(this,ws),i(this,gs),i(this,sa))),i(this,J).intMode=i(this,ms)}}get closed(){return i(this,J).closed}}J=new WeakMap,hs=new WeakMap,ms=new WeakMap,gs=new WeakMap,ta=new WeakMap,ws=new WeakMap,sa=new WeakMap,aa=new WeakMap;var Bt,na;class Wc extends Si{constructor(s,a,n){super(a,n);b(this,Bt);b(this,na);x(this,Bt,s),x(this,na,new kn(s,Ci))}_getStream(){return i(this,Bt)}_getSqlCache(){return i(this,na)}close(){i(this,Bt).close()}get closed(){return i(this,Bt).closed}}Bt=new WeakMap,na=new WeakMap;function zc(e){return Jc(Jr(e))}function Jc(e){if(e.scheme==="ws"||e.scheme==="wss")return Bc(e);if(e.scheme==="http"||e.scheme==="https")return Gc(e);throw new j(`The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Fs}`,"URL_SCHEME_NOT_SUPPORTED")}const Yc={url:"libsql://retailer-os-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAxODY2NzMsImlkIjoiNDcwMDliODAtYmJlYS00YzQ3LTk1MzQtY2NlYjg4OWUzYjFjIiwicmlkIjoiNTk1ODMwNWEtMjlkNy00OGU5LWJkNTctN2FiZWVjNzVjMWYwIn0.381aJkYkBtcCsSDyQkFNLZud9lOPi9TuT3uRZgLYS9BqrjLFb0Zc7P1qRWN0k16XkHQ7raDwhCUE9H1G8Q80BA"},Kc=zc(Yc);async function $(e,t=[]){try{return(await Kc.execute({sql:e,args:t})).rows}catch(s){throw console.error("DB Query Error:",s.message,"SQL:",e,"Params:",t),s}}const M={clients:{getAll:()=>$("SELECT * FROM customers"),add:e=>$("INSERT INTO customers (id, name, phone, email, joined_at, dob, location) VALUES (?, ?, ?, ?, ?, ?, ?)",[e.id,e.name,e.phone||"",e.email||"",new Date().toISOString(),e.dob||null,e.location||""]),getById:e=>$("SELECT * FROM customers WHERE id = ?",[e])},companies:{getAll:()=>$("SELECT * FROM companies"),add:e=>$("INSERT INTO companies (id, name, gst_number, customer_id, created_at) VALUES (?, ?, ?, ?, ?)",[e.id,e.name,e.gst_number,e.customer_id,new Date().toISOString()]),getByCustomerId:e=>$("SELECT * FROM companies WHERE customer_id = ?",[e]),getById:e=>$("SELECT * FROM companies WHERE id = ?",[e])},sales:{getAll:()=>$("SELECT * FROM sales ORDER BY date DESC"),getById:e=>$("SELECT * FROM sales WHERE id = ?",[e]),getDrafts:()=>$("SELECT * FROM sales WHERE status = 'draft' ORDER BY date DESC"),add:e=>$(`INSERT INTO sales (id, customer_id, customer_name, date, total_amount, status, payment_mode, payment_reference, gst_required, company_id, installation_required, installation_date) 
    ...
    `}let Xt=!1,ma="",I=[],De=null,nt="Select Customer",ie=!1,Ve="",Ge="",ia=!1,B="",lt="",vt=null;const Zt=e=>`${e}-${Math.random().toString(36).substr(2,8).toUpperCase()}`,Qc=["appliances","air conditioners","ac","washing machines","refrigerators","tvs","television","home theater","dishwasher","microwave","geyser","water heater"];function _n(e){if(e.installation_required===1)return!0;const t=(e.category||"").toLowerCase();return Qc.some(s=>t.includes(s))}async function Xc(e){const t=window.getCache().products,s=window.getCache().schemes||[],a=t.find(n=>n.id===e);if(a){const n=_n(a),l=s.filter(r=>{const p=!r.brand||r.brand===a.brand,o=!r.category||r.category===a.category,u=(!r.min_price||a.mop>=r.min_price)&&(!r.max_price||a.mop<=r.max_price),h=new Date(r.start_date)<=new Date&&new Date(r.end_date)>=new Date;return p&&o&&u&&h&&r.status==="active"});I.push({...a,qty:1,imei:"",serial_number:"",mac_id:"",manufacturing_date:"",showDetails:!1,installation_required:n,installation_date:"",discount_type:null,discount_value:0,discount_amount:0,scheme_id:null,scheme_name:null,final_price:a.mop,applicableSchemes:l,showDiscount:!1,extraFields:[]});const d=document.getElementById("sales-item-search");d&&(d.value=""),window.triggerRender()}}window.toggleCartItemDiscount=e=>{I[e]&&(I[e].showDiscount=!I[e].showDiscount,window.triggerRender())};window.applyStoreDiscount=(e,t)=>{if(I[e]){const s=I[e],a=parseFloat(t)||0;a>0&&a<=100?(s.discount_type="store",s.discount_value=a,s.discount_amount=Math.round(s.mop*a/100),s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop-s.discount_amount):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.applySchemeDiscount=(e,t)=>{if(I[e]){const s=I[e],n=(window.getCache().schemes||[]).find(l=>l.id===t);n?(s.discount_type="scheme",s.scheme_id=n.id,s.scheme_name=n.name,n.discount_type==="percentage"?(s.discount_value=n.discount_value,s.discount_amount=Math.round(s.mop*n.discount_value/100)):(s.discount_value=n.discount_value,s.discount_amount=n.discount_value),s.final_price=s.mop-s.discount_amount):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.clearItemDiscount=e=>{if(I[e]){const t=I[e];t.discount_type=null,t.discount_value=0,t.discount_amount=0,t.scheme_id=null,t.scheme_name=null,t.final_price=t.mop,window.triggerRender()}};function Ri(e,t){De=e,nt=t;const s=document.getElementById("customer-dropdown-menu");s&&s.classList.add("hidden");const n=(window.getCache().companies||[]).find(l=>l.customer_id===e);n&&(Ve=n.name,Ge=n.gst_number),window.triggerRender()}window.updateCartItemDetail=(e,t,s)=>{I[e]&&(I[e][t]=s)};window.toggleCartItemDetails=e=>{I[e]&&(I[e].showDetails=!I[e].showDetails,window.triggerRender())};window.toggleItemInstallation=e=>{I[e]&&(I[e].installation_required=!I[e].installation_required,I[e].installation_required||(I[e].installation_date=""),window.triggerRender())};window.updateItemInstallationDate=(e,t)=>{I[e]&&(I[e].installation_date=t)};const Zc="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";function ed(){return localStorage.getItem("openai_api_key")||Zc}window.captureDeviceImage=async e=>{const t=ed(),s=document.createElement("input");s.type="file",s.accept="image/*",s.capture="environment",s.onchange=async a=>{const n=a.target.files[0];if(n){Xt=!0,ma="Reading image...",window.triggerRender(!1);try{const l=await td(n);ma="AI analyzing...",sd(e,ma);const d=I[e],r={name:d.name,brand:d.brand,category:d.category},p=await ad(l,r,t);I[e]&&p&&(p.imei&&(I[e].imei=p.imei),p.serial_number&&(I[e].serial_number=p.serial_number),p.mac_id&&(I[e].mac_id=p.mac_id),p.manufacturing_date&&(I[e].manufacturing_date=p.manufacturing_date),p.extraFields&&p.extraFields.length>0&&(I[e].extraFields=[...I[e].extraFields||[],...p.extraFields])),Xt=!1,window.triggerRender(!1);const o=[];p.imei&&o.push("IMEI"),p.serial_number&&o.push("Serial"),p.mac_id&&o.push("MAC ID"),p.manufacturing_date&&o.push("Mfg Date"),p.extraFields&&p.extraFields.forEach(u=>o.push(u.label)),o.length>0?window.toast.success(`Found: ${o.join(", ")}`):window.toast.warning("No device details found. Try a clearer image.")}catch(l){console.error("AI Vision Error:",l),Xt=!1,window.triggerRender(!1),window.toast.error(l.message||"Error analyzing image")}}},s.click()};function td(e){return new Promise((t,s)=>{const a=new FileReader;a.onload=()=>{const n=a.result.split(",")[1];t(n)},a.onerror=s,a.readAsDataURL(e)})}function sd(e,t){const s=document.getElementById(`ocr-progress-${e}`);s&&(s.textContent=t)}async function ad(e,t,s){var p,o,u,h;const a=`You are analyzing a product label/box image to extract device information.
...
Example response:
{
  ...
  "extraFields": [{"key": "model", "label": "Model", "value": "SM-A546E"}]
                                ...
                                <div class="p-4 bg-slate-50 border-t border-slate-100 space-y-3">
                                    ...
                                    <button type="button" onclick="window.captureDeviceImage(${u})" class="w-full py-3 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase flex items-center justify-center gap-2 hover:bg-slate-800 transition-all sm:hidden ${Xt?"opacity-50 cursor-not-allowed":""}" ${Xt?"disabled":""}>
                                        ${Xt?`
                                            ...
                                            <span id="ocr-progress-${u}">${ma||"Analyzing..."}</span>
                                        `:`
        ...
        `:""}
    `}function sl(e){const t=new Date(e);return t.setHours(0,0,0,0),t}function da(e){const t=new Date(e);return t.setHours(23,59,59,999),t}function al(e,t,s,a){if(t==="all")return e;const n=new Date,l=sl(n);return e.filter(d=>{const r=new Date(d.date);switch(t){case"today":return r>=l&&r<=da(n);case"week":{const p=new Date(l);return p.setDate(p.getDate()-p.getDay()),r>=p&&r<=da(n)}case"month":{const p=new Date(l.getFullYear(),l.getMonth(),1);return r>=p&&r<=da(n)}case"custom":{if(!s&&!a)return!0;const p=s?sl(new Date(s)):new Date(0),o=a?da(new Date(a)):new Date;return r>=p&&r<=o}default:return!0}})}window.toggleDateFilterDropdown=e=>{e&&e.stopPropagation();const t=document.getElementById("date-filter-dropdown");t&&t.classList.toggle("hidden")};window.updateHistoryFromDate=e=>{c.historyFromDate=e,c.historyToDate&&(c.historyDateFilter="custom",window.triggerRender())};window.updateHistoryToDate=e=>{c.historyToDate=e,c.historyFromDate&&(c.historyDateFilter="custom",window.triggerRender())};function Mi(){const e=window.getCache(),t=e.sales||[],s=e.saleItems||[],a=t.filter(v=>v.status==="draft"),n=t.filter(v=>v.status!=="draft"),l=c.historyViewMode||"completed",d=c.historyDateFilter||"all",r=al(a,d,c.historyFromDate,c.historyToDate),p=al(n,d,c.historyFromDate,c.historyToDate),o=l==="drafts"?r:p,u=()=>{switch(d){case"today":return"Today";case"week":return"This Week";case"month":return"This Month";case"custom":return c.historyFromDate||c.historyToDate?"Custom Range":"All Time";default:return"All Time"}},h=v=>{switch(v){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}},w=v=>{switch(v){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Paid"}};return`
        ${Ai("history")}
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left">
...
`,t+="Powered by RetailerOS",t}function rd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function od(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function In(){const e=c.currentTab==="history",t=Da();if(!t)return`<div class="p-10 text-center opacity-40 flex flex-col items-center justify-center h-full">
                ...
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <span class="material-icons-outlined text-sm">${rd(t.paymentMode)}</span>
                        </div>
                        <div class="text-left">
    ...
    `}function xd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=e.sales||[],l=t.find(u=>u.id===c.selectedGroupId);if(!l)return`
    ...
    `}function fd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=t.find(r=>r.id===c.selectedGroupId);if(!n)return c.groupViewMode="list","";const l=s.filter(r=>r.group_id===n.id).map(r=>r.customer_id),d=a.filter(r=>!l.includes(r.id));return`
        <div class="h-full flex flex-col overflow-hidden">
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0">
                <div class="flex items-center gap-4">
    ...
    `}function il(){return pd()}function rl(){switch(c.groupViewMode){case"create":return ud();case"detail":return xd();case"add-members":return fd();default:return`
                <div class="h-full flex items-center justify-center text-slate-300 text-center p-8">
                    <div class="text-center">
            ...
            `}}function bd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function hd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function ol(e="desktop"){var u,h;const t=window.getCache(),s=c.clientInvoiceId,a=(t.sales||[]).find(w=>w.id===s);if(!a)return`
                ...
                <div class="card p-6 sm:p-8 bg-white text-slate-900 leading-relaxed shadow-sm border border-slate-100">
                    ...
                    ${o.paymentMode?`
                        <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <span class="material-icons-outlined text-sm">${bd(o.paymentMode)}</span>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest">Paid via ${hd(o.paymentMode)}</p>
...
`,l+="Powered by RetailerOS";const d=`https://wa.me/${((p=a==null?void 0:a.phone)==null?void 0:p.replace(/\D/g,""))||""}?text=${encodeURIComponent(l)}`;window.open(d,"_blank")};function $n(e){const t=e==="desktop-secondary",s=e==="desktop-primary";return t?c.clientViewMode==="add"?cn("desktop"):c.clientViewMode==="invoice"?ol("desktop"):c.clientViewMode==="profile"?ll("desktop"):c.clientViewMode==="groups"?rl():`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:s?c.clientViewMode==="groups"?il():nl():c.clientViewMode==="add"?cn("mobile"):c.clientViewMode==="invoice"?ol("mobile"):c.clientViewMode==="profile"?ll("mobile"):c.clientViewMode==="groups"?c.groupViewMode==="detail"||c.groupViewMode==="create"||c.groupViewMode==="add-members"?rl():il():nl()}const Pa=(e,t,s=[])=>`
...
`;window.setRepairCustomer=(e,t)=>{c.repairContext={customer_name:e,customer_phone:t},C()};function yd(){const e=document.getElementById("repair-search-input"),t=e?e.value.trim():"",s=window.getCache?window.getCache():{customers:[]},a=t?s.customers.filter(n=>n.name.toLowerCase().includes(t.toLowerCase())||n.phone.includes(t)):[];return`
    ...
    `}async function Sd(e){if(c.activeRepairId)try{await M.query("UPDATE repairs SET status = ? WHERE id = ?",[e,c.activeRepairId]),await K()}catch(t){alert("Update failed: "+t.message)}}window.updateRepairStatus=Sd;function Id(){const e=window.getCache(),t=e.repairs.find(n=>n.id===c.activeRepairId)||e.repairs[0];if(!t)return'<div class="p-20 text-center opacity-30 text-[10px] font-black uppercase">No active job selected</div>';const s=[{l:"Collected",s:"COLLECTED",i:"done"},{l:"Sent to Brand",s:"SENT_TO_BRAND",i:"shipping"},{l:"At Service Center",s:"IN_REPAIR",i:"build"},{l:"Ready for Pickup",s:"READY",i:"check_circle"},{l:"Handed Over",s:"COMPLETED",i:"person"}],a=s.findIndex(n=>n.s===t.status);return`
    ...
    `}function An(e){const t={search:{t:"RetailerOS",s:"Repairs Management",txn:null},intake:{t:"Device Intake",s:"Repair Management",txn:"TXN-4920"},status:{t:"Job ID: #REP-2024",s:"Repair Assignment",badge:"ACTIVE"},history:{t:"Job History",s:"Service Records",badge:null}},s={search:yd(),intake:_d(),status:Id()};if(e==="desktop-primary")return`
    ...
    `}function Rn(e){return e==="desktop-secondary"?Ad():Cd()}function Rd(){return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
             <div class="flex items-center justify-between mb-6">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
                    <span class="material-icons-outlined">chevron_left</span>
    ...
    `}function En(e){const t=e==="desktop-secondary";return window.setPromoterViewMode=s=>{c.promoterViewMode=s,C()},t?c.promoterViewMode==="onboarding"?Td():Md():Ed()}function Dd(){return`
    ...
    `}async function qd(){const e=document.getElementById("inward-model").value,t=document.getElementById("inward-imei").value;if(document.getElementById("inward-sn").value,!e||!t){alert("Model name and IMEI are required.");return}const s=document.getElementById("confirm-inward-btn");s.disabled=!0,s.innerText="Syncing...";try{const a=await M.query("SELECT * FROM products WHERE name = ?",[e]);let n=1;if(a.length>0)n=parseInt(a[0].stock)+1,await M.query("UPDATE products SET stock = ? WHERE id = ?",[n,a[0].id]);else{const l="PRD-"+Math.random().toString(36).substr(2,6).toUpperCase();await M.query(`
            ...
            VALUES (?, ?, ?, ?, ?, ?)
        `,["LOG-"+Math.random().toString(36).substr(2,6).toUpperCase(),e,"INWARD",1,"New Shipment Arrival",new Date().toISOString()]),await K(),window.setInventoryMode("details")}catch(a){alert("Inward failed: "+a.message),s.disabled=!1,s.innerText="Confirm Inward"}}window.confirmInward=qd;function Od(){return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0 text-left">
                 <div class="flex items-center gap-3 text-left">
    ...
    `}function Pd(){const t=(window.getCache?window.getCache():{products:[]}).products||[];return`
         <div class="h-full flex flex-col relative bg-white text-left">
            <!-- Header -->
    ...
    `}function Tn(e){const t=e==="desktop-secondary";return window.setInventoryTab=s=>{c.inventoryTab=s,C()},window.setInventoryMode=s=>{c.inventoryMode=s,C()},t?c.inventoryMode==="inward"?Od():Pd():`
        <div class="h-full flex flex-col relative bg-white">
            ${Dd()}
            ${c.inventoryTab==="brands"?Ld():jd()}
        </div>
    ...
    `}function Bd(){const e=c.settingsSubView==="add",t=c.settingsActiveRole||"Store Manager";return`
         <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
    ...
    `}function Mn(e){const t=e==="desktop-secondary";return window.setSettingsView=s=>{c.settingsView=s,c.settingsSubView=null,C()},window.setSettingsSubView=s=>{c.settingsSubView=s,C()},window.setSettingsRole=s=>{c.settingsActiveRole=s,c.settingsSubView="detail",C()},window.saveNewRole=()=>{const s=document.querySelector('input[placeholder="e.g. Floor Supervisor"]');s&&s.value?(c.settingsActiveRole=s.value,c.settingsSubView="detail",window.toast.success(`Role "${s.value}" created successfully!`),C()):window.toast.warning("Please enter a role name")},window.updateRole=()=>{window.toast.success("Role profile updated successfully!"),window.setSettingsSubView("detail")},t?c.settingsView==="roles"?Bd():c.settingsView==="accounting"?Fd():c.settingsView==="ledger"?Ud():c.settingsView==="ai"?Gd():"":Nd(e)}function Hd(){return`
        <div class="space-y-4 text-left">
    ...
    `}window.setSchemeViewMode=e=>{c.showSchemeDetails=e==="details",C()};window.setActiveScheme=e=>{c.activeScheme=e,C()};function Wd(){const t=(window.getCache?window.getCache():{schemes:[]}).schemes||[];return`
    ...
    `}function Dn(e){const t=e==="desktop-secondary",s=e==="mobile";if(window.selectSchemeBrand=n=>{c.activeSchemeBrand=n,c.schemesTab="list",C()},window.selectScheme=n=>{c.activeScheme=n,s&&(c.showSchemeDetails=!0),C()},window.setSchemesTab=n=>{c.schemesTab=n,C()},window.toggleSchemeDetails=n=>{c.showSchemeDetails=n,C()},t||s&&c.showSchemeDetails)return zd(e);const a=c.schemesTab==="brands";return`
    ...
    `}function Jd(){const e=c.marketplaceTab==="browse";return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
            <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function Yd(){const t=window.getCache().marketplace||[];return`
    ...
    `}function Ln(e){if(e==="desktop-secondary"||e==="mobile"&&c.marketplaceViewMode==="add")return Qd(e);const a=c.marketplaceTab==="browse";return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Jd()}
    ...
    `}function ep(){const t=window.getCache().inquiries||[],s=a=>{switch(a){case"PENDING":return"bg-orange-50 text-orange-400";case"FULFILLED":return"bg-green-50 text-green-500";case"CONTACTED":return"bg-blue-50 text-blue-500";case"LOST SALE":return"bg-red-50 text-red-400";default:return"bg-slate-50 text-slate-400"}};return`
        <div class="space-y-3 text-left">
    ...
    `}async function ap(e){var t;if((t=c.activeInquiry)!=null&&t.id)try{await M.query("UPDATE inquiries SET status = ? WHERE id = ?",[e,c.activeInquiry.id]),await K(),window.setInquiryViewMode("list")}catch(s){alert("Update failed: "+s.message)}}window.updateInquiryStatus=ap;function np(){const e=c.activeInquiry;return e?`
    ...
    `:'<div class="p-20 text-center uppercase text-[10px] font-black opacity-30">No inquiry selected</div>'}function jn(e){return e==="desktop-secondary"||e==="mobile"&&c.inquiryViewMode==="add"?sp():c.inquiryViewMode==="resolve"&&c.activeInquiry?np():`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Xd()}
    ...
    `}function rp(e){const t=c.activeCampaign;return t?`
    ...
    `}function qn(e){return e==="desktop-secondary"||e==="mobile"&&c.preBookingViewMode==="create"?ip():c.preBookingViewMode==="details"&&c.activeCampaign?rp():c.preBookingViewMode==="public"?op():lp()}function cp(){const e=window.getCache(),t=e.automations||[],s=e.automationMessages||[],a=t.filter(o=>o.status==="active").length;t.filter(o=>o.status==="completed").length,s.length;const n=s.filter(o=>o.status==="sent").length,l=s.filter(o=>o.status==="pending").length,d=new Date,r=new Date(Date.now()+7*864e5),p=s.filter(o=>o.status==="pending"&&new Date(o.scheduled_date)<=r).sort((o,u)=>new Date(o.scheduled_date)-new Date(u.scheduled_date)).slice(0,5);return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
             <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function On(e){const t=e==="mobile",s=e==="desktop-secondary";return window.setAutomationMode=(a,n=null)=>{c.automationViewMode=a,n!==null&&(c.activeAutomationId=n),C()},s?c.automationViewMode==="create"?dl():c.automationViewMode==="details"&&c.activeAutomationId?pl(c.activeAutomationId):`
        ...
        `:t&&c.automationViewMode==="create"?dl(!0):t&&c.automationViewMode==="details"?pl(c.activeAutomationId,!0):cp()}function dp(e=!0){if(!e)return;const t=[c.currentApp];c.currentApp==="sales"?t.push(c.currentTab):c.currentApp==="clients"?(t.push(c.clientViewMode),c.selectedClient&&c.clientViewMode==="profile"&&t.push(encodeURIComponent(c.selectedClient))):c.currentApp==="reports"?t.push(c.reportsTab):c.currentApp==="repairs"?(t.push(c.repairTab),t.push(c.repairViewMode)):c.currentApp==="inventory"?(t.push(c.inventoryTab),t.push(c.inventoryMode)):c.currentApp==="marketplace"?(t.push(c.marketplaceTab),t.push(c.marketplaceViewMode)):c.currentApp==="inquiries"?t.push(c.inquiryViewMode):c.currentApp==="prebooking"?t.push(c.preBookingViewMode):c.currentApp==="automation"?t.push(c.automationViewMode):c.currentApp==="schemes"?t.push(c.schemesTab):c.currentApp==="settings"&&t.push(c.settingsView);const s="#/"+t.filter(Boolean).join("/");window.location.hash!==s&&window.history.pushState(null,"",s)}function ul(){const e=window.location.hash.replace("#/","");if(!e)return;const t=e.split("/"),s=t[0];s&&(c.currentApp=s),s==="sales"?t[1]&&(c.currentTab=t[1]):s==="clients"?(t[1]&&(c.clientViewMode=t[1]),t[2]&&(c.selectedClient=decodeURIComponent(t[2]))):s==="reports"?t[1]&&(c.reportsTab=t[1]):s==="repairs"?(t[1]&&(c.repairTab=t[1]),t[2]&&(c.repairViewMode=t[2])):s==="inventory"?(t[1]&&(c.inventoryTab=t[1]),t[2]&&(c.inventoryMode=t[2])):s==="marketplace"?(t[1]&&(c.marketplaceTab=t[1]),t[2]&&(c.marketplaceViewMode=t[2])):s==="inquiries"?t[1]&&(c.inquiryViewMode=t[1]):s==="prebooking"?t[1]&&(c.preBookingViewMode=t[1]):s==="automation"?t[1]&&(c.automationViewMode=t[1]):s==="schemes"?t[1]&&(c.schemesTab=t[1]):s==="settings"&&t[1]&&(c.settingsView=t[1]),C(!1)}function pp(){window.addEventListener("hashchange",ul),ul()}const St={endpoint:"https://live-mt-server.wati.io/319917",token:"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..V1k2oIW0iDKep9_zG9WpS62LVcgXxj7vAndigvmZS2I"};function up(e){if(!e)return null;let t=e.replace(/\D/g,"");return t.length===10&&(t="91"+t),t}async function xp(e,t){var a;const s=up(e);if(!s)throw new Error("Invalid phone number");try{const n=await fetch(`${St.endpoint}/api/v1/sendSessionMessage/${s}`,{method:"POST",headers:{Authorization:St.token,"Content-Type":"application/json"},body:JSON.stringify({messageText:t})}),l=await n.json();if(!n.ok){if(console.error("WATI API Error:",l),(a=l.message)!=null&&a.includes("session")||l.result===!1)return console.log("Session expired, trying template message..."),await fp(s,t);throw new Error(l.message||"Failed to send message")}return{success:!0,data:l}}catch(n){throw console.error("WATI Send Error:",n),n}}async function fp(e,t){try{const s=await fetch(`${St.endpoint}/api/v1/sendTemplateMessage`,{method:"POST",headers:{Authorization:St.token,"Content-Type":"application/json"},body:JSON.stringify({whatsappNumber:e,templateName:"retaileros_notification",parameters:[{name:"message",value:t}],broadcast_name:"RetailerOS"})}),a=await s.json();return!s.ok&&a.result===!1?(console.log("Template not found, trying interactive message..."),await bp(e,t)):{success:!0,data:a,method:"template"}}catch(s){throw console.error("Template message error:",s),s}}async function bp(e,t){try{const s=await fetch(`${St.endpoint}/api/v1/sendInteractiveButtonsMessage`,{method:"POST",headers:{Authorization:St.token,"Content-Type":"application/json"},body:JSON.stringify({whatsappNumber:e,header:{type:"Text",text:"RetailerOS"},body:t,footer:"Powered by RetailerOS",buttons:[{type:"reply",reply:{id:"reply_ok",title:"OK"}}]})}),a=await s.json();return{success:s.ok,data:a,method:"interactive"}}catch(s){throw console.error("Interactive message error:",s),s}}async function hp(){try{return(await fetch(`${St.endpoint}/api/v1/getContacts?pageSize=1`,{method:"GET",headers:{Authorization:St.token}})).ok}catch(e){return console.error("WATI connection test failed:",e),!1}}window.sendWhatsAppMessage=xp;window.testWatiConnection=hp;let Rt=null,Ba=null;const xl={success:{icon:"check_circle",bg:"bg-slate-900",text:"text-white"},error:{icon:"error",bg:"bg-red-600",text:"text-white"},warning:{icon:"warning",bg:"bg-amber-500",text:"text-white"},info:{icon:"info",bg:"bg-slate-700",text:"text-white"}};function mp(){Rt||(Rt=document.createElement("div"),Rt.id="toast-container",Rt.className="fixed top-4 left-1/2 -translate-x-1/2 z-[9999] flex flex-col items-center gap-2 pointer-events-none",document.body.appendChild(Rt))}function Os(e,t="info",s=3e3){mp(),Ba&&clearTimeout(Ba);const a=xl[t]||xl.info,n=document.createElement("div");return n.className=`
        ${a.bg} ${a.text} 
    ...
    `,(t==="error"||e.length>50)&&(n.innerHTML+=`
        ...
        `),Rt.innerHTML="",Rt.appendChild(n),requestAnimationFrame(()=>{n.classList.remove("opacity-0","translate-y-[-20px]","scale-95"),n.classList.add("opacity-100","translate-y-0","scale-100")}),Ba=setTimeout(()=>{gp(n)},s),n}function gp(e){!e||!e.parentElement||(e.classList.remove("opacity-100","translate-y-0","scale-100"),e.classList.add("opacity-0","translate-y-[-20px]","scale-95"),setTimeout(()=>{e.remove()},300))}function Ia(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const wp={success:(e,t)=>Os(e,"success",t),error:(e,t)=>Os(e,"error",t||5e3),warning:(e,t)=>Os(e,"warning",t||4e3),info:(e,t)=>Os(e,"info",t)};function vp(e,t,s){const a=document.createElement("div");a.className="fixed inset-0 z-[9998] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4",a.innerHTML=`
    ...
    `,document.body.appendChild(n);const l=n.querySelector("div > div"),d=n.querySelector("#prompt-input");requestAnimationFrame(()=>{l.classList.remove("scale-95","opacity-0"),l.classList.add("scale-100","opacity-100"),d.focus(),d.select()}),d.onkeydown=r=>{if(r.key==="Enter"){const p=d.value.trim();ct(n),p&&s&&s(p)}else r.key==="Escape"&&(ct(n),a&&a())},n.querySelector("#prompt-cancel").onclick=()=>{ct(n),a&&a()},n.querySelector("#prompt-ok").onclick=()=>{const r=d.value.trim();ct(n),r&&s&&s(r)},n.onclick=r=>{r.target===n&&(ct(n),a&&a())}}window.toast=wp;window.showToast=Os;window.showConfirm=vp;window.showPrompt=yp;function ji(){return c.currentApp==="sales"?c.currentTab==="new-sale"?Ti():Mi():c.currentApp==="clients"?$n("desktop-primary"):c.currentApp==="reports"?Cn("desktop-primary"):c.currentApp==="repairs"?An("desktop-primary"):c.currentApp==="marketing"?Rn("desktop-primary"):c.currentApp==="promoters"?En("desktop-primary"):c.currentApp==="inventory"?Tn("desktop-primary"):c.currentApp==="settings"?Mn("desktop-primary"):c.currentApp==="schemes"?Dn("desktop-primary"):c.currentApp==="marketplace"?Ln("desktop-primary"):c.currentApp==="inquiries"?jn("desktop-primary"):c.currentApp==="prebooking"?qn("desktop-primary"):c.currentApp==="automation"?On("desktop-primary"):'<div class="p-10 flex items-center justify-center h-full text-slate-300 font-bold uppercase tracking-widest">App Module Not Found</div>'}function kp(){return c.currentApp==="sales"?c.salesMode==="add-customer"?cn("desktop"):In():c.currentApp==="clients"?$n("desktop-secondary"):c.currentApp==="reports"?Cn("desktop-secondary"):c.currentApp==="repairs"?An("desktop-secondary"):c.currentApp==="marketing"?Rn("desktop-secondary"):c.currentApp==="promoters"?En("desktop-secondary"):c.currentApp==="inventory"?Tn("desktop-secondary"):c.currentApp==="settings"?Mn("desktop-secondary"):c.currentApp==="schemes"?Dn("desktop-secondary"):c.currentApp==="marketplace"?Ln("desktop-secondary"):c.currentApp==="inquiries"?jn("desktop-secondary"):c.currentApp==="prebooking"?qn("desktop-secondary"):c.currentApp==="automation"?On("desktop-secondary"):'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">Select an app to view details</p></div></div>'}function qi(){return Fa("desktop")}function _p(){return`
        <div class="h-full flex flex-row divide-x divide-slate-200 bg-white w-full">
            ...
            <div class="flex-1 bg-white h-full overflow-hidden flex flex-col relative z-10">
               ${c.isLoggedIn?c.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-4 opacity-20">arrow_back</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Select an App from the Menu</p></div></div>':ji():c.authMode==="register"?Bs("desktop-primary"):'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'}
            </div>
            ...
            <div class="w-[30%] shrink-0 bg-slate-50/50 h-full overflow-hidden flex flex-col relative dot-grid border-l border-slate-200">
                ${c.isLoggedIn?c.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-6xl mb-4 opacity-20">dashboard</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Retailer OS Environment</p></div></div>':kp():c.authMode==="register"?Bs("desktop-secondary"):'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>'}
            </div>
        </div>
    `}function Sp(){return`
        <div class="h-full grid grid-cols-2 divide-x divide-slate-200 bg-white">
            ...
            <div class="col-span-1 bg-white h-full overflow-hidden flex flex-col relative z-10">
               ${c.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-4 opacity-20">arrow_back</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Select an App from the Menu</p></div></div>':ji()}
    ...
    `}function Oi(){if(!c.isLoggedIn)return`
            <div class="h-full w-full bg-white">
                ${_l()}
            </div>
        `;if(c.currentApp==="launcher")return Fa("mobile");if(c.currentApp==="sales"){const t=window.getActiveCart&&window.getActiveCart().length>0,s=c.currentTab==="new-sale"&&t||c.currentTab==="history"&&c.salesHistoryId;return c.showMobileReceipt&&s?`
        ...
        `:""}
        `}let e="";if(c.currentApp==="clients")e=$n("mobile");else if(c.currentApp==="reports")e=Cn("mobile");else if(c.currentApp==="repairs")e=An("mobile");else if(c.currentApp==="marketing")e=Rn("mobile");else if(c.currentApp==="promoters")e=En("mobile");else if(c.currentApp==="inventory")e=Tn("mobile");else if(c.currentApp==="settings")e=Mn("mobile");else if(c.currentApp==="schemes")e=Dn("mobile");else if(c.currentApp==="marketplace")e=Ln("mobile");else if(c.currentApp==="inquiries")e=jn("mobile");else if(c.currentApp==="prebooking")e=qn("mobile");else if(c.currentApp==="automation")e=On("mobile");else return Fa("mobile");return`
        <div class="flex flex-col w-full h-full overflow-hidden bg-slate-50 relative">
            ${e}
        </div>
    `}function $a(){const e=document.getElementById("app");if(e)try{const t=window.innerWidth;t<768?e.innerHTML=Oi():t>=768&&t<1024?e.innerHTML=Sp():e.innerHTML=_p()}catch(t){console.error(t),e.innerHTML=`< div class="p-4 text-red-500 font-bold" > Error: ${t.message} <br><small>${t.stack}</small></div>`}}function Ip(){const e=window.innerWidth;if(e<768){const t=document.getElementById("app");t&&(t.innerHTML=Oi())}else{const t=document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10")||document.querySelector(".col-span-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10"),s=document.querySelector(".w-\\[30\\%\\].shrink-0.bg-slate-50\\/50.h-full.overflow-hidden.flex.flex-col.relative.dot-grid.border-l.border-slate-200");t&&(t.innerHTML=c.authMode==="register"?Bs("desktop-primary"):'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'),s&&e>=1024&&(s.innerHTML=c.authMode==="register"?Bs("desktop-secondary"):'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>')}}window.updateAuthContent=Ip;wl($a);wl(dp);pp();window.addEventListener("resize",()=>{window.innerWidth!==c.viewportWidth&&(c.viewportWidth=window.innerWidth,c.gridCols=window.innerWidth<768?4:3,$a())});K().then(()=>{console.log("Initial data sync complete"),$a()}).catch(e=>{console.error("Initial sync failed:",e),$a()});
