var xr=Object.defineProperty;var el=e=>{throw TypeError(e)};var fr=(e,t,s)=>t in e?xr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var q=(e,t,s)=>fr(e,typeof t!="symbol"?t+"":t,s),Wa=(e,t,s)=>t.has(e)||el("Cannot "+s);var d=(e,t,s)=>(Wa(e,t,"read from private field"),s?s.call(e):t.get(e)),_=(e,t,s)=>t.has(e)?el("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),h=(e,t,s,a)=>(Wa(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),S=(e,t,s)=>(Wa(e,t,"access private method"),s);var es=(e,t,s,a)=>({set _(n){h(e,t,n,s)},get _(){return d(e,t,a)}});(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();const mr=localStorage.getItem("retaileros_logged_in")==="true",br=localStorage.getItem("retaileros_retailer_id")||null,hr=localStorage.getItem("retaileros_retailer_code")||null,gr=localStorage.getItem("retaileros_retailer_name")||null,wr=localStorage.getItem("retaileros_push_notifications")!=="false";window._pushNotificationsEnabled=wr;const p={retailerId:br,retailerCode:hr,retailerName:gr,currentApp:window.innerWidth<768?"launcher":"sales",currentTab:"new-sale",salesMode:"default",salesHistoryId:"ORD-99281",historyViewMode:"completed",historyDateFilter:"today",historyFromDate:"",historyToDate:"",showMobileReceipt:!1,reportsTab:"sales",repairTab:"active",repairViewMode:"search",selectedRepairDevice:null,activeRepairId:null,repairContext:null,selectedClient:null,selectedClientId:null,clientViewMode:"directory",clientSearchQuery:"",clientInvoiceId:null,selectedGroupId:null,groupViewMode:"list",groupSearchQuery:"",promoterViewMode:"performance",inventoryTab:"brands",inventoryMode:"details",activeCategory:null,settingsView:null,viewportWidth:window.innerWidth,gridCols:window.innerWidth<768?4:3,schemesTab:"list",activeSchemeBrand:"Apple",activeScheme:"June Activation Bonus",showSchemeDetails:!1,marketplaceTab:"browse",marketplaceViewMode:"list",myStoreTab:"dashboard",myStoreViewMode:"list",activeStoreOrderId:null,activeListingId:null,isLoggedIn:mr,authMode:"login",registrationStep:1,inquiryViewMode:"list",activeInquiry:null,preBookingViewMode:"dashboard",activeCampaign:null,automationViewMode:"dashboard",activeAutomationId:null},ql=[],Bl=e=>{ql.push(e)},D=(e=!0)=>{ql.forEach(t=>t(e))};function vr(e){p.currentApp=e,e==="clients"&&(p.clientViewMode="directory"),D()}function yr(e){p.currentTab=e,D()}function kr(e){p.salesHistoryId=e,e&&window.innerWidth<768&&(p.showMobileReceipt=!0),D()}function _r(e){p.showMobileReceipt=e,D()}function Sr(e){p.reportsTab=e,D()}function $r(e){p.repairTab=e,D()}function Er(e,t=null){p.repairViewMode=e,t&&(p.selectedRepairDevice=t),D()}function Ir(e){p.gridCols=e,D()}function Fl(e,t=null,s=null){p.clientViewMode=e,t&&(p.selectedClient=t),s&&(p.selectedClientId=s),e!=="invoice"&&(p.clientInvoiceId=null),D()}function Cr(e){p.clientInvoiceId=e,p.clientViewMode="invoice",D()}function Rr(e){p.schemesTab=e,D()}function Ar(e){p.activeSchemeBrand=e,D()}function Tr(e){p.activeScheme=e,D()}function Mr(e){p.showSchemeDetails=e,D()}function Dr(e){p.marketplaceTab=e,D()}function Lr(e){p.marketplaceViewMode=e,D()}function Or(e,t,s){p.retailerId=e,p.retailerCode=t,p.retailerName=s,localStorage.setItem("retaileros_retailer_id",e),localStorage.setItem("retaileros_retailer_code",t),localStorage.setItem("retaileros_retailer_name",s)}function Vl(){p.retailerId=null,p.retailerCode=null,p.retailerName=null,localStorage.removeItem("retaileros_retailer_id"),localStorage.removeItem("retaileros_retailer_code"),localStorage.removeItem("retaileros_retailer_name")}function jr(){return p.retailerId}function Pr(e){p.isLoggedIn=e,e?localStorage.setItem("retaileros_logged_in","true"):(localStorage.removeItem("retaileros_logged_in"),Vl());const t=window.innerWidth<768;p.currentApp=e?t?"launcher":"sales":"launcher",D()}function Nr(e){p.authMode=e,p.registrationStep=1,D()}function qr(e){p.registrationStep=e,window.updateAuthContent?window.updateAuthContent():D()}function Br(e){p.inquiryViewMode=e,D()}function Fr(e){p.activeInquiry=e,D()}function Vr(e){p.preBookingViewMode=e,D()}function Ur(e){p.activeCampaign=e,D()}function Hr(e){p.automationViewMode=e,D()}function Gr(e){p.activeAutomationId=e,D()}window.triggerRender=D;window.setApp=vr;window.setTab=yr;window.setSalesHistoryId=kr;window.toggleMobileReceipt=_r;window.setReportsTab=Sr;window.setRepairTab=$r;function Ul(e){p.salesMode=e,D()}window.setSalesMode=Ul;function Wr(e){p.historyViewMode=e,D()}function zr(e){p.historyDateFilter=e,e!=="custom"&&(p.historyFromDate="",p.historyToDate=""),D()}function Yr(e,t){p.historyFromDate=e,p.historyToDate=t,p.historyDateFilter="custom",D()}window.setHistoryViewMode=Wr;window.setHistoryDateFilter=zr;window.setHistoryCustomDates=Yr;window.setRepairMode=Er;window.setGridCols=Ir;window.setClientMode=Fl;window.viewClientInvoice=Cr;window.setSchemesTab=Rr;window.setSchemeBrand=Ar;window.setScheme=Tr;window.toggleSchemeDetails=Mr;window.setMarketplaceTab=Dr;window.setMarketplaceViewMode=Lr;function Jr(e){p.myStoreTab=e,p.myStoreViewMode="list",D()}function Kr(e){p.myStoreViewMode=e,D()}function Qr(e){p.activeStoreOrderId=e,p.myStoreViewMode="order-detail",D()}function Xr(e){p.activeListingId=e,D()}window.setMyStoreTab=Jr;window.setMyStoreViewMode=Kr;window.setActiveStoreOrder=Qr;window.setActiveListing=Xr;window.setRetailer=Or;window.clearRetailer=Vl;window.getRetailerId=jr;window.setLoginStatus=Pr;window.setAuthMode=Nr;window.setRegistrationStep=qr;window.setInquiryViewMode=Br;window.setActiveInquiry=Fr;window.setPreBookingViewMode=Vr;window.setActiveCampaign=Ur;window.setAutomationViewMode=Hr;window.setActiveAutomation=Gr;function Zr(e){p.groupViewMode=e,D()}function eo(e){p.selectedGroupId=e,D()}window.setGroupViewMode=Zr;window.setSelectedGroup=eo;function to(){const e=window._pushNotificationsEnabled!==!1;window._pushNotificationsEnabled=!e,localStorage.setItem("retaileros_push_notifications",e?"false":"true"),D()}window.togglePushNotifications=to;const so="modulepreload",ao=function(e){return"/"+e},tl={},Ys=function(t,s,a){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=Promise.allSettled(s.map(c=>{if(c=ao(c),c in tl)return;tl[c]=!0;const o=c.endsWith(".css"),u=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const m=document.createElement("link");if(m.rel=o?"stylesheet":so,o||(m.as="script"),m.crossOrigin="",m.href=c,r&&m.setAttribute("nonce",r),document.head.appendChild(m),o)return new Promise((b,y)=>{m.addEventListener("load",b),m.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function l(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return n.then(i=>{for(const r of i||[])r.status==="rejected"&&l(r.reason);return t().catch(l)})};function Hl(e){const t=e==="mobile";return`
    ...
    `}window.loginWithCredentials=async function(){const e=document.getElementById("login-identifier"),t=e?e.value.trim():"",s=document.getElementById("login-error"),a=document.getElementById("login-error-text"),n=document.getElementById("login-btn");if(!t){s&&a&&(a.textContent="Please enter your mobile number or store code.",s.classList.remove("hidden"));return}s&&s.classList.add("hidden"),n&&(n.disabled=!0,n.textContent="Authenticating...");try{const{query:l}=await Ys(async()=>{const{query:c}=await Promise.resolve().then(()=>Mn);return{query:c}},void 0);let i=null;if(/^\d{10}$/.test(t)){const c=await l("SELECT * FROM retailers WHERE mobile_number = ? AND status = 'active' LIMIT 1",[t]);c.length>0&&(i=c[0])}if(!i){const c=await l("SELECT * FROM retailers WHERE retailer_code = ? AND status = 'active' LIMIT 1",[t.toUpperCase()]);c.length>0&&(i=c[0])}if(!i){s&&a&&(a.textContent="No registered store found. Please check your mobile number or store code, or register first.",s.classList.remove("hidden"));return}window.setRetailer(i.id,i.retailer_code,i.retailer_name);const{syncData:r}=await Ys(async()=>{const{syncData:c}=await Promise.resolve().then(()=>Xi);return{syncData:c}},void 0);await r(),window.setLoginStatus(!0)}catch(l){console.error("Login failed:",l),s&&a&&(a.textContent="Login failed: "+l.message,s.classList.remove("hidden"))}finally{n&&(n.disabled=!1,n.textContent="Authenticate")}};function Js(e="mobile"){return e==="desktop-primary"?no():e==="desktop-secondary"?lo():io()}function no(){const e=p.registrationStep;return e===3?`
    ...
    `}function lo(){return p.registrationStep<3?`
    ...
    `}function io(){const e=p.registrationStep;return`
...
Error: `+s.message)}};window.verifyOtp=function(){const e=[];for(let a=0;a<6;a++){const n=document.getElementById(`otp-${a}`);n&&e.push(n.value)}const t=e.join("");if(t.length!==6){alert("Please enter all 6 digits");return}const s="444619";console.log("Verifying OTP:",t),t===s?console.log("✅ Default OTP accepted:",s):console.log("ℹ️  Development mode: Any OTP accepted"),window.setRegistrationStep(3)};window.resendOtp=function(){for(let t=0;t<6;t++){const s=document.getElementById(`otp-${t}`);s&&(s.value="")}const e=document.getElementById("otp-0");e&&e.focus(),console.log("Resending OTP..."),alert("OTP has been resent successfully!")};window.finalizeRegistration=async function(){try{const e=window._approvedRetailerData;if(!e){alert("Session expired. Please start registration again."),window.setRegistrationStep(1);return}const{db:t}=await Ys(async()=>{const{db:n}=await Promise.resolve().then(()=>Mn);return{db:n}},void 0),s=await t.retailers.add(e);window.setRetailer(s.id,s.retailerCode,e.RetailerName),localStorage.setItem("retaileros_logged_in","true"),delete window._approvedRetailerData;const{syncData:a}=await Ys(async()=>{const{syncData:n}=await Promise.resolve().then(()=>Xi);return{syncData:n}},void 0);await a(),window.setLoginStatus(!0),console.log("Registration completed successfully:",s)}catch(e){console.error("Registration failed:",e),alert("Registration failed. Please try again.")}};function Gl(){return p.authMode==="register"?Js("mobile"):Hl("mobile")}const ro=[{n:"ALERTS",i:"notifications",k:"notifications"},{n:"SALES DESK",i:"account_balance_wallet",k:"sales"},{n:"CLIENTS",i:"group",k:"clients"},{n:"INQUIRIES",i:"help_outline",k:"inquiries"},{n:"PROMOTERS",i:"business_center",k:"promoters"},{n:"MY STORE",i:"storefront",k:"mystore"},{n:"INVENTORY",i:"inventory_2",k:"inventory"},{n:"REPAIRS",i:"build",k:"repairs"},{n:"MARKETPLACE",i:"swap_horizontal_circle",k:"marketplace"},{n:"CLAIMS",i:"verified_user"},{n:"SCHEMES",i:"percent",k:"schemes"},{n:"MARKETING",i:"campaign",k:"marketing"},{n:"AUTOMATION",i:"smart_toy",s:!0,k:"automation"},{n:"PRE-BOOKING",i:"rocket_launch",k:"prebooking"},{n:"REPORTS",i:"bar_chart",k:"reports"},{n:"SETTINGS",i:"settings",k:"settings"}];function oo(e){const t=e?p.gridCols:4,s=e&&{2:"grid-cols-2",3:"grid-cols-3",4:"grid-cols-4"}[t]||"grid-cols-4",a=window.getNotificationCount?window.getNotificationCount():0;return`
    ...
    `}function Wl(e){const t=e==="mobile";return`
    ...
    `}class F extends Error{constructor(s,a,n,l,i){a!==void 0&&(s=`${a}: ${s}`);super(s,{cause:i});q(this,"code");q(this,"extendedCode");q(this,"rawCode");this.code=a,this.extendedCode=n,this.rawCode=l,this.name="LibsqlError"}}class ls extends F{constructor(s,a,n,l,i,r){super(s,n,l,i,r);q(this,"statementIndex");this.statementIndex=a,this.name="LibsqlBatchError"}}function po(e){const t=uo.exec(e);if(t===null)throw new F(`The URL '${e}' is not in a valid format`,"URL_INVALID");const s=t.groups,a=s.scheme,n=s.authority!==void 0?xo(s.authority):void 0,l=Qt(s.path),i=s.query!==void 0?mo(s.query):void 0,r=s.fragment!==void 0?Qt(s.fragment):void 0;return{scheme:a,authority:n,path:l,query:i,fragment:r}}const uo=(()=>{const e="(?<scheme>[A-Za-z][A-Za-z.+-]*)",t="(?<authority>[^/?#]*)",s="(?<path>[^?#]*)",a="(?<query>[^#]*)",n="(?<fragment>.*)";return new RegExp(`^${e}:(//${t})?${s}(\\?${a})?(#${n})?$`,"su")})();function xo(e){const t=fo.exec(e);if(t===null)throw new F("The authority part of the URL is not in a valid format","URL_INVALID");const s=t.groups,a=Qt(s.host_br??s.host),n=s.port?parseInt(s.port,10):void 0,l=s.username!==void 0?{username:Qt(s.username),password:s.password!==void 0?Qt(s.password):void 0}:void 0;return{host:a,port:n,userinfo:l}}const fo=new RegExp("^((?<username>[^:]*)(:(?<password>.*))?@)?((?<host>[^:\\[\\]]*)|(\\[(?<host_br>[^\\[\\]]*)\\]))(:(?<port>[0-9]*))?$","su");function mo(e){const t=e.split("&"),s=[];for(const a of t){if(a==="")continue;let n,l;const i=a.indexOf("=");i<0?(n=a,l=""):(n=a.substring(0,i),l=a.substring(i+1)),s.push({key:Qt(n.replaceAll("+"," ")),value:Qt(l.replaceAll("+"," "))})}return{pairs:s}}function Qt(e){try{return decodeURIComponent(e)}catch(t){throw t instanceof URIError?new F(`URL component has invalid percent encoding: ${t}`,"URL_INVALID",void 0,void 0,t):t}}function Qa(e,t,s){if(t===void 0)throw new F(`URL with scheme ${JSON.stringify(e+":")} requires authority (the "//" part)`,"URL_INVALID");const a=`${e}:`,n=bo(t.host),l=ho(t.port),r=`//${go(t.userinfo)}${n}${l}`;let c=s.split("/").map(encodeURIComponent).join("/");return c!==""&&!c.startsWith("/")&&(c="/"+c),new URL(`${a}${r}${c}`)}function bo(e){return e.includes(":")?`[${encodeURI(e)}]`:encodeURI(e)}function ho(e){return e!==void 0?`:${e}`:""}function go(e){if(e===void 0)return"";const t=encodeURIComponent(e.username),s=e.password!==void 0?`:${encodeURIComponent(e.password)}`:"";return`${t}${s}@`}const zl="3.7.8",wo=zl,Ds=typeof Buffer=="function",sl=typeof TextDecoder=="function"?new TextDecoder:void 0,al=typeof TextEncoder=="function"?new TextEncoder:void 0,vo="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",js=Array.prototype.slice.call(vo),ha=(e=>{let t={};return e.forEach((s,a)=>t[s]=a),t})(js),yo=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,le=String.fromCharCode.bind(String),nl=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),Yl=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),Jl=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),Kl=e=>{let t,s,a,n,l="";const i=e.length%3;for(let r=0;r<e.length;){if((s=e.charCodeAt(r++))>255||(a=e.charCodeAt(r++))>255||(n=e.charCodeAt(r++))>255)throw new TypeError("invalid character found");t=s<<16|a<<8|n,l+=js[t>>18&63]+js[t>>12&63]+js[t>>6&63]+js[t&63]}return i?l.slice(0,i-3)+"===".substring(i):l},kn=typeof btoa=="function"?e=>btoa(e):Ds?e=>Buffer.from(e,"binary").toString("base64"):Kl,Xa=Ds?e=>Buffer.from(e).toString("base64"):e=>{let s=[];for(let a=0,n=e.length;a<n;a+=4096)s.push(le.apply(null,e.subarray(a,a+4096)));return kn(s.join(""))},va=(e,t=!1)=>t?Yl(Xa(e)):Xa(e),ko=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?le(192|t>>>6)+le(128|t&63):le(224|t>>>12&15)+le(128|t>>>6&63)+le(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return le(240|t>>>18&7)+le(128|t>>>12&63)+le(128|t>>>6&63)+le(128|t&63)}},_o=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Ql=e=>e.replace(_o,ko),ll=Ds?e=>Buffer.from(e,"utf8").toString("base64"):al?e=>Xa(al.encode(e)):e=>kn(Ql(e)),is=(e,t=!1)=>t?Yl(ll(e)):ll(e),il=e=>is(e,!0),So=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,$o=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),s=t-65536;return le((s>>>10)+55296)+le((s&1023)+56320);case 3:return le((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return le((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},Xl=e=>e.replace(So,$o),Zl=e=>{if(e=e.replace(/\s+/g,""),!yo.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,s,a,n=[];for(let l=0;l<e.length;)t=ha[e.charAt(l++)]<<18|ha[e.charAt(l++)]<<12|(s=ha[e.charAt(l++)])<<6|(a=ha[e.charAt(l++)]),s===64?n.push(le(t>>16&255)):a===64?n.push(le(t>>16&255,t>>8&255)):n.push(le(t>>16&255,t>>8&255,t&255));return n.join("")},_n=typeof atob=="function"?e=>atob(Jl(e)):Ds?e=>Buffer.from(e,"base64").toString("binary"):Zl,ei=Ds?e=>nl(Buffer.from(e,"base64")):e=>nl(_n(e).split("").map(t=>t.charCodeAt(0))),ti=e=>ei(si(e)),Eo=Ds?e=>Buffer.from(e,"base64").toString("utf8"):sl?e=>sl.decode(ei(e)):e=>Xl(_n(e)),si=e=>Jl(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),Za=e=>Eo(si(e)),Io=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},ai=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),ni=function(){const e=(t,s)=>Object.defineProperty(String.prototype,t,ai(s));e("fromBase64",function(){return Za(this)}),e("toBase64",function(t){return is(this,t)}),e("toBase64URI",function(){return is(this,!0)}),e("toBase64URL",function(){return is(this,!0)}),e("toUint8Array",function(){return ti(this)})},li=function(){const e=(t,s)=>Object.defineProperty(Uint8Array.prototype,t,ai(s));e("toBase64",function(t){return va(this,t)}),e("toBase64URI",function(){return va(this,!0)}),e("toBase64URL",function(){return va(this,!0)})},Co=()=>{ni(),li()},Sn={version:zl,VERSION:wo,atob:_n,atobPolyfill:Zl,btoa:kn,btoaPolyfill:Kl,fromBase64:Za,toBase64:is,encode:is,encodeURI:il,encodeURL:il,utob:Ql,btou:Xl,decode:Za,isValid:Io,fromUint8Array:va,toUint8Array:ti,extendString:ni,extendUint8Array:li,extendBuiltins:Co},Ks="https://github.com/libsql/libsql-client-ts#supported-urls";function en(e){if(e==="write")return"BEGIN IMMEDIATE";if(e==="read")return"BEGIN TRANSACTION READONLY";if(e==="deferred")return"BEGIN DEFERRED";throw RangeError('Unknown transaction mode, supported values are "write", "read" and "deferred"')}class Ro{constructor(t,s,a,n,l){q(this,"columns");q(this,"columnTypes");q(this,"rows");q(this,"rowsAffected");q(this,"lastInsertRowid");this.columns=t,this.columnTypes=s,this.rows=a,this.rowsAffected=n,this.lastInsertRowid=l}toJSON(){return{columns:this.columns,columnTypes:this.columnTypes,rows:this.rows.map(Ao),rowsAffected:this.rowsAffected,lastInsertRowid:this.lastInsertRowid!==void 0?""+this.lastInsertRowid:null}}}function Ao(e){return Array.prototype.map.call(e,To)}function To(e){return typeof e=="bigint"?""+e:e instanceof ArrayBuffer?Sn.fromUint8Array(new Uint8Array(e)):e}const rl=":memory:";function Mo(e,t){var f,x;if(typeof e!="object")throw new TypeError(`Expected client configuration as object, got ${typeof e}`);let{url:s,authToken:a,tls:n,intMode:l,concurrency:i}=e;i=Math.max(0,i||20),l??(l="number");let r=[];s===rl&&(s="file::memory:");const c=po(s),o=c.scheme.toLowerCase(),u=o==="file"&&c.path===rl&&c.authority===void 0;let m;u?m={cache:{values:["shared","private"],update:(g,$)=>r.push(`${g}=${$}`)}}:m={tls:{values:["0","1"],update:(g,$)=>n=$==="1"},authToken:{update:(g,$)=>a=$}};for(const{key:g,value:$}of((f=c.query)==null?void 0:f.pairs)??[]){if(!Object.hasOwn(m,g))throw new F(`Unsupported URL query parameter ${JSON.stringify(g)}`,"URL_PARAM_NOT_SUPPORTED");const C=m[g];if(C.values!==void 0&&!C.values.includes($))throw new F(`Unknown value for the "${g}" query argument: ${JSON.stringify($)}. Supported values are: [${C.values.map(E=>'"'+E+'"').join(", ")}]`,"URL_INVALID");C.update!==void 0&&(C==null||C.update(g,$))}const b=r.length===0?"":`?${r.join("&")}`,y=c.path+b;let w;if(o==="libsql")if(n===!1){if(((x=c.authority)==null?void 0:x.port)===void 0)throw new F('A "libsql:" URL with ?tls=0 must specify an explicit port',"URL_INVALID");w="http"}else w="https";else w=o;if(w==="http"||w==="ws"?n??(n=!1):n??(n=!0),w!=="http"&&w!=="ws"&&w!=="https"&&w!=="wss"&&w!=="file")throw new F(`The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${JSON.stringify(c.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(l!=="number"&&l!=="bigint"&&l!=="string")throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(l)}`);if(c.fragment!==void 0)throw new F(`URL fragments are not supported: ${JSON.stringify("#"+c.fragment)}`,"URL_INVALID");return u?{scheme:"file",tls:!1,path:y,intMode:l,concurrency:i,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch,authToken:void 0,encryptionKey:void 0,remoteEncryptionKey:void 0,authority:void 0}:{scheme:w,tls:n,authority:c.authority,path:y,authToken:a,intMode:l,concurrency:i,encryptionKey:e.encryptionKey,remoteEncryptionKey:e.remoteEncryptionKey,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch}}let as;typeof WebSocket<"u"?as=WebSocket:typeof global<"u"?as=global.WebSocket:typeof window<"u"?as=window.WebSocket:typeof self<"u"&&(as=self.WebSocket);class ii{constructor(){q(this,"intMode");this.intMode="number"}}class K extends Error{constructor(t){super(t),this.name="ClientError"}}class j extends K{constructor(t){super(t),this.name="ProtoError"}}class ri extends K{constructor(s,a){super(s);q(this,"code");q(this,"proto");this.name="ResponseError",this.code=a.code,this.proto=a,this.stack=void 0}}class Ae extends K{constructor(t,s){s!==void 0?(super(`${t}: ${s}`),this.cause=s):super(t),this.name="ClosedError"}}class oi extends K{constructor(t){super(t),this.name="WebSocketUnsupportedError"}}class tn extends K{constructor(t){super(t),this.name="WebSocketError"}}class ya extends K{constructor(s,a){super(s);q(this,"status");this.status=a,this.name="HttpServerError"}}class Rs extends K{constructor(t){super(t),this.name="ProtocolVersionError"}}class At extends K{constructor(t){super(t),this.name="InternalError"}}class Ls extends K{constructor(t){super(t),this.name="MisuseError"}}function qe(e){if(typeof e=="string")return e;throw Os(e,"string")}function Fe(e){if(e!=null){if(typeof e=="string")return e;throw Os(e,"string or null")}}function Xt(e){if(typeof e=="number")return e;throw Os(e,"number")}function Qs(e){if(typeof e=="boolean")return e;throw Os(e,"boolean")}function Ia(e){if(Array.isArray(e))return e;throw Os(e,"array")}function ie(e){if(e!==null&&typeof e=="object"&&!Array.isArray(e))return e;throw Os(e,"object")}function Tt(e,t){return Ia(e).map(s=>t(ie(s)))}function Os(e,t){if(e===void 0)return new j(`Expected ${t}, but the property was missing`);let s=typeof e;return e===null?s="null":Array.isArray(e)&&(s="array"),new j(`Expected ${t}, received ${s}`)}function $n(e,t){return t(ie(e))}var X,gt,Ze,Ot;class Do{constructor(t){_(this,Ze);_(this,X);_(this,gt);h(this,X,t),h(this,gt,!1)}begin(){d(this,X).push("{"),h(this,gt,!0)}end(){d(this,X).push("}"),h(this,gt,!1)}string(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(JSON.stringify(s))}stringRaw(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push('"'),d(this,X).push(s),d(this,X).push('"')}number(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(""+s)}boolean(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(s?"true":"false")}object(t,s,a){S(this,Ze,Ot).call(this,t),this.begin(),a(this,s),this.end()}arrayObjects(t,s,a){S(this,Ze,Ot).call(this,t),d(this,X).push("[");for(let n=0;n<s.length;++n)n!==0&&d(this,X).push(","),this.begin(),a(this,s[n]),this.end();d(this,X).push("]")}}X=new WeakMap,gt=new WeakMap,Ze=new WeakSet,Ot=function(t){d(this,gt)?(d(this,X).push('"'),h(this,gt,!1)):d(this,X).push(',"'),d(this,X).push(t),d(this,X).push('":')};function ci(e,t){const s=[],a=new Do(s);return a.begin(),t(a,e),a.end(),s.join("")}const Ws=0,sn=1,an=2,Lo=5;var Ue,Xs,_e;class Oo{constructor(t){_(this,Ue);_(this,Xs);_(this,_e);h(this,Ue,t),h(this,Xs,new DataView(t.buffer,t.byteOffset,t.byteLength)),h(this,_e,0)}varint(){let t=0;for(let s=0;;s+=7){const a=d(this,Ue)[es(this,_e)._++];if(t|=(a&127)<<s,!(a&128))break}return t}varintBig(){let t=0n;for(let s=0n;;s+=7n){const a=d(this,Ue)[es(this,_e)._++];if(t|=BigInt(a&127)<<s,!(a&128))break}return t}bytes(t){const s=new Uint8Array(d(this,Ue).buffer,d(this,Ue).byteOffset+d(this,_e),t);return h(this,_e,d(this,_e)+t),s}double(){const t=d(this,Xs).getFloat64(d(this,_e),!0);return h(this,_e,d(this,_e)+8),t}skipVarint(){for(;d(this,Ue)[es(this,_e)._++]&128;);}skip(t){h(this,_e,d(this,_e)+t)}eof(){return d(this,_e)>=d(this,Ue).byteLength}}Ue=new WeakMap,Xs=new WeakMap,_e=new WeakMap;var me,ce,Bt,Ps;class jo{constructor(t){_(this,Bt);_(this,me);_(this,ce);h(this,me,t),h(this,ce,-1)}setup(t){h(this,ce,t)}bytes(){S(this,Bt,Ps).call(this,an);const t=d(this,me).varint();return d(this,me).bytes(t)}string(){return new TextDecoder().decode(this.bytes())}message(t){return qa(this.bytes(),t)}int32(){return S(this,Bt,Ps).call(this,Ws),d(this,me).varint()}uint32(){return this.int32()}bool(){return this.int32()!==0}uint64(){return S(this,Bt,Ps).call(this,Ws),d(this,me).varintBig()}sint64(){const t=this.uint64();return t>>1n^-(t&1n)}double(){return S(this,Bt,Ps).call(this,sn),d(this,me).double()}maybeSkip(){if(!(d(this,ce)<0)){if(d(this,ce)===Ws)d(this,me).skipVarint();else if(d(this,ce)===sn)d(this,me).skip(8);else if(d(this,ce)===an){const t=d(this,me).varint();d(this,me).skip(t)}else if(d(this,ce)===Lo)d(this,me).skip(4);else throw new j(`Unexpected wire type ${d(this,ce)}`);h(this,ce,-1)}}}me=new WeakMap,ce=new WeakMap,Bt=new WeakSet,Ps=function(t){if(d(this,ce)!==t)throw new j(`Expected wire type ${t}, got ${d(this,ce)}`);h(this,ce,-1)};function qa(e,t){const s=new Oo(e),a=new jo(s);let n=t.default();for(;!s.eof();){const l=s.varint(),i=l>>3,r=l&7;a.setup(r);const c=t[i];if(c!==void 0){const o=c(a,n);o!==void 0&&(n=o)}a.maybeSkip()}return n}var Te,wt,cs,be,se,Ns,ka,di,qs;const Qn=class Qn{constructor(){_(this,se);_(this,Te);_(this,wt);_(this,cs);_(this,be);h(this,Te,new ArrayBuffer(256)),h(this,wt,new Uint8Array(d(this,Te))),h(this,cs,new DataView(d(this,Te))),h(this,be,0)}bytes(t,s){S(this,se,qs).call(this,t,an),S(this,se,ka).call(this,s.byteLength),S(this,se,Ns).call(this,s.byteLength),d(this,wt).set(s,d(this,be)),h(this,be,d(this,be)+s.byteLength)}string(t,s){this.bytes(t,new TextEncoder().encode(s))}message(t,s,a){const n=new Qn;a(n,s),this.bytes(t,n.data())}int32(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,ka).call(this,s)}uint32(t,s){this.int32(t,s)}bool(t,s){this.int32(t,s?1:0)}sint64(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,di).call(this,s<<1n^s>>63n)}double(t,s){S(this,se,qs).call(this,t,sn),S(this,se,Ns).call(this,8),d(this,cs).setFloat64(d(this,be),s,!0),h(this,be,d(this,be)+8)}data(){return new Uint8Array(d(this,Te),0,d(this,be))}};Te=new WeakMap,wt=new WeakMap,cs=new WeakMap,be=new WeakMap,se=new WeakSet,Ns=function(t){if(d(this,be)+t<=d(this,Te).byteLength)return;let s=d(this,Te).byteLength;for(;s<d(this,be)+t;)s*=2;const a=new ArrayBuffer(s),n=new Uint8Array(a),l=new DataView(a);n.set(new Uint8Array(d(this,Te),0,d(this,be))),h(this,Te,a),h(this,wt,n),h(this,cs,l)},ka=function(t){S(this,se,Ns).call(this,5),t=0|t;do{let s=t&127;t>>>=7,s|=t?128:0,d(this,wt)[es(this,be)._++]=s}while(t)},di=function(t){S(this,se,Ns).call(this,10),t=t&0xffffffffffffffffn;do{let s=Number(t&0x7fn);t>>=7n,s|=t?128:0,d(this,wt)[es(this,be)._++]=s}while(t)},qs=function(t,s){S(this,se,ka).call(this,t<<3|s)};let nn=Qn;function pi(e,t){const s=new nn;return t(s,e),s.data()}var Se,et;class Bs{constructor(){_(this,Se);_(this,et);h(this,Se,new Set),h(this,et,new Set)}alloc(){for(const s of d(this,et))return d(this,et).delete(s),d(this,Se).add(s),d(this,Se).has(d(this,Se).size-1)||d(this,et).add(d(this,Se).size-1),s;const t=d(this,Se).size;return d(this,Se).add(t),t}free(t){if(!d(this,Se).delete(t))throw new At("Freeing an id that is not allocated");d(this,et).delete(d(this,Se).size),t<d(this,Se).size&&d(this,et).add(t)}}Se=new WeakMap,et=new WeakMap;function Q(e,t){throw new At(t)}function zs(e){if(e===null)return null;if(typeof e=="string")return e;if(typeof e=="number"){if(!Number.isFinite(e))throw new RangeError("Only finite numbers (not Infinity or NaN) can be passed as arguments");return e}else if(typeof e=="bigint"){if(e<Po||e>No)throw new RangeError("This bigint value is too large to be represented as a 64-bit integer and passed as argument");return e}else{if(typeof e=="boolean")return e?1n:0n;if(e instanceof ArrayBuffer)return new Uint8Array(e);if(e instanceof Uint8Array)return e;if(e instanceof Date)return+e.valueOf();if(typeof e=="object")return""+e.toString();throw new TypeError("Unsupported type of value")}}const Po=-9223372036854775808n,No=9223372036854775807n;function ui(e,t){if(e===null)return null;if(typeof e=="number")return e;if(typeof e=="string")return e;if(typeof e=="bigint")if(t==="number"){const s=Number(e);if(!Number.isSafeInteger(s))throw new RangeError("Received integer which is too large to be safely represented as a JavaScript number");return s}else{if(t==="bigint")return e;if(t==="string")return""+e;throw new Ls("Invalid value for IntMode")}else{if(e instanceof Uint8Array)return e.slice().buffer;throw e===void 0?new j("Received unrecognized type of Value"):Q(e,"Impossible type of Value")}}function fa(e){return{affectedRowCount:e.affectedRowCount,lastInsertRowid:e.lastInsertRowid,columnNames:e.cols.map(t=>t.name),columnDecltypes:e.cols.map(t=>t.decltype)}}function xi(e,t){const s=fa(e),a=e.rows.map(n=>bi(s.columnNames,n,t));return{...s,rows:a}}function fi(e,t){const s=fa(e);let a;return e.rows.length>0&&(a=bi(s.columnNames,e.rows[0],t)),{...s,row:a}}function mi(e,t){const s=fa(e);let a;return e.rows.length>0&&s.columnNames.length>0&&(a=ui(e.rows[0][0],t)),{...s,value:a}}function bi(e,t,s){const a={};Object.defineProperty(a,"length",{value:t.length});for(let n=0;n<t.length;++n){const l=ui(t[n],s);Object.defineProperty(a,n,{value:l});const i=e[n];i!==void 0&&!Object.hasOwn(a,i)&&Object.defineProperty(a,i,{value:l,enumerable:!0,configurable:!0,writable:!0})}return a}function As(e){return new ri(e.message,e)}var ds,ps,tt;class En{constructor(t,s){_(this,ds);_(this,ps);_(this,tt);h(this,ds,t),h(this,ps,s),h(this,tt,void 0)}_getSqlId(t){if(d(this,ds)!==t)throw new Ls("Attempted to use SQL text opened with other object");if(d(this,tt)!==void 0)throw new Ae("SQL text is closed",d(this,tt));return d(this,ps)}close(){this._setClosed(new K("SQL text was manually closed"))}_setClosed(t){d(this,tt)===void 0&&(h(this,tt,t),d(this,ds)._closeSql(d(this,ps)))}get closed(){return d(this,tt)!==void 0}}ds=new WeakMap,ps=new WeakMap,tt=new WeakMap;function ln(e,t){return t instanceof En?{sqlId:t._getSqlId(e)}:{sql:""+t}}var He,Me;class Ca{constructor(){_(this,He);_(this,Me);h(this,He,[]),h(this,Me,[])}get length(){return d(this,He).length+d(this,Me).length}push(t){d(this,He).push(t)}shift(){return d(this,Me).length===0&&d(this,He).length>0&&(h(this,Me,d(this,He).reverse()),h(this,He,[])),d(this,Me).pop()}first(){return d(this,Me).length!==0?d(this,Me)[d(this,Me).length-1]:d(this,He)[0]}}He=new WeakMap,Me=new WeakMap;let hi=class{constructor(t){q(this,"sql");q(this,"_args");q(this,"_namedArgs");this.sql=t,this._args=[],this._namedArgs=new Map}bindIndexes(t){this._args.length=0;for(const s of t)this._args.push(zs(s));return this}bindIndex(t,s){if(t!==(t|0)||t<=0)throw new RangeError("Index of a positional argument must be positive integer");for(;this._args.length<t;)this._args.push(null);return this._args[t-1]=zs(s),this}bindName(t,s){return this._namedArgs.set(t,zs(s)),this}unbindAll(){return this._args.length=0,this._namedArgs.clear(),this}};function gi(e,t,s){let a,n=[],l=[];if(t instanceof hi){a=t.sql,n=t._args;for(const[c,o]of t._namedArgs.entries())l.push({name:c,value:o})}else Array.isArray(t)?(a=t[0],Array.isArray(t[1])?n=t[1].map(c=>zs(c)):l=Object.entries(t[1]).map(([c,o])=>({name:c,value:zs(o)}))):a=t;const{sql:i,sqlId:r}=ln(e,a);return{sql:i,sqlId:r,args:n,namedArgs:l,wantRows:s}}var Zs,us,Ol;let qo=(Ol=class{constructor(t,s){q(this,"_stream");_(this,Zs);q(this,"_steps");_(this,us);this._stream=t,h(this,Zs,s),this._steps=[],h(this,us,!1)}step(){return new Vo(this)}execute(){if(d(this,us))throw new Ls("This batch has already been executed");h(this,us,!0);const t={steps:this._steps.map(s=>s.proto)};return d(this,Zs)?Fo(this._stream,this._steps,t):Bo(this._stream,this._steps,t)}},Zs=new WeakMap,us=new WeakMap,Ol);function Bo(e,t,s){return e._batch(s).then(a=>{for(let n=0;n<t.length;++n){const l=a.stepResults.get(n),i=a.stepErrors.get(n);t[n].callback(l,i)}})}async function Fo(e,t,s){const a=await e._openCursor(s);try{let n=0,l,i=[];for(;;){const r=await a.next();if(r===void 0)break;if(r.type==="step_begin"){if(r.step<n||r.step>=t.length)throw new j("Server produced StepBeginEntry for unexpected step");if(l!==void 0)throw new j("Server produced StepBeginEntry before terminating previous step");for(let c=n;c<r.step;++c)t[c].callback(void 0,void 0);n=r.step+1,l=r,i=[]}else if(r.type==="step_end"){if(l===void 0)throw new j("Server produced StepEndEntry but no step is active");const c={cols:l.cols,rows:i,affectedRowCount:r.affectedRowCount,lastInsertRowid:r.lastInsertRowid};t[l.step].callback(c,void 0),l=void 0,i=[]}else if(r.type==="step_error"){if(l===void 0){if(r.step>=t.length)throw new j("Server produced StepErrorEntry for unexpected step");for(let c=n;c<r.step;++c)t[c].callback(void 0,void 0)}else{if(r.step!==l.step)throw new j("Server produced StepErrorEntry for unexpected step");l=void 0,i=[]}t[r.step].callback(void 0,r.error),n=r.step+1}else if(r.type==="row"){if(l===void 0)throw new j("Server produced RowEntry but no step is active");i.push(r.row)}else throw r.type==="error"?As(r.error):r.type==="none"?new j("Server produced unrecognized CursorEntry"):Q(r,"Impossible CursorEntry")}if(l!==void 0)throw new j("Server closed Cursor before terminating active step");for(let r=n;r<t.length;++r)t[r].callback(void 0,void 0)}finally{a.close()}}var st,Ft,Fs,jl;let Vo=(jl=class{constructor(t){_(this,Ft);q(this,"_batch");_(this,st);q(this,"_index");this._batch=t,h(this,st,[]),this._index=void 0}condition(t){return d(this,st).push(t._proto),this}query(t){return S(this,Ft,Fs).call(this,t,!0,xi)}queryRow(t){return S(this,Ft,Fs).call(this,t,!0,fi)}queryValue(t){return S(this,Ft,Fs).call(this,t,!0,mi)}run(t){return S(this,Ft,Fs).call(this,t,!1,fa)}},st=new WeakMap,Ft=new WeakSet,Fs=function(t,s,a){if(this._index!==void 0)throw new Ls("This BatchStep has already been added to the batch");const n=gi(this._batch._stream._sqlOwner(),t,s);let l;d(this,st).length===0?l=void 0:d(this,st).length===1?l=d(this,st)[0]:l={type:"and",conds:d(this,st).slice()};const i={stmt:n,condition:l};return new Promise((r,c)=>{const o=(u,m)=>{u!==void 0&&m!==void 0?c(new j("Server returned both result and error")):m!==void 0?c(As(m)):r(u!==void 0?a(u,this._batch._stream.intMode):void 0)};this._index=this._batch._steps.length,this._batch._steps.push({proto:i,callback:o})})},jl),ve=class jt{constructor(t,s){q(this,"_batch");q(this,"_proto");this._batch=t,this._proto=s}static ok(t){return new jt(t._batch,{type:"ok",step:ol(t)})}static error(t){return new jt(t._batch,{type:"error",step:ol(t)})}static not(t){return new jt(t._batch,{type:"not",cond:t._proto})}static and(t,s){for(const a of s)cl(t,a);return new jt(t,{type:"and",conds:s.map(a=>a._proto)})}static or(t,s){for(const a of s)cl(t,a);return new jt(t,{type:"or",conds:s.map(a=>a._proto)})}static isAutocommit(t){return t._stream.client()._ensureVersion(3,"BatchCond.isAutocommit()"),new jt(t,{type:"is_autocommit"})}};function ol(e){if(e._index===void 0)throw new Ls("Cannot add a condition referencing a step that has not been added to the batch");return e._index}function cl(e,t){if(t._batch!==e)throw new Ls("Cannot mix BatchCond objects for different Batch objects")}function Uo(e){return{paramNames:e.params.map(t=>t.name),columns:e.cols,isExplain:e.isExplain,isReadonly:e.isReadonly}}var Vt,Vs;class wi{constructor(t){_(this,Vt);q(this,"intMode");this.intMode=t}query(t){return S(this,Vt,Vs).call(this,t,!0,xi)}queryRow(t){return S(this,Vt,Vs).call(this,t,!0,fi)}queryValue(t){return S(this,Vt,Vs).call(this,t,!0,mi)}run(t){return S(this,Vt,Vs).call(this,t,!1,fa)}batch(t=!1){return new qo(this,t)}describe(t){const s=ln(this._sqlOwner(),t);return this._describe(s).then(Uo)}sequence(t){const s=ln(this._sqlOwner(),t);return this._sequence(s)}}Vt=new WeakSet,Vs=function(t,s,a){const n=gi(this._sqlOwner(),t,s);return this._execute(n).then(l=>a(l,this.intMode))};class vi{}const Ho=1e3,Go=10;var ja,Ut,xs,fs,Ht,at,Gt,Pa,yi;class Wo extends vi{constructor(s,a,n){super();_(this,Pa);_(this,ja);_(this,Ut);_(this,xs);_(this,fs);_(this,Ht);_(this,at);_(this,Gt);h(this,ja,s),h(this,Ut,a),h(this,xs,n),h(this,fs,new Ca),h(this,Ht,new Ca),h(this,at,void 0),h(this,Gt,!1)}async next(){for(;;){if(d(this,at)!==void 0)throw new Ae("Cursor is closed",d(this,at));for(;!d(this,Gt)&&d(this,Ht).length<Go;)d(this,Ht).push(S(this,Pa,yi).call(this));const s=d(this,fs).shift();if(d(this,Gt)||s!==void 0)return s;await d(this,Ht).shift().then(a=>{if(a!==void 0){for(const n of a.entries)d(this,fs).push(n);d(this,Gt)||h(this,Gt,a.done)}})}}_setClosed(s){d(this,at)===void 0&&(h(this,at,s),d(this,Ut)._sendCursorRequest(this,{type:"close_cursor",cursorId:d(this,xs)}).catch(()=>{}),d(this,Ut)._cursorClosed(this))}close(){this._setClosed(new K("Cursor was manually closed"))}get closed(){return d(this,at)!==void 0}}ja=new WeakMap,Ut=new WeakMap,xs=new WeakMap,fs=new WeakMap,Ht=new WeakMap,at=new WeakMap,Gt=new WeakMap,Pa=new WeakSet,yi=function(){return d(this,Ut)._sendCursorRequest(this,{type:"fetch_cursor",cursorId:d(this,xs),maxCount:Ho}).then(s=>s,s=>{this._setClosed(s)})};var ne,Ce,nt,$e,vt,De,Z,ts,on,_a,Sa;const Xn=class Xn extends wi{constructor(s,a){super(s.intMode);_(this,Z);_(this,ne);_(this,Ce);_(this,nt);_(this,$e);_(this,vt);_(this,De);h(this,ne,s),h(this,Ce,a),h(this,nt,new Ca),h(this,$e,void 0),h(this,vt,!1),h(this,De,void 0)}static open(s){const a=s._streamIdAlloc.alloc(),n=new Xn(s,a),l=()=>{},i=c=>{var o;return S(o=n,Z,Sa).call(o,c)},r={type:"open_stream",streamId:a};return s._sendRequest(r,{responseCallback:l,errorCallback:i}),n}client(){return d(this,ne)}_sqlOwner(){return d(this,ne)}_execute(s){return S(this,Z,ts).call(this,{type:"execute",streamId:d(this,Ce),stmt:s}).then(a=>a.result)}_batch(s){return S(this,Z,ts).call(this,{type:"batch",streamId:d(this,Ce),batch:s}).then(a=>a.result)}_describe(s){return d(this,ne)._ensureVersion(2,"describe()"),S(this,Z,ts).call(this,{type:"describe",streamId:d(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return d(this,ne)._ensureVersion(2,"sequence()"),S(this,Z,ts).call(this,{type:"sequence",streamId:d(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return d(this,ne)._ensureVersion(3,"getAutocommit()"),S(this,Z,ts).call(this,{type:"get_autocommit",streamId:d(this,Ce)}).then(s=>s.isAutocommit)}_openCursor(s){return d(this,ne)._ensureVersion(3,"cursor"),new Promise((a,n)=>{S(this,Z,on).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_sendCursorRequest(s,a){if(s!==d(this,$e))throw new At("Cursor not associated with the stream attempted to execute a request");return new Promise((n,l)=>{d(this,De)!==void 0?l(new Ae("Stream is closed",d(this,De))):d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})})}_cursorClosed(s){if(s!==d(this,$e))throw new At("Cursor was closed, but it was not associated with the stream");h(this,$e,void 0),S(this,Z,_a).call(this)}close(){S(this,Z,Sa).call(this,new K("Stream was manually closed"))}closeGracefully(){h(this,vt,!0),S(this,Z,_a).call(this)}get closed(){return d(this,De)!==void 0||d(this,vt)}};ne=new WeakMap,Ce=new WeakMap,nt=new WeakMap,$e=new WeakMap,vt=new WeakMap,De=new WeakMap,Z=new WeakSet,ts=function(s){return new Promise((a,n)=>{S(this,Z,on).call(this,{type:"request",request:s,responseCallback:a,errorCallback:n})})},on=function(s){d(this,De)!==void 0?s.errorCallback(new Ae("Stream is closed",d(this,De))):d(this,vt)?s.errorCallback(new Ae("Stream is closing",void 0)):(d(this,nt).push(s),S(this,Z,_a).call(this))},_a=function(){for(;;){const s=d(this,nt).first();if(s===void 0&&d(this,$e)===void 0&&d(this,vt)){S(this,Z,Sa).call(this,new K("Stream was gracefully closed"));break}else if((s==null?void 0:s.type)==="request"&&d(this,$e)===void 0){const{request:a,responseCallback:n,errorCallback:l}=s;d(this,nt).shift(),d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})}else if((s==null?void 0:s.type)==="cursor"&&d(this,$e)===void 0){const{batch:a,cursorCallback:n}=s;d(this,nt).shift();const l=d(this,ne)._cursorIdAlloc.alloc(),i=new Wo(d(this,ne),this,l),r={type:"open_cursor",streamId:d(this,Ce),cursorId:l,batch:a},c=()=>{},o=u=>i._setClosed(u);d(this,ne)._sendRequest(r,{responseCallback:c,errorCallback:o}),h(this,$e,i),n(i)}else break}},Sa=function(s){if(d(this,De)!==void 0)return;for(h(this,De,s),d(this,$e)!==void 0&&d(this,$e)._setClosed(s);;){const i=d(this,nt).shift();if(i!==void 0)i.errorCallback(s);else break}const a={type:"close_stream",streamId:d(this,Ce)},n=()=>d(this,ne)._streamIdAlloc.free(d(this,Ce)),l=()=>{};d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})};let rn=Xn;function In(e,t){t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId),e.arrayObjects("args",t.args,ki),e.arrayObjects("named_args",t.namedArgs,zo),e.boolean("want_rows",t.wantRows)}function zo(e,t){e.string("name",t.name),e.object("value",t.value,ki)}function Ra(e,t){e.arrayObjects("steps",t.steps,Yo)}function Yo(e,t){t.condition!==void 0&&e.object("condition",t.condition,cn),e.object("stmt",t.stmt,In)}function cn(e,t){if(e.stringRaw("type",t.type),t.type==="ok"||t.type==="error")e.number("step",t.step);else if(t.type==="not")e.object("cond",t.cond,cn);else if(t.type==="and"||t.type==="or")e.arrayObjects("conds",t.conds,cn);else if(t.type!=="is_autocommit")throw Q(t,"Impossible type of BatchCond")}function ki(e,t){if(t===null)e.stringRaw("type","null");else if(typeof t=="bigint")e.stringRaw("type","integer"),e.stringRaw("value",""+t);else if(typeof t=="number")e.stringRaw("type","float"),e.number("value",t);else if(typeof t=="string")e.stringRaw("type","text"),e.string("value",t);else if(t instanceof Uint8Array)e.stringRaw("type","blob"),e.stringRaw("base64",Sn.fromUint8Array(t));else if(t!==void 0)throw Q(t,"Impossible type of Value")}function Jo(e,t){if(e.stringRaw("type",t.type),t.type==="hello")t.jwt!==void 0&&e.string("jwt",t.jwt);else if(t.type==="request")e.number("request_id",t.requestId),e.object("request",t.request,Ko);else throw Q(t,"Impossible type of ClientMsg")}function Ko(e,t){if(e.stringRaw("type",t.type),t.type==="open_stream")e.number("stream_id",t.streamId);else if(t.type==="close_stream")e.number("stream_id",t.streamId);else if(t.type==="execute")e.number("stream_id",t.streamId),e.object("stmt",t.stmt,In);else if(t.type==="batch")e.number("stream_id",t.streamId),e.object("batch",t.batch,Ra);else if(t.type==="open_cursor")e.number("stream_id",t.streamId),e.number("cursor_id",t.cursorId),e.object("batch",t.batch,Ra);else if(t.type==="close_cursor")e.number("cursor_id",t.cursorId);else if(t.type==="fetch_cursor")e.number("cursor_id",t.cursorId),e.number("max_count",t.maxCount);else if(t.type==="sequence")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type==="get_autocommit")e.number("stream_id",t.streamId);else throw Q(t,"Impossible type of Request")}function Cn(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId);for(const s of t.args)e.message(3,s,_i);for(const s of t.namedArgs)e.message(4,s,Qo);e.bool(5,t.wantRows)}function Qo(e,t){e.string(1,t.name),e.message(2,t.value,_i)}function Ba(e,t){for(const s of t.steps)e.message(1,s,Xo)}function Xo(e,t){t.condition!==void 0&&e.message(1,t.condition,Rn),e.message(2,t.stmt,Cn)}function Rn(e,t){if(t.type==="ok")e.uint32(1,t.step);else if(t.type==="error")e.uint32(2,t.step);else if(t.type==="not")e.message(3,t.cond,Rn);else if(t.type==="and")e.message(4,t.conds,dl);else if(t.type==="or")e.message(5,t.conds,dl);else if(t.type==="is_autocommit")e.message(6,void 0,Si);else throw Q(t,"Impossible type of BatchCond")}function dl(e,t){for(const s of t)e.message(1,s,Rn)}function _i(e,t){if(t===null)e.message(1,void 0,Si);else if(typeof t=="bigint")e.sint64(2,t);else if(typeof t=="number")e.double(3,t);else if(typeof t=="string")e.string(4,t);else if(t instanceof Uint8Array)e.bytes(5,t);else if(t!==void 0)throw Q(t,"Impossible type of Value")}function Si(e,t){}function Zo(e,t){if(t.type==="hello")e.message(1,t,ec);else if(t.type==="request")e.message(2,t,tc);else throw Q(t,"Impossible type of ClientMsg")}function ec(e,t){t.jwt!==void 0&&e.string(1,t.jwt)}function tc(e,t){e.int32(1,t.requestId);const s=t.request;if(s.type==="open_stream")e.message(2,s,sc);else if(s.type==="close_stream")e.message(3,s,ac);else if(s.type==="execute")e.message(4,s,nc);else if(s.type==="batch")e.message(5,s,lc);else if(s.type==="open_cursor")e.message(6,s,ic);else if(s.type==="close_cursor")e.message(7,s,rc);else if(s.type==="fetch_cursor")e.message(8,s,oc);else if(s.type==="sequence")e.message(9,s,cc);else if(s.type==="describe")e.message(10,s,dc);else if(s.type==="store_sql")e.message(11,s,pc);else if(s.type==="close_sql")e.message(12,s,uc);else if(s.type==="get_autocommit")e.message(13,s,xc);else throw Q(s,"Impossible type of Request")}function sc(e,t){e.int32(1,t.streamId)}function ac(e,t){e.int32(1,t.streamId)}function nc(e,t){e.int32(1,t.streamId),e.message(2,t.stmt,Cn)}function lc(e,t){e.int32(1,t.streamId),e.message(2,t.batch,Ba)}function ic(e,t){e.int32(1,t.streamId),e.int32(2,t.cursorId),e.message(3,t.batch,Ba)}function rc(e,t){e.int32(1,t.cursorId)}function oc(e,t){e.int32(1,t.cursorId),e.uint32(2,t.maxCount)}function cc(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function dc(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function pc(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function uc(e,t){e.int32(1,t.sqlId)}function xc(e,t){e.int32(1,t.streamId)}function Ts(e){const t=qe(e.message),s=Fe(e.code);return{message:t,code:s}}function An(e){const t=Tt(e.cols,$i),s=Ia(e.rows).map(i=>Tt(i,Ri)),a=Xt(e.affected_row_count),n=Fe(e.last_insert_rowid),l=n!==void 0?BigInt(n):void 0;return{cols:t,rows:s,affectedRowCount:a,lastInsertRowid:l}}function $i(e){const t=Fe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function Ei(e){const t=new Map;Ia(e.step_results).forEach((a,n)=>{a!==null&&t.set(n,An(ie(a)))});const s=new Map;return Ia(e.step_errors).forEach((a,n)=>{a!==null&&s.set(n,Ts(ie(a)))}),{stepResults:t,stepErrors:s}}function Ii(e){const t=qe(e.type);if(t==="step_begin"){const s=Xt(e.step),a=Tt(e.cols,$i);return{type:"step_begin",step:s,cols:a}}else if(t==="step_end"){const s=Xt(e.affected_row_count),a=Fe(e.last_insert_rowid),n=a!==void 0?BigInt(a):void 0;return{type:"step_end",affectedRowCount:s,lastInsertRowid:n}}else if(t==="step_error"){const s=Xt(e.step),a=Ts(ie(e.error));return{type:"step_error",step:s,error:a}}else{if(t==="row")return{type:"row",row:Tt(e.row,Ri)};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of CursorEntry")}}function Ci(e){const t=Tt(e.params,fc),s=Tt(e.cols,mc),a=Qs(e.is_explain),n=Qs(e.is_readonly);return{params:t,cols:s,isExplain:a,isReadonly:n}}function fc(e){return{name:Fe(e.name)}}function mc(e){const t=qe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function Ri(e){const t=qe(e.type);if(t==="null")return null;if(t==="integer"){const s=qe(e.value);return BigInt(s)}else{if(t==="float")return Xt(e.value);if(t==="text")return qe(e.value);if(t==="blob")return Sn.toUint8Array(qe(e.base64));throw new j("Unexpected type of Value")}}function bc(e){const t=qe(e.type);if(t==="hello_ok")return{type:"hello_ok"};if(t==="hello_error")return{type:"hello_error",error:Ts(ie(e.error))};if(t==="response_ok"){const s=Xt(e.request_id),a=hc(ie(e.response));return{type:"response_ok",requestId:s,response:a}}else if(t==="response_error"){const s=Xt(e.request_id),a=Ts(ie(e.error));return{type:"response_error",requestId:s,error:a}}else throw new j("Unexpected type of ServerMsg")}function hc(e){const t=qe(e.type);if(t==="open_stream")return{type:"open_stream"};if(t==="close_stream")return{type:"close_stream"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:Ei(ie(e.result))};if(t==="open_cursor")return{type:"open_cursor"};if(t==="close_cursor")return{type:"close_cursor"};if(t==="fetch_cursor"){const s=Tt(e.entries,Ii),a=Qs(e.done);return{type:"fetch_cursor",entries:s,done:a}}else{if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:Ci(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of Response")}}const Je={default(){return{message:"",code:void 0}},1(e,t){t.message=e.string()},2(e,t){t.code=e.string()}},Ms={default(){return{cols:[],rows:[],affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.cols.push(e.message(Ai))},2(e,t){t.rows.push(e.message(Ti))},3(e,t){t.affectedRowCount=Number(e.uint64())},4(e,t){t.lastInsertRowid=e.sint64()}},Ai={default(){return{name:void 0,decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},Ti={default(){return[]},1(e,t){t.push(e.message($c))}},Aa={default(){return{stepResults:new Map,stepErrors:new Map}},1(e,t){const[s,a]=e.message(gc);t.stepResults.set(s,a)},2(e,t){const[s,a]=e.message(wc);t.stepErrors.set(s,a)}},gc={default(){return[0,Ms.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Ms)}},wc={default(){return[0,Je.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Je)}},Mi={default(){return{type:"none"}},1(e){return e.message(vc)},2(e){return e.message(yc)},3(e){return e.message(kc)},4(e){return{type:"row",row:e.message(Ti)}},5(e){return{type:"error",error:e.message(Je)}}},vc={default(){return{type:"step_begin",step:0,cols:[]}},1(e,t){t.step=e.uint32()},2(e,t){t.cols.push(e.message(Ai))}},yc={default(){return{type:"step_end",affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.affectedRowCount=e.uint32()},2(e,t){t.lastInsertRowid=e.uint64()}},kc={default(){return{type:"step_error",step:0,error:Je.default()}},1(e,t){t.step=e.uint32()},2(e,t){t.error=e.message(Je)}},Ta={default(){return{params:[],cols:[],isExplain:!1,isReadonly:!1}},1(e,t){t.params.push(e.message(_c))},2(e,t){t.cols.push(e.message(Sc))},3(e,t){t.isExplain=e.bool()},4(e,t){t.isReadonly=e.bool()}},_c={default(){return{name:void 0}},1(e,t){t.name=e.string()}},Sc={default(){return{name:"",decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},$c={default(){},1(e){return null},2(e){return e.sint64()},3(e){return e.double()},4(e){return e.string()},5(e){return e.bytes()}},Ec={default(){return{type:"none"}},1(e){return{type:"hello_ok"}},2(e){return e.message(Ic)},3(e){return e.message(Rc)},4(e){return e.message(Cc)}},Ic={default(){return{type:"hello_error",error:Je.default()}},1(e,t){t.error=e.message(Je)}},Cc={default(){return{type:"response_error",requestId:0,error:Je.default()}},1(e,t){t.requestId=e.int32()},2(e,t){t.error=e.message(Je)}},Rc={default(){return{type:"response_ok",requestId:0,response:{type:"none"}}},1(e,t){t.requestId=e.int32()},2(e,t){t.response={type:"open_stream"}},3(e,t){t.response={type:"close_stream"}},4(e,t){t.response=e.message(Ac)},5(e,t){t.response=e.message(Tc)},6(e,t){t.response={type:"open_cursor"}},7(e,t){t.response={type:"close_cursor"}},8(e,t){t.response=e.message(Mc)},9(e,t){t.response={type:"sequence"}},10(e,t){t.response=e.message(Dc)},11(e,t){t.response={type:"store_sql"}},12(e,t){t.response={type:"close_sql"}},13(e,t){t.response=e.message(Lc)}},Ac={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},Tc={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},Mc={default(){return{type:"fetch_cursor",entries:[],done:!1}},1(e,t){t.entries.push(e.message(Mi))},2(e,t){t.done=e.bool()}},Dc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Lc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Oc=new Map([["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]),Di=new Map([["hrana3-protobuf",{version:3,encoding:"protobuf"}],["hrana3",{version:3,encoding:"json"}],["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]);var re,Ge,Wt,he,zt,ge,ms,Le,yt,bs,V,dn,Li,pn,Oi,ji,Ve,Pi,Ni,Pl;let jc=(Pl=class extends ii{constructor(s,a){super();_(this,V);_(this,re);_(this,Ge);_(this,Wt);_(this,he);_(this,zt);_(this,ge);_(this,ms);_(this,Le);_(this,yt);q(this,"_streamIdAlloc");q(this,"_cursorIdAlloc");_(this,bs);h(this,re,s),h(this,Ge,[]),h(this,Wt,!1),h(this,he,void 0),h(this,zt,!1),h(this,ge,void 0),h(this,ms,!1),h(this,Le,new Map),h(this,yt,new Bs),this._streamIdAlloc=new Bs,this._cursorIdAlloc=new Bs,h(this,bs,new Bs),d(this,re).binaryType="arraybuffer",d(this,re).addEventListener("open",()=>S(this,V,Li).call(this)),d(this,re).addEventListener("close",n=>S(this,V,ji).call(this,n)),d(this,re).addEventListener("error",n=>S(this,V,Oi).call(this,n)),d(this,re).addEventListener("message",n=>S(this,V,Pi).call(this,n)),S(this,V,dn).call(this,{type:"hello",jwt:a})}getVersion(){return new Promise((s,a)=>{if(h(this,ms,!0),d(this,he)!==void 0)a(d(this,he));else if(d(this,Wt))s(d(this,ge).version);else{const n=()=>s(d(this,ge).version);d(this,Ge).push({openCallback:n,errorCallback:a})}})}_ensureVersion(s,a){if(d(this,ge)===void 0||!d(this,ms))throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the WebSocket server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(d(this,ge).version<s)throw new Rs(`${a} is supported on protocol version ${s} and higher, but the WebSocket server only supports version ${d(this,ge).version}`)}_sendRequest(s,a){if(d(this,he)!==void 0){a.errorCallback(new Ae("Client is closed",d(this,he)));return}const n=d(this,yt).alloc();d(this,Le).set(n,{...a,type:s.type}),S(this,V,dn).call(this,{type:"request",requestId:n,request:s})}openStream(){return rn.open(this)}storeSql(s){this._ensureVersion(2,"storeSql()");const a=d(this,bs).alloc(),n=new En(this,a),l=()=>{},i=c=>n._setClosed(c),r={type:"store_sql",sqlId:a,sql:s};return this._sendRequest(r,{responseCallback:l,errorCallback:i}),n}_closeSql(s){if(d(this,he)!==void 0)return;const a=()=>d(this,bs).free(s),n=i=>S(this,V,Ve).call(this,i),l={type:"close_sql",sqlId:s};this._sendRequest(l,{responseCallback:a,errorCallback:n})}close(){S(this,V,Ve).call(this,new K("Client was manually closed"))}get closed(){return d(this,he)!==void 0}},re=new WeakMap,Ge=new WeakMap,Wt=new WeakMap,he=new WeakMap,zt=new WeakMap,ge=new WeakMap,ms=new WeakMap,Le=new WeakMap,yt=new WeakMap,bs=new WeakMap,V=new WeakSet,dn=function(s){if(d(this,he)!==void 0)throw new At("Trying to send a message on a closed client");if(d(this,Wt))S(this,V,pn).call(this,s);else{const a=()=>S(this,V,pn).call(this,s),n=()=>{};d(this,Ge).push({openCallback:a,errorCallback:n})}},Li=function(){const s=d(this,re).protocol;if(s===void 0){S(this,V,Ve).call(this,new K("The `WebSocket.protocol` property is undefined. This most likely means that the WebSocket implementation provided by the environment is broken. If you are using Miniflare 2, please update to Miniflare 3, which fixes this problem."));return}else if(s==="")h(this,ge,{version:1,encoding:"json"});else if(h(this,ge,Di.get(s)),d(this,ge)===void 0){S(this,V,Ve).call(this,new j(`Unrecognized WebSocket subprotocol: ${JSON.stringify(s)}`));return}for(const a of d(this,Ge))a.openCallback();d(this,Ge).length=0,h(this,Wt,!0)},pn=function(s){const a=d(this,ge).encoding;if(a==="json"){const n=ci(s,Jo);d(this,re).send(n)}else if(a==="protobuf"){const n=pi(s,Zo);d(this,re).send(n)}else throw Q(a,"Impossible encoding")},Oi=function(s){const n=s.message??"WebSocket was closed due to an error";S(this,V,Ve).call(this,new tn(n))},ji=function(s){let a=`WebSocket was closed with code ${s.code}`;s.reason&&(a+=`: ${s.reason}`),S(this,V,Ve).call(this,new tn(a))},Ve=function(s){if(d(this,he)===void 0){h(this,he,s);for(const a of d(this,Ge))a.errorCallback(s);d(this,Ge).length=0;for(const[a,n]of d(this,Le).entries())n.errorCallback(s),d(this,yt).free(a);d(this,Le).clear(),d(this,re).close()}},Pi=function(s){if(d(this,he)===void 0)try{let a;const n=d(this,ge).encoding;if(n==="json"){if(typeof s.data!="string"){d(this,re).close(3003,"Only text messages are accepted with JSON encoding"),S(this,V,Ve).call(this,new j("Received non-text message from server with JSON encoding"));return}a=$n(JSON.parse(s.data),bc)}else if(n==="protobuf"){if(!(s.data instanceof ArrayBuffer)){d(this,re).close(3003,"Only binary messages are accepted with Protobuf encoding"),S(this,V,Ve).call(this,new j("Received non-binary message from server with Protobuf encoding"));return}a=qa(new Uint8Array(s.data),Ec)}else throw Q(n,"Impossible encoding");S(this,V,Ni).call(this,a)}catch(a){d(this,re).close(3007,"Could not handle message"),S(this,V,Ve).call(this,a)}},Ni=function(s){if(s.type==="none")throw new j("Received an unrecognized ServerMsg");if(s.type==="hello_ok"||s.type==="hello_error"){if(d(this,zt))throw new j("Received a duplicated hello response");if(h(this,zt,!0),s.type==="hello_error")throw As(s.error);return}else if(!d(this,zt))throw new j("Received a non-hello message before a hello response");if(s.type==="response_ok"){const a=s.requestId,n=d(this,Le).get(a);if(d(this,Le).delete(a),n===void 0)throw new j("Received unexpected OK response");d(this,yt).free(a);try{if(n.type!==s.response.type)throw console.dir({responseState:n,msg:s}),new j("Received unexpected type of response");n.responseCallback(s.response)}catch(l){throw n.errorCallback(l),l}}else if(s.type==="response_error"){const a=s.requestId,n=d(this,Le).get(a);if(d(this,Le).delete(a),n===void 0)throw new j("Received unexpected error response");d(this,yt).free(a),n.errorCallback(As(s.error))}else throw Q(s,"Impossible ServerMsg type")},Pl);var ga=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Pc(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var un={exports:{}};(function(e,t){var s=typeof globalThis<"u"&&globalThis||typeof self<"u"&&self||typeof ga<"u"&&ga,a=function(){function l(){this.fetch=!1,this.DOMException=s.DOMException}return l.prototype=s,new l}();(function(l){(function(i){var r=typeof l<"u"&&l||typeof self<"u"&&self||typeof ga<"u"&&ga||{},c={searchParams:"URLSearchParams"in r,iterable:"Symbol"in r&&"iterator"in Symbol,blob:"FileReader"in r&&"Blob"in r&&function(){try{return new Blob,!0}catch{return!1}}(),formData:"FormData"in r,arrayBuffer:"ArrayBuffer"in r};function o(k){return k&&DataView.prototype.isPrototypeOf(k)}if(c.arrayBuffer)var u=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]"],m=ArrayBuffer.isView||function(k){return k&&u.indexOf(Object.prototype.toString.call(k))>-1};function b(k){if(typeof k!="string"&&(k=String(k)),/[^a-z0-9\-#$%&'*+.^_`|~!]/i.test(k)||k==="")throw new TypeError('Invalid character in header field name: "'+k+'"');return k.toLowerCase()}function y(k){return typeof k!="string"&&(k=String(k)),k}function w(k){var I={next:function(){var O=k.shift();return{done:O===void 0,value:O}}};return c.iterable&&(I[Symbol.iterator]=function(){return I}),I}function f(k){this.map={},k instanceof f?k.forEach(function(I,O){this.append(O,I)},this):Array.isArray(k)?k.forEach(function(I){if(I.length!=2)throw new TypeError("Headers constructor: expected name/value pair to be length 2, found"+I.length);this.append(I[0],I[1])},this):k&&Object.getOwnPropertyNames(k).forEach(function(I){this.append(I,k[I])},this)}f.prototype.append=function(k,I){k=b(k),I=y(I);var O=this.map[k];this.map[k]=O?O+", "+I:I},f.prototype.delete=function(k){delete this.map[b(k)]},f.prototype.get=function(k){return k=b(k),this.has(k)?this.map[k]:null},f.prototype.has=function(k){return this.map.hasOwnProperty(b(k))},f.prototype.set=function(k,I){this.map[b(k)]=y(I)},f.prototype.forEach=function(k,I){for(var O in this.map)this.map.hasOwnProperty(O)&&k.call(I,this.map[O],O,this)},f.prototype.keys=function(){var k=[];return this.forEach(function(I,O){k.push(O)}),w(k)},f.prototype.values=function(){var k=[];return this.forEach(function(I){k.push(I)}),w(k)},f.prototype.entries=function(){var k=[];return this.forEach(function(I,O){k.push([O,I])}),w(k)},c.iterable&&(f.prototype[Symbol.iterator]=f.prototype.entries);function x(k){if(!k._noBody){if(k.bodyUsed)return Promise.reject(new TypeError("Already read"));k.bodyUsed=!0}}function g(k){return new Promise(function(I,O){k.onload=function(){I(k.result)},k.onerror=function(){O(k.error)}})}function $(k){var I=new FileReader,O=g(I);return I.readAsArrayBuffer(k),O}function C(k){var I=new FileReader,O=g(I),U=/charset=([A-Za-z0-9_-]+)/.exec(k.type),G=U?U[1]:"utf-8";return I.readAsText(k,G),O}function E(k){for(var I=new Uint8Array(k),O=new Array(I.length),U=0;U<I.length;U++)O[U]=String.fromCharCode(I[U]);return O.join("")}function L(k){if(k.slice)return k.slice(0);var I=new Uint8Array(k.byteLength);return I.set(new Uint8Array(k)),I.buffer}function J(){return this.bodyUsed=!1,this._initBody=function(k){this.bodyUsed=this.bodyUsed,this._bodyInit=k,k?typeof k=="string"?this._bodyText=k:c.blob&&Blob.prototype.isPrototypeOf(k)?this._bodyBlob=k:c.formData&&FormData.prototype.isPrototypeOf(k)?this._bodyFormData=k:c.searchParams&&URLSearchParams.prototype.isPrototypeOf(k)?this._bodyText=k.toString():c.arrayBuffer&&c.blob&&o(k)?(this._bodyArrayBuffer=L(k.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):c.arrayBuffer&&(ArrayBuffer.prototype.isPrototypeOf(k)||m(k))?this._bodyArrayBuffer=L(k):this._bodyText=k=Object.prototype.toString.call(k):(this._noBody=!0,this._bodyText=""),this.headers.get("content-type")||(typeof k=="string"?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):c.searchParams&&URLSearchParams.prototype.isPrototypeOf(k)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},c.blob&&(this.blob=function(){var k=x(this);if(k)return k;if(this._bodyBlob)return Promise.resolve(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]));if(this._bodyFormData)throw new Error("could not read FormData body as blob");return Promise.resolve(new Blob([this._bodyText]))}),this.arrayBuffer=function(){if(this._bodyArrayBuffer){var k=x(this);return k||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer))}else{if(c.blob)return this.blob().then($);throw new Error("could not read as ArrayBuffer")}},this.text=function(){var k=x(this);if(k)return k;if(this._bodyBlob)return C(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(E(this._bodyArrayBuffer));if(this._bodyFormData)throw new Error("could not read FormData body as text");return Promise.resolve(this._bodyText)},c.formData&&(this.formData=function(){return this.text().then(M)}),this.json=function(){return this.text().then(JSON.parse)},this}var mt=["CONNECT","DELETE","GET","HEAD","OPTIONS","PATCH","POST","PUT","TRACE"];function Xe(k){var I=k.toUpperCase();return mt.indexOf(I)>-1?I:k}function xe(k,I){if(!(this instanceof xe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');I=I||{};var O=I.body;if(k instanceof xe){if(k.bodyUsed)throw new TypeError("Already read");this.url=k.url,this.credentials=k.credentials,I.headers||(this.headers=new f(k.headers)),this.method=k.method,this.mode=k.mode,this.signal=k.signal,!O&&k._bodyInit!=null&&(O=k._bodyInit,k.bodyUsed=!0)}else this.url=String(k);if(this.credentials=I.credentials||this.credentials||"same-origin",(I.headers||!this.headers)&&(this.headers=new f(I.headers)),this.method=Xe(I.method||this.method||"GET"),this.mode=I.mode||this.mode||null,this.signal=I.signal||this.signal||function(){if("AbortController"in r){var P=new AbortController;return P.signal}}(),this.referrer=null,(this.method==="GET"||this.method==="HEAD")&&O)throw new TypeError("Body not allowed for GET or HEAD requests");if(this._initBody(O),(this.method==="GET"||this.method==="HEAD")&&(I.cache==="no-store"||I.cache==="no-cache")){var U=/([?&])_=[^&]*/;if(U.test(this.url))this.url=this.url.replace(U,"$1_="+new Date().getTime());else{var G=/\?/;this.url+=(G.test(this.url)?"&":"?")+"_="+new Date().getTime()}}}xe.prototype.clone=function(){return new xe(this,{body:this._bodyInit})};function M(k){var I=new FormData;return k.trim().split("&").forEach(function(O){if(O){var U=O.split("="),G=U.shift().replace(/\+/g," "),P=U.join("=").replace(/\+/g," ");I.append(decodeURIComponent(G),decodeURIComponent(P))}}),I}function Dt(k){var I=new f,O=k.replace(/\r?\n[\t ]+/g," ");return O.split("\r").map(function(U){return U.indexOf(`
`)===0?U.substr(1,U.length):U}).forEach(function(U){var G=U.split(":"),P=G.shift().trim();if(P){var ba=G.join(":").trim();try{I.append(P,ba)}catch(Ga){console.warn("Response "+Ga.message)}}}),I}J.call(xe.prototype);function fe(k,I){if(!(this instanceof fe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');if(I||(I={}),this.type="default",this.status=I.status===void 0?200:I.status,this.status<200||this.status>599)throw new RangeError("Failed to construct 'Response': The status provided (0) is outside the range [200, 599].");this.ok=this.status>=200&&this.status<300,this.statusText=I.statusText===void 0?"":""+I.statusText,this.headers=new f(I.headers),this.url=I.url||"",this._initBody(k)}J.call(fe.prototype),fe.prototype.clone=function(){return new fe(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new f(this.headers),url:this.url})},fe.error=function(){var k=new fe(null,{status:200,statusText:""});return k.ok=!1,k.status=0,k.type="error",k};var ur=[301,302,303,307,308];fe.redirect=function(k,I){if(ur.indexOf(I)===-1)throw new RangeError("Invalid status code");return new fe(null,{status:I,headers:{location:k}})},i.DOMException=r.DOMException;try{new i.DOMException}catch{i.DOMException=function(I,O){this.message=I,this.name=O;var U=Error(I);this.stack=U.stack},i.DOMException.prototype=Object.create(Error.prototype),i.DOMException.prototype.constructor=i.DOMException}function Ha(k,I){return new Promise(function(O,U){var G=new xe(k,I);if(G.signal&&G.signal.aborted)return U(new i.DOMException("Aborted","AbortError"));var P=new XMLHttpRequest;function ba(){P.abort()}P.onload=function(){var ae={statusText:P.statusText,headers:Dt(P.getAllResponseHeaders()||"")};G.url.indexOf("file://")===0&&(P.status<200||P.status>599)?ae.status=200:ae.status=P.status,ae.url="responseURL"in P?P.responseURL:ae.headers.get("X-Request-URL");var Lt="response"in P?P.response:P.responseText;setTimeout(function(){O(new fe(Lt,ae))},0)},P.onerror=function(){setTimeout(function(){U(new TypeError("Network request failed"))},0)},P.ontimeout=function(){setTimeout(function(){U(new TypeError("Network request timed out"))},0)},P.onabort=function(){setTimeout(function(){U(new i.DOMException("Aborted","AbortError"))},0)};function Ga(ae){try{return ae===""&&r.location.href?r.location.href:ae}catch{return ae}}if(P.open(G.method,Ga(G.url),!0),G.credentials==="include"?P.withCredentials=!0:G.credentials==="omit"&&(P.withCredentials=!1),"responseType"in P&&(c.blob?P.responseType="blob":c.arrayBuffer&&(P.responseType="arraybuffer")),I&&typeof I.headers=="object"&&!(I.headers instanceof f||r.Headers&&I.headers instanceof r.Headers)){var Zn=[];Object.getOwnPropertyNames(I.headers).forEach(function(ae){Zn.push(b(ae)),P.setRequestHeader(ae,y(I.headers[ae]))}),G.headers.forEach(function(ae,Lt){Zn.indexOf(Lt)===-1&&P.setRequestHeader(Lt,ae)})}else G.headers.forEach(function(ae,Lt){P.setRequestHeader(Lt,ae)});G.signal&&(G.signal.addEventListener("abort",ba),P.onreadystatechange=function(){P.readyState===4&&G.signal.removeEventListener("abort",ba)}),P.send(typeof G._bodyInit>"u"?null:G._bodyInit)})}return Ha.polyfill=!0,r.fetch||(r.fetch=Ha,r.Headers=f,r.Request=xe,r.Response=fe),i.Headers=f,i.Request=xe,i.Response=fe,i.fetch=Ha,i})({})})(a),a.fetch.ponyfill=!0,delete a.fetch.polyfill;var n=s.fetch?s:a;t=n.fetch,t.default=n.fetch,t.fetch=n.fetch,t.Headers=n.Headers,t.Request=n.Request,t.Response=n.Response,e.exports=t})(un,un.exports);var Ma=un.exports;let ns;if(typeof queueMicrotask<"u")ns=queueMicrotask;else{const e=Promise.resolve();ns=t=>{e.then(t)}}var Ee,Oe,we,Na,qi;class Nc{constructor(t){_(this,Na);_(this,Ee);_(this,Oe);_(this,we);h(this,Ee,new Uint8Array(new ArrayBuffer(t))),h(this,Oe,0),h(this,we,0)}get length(){return d(this,we)-d(this,Oe)}data(){return d(this,Ee).slice(d(this,Oe),d(this,we))}push(t){S(this,Na,qi).call(this,t.byteLength),d(this,Ee).set(t,d(this,we)),h(this,we,d(this,we)+t.byteLength)}shift(t){h(this,Oe,d(this,Oe)+t)}}Ee=new WeakMap,Oe=new WeakMap,we=new WeakMap,Na=new WeakSet,qi=function(t){if(d(this,we)+t<=d(this,Ee).byteLength)return;const s=d(this,we)-d(this,Oe);if(s+t<=d(this,Ee).byteLength&&2*d(this,we)>=d(this,Ee).byteLength)d(this,Ee).copyWithin(0,d(this,Oe),d(this,we));else{let a=d(this,Ee).byteLength;do a*=2;while(s+t>a);const n=new Uint8Array(new ArrayBuffer(a));n.set(d(this,Ee).slice(d(this,Oe),d(this,we)),0),h(this,Ee,n)}h(this,we,s),h(this,Oe,0)};function qc(e){const t=Fe(e.baton),s=Fe(e.base_url),a=Tt(e.results,Bc);return{baton:t,baseUrl:s,results:a}}function Bc(e){const t=qe(e.type);if(t==="ok")return{type:"ok",response:Fc(ie(e.response))};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of StreamResult")}function Fc(e){const t=qe(e.type);if(t==="close")return{type:"close"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:Ei(ie(e.result))};if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:Ci(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of StreamResponse")}function Vc(e){const t=Fe(e.baton),s=Fe(e.base_url);return{baton:t,baseUrl:s}}const Uc={default(){return{baton:void 0,baseUrl:void 0,results:[]}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()},3(e,t){t.results.push(e.message(Hc))}},Hc={default(){return{type:"none"}},1(e){return{type:"ok",response:e.message(Gc)}},2(e){return{type:"error",error:e.message(Je)}}},Gc={default(){return{type:"none"}},1(e){return{type:"close"}},2(e){return e.message(Wc)},3(e){return e.message(zc)},4(e){return{type:"sequence"}},5(e){return e.message(Yc)},6(e){return{type:"store_sql"}},7(e){return{type:"close_sql"}},8(e){return e.message(Jc)}},Wc={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},zc={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},Yc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Jc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Kc={default(){return{baton:void 0,baseUrl:void 0}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()}};var ea,Yt,lt,We,it,hs,ft,xn,Bi,Fi;class Qc extends vi{constructor(s,a){super();_(this,ft);_(this,ea);_(this,Yt);_(this,lt);_(this,We);_(this,it);_(this,hs);h(this,ea,s),h(this,Yt,a),h(this,lt,void 0),h(this,We,new Nc(16*1024)),h(this,it,void 0),h(this,hs,!1)}async open(s){if(s.body===null)throw new j("No response body for cursor request");h(this,lt,s.body[Symbol.asyncIterator]());const a=await S(this,ft,xn).call(this,Vc,Kc);if(a===void 0)throw new j("Empty response to cursor request");return a}next(){return S(this,ft,xn).call(this,Ii,Mi)}close(){this._setClosed(new K("Cursor was manually closed"))}_setClosed(s){d(this,it)===void 0&&(h(this,it,s),d(this,ea)._cursorClosed(this),d(this,lt)!==void 0&&d(this,lt).return())}get closed(){return d(this,it)!==void 0}}ea=new WeakMap,Yt=new WeakMap,lt=new WeakMap,We=new WeakMap,it=new WeakMap,hs=new WeakMap,ft=new WeakSet,xn=async function(s,a){for(;;){if(d(this,hs))return;if(d(this,it)!==void 0)throw new Ae("Cursor is closed",d(this,it));if(d(this,Yt)==="json"){const i=S(this,ft,Bi).call(this);if(i!==void 0){const r=new TextDecoder().decode(i),c=JSON.parse(r);return $n(c,s)}}else if(d(this,Yt)==="protobuf"){const i=S(this,ft,Fi).call(this);if(i!==void 0)return qa(i,a)}else throw Q(d(this,Yt),"Impossible encoding");if(d(this,lt)===void 0)throw new At("Attempted to read from HTTP cursor before it was opened");const{value:n,done:l}=await d(this,lt).next();if(l&&d(this,We).length===0)h(this,hs,!0);else{if(l)throw new j("Unexpected end of cursor stream");d(this,We).push(n)}}},Bi=function(){const s=d(this,We).data(),n=s.indexOf(10);if(n<0)return;const l=s.slice(0,n);return d(this,We).shift(n+1),l},Fi=function(){const s=d(this,We).data();let a=0,n=0;for(;;){if(n>=s.byteLength)return;const i=s[n];if(a|=(i&127)<<7*n,n+=1,!(i&128))break}if(s.byteLength<n+a)return;const l=s.slice(n,n+a);return d(this,We).shift(n+a),l};function Xc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.arrayObjects("requests",t.requests,Zc)}function Zc(e,t){if(e.stringRaw("type",t.type),t.type!=="close"){if(t.type==="execute")e.object("stmt",t.stmt,In);else if(t.type==="batch")e.object("batch",t.batch,Ra);else if(t.type==="sequence")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type!=="get_autocommit")throw Q(t,"Impossible type of StreamRequest")}}function ed(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.object("batch",t.batch,Ra)}function td(e,t){t.baton!==void 0&&e.string(1,t.baton);for(const s of t.requests)e.message(2,s,sd)}function sd(e,t){if(t.type==="close")e.message(1,t,ad);else if(t.type==="execute")e.message(2,t,nd);else if(t.type==="batch")e.message(3,t,ld);else if(t.type==="sequence")e.message(4,t,id);else if(t.type==="describe")e.message(5,t,rd);else if(t.type==="store_sql")e.message(6,t,od);else if(t.type==="close_sql")e.message(7,t,cd);else if(t.type==="get_autocommit")e.message(8,t,dd);else throw Q(t,"Impossible type of StreamRequest")}function ad(e,t){}function nd(e,t){e.message(1,t.stmt,Cn)}function ld(e,t){e.message(1,t.batch,Ba)}function id(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function rd(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function od(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function cd(e,t){e.int32(1,t.sqlId)}function dd(e,t){}function pd(e,t){t.baton!==void 0&&e.string(1,t.baton),e.message(2,t.batch,Ba)}var rt,kt,gs,ta,ws,_t,je,St,ot,ct,$t,ze,vs,N,bt,fn,Pt,Vi,Ui,mn,Hi,Gi,bn;class ud extends wi{constructor(s,a,n,l,i){super(s.intMode);_(this,N);_(this,rt);_(this,kt);_(this,gs);_(this,ta);_(this,ws);_(this,_t);_(this,je);_(this,St);_(this,ot);_(this,ct);_(this,$t);_(this,ze);_(this,vs);h(this,rt,s),h(this,kt,a.toString()),h(this,gs,n),h(this,ta,l),h(this,ws,i),h(this,_t,void 0),h(this,je,new Ca),h(this,St,!1),h(this,ct,!1),h(this,$t,!1),h(this,ze,void 0),h(this,vs,new Bs)}client(){return d(this,rt)}_sqlOwner(){return this}storeSql(s){const a=d(this,vs).alloc();return S(this,N,bt).call(this,{type:"store_sql",sqlId:a,sql:s}).then(()=>{},n=>this._setClosed(n)),new En(this,a)}_closeSql(s){d(this,ze)===void 0&&S(this,N,bt).call(this,{type:"close_sql",sqlId:s}).then(()=>d(this,vs).free(s),a=>this._setClosed(a))}_execute(s){return S(this,N,bt).call(this,{type:"execute",stmt:s}).then(a=>a.result)}_batch(s){return S(this,N,bt).call(this,{type:"batch",batch:s}).then(a=>a.result)}_describe(s){return S(this,N,bt).call(this,{type:"describe",sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return S(this,N,bt).call(this,{type:"sequence",sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return d(this,rt)._ensureVersion(3,"getAutocommit()"),S(this,N,bt).call(this,{type:"get_autocommit"}).then(s=>s.isAutocommit)}_openCursor(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_cursorClosed(s){if(s!==d(this,ot))throw new At("Cursor was closed, but it was not associated with the stream");h(this,ot,void 0),ns(()=>S(this,N,Pt).call(this))}close(){this._setClosed(new K("Stream was manually closed"))}closeGracefully(){h(this,ct,!0),ns(()=>S(this,N,Pt).call(this))}get closed(){return d(this,ze)!==void 0||d(this,ct)}_setClosed(s){if(d(this,ze)===void 0){for(h(this,ze,s),d(this,ot)!==void 0&&d(this,ot)._setClosed(s),d(this,rt)._streamClosed(this);;){const a=d(this,je).shift();if(a!==void 0)a.errorCallback(s);else break}(d(this,_t)!==void 0||d(this,St))&&!d(this,$t)&&(d(this,je).push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),h(this,$t,!0),ns(()=>S(this,N,Pt).call(this)))}}}rt=new WeakMap,kt=new WeakMap,gs=new WeakMap,ta=new WeakMap,ws=new WeakMap,_t=new WeakMap,je=new WeakMap,St=new WeakMap,ot=new WeakMap,ct=new WeakMap,$t=new WeakMap,ze=new WeakMap,vs=new WeakMap,N=new WeakSet,bt=function(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"pipeline",request:s,responseCallback:a,errorCallback:n})})},fn=function(s){if(d(this,ze)!==void 0)throw new Ae("Stream is closed",d(this,ze));if(d(this,ct))throw new Ae("Stream is closing",void 0);d(this,je).push(s),ns(()=>S(this,N,Pt).call(this))},Pt=function(){if(d(this,St)||d(this,ot)!==void 0)return;if(d(this,ct)&&d(this,je).length===0){this._setClosed(new K("Stream was gracefully closed"));return}const s=d(this,rt)._endpoint;if(s===void 0){d(this,rt)._endpointPromise.then(()=>S(this,N,Pt).call(this),n=>this._setClosed(n));return}const a=d(this,je).shift();if(a!==void 0)if(a.type==="pipeline"){const n=[a];for(;;){const l=d(this,je).first();if(l!==void 0&&l.type==="pipeline")n.push(l),d(this,je).shift();else if(l===void 0&&d(this,ct)&&!d(this,$t)){n.push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),h(this,$t,!0);break}else break}S(this,N,Vi).call(this,s,n)}else if(a.type==="cursor")S(this,N,Ui).call(this,s,a);else throw Q(a,"Impossible type of QueueEntry")},Vi=function(s,a){S(this,N,mn).call(this,()=>S(this,N,Hi).call(this,a,s),n=>fd(n,s.encoding),n=>n.baton,n=>n.baseUrl,n=>xd(a,n),n=>a.forEach(l=>l.errorCallback(n)))},Ui=function(s,a){const n=new Qc(this,s.encoding);h(this,ot,n),S(this,N,mn).call(this,()=>S(this,N,Gi).call(this,a,s),l=>n.open(l),l=>l.baton,l=>l.baseUrl,l=>a.cursorCallback(n),l=>a.errorCallback(l))},mn=function(s,a,n,l,i,r){let c;try{const o=s();c=d(this,ta)(o)}catch(o){c=Promise.reject(o)}h(this,St,!0),c.then(o=>o.ok?a(o):md(o).then(u=>{throw u})).then(o=>{h(this,_t,n(o)),h(this,kt,l(o)??d(this,kt)),i(o)}).catch(o=>{this._setClosed(o),r(o)}).finally(()=>{h(this,St,!1),S(this,N,Pt).call(this)})},Hi=function(s,a){return S(this,N,bn).call(this,new URL(a.pipelinePath,d(this,kt)),{baton:d(this,_t),requests:s.map(n=>n.request)},a.encoding,Xc,td)},Gi=function(s,a){if(a.cursorPath===void 0)throw new Rs(`Cursors are supported only on protocol version 3 and higher, but the HTTP server only supports version ${a.version}.`);return S(this,N,bn).call(this,new URL(a.cursorPath,d(this,kt)),{baton:d(this,_t),batch:s.batch},a.encoding,ed,pd)},bn=function(s,a,n,l,i){let r,c;if(n==="json")r=ci(a,l),c="application/json";else if(n==="protobuf")r=pi(a,i),c="application/x-protobuf";else throw Q(n,"Impossible encoding");const o=new Ma.Headers;return o.set("content-type",c),d(this,gs)!==void 0&&o.set("authorization",`Bearer ${d(this,gs)}`),d(this,ws)!==void 0&&o.set("x-turso-encryption-key",d(this,ws)),new Ma.Request(s.toString(),{method:"POST",headers:o,body:r})};function xd(e,t){if(t.results.length!==e.length)throw new j("Server returned unexpected number of pipeline results");for(let s=0;s<e.length;++s){const a=t.results[s],n=e[s];if(a.type==="ok"){if(a.response.type!==n.request.type)throw new j("Received unexpected type of response");n.responseCallback(a.response)}else if(a.type==="error")n.errorCallback(As(a.error));else throw a.type==="none"?new j("Received unrecognized type of StreamResult"):Q(a,"Received impossible type of StreamResult")}}async function fd(e,t){var s;if(t==="json"){const a=await e.json();return $n(a,qc)}if(t==="protobuf"){const a=await e.arrayBuffer();return qa(new Uint8Array(a),Uc)}throw await((s=e.body)==null?void 0:s.cancel()),Q(t,"Impossible encoding")}async function md(e){var a;const t=e.headers.get("content-type")??"text/plain";let s=`Server returned HTTP status ${e.status}`;if(t==="application/json"){const n=await e.json();return"message"in n?As(n):new ya(s,e.status)}if(t==="text/plain"){const n=(await e.text()).trim();return n!==""&&(s+=`: ${n}`),new ya(s,e.status)}return await((a=e.body)==null?void 0:a.cancel()),new ya(s,e.status)}const bd=[{versionPath:"v3-protobuf",pipelinePath:"v3-protobuf/pipeline",cursorPath:"v3-protobuf/cursor",version:3,encoding:"protobuf"}],hn={versionPath:"v2",pipelinePath:"v2/pipeline",cursorPath:void 0,version:2,encoding:"json"};var ys,sa,ks,aa,dt,Jt,_s,$a,Nl;let hd=(Nl=class extends ii{constructor(s,a,n,l,i=2){super();_(this,_s);_(this,ys);_(this,sa);_(this,ks);_(this,aa);_(this,dt);_(this,Jt);q(this,"_endpointPromise");q(this,"_endpoint");h(this,ys,s),h(this,sa,a),h(this,ks,n??Ma.fetch),h(this,aa,l),h(this,dt,void 0),h(this,Jt,new Set),i==3?(this._endpointPromise=gd(d(this,ks),d(this,ys)),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r))):(this._endpointPromise=Promise.resolve(hn),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r)))}async getVersion(){return this._endpoint!==void 0?this._endpoint.version:(await this._endpointPromise).version}_ensureVersion(s,a){if(!(s<=hn.version)){if(this._endpoint===void 0)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the HTTP server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(this._endpoint.version<s)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the HTTP server only supports version ${this._endpoint.version}.`)}}openStream(){if(d(this,dt)!==void 0)throw new Ae("Client is closed",d(this,dt));const s=new ud(this,d(this,ys),d(this,sa),d(this,ks),d(this,aa));return d(this,Jt).add(s),s}_streamClosed(s){d(this,Jt).delete(s)}close(){S(this,_s,$a).call(this,new K("Client was manually closed"))}get closed(){return d(this,dt)!==void 0}},ys=new WeakMap,sa=new WeakMap,ks=new WeakMap,aa=new WeakMap,dt=new WeakMap,Jt=new WeakMap,_s=new WeakSet,$a=function(s){if(d(this,dt)===void 0){h(this,dt,s);for(const a of Array.from(d(this,Jt)))a._setClosed(new Ae("Client was closed",s))}},Nl);async function gd(e,t){const s=e;for(const a of bd){const n=new URL(a.versionPath,t),l=new Ma.Request(n.toString(),{method:"GET"}),i=await s(l);if(await i.arrayBuffer(),i.ok)return a}return hn}function Wi(e,t,s=2){if(typeof as>"u")throw new oi("WebSockets are not supported in this environment");var a=void 0;s==3?a=Array.from(Di.keys()):a=Array.from(Oc.keys());const n=new as(e,a);return new jc(n,t)}function pl(e,t,s,a,n=2){return new hd(e instanceof URL?e:new URL(e),t,s,a,n)}var Ss,pt,de;class zi{constructor(t,s){_(this,Ss);_(this,pt);_(this,de);h(this,Ss,t),h(this,pt,s),h(this,de,void 0)}execute(t){return this.batch([t]).then(s=>s[0])}async batch(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{const a=t.map(Zt);let n;if(d(this,de)===void 0){this._getSqlCache().apply(a);const i=s.batch(d(this,pt)>=3),r=i.step(),c=r.run(en(d(this,Ss)));let o=r;n=a.map(u=>{const m=i.step().condition(ve.ok(o));d(this,pt)>=3&&m.condition(ve.not(ve.isAutocommit(i)));const b=m.query(u);return b.catch(()=>{}),o=m,b}),h(this,de,i.execute().then(()=>c).then(()=>{}));try{await d(this,de)}catch(u){throw this.close(),u}}else{d(this,pt)<3&&await d(this,de),this._getSqlCache().apply(a);const i=s.batch(d(this,pt)>=3);let r;n=a.map(c=>{const o=i.step();r!==void 0&&o.condition(ve.ok(r)),d(this,pt)>=3&&o.condition(ve.not(ve.isAutocommit(i)));const u=o.query(c);return u.catch(()=>{}),r=o,u}),await i.execute()}const l=[];for(let i=0;i<n.length;i++)try{const r=await n[i];if(r===void 0)throw new ls("Statement in a transaction was not executed, probably because the transaction has been rolled back",i,"TRANSACTION_CLOSED");l.push(Fa(r))}catch(r){if(r instanceof ls)throw r;const c=z(r);throw c instanceof F?new ls(c.message,i,c.code,c.extendedCode,c.rawCode,c.cause instanceof Error?c.cause:void 0):c}return l}catch(a){throw z(a)}}async executeMultiple(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{if(d(this,de)===void 0){h(this,de,s.run(en(d(this,Ss))).then(()=>{}));try{await d(this,de)}catch(a){throw this.close(),a}}else await d(this,de);await s.sequence(t)}catch(a){throw z(a)}}async rollback(){try{const t=this._getStream();if(t.closed||d(this,de)===void 0)return;const s=t.run("ROLLBACK").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}async commit(){try{const t=this._getStream();if(t.closed)throw new F("Cannot commit the transaction because it is already closed","TRANSACTION_CLOSED");if(d(this,de)!==void 0)await d(this,de);else return;const s=t.run("COMMIT").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}}Ss=new WeakMap,pt=new WeakMap,de=new WeakMap;async function Da(e,t,s,a,n=!1){n&&s.step().run("PRAGMA foreign_keys=off");const l=s.step(),i=l.run(en(e));let r=l;const c=a.map(y=>{const w=s.step().condition(ve.ok(r));t>=3&&w.condition(ve.not(ve.isAutocommit(s)));const f=w.query(y);return r=w,f}),o=s.step().condition(ve.ok(r));t>=3&&o.condition(ve.not(ve.isAutocommit(s)));const u=o.run("COMMIT");s.step().condition(ve.not(ve.ok(o))).run("ROLLBACK").catch(y=>{}),n&&s.step().run("PRAGMA foreign_keys=on"),await s.execute();const b=[];await i;for(let y=0;y<c.length;y++)try{const w=await c[y];if(w===void 0)throw new ls("Statement in a batch was not executed, probably because the transaction has been rolled back",y,"TRANSACTION_CLOSED");b.push(Fa(w))}catch(w){if(w instanceof ls)throw w;const f=z(w);throw f instanceof F?new ls(f.message,y,f.code,f.extendedCode,f.rawCode,f.cause instanceof Error?f.cause:void 0):f}return await u,b}function Zt(e){let t,s;Array.isArray(e)?[t,s]=e:typeof e=="string"?t=e:(t=e.sql,s=e.args);const a=new hi(t);if(s)if(Array.isArray(s))a.bindIndexes(s);else for(const[n,l]of Object.entries(s))a.bindName(n,l);return a}function Fa(e){const t=e.columnNames.map(i=>i??""),s=e.columnDecltypes.map(i=>i??""),a=e.rows,n=e.affectedRowCount,l=e.lastInsertRowid!==void 0?e.lastInsertRowid:void 0;return new Ro(t,s,a,n,l)}function z(e){if(e instanceof K){const t=Yi(e);return new F(e.message,t,void 0,void 0,e)}return e}function Yi(e){return e instanceof ri&&e.code!==void 0?e.code:e instanceof j?"HRANA_PROTO_ERROR":e instanceof Ae?e.cause instanceof K?Yi(e.cause):"HRANA_CLOSED_ERROR":e instanceof tn?"HRANA_WEBSOCKET_ERROR":e instanceof ya?"SERVER_ERROR":e instanceof Rs?"PROTOCOL_VERSION_ERROR":e instanceof At?"INTERNAL_ERROR":"UNKNOWN"}var na,Ye;class Tn{constructor(t,s){_(this,na);_(this,Ye);q(this,"capacity");h(this,na,t),h(this,Ye,new wd),this.capacity=s}apply(t){if(this.capacity<=0)return;const s=new Set;for(const a of t){if(typeof a.sql!="string")continue;const n=a.sql;if(n.length>=5e3)continue;let l=d(this,Ye).get(n);if(l===void 0){for(;d(this,Ye).size+1>this.capacity;){const[i,r]=d(this,Ye).peekLru();if(s.has(r))break;r.close(),d(this,Ye).delete(i)}d(this,Ye).size+1<=this.capacity&&(l=d(this,na).storeSql(n),d(this,Ye).set(n,l))}l!==void 0&&(a.sql=l,s.add(l))}}}na=new WeakMap,Ye=new WeakMap;var Pe;class wd{constructor(){_(this,Pe);h(this,Pe,new Map)}get(t){const s=d(this,Pe).get(t);return s!==void 0&&(d(this,Pe).delete(t),d(this,Pe).set(t,s)),s}set(t,s){d(this,Pe).set(t,s)}peekLru(){for(const t of d(this,Pe).entries())return t}delete(t){d(this,Pe).delete(t)}get size(){return d(this,Pe).size}}Pe=new WeakMap;function vd(e){var t=0,s=[];function a(){t--,t<e&&n()}function n(){var c=s.shift();r.queue=s.length,c&&i(c.fn).then(c.resolve).catch(c.reject)}function l(c){return new Promise(function(o,u){s.push({fn:c,resolve:o,reject:u}),r.queue=s.length})}function i(c){t++;try{return Promise.resolve(c()).then(function(o){return a(),o},function(o){throw a(),o})}catch(o){return a(),Promise.reject(o)}}var r=function(c){return t>=e?l(c):i(c)};return r}function yd(e,t){var s=!1,a=this;return Promise.all(e.map(function(){var n=arguments;return a(function(){if(!s)return t.apply(void 0,n).catch(function(l){throw s=!0,l})})}))}function ul(e){return e.queue=0,e.map=yd,e}var kd=function(e){return ul(e?vd(e):function(t){return t()})};const Ji=Pc(kd);function _d(e){if(e.scheme!=="wss"&&e.scheme!=="ws")throw new F(`The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="ws"&&e.tls)throw new F('A "ws:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="wss"&&!e.tls)throw new F('A "wss:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);let s;try{s=Wi(t,e.authToken)}catch(a){if(a instanceof oi){const n=e.scheme==="wss"?"https":"http",l=Qa(n,e.authority,e.path);throw new F(`This environment does not support WebSockets, please switch to the HTTP client by using a "${n}:" URL (${JSON.stringify(l)}). For more information, please read ${Ks}`,"WEBSOCKETS_NOT_SUPPORTED")}throw z(a)}return new $d(s,t,e.authToken,e.intMode,e.concurrency)}const Sd=60*1e3,xl=100;var la,ia,ra,ee,oe,vn,oa,Ie,ss,Us;class $d{constructor(t,s,a,n,l){_(this,Ie);_(this,la);_(this,ia);_(this,ra);_(this,ee);_(this,oe);q(this,"closed");q(this,"protocol");_(this,vn);_(this,oa);h(this,la,s),h(this,ia,a),h(this,ra,n),h(this,ee,S(this,Ie,Us).call(this,t)),h(this,oe,void 0),this.closed=!1,this.protocol="ws",h(this,oa,Ji(l))}async limit(t){return d(this,oa).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{const n=await S(this,Ie,ss).call(this);try{const l=Zt(a);n.conn.sqlCache.apply([l]);const i=n.stream.query(l);n.stream.closeGracefully();const r=await i;return Fa(r)}catch(l){throw z(l)}finally{this._closeStream(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{const a=await S(this,Ie,ss).call(this);try{const l=t.map(u=>Array.isArray(u)?{sql:u[0],args:u[1]||[]}:u).map(Zt),i=await a.conn.client.getVersion();a.conn.sqlCache.apply(l);const r=a.stream.batch(i>=3);return await Da(s,i,r,l)}catch(n){throw z(n)}finally{this._closeStream(a)}})}async migrate(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=t.map(Zt),n=await s.conn.client.getVersion(),l=s.stream.batch(n>=3);return await Da("deferred",n,l,a,!0)}catch(a){throw z(a)}finally{this._closeStream(s)}})}async transaction(t="write"){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=await s.conn.client.getVersion();return new Ed(this,s,t,a)}catch(a){throw this._closeStream(s),z(a)}})}async executeMultiple(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=s.stream.sequence(t);s.stream.closeGracefully(),await a}catch(a){throw z(a)}finally{this._closeStream(s)}})}sync(){throw new F("sync not supported in ws mode","SYNC_NOT_SUPPORTED")}async reconnect(){try{for(const a of Array.from(d(this,ee).streamStates))try{a.stream.close()}catch{}d(this,ee).client.close()}catch{}if(d(this,oe)){try{d(this,oe).client.close()}catch{}h(this,oe,void 0)}const t=S(this,Ie,Us).call(this),s=await t.client.getVersion();t.useSqlCache=s>=2,t.useSqlCache&&(t.sqlCache.capacity=xl),h(this,ee,t),this.closed=!1}_closeStream(t){t.stream.close();const s=t.conn;s.streamStates.delete(t),s.streamStates.size===0&&s!==d(this,ee)&&s.client.close()}close(){if(d(this,ee).client.close(),this.closed=!0,d(this,oe)){try{d(this,oe).client.close()}catch{}h(this,oe,void 0)}this.closed=!0}}la=new WeakMap,ia=new WeakMap,ra=new WeakMap,ee=new WeakMap,oe=new WeakMap,vn=new WeakMap,oa=new WeakMap,Ie=new WeakSet,ss=async function(){if(this.closed)throw new F("The client is closed","CLIENT_CLOSED");if(new Date().valueOf()-d(this,ee).openTime.valueOf()>Sd&&d(this,oe)===void 0){const n=S(this,Ie,Us).call(this);h(this,oe,n),n.client.getVersion().then(l=>{d(this,ee)!==n&&d(this,ee).streamStates.size===0&&d(this,ee).client.close(),h(this,ee,n),h(this,oe,void 0)},l=>{h(this,oe,void 0)})}if(d(this,ee).client.closed)try{d(this,oe)!==void 0?h(this,ee,d(this,oe)):h(this,ee,S(this,Ie,Us).call(this))}catch(n){throw z(n)}const a=d(this,ee);try{a.useSqlCache===void 0&&(a.useSqlCache=await a.client.getVersion()>=2,a.useSqlCache&&(a.sqlCache.capacity=xl));const n=a.client.openStream();n.intMode=d(this,ra);const l={conn:a,stream:n};return a.streamStates.add(l),l}catch(n){throw z(n)}},Us=function(t){try{return t??(t=Wi(d(this,la),d(this,ia))),{client:t,useSqlCache:void 0,sqlCache:new Tn(t,0),openTime:new Date,streamStates:new Set}}catch(s){throw z(s)}};var ca,Et;class Ed extends zi{constructor(s,a,n,l){super(n,l);_(this,ca);_(this,Et);h(this,ca,s),h(this,Et,a)}_getStream(){return d(this,Et).stream}_getSqlCache(){return d(this,Et).conn.sqlCache}close(){d(this,ca)._closeStream(d(this,Et))}get closed(){return d(this,Et).stream.closed}}ca=new WeakMap,Et=new WeakMap;function Id(e){if(e.scheme!=="https"&&e.scheme!=="http")throw new F(`The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="http"&&e.tls)throw new F('A "http:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="https"&&!e.tls)throw new F('A "https:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);return new Cd(t,e.authToken,e.intMode,e.fetch,e.concurrency,e.remoteEncryptionKey)}const Ki=30;var te,$s,Es,Is,da,Cs,pa,ua;class Cd{constructor(t,s,a,n,l,i){_(this,te);q(this,"protocol");_(this,$s);_(this,Es);_(this,Is);_(this,da);_(this,Cs);_(this,pa);_(this,ua);h(this,$s,t),h(this,Cs,s),h(this,Es,a),h(this,Is,n),h(this,da,l),h(this,pa,i),h(this,te,pl(d(this,$s),d(this,Cs),d(this,Is),i)),d(this,te).intMode=d(this,Es),this.protocol="http",h(this,ua,Ji(d(this,da)))}async limit(t){return d(this,ua).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{try{const n=Zt(a);let l;const i=d(this,te).openStream();try{l=i.query(n)}finally{i.closeGracefully()}const r=await l;return Fa(r)}catch(n){throw z(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{try{const n=t.map(o=>Array.isArray(o)?{sql:o[0],args:o[1]||[]}:o).map(Zt),l=await d(this,te).getVersion();let i;const r=d(this,te).openStream();try{new Tn(r,Ki).apply(n);const u=r.batch(!1);i=Da(s,l,u,n)}finally{r.closeGracefully()}return await i}catch(a){throw z(a)}})}async migrate(t){return this.limit(async()=>{try{const s=t.map(Zt),a=await d(this,te).getVersion();let n;const l=d(this,te).openStream();try{const r=l.batch(!1);n=Da("deferred",a,r,s,!0)}finally{l.closeGracefully()}return await n}catch(s){throw z(s)}})}async transaction(t="write"){return this.limit(async()=>{try{const s=await d(this,te).getVersion();return new Rd(d(this,te).openStream(),t,s)}catch(s){throw z(s)}})}async executeMultiple(t){return this.limit(async()=>{try{let s;const a=d(this,te).openStream();try{s=a.sequence(t)}finally{a.closeGracefully()}await s}catch(s){throw z(s)}})}sync(){throw new F("sync not supported in http mode","SYNC_NOT_SUPPORTED")}close(){d(this,te).close()}async reconnect(){try{this.closed||d(this,te).close()}finally{h(this,te,pl(d(this,$s),d(this,Cs),d(this,Is),d(this,pa))),d(this,te).intMode=d(this,Es)}}get closed(){return d(this,te).closed}}te=new WeakMap,$s=new WeakMap,Es=new WeakMap,Is=new WeakMap,da=new WeakMap,Cs=new WeakMap,pa=new WeakMap,ua=new WeakMap;var Kt,xa;class Rd extends zi{constructor(s,a,n){super(a,n);_(this,Kt);_(this,xa);h(this,Kt,s),h(this,xa,new Tn(s,Ki))}_getStream(){return d(this,Kt)}_getSqlCache(){return d(this,xa)}close(){d(this,Kt).close()}get closed(){return d(this,Kt).closed}}Kt=new WeakMap,xa=new WeakMap;function Qi(e){return Ad(Mo(e))}function Ad(e){if(e.scheme==="ws"||e.scheme==="wss")return _d(e);if(e.scheme==="http"||e.scheme==="https")return Id(e);throw new F(`The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED")}const Td={url:"libsql://retailer-os-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAxODY2NzMsImlkIjoiNDcwMDliODAtYmJlYS00YzQ3LTk1MzQtY2NlYjg4OWUzYjFjIiwicmlkIjoiNTk1ODMwNWEtMjlkNy00OGU5LWJkNTctN2FiZWVjNzVjMWYwIn0.381aJkYkBtcCsSDyQkFNLZud9lOPi9TuT3uRZgLYS9BqrjLFb0Zc7P1qRWN0k16XkHQ7raDwhCUE9H1G8Q80BA"},Md={url:"libsql://retailer-data-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAyODMwNTgsImlkIjoiZTVmNzQ5MjMtMDFiMi00YzkxLTlmMjEtZTJhZDIxMzBmMmZmIiwicmlkIjoiZjQzNTc5NTMtN2E2OS00M2UzLWE3MWUtNDcyYzk1MWM1NTRiIn0.8dOIX1XeNnJswuRGhacgPypg_h_9_-bRAwBxtKhBX7rJ4bQuEtSz9Z6igZsvGrWxDlsYlHMo4V3KKIuIZRSuBA"},Nt=Qi(Td),fl=Qi(Md);async function v(e,t=[]){try{return(await Nt.execute({sql:e,args:t})).rows}catch(s){throw console.error("DB Query Error:",s.message,"SQL:",e,"Params:",t),s}}async function Dd(e){try{return await Nt.batch(e)}catch(t){throw console.error("DB Transaction Error:",t),t}}function R(){return localStorage.getItem("retaileros_retailer_id")}const A={clients:{getAll:()=>{const e=R();return e?v("SELECT * FROM customers WHERE retailer_id = ?",[e]):v("SELECT * FROM customers")},add:e=>{const t=R();return v("INSERT INTO customers (id, name, phone, email, joined_at, dob, location, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.name,e.phone||"",e.email||"",new Date().toISOString(),e.dob||null,e.location||"",t])},getById:e=>{const t=R();return t?v("SELECT * FROM customers WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM customers WHERE id = ?",[e])}},companies:{getAll:()=>{const e=R();return e?v("SELECT * FROM companies WHERE retailer_id = ?",[e]):v("SELECT * FROM companies")},add:e=>{const t=R();return v("INSERT INTO companies (id, name, gst_number, customer_id, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?)",[e.id,e.name,e.gst_number,e.customer_id,new Date().toISOString(),t])},getByCustomerId:e=>{const t=R();return t?v("SELECT * FROM companies WHERE customer_id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM companies WHERE customer_id = ?",[e])},getById:e=>{const t=R();return t?v("SELECT * FROM companies WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM companies WHERE id = ?",[e])}},sales:{getAll:()=>{const e=R();return e?v("SELECT * FROM sales WHERE retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM sales ORDER BY date DESC")},getById:e=>{const t=R();return t?v("SELECT * FROM sales WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM sales WHERE id = ?",[e])},getDrafts:()=>{const e=R();return e?v("SELECT * FROM sales WHERE status = 'draft' AND retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM sales WHERE status = 'draft' ORDER BY date DESC")},add:e=>{const t=R();return v(`INSERT INTO sales (id, customer_id, customer_name, date, total_amount, status, payment_mode, payment_reference, gst_required, company_id, installation_required, installation_date, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.customer_id,e.customer_name,e.date,e.total_amount,e.status||"completed",e.payment_mode||null,e.payment_reference||null,e.gst_required||0,e.company_id||null,e.installation_required||0,e.installation_date||null,t])},update:e=>{const t=R(),s=t?"WHERE id = ? AND retailer_id = ?":"WHERE id = ?",a=[e.customer_id,e.customer_name,e.total_amount,e.status,e.payment_mode||null,e.payment_reference||null,e.gst_required||0,e.company_id||null,e.installation_required||0,e.installation_date||null,e.id];return t&&a.push(t),v(`UPDATE sales SET customer_id = ?, customer_name = ?, total_amount = ?, status = ?,
                 payment_mode = ?, payment_reference = ?, gst_required = ?, company_id = ?,
                 installation_required = ?, installation_date = ? ${s}`,a)},delete:e=>{const t=R();return t?v("DELETE FROM sales WHERE id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM sales WHERE id = ?",[e])},addItem:e=>v(`INSERT INTO sale_items (id, sale_id, product_id, product_name, category, quantity, price, discount_type, discount_value, discount_amount, scheme_id, final_price, imei, serial_number, mac_id, manufacturing_date, installation_date, extra_fields)
             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.sale_id,e.product_id,e.product_name,e.category,e.quantity,e.price,e.discount_type||null,e.discount_value||null,e.discount_amount||null,e.scheme_id||null,e.final_price||e.price,e.imei||null,e.serial_number||null,e.mac_id||null,e.manufacturing_date||null,e.installation_date||null,e.extra_fields||null]),deleteItems:e=>v("DELETE FROM sale_items WHERE sale_id = ?",[e]),getItems:e=>v("SELECT * FROM sale_items WHERE sale_id = ?",[e])},inventory:{getProducts:()=>v("SELECT * FROM products")},schemes:{getAll:()=>v("SELECT * FROM schemes WHERE status = 'active' ORDER BY brand, name"),getById:e=>v("SELECT * FROM schemes WHERE id = ?",[e]),getByBrand:e=>v("SELECT * FROM schemes WHERE brand = ? AND status = 'active'",[e]),getByCategory:e=>v("SELECT * FROM schemes WHERE category = ? AND status = 'active'",[e]),getApplicable:(e,t,s)=>v(`SELECT * FROM schemes WHERE status = 'active'
             AND (brand = ? OR brand IS NULL)
             AND (category = ? OR category IS NULL)
             AND (min_price IS NULL OR min_price <= ?)
             AND (max_price IS NULL OR max_price >= ?)
             AND date(start_date) <= date('now') AND date(end_date) >= date('now')`,[e,t,s,s])},groups:{getAll:()=>{const e=R();return e?v("SELECT * FROM groups WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM groups ORDER BY created_at DESC")},add:e=>{const t=R();return v(`INSERT INTO groups (id, name, description, is_company, gst_number, contact_person, created_at, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.name,e.description||null,e.is_company||0,e.gst_number||null,e.contact_person||null,e.created_at,t])},getById:e=>{const t=R();return t?v("SELECT * FROM groups WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM groups WHERE id = ?",[e])},delete:e=>{const t=R();return t?v("DELETE FROM groups WHERE id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM groups WHERE id = ?",[e])},getMembers:e=>{const t=R();return t?v("SELECT * FROM group_members WHERE group_id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM group_members WHERE group_id = ?",[e])},getAllMembers:()=>{const e=R();return e?v("SELECT * FROM group_members WHERE retailer_id = ?",[e]):v("SELECT * FROM group_members")},addMember:e=>{const t=R();return v("INSERT INTO group_members (id, group_id, customer_id, added_at, retailer_id) VALUES (?, ?, ?, ?, ?)",[e.id,e.group_id,e.customer_id,e.added_at,t])},removeMember:(e,t)=>{const s=R();return s?v("DELETE FROM group_members WHERE group_id = ? AND customer_id = ? AND retailer_id = ?",[e,t,s]):v("DELETE FROM group_members WHERE group_id = ? AND customer_id = ?",[e,t])},deleteMembers:e=>{const t=R();return t?v("DELETE FROM group_members WHERE group_id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM group_members WHERE group_id = ?",[e])}},automations:{getAll:()=>{const e=R();return e?v("SELECT * FROM automations WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM automations ORDER BY created_at DESC")},getById:e=>{const t=R();return t?v("SELECT * FROM automations WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM automations WHERE id = ?",[e])},getByCustomer:e=>{const t=R();return t?v("SELECT * FROM automations WHERE customer_id = ? AND retailer_id = ? ORDER BY created_at DESC",[e,t]):v("SELECT * FROM automations WHERE customer_id = ? ORDER BY created_at DESC",[e])},getBySale:e=>{const t=R();return t?v("SELECT * FROM automations WHERE sale_id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM automations WHERE sale_id = ?",[e])},add:e=>{const t=R();return v(`INSERT INTO automations (id, name, customer_id, customer_name, sale_id, status, created_at, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.name,e.customer_id,e.customer_name,e.sale_id||null,e.status||"active",e.created_at||new Date().toISOString(),t])},update:(e,t)=>{const s=R();return s?v("UPDATE automations SET status = ?, completed_at = ? WHERE id = ? AND retailer_id = ?",[t.status,t.completed_at||null,e,s]):v("UPDATE automations SET status = ?, completed_at = ? WHERE id = ?",[t.status,t.completed_at||null,e])},delete:e=>{const t=R();return t?v("DELETE FROM automations WHERE id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM automations WHERE id = ?",[e])},getMessages:e=>{const t=R();return t?v("SELECT * FROM automation_messages WHERE automation_id = ? AND retailer_id = ? ORDER BY day_offset",[e,t]):v("SELECT * FROM automation_messages WHERE automation_id = ? ORDER BY day_offset",[e])},getAllMessages:()=>{const e=R();return e?v("SELECT * FROM automation_messages WHERE retailer_id = ? ORDER BY scheduled_date",[e]):v("SELECT * FROM automation_messages ORDER BY scheduled_date")},addMessage:e=>{const t=R();return v(`INSERT INTO automation_messages (id, automation_id, message_type, title, content, day_offset, scheduled_date, status, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.automation_id,e.message_type,e.title,e.content,e.day_offset,e.scheduled_date,e.status||"pending",t])},updateMessageStatus:(e,t,s)=>{const a=R();return a?v("UPDATE automation_messages SET status = ?, sent_at = ? WHERE id = ? AND retailer_id = ?",[t,s,e,a]):v("UPDATE automation_messages SET status = ?, sent_at = ? WHERE id = ?",[t,s,e])},deleteMessages:e=>{const t=R();return t?v("DELETE FROM automation_messages WHERE automation_id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM automation_messages WHERE automation_id = ?",[e])}},communications:{getAll:()=>{const e=R();return e?v("SELECT * FROM communication_log WHERE retailer_id = ? ORDER BY sent_at DESC",[e]):v("SELECT * FROM communication_log ORDER BY sent_at DESC")},getByCustomer:e=>{const t=R();return t?v("SELECT * FROM communication_log WHERE customer_id = ? AND retailer_id = ? ORDER BY sent_at DESC",[e,t]):v("SELECT * FROM communication_log WHERE customer_id = ? ORDER BY sent_at DESC",[e])},add:e=>{const t=R();return v(`INSERT INTO communication_log (id, customer_id, type, direction, content, sent_at, automation_id, sale_id, status, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.customer_id,e.type,e.direction||"outgoing",e.content,e.sent_at||new Date().toISOString(),e.automation_id||null,e.sale_id||null,e.status||"sent",t])},updateStatus:(e,t)=>{const s=R();return s?v("UPDATE communication_log SET status = ? WHERE id = ? AND retailer_id = ?",[t,e,s]):v("UPDATE communication_log SET status = ? WHERE id = ?",[t,e])}},inquiries:{getAll:()=>{const e=R();return e?v("SELECT * FROM inquiries WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM inquiries ORDER BY created_at DESC")},getById:e=>{const t=R();return t?v("SELECT * FROM inquiries WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM inquiries WHERE id = ?",[e])},add:e=>{const t=R();return v("INSERT INTO inquiries (id, customer_name, product_name, request, status, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?)",[e.id,e.customer_name,e.product_name,e.request,e.status||"PENDING",e.created_at||new Date().toISOString(),t])},updateStatus:(e,t)=>{const s=R();return s?v("UPDATE inquiries SET status = ? WHERE id = ? AND retailer_id = ?",[t,e,s]):v("UPDATE inquiries SET status = ? WHERE id = ?",[t,e])}},repairs:{getAll:()=>{const e=R();return e?v("SELECT * FROM repairs WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM repairs ORDER BY created_at DESC")},getById:e=>{const t=R();return t?v("SELECT * FROM repairs WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM repairs WHERE id = ?",[e])},add:e=>{const t=R();return v("INSERT INTO repairs (id, customer_name, phone, device, issue, status, job_sheet_no, estimated_cost, assigned_to, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.customer_name,e.phone,e.device,e.issue,e.status||"COLLECTED",e.job_sheet_no,e.estimated_cost||"0",e.assigned_to||"Unassigned",e.created_at||new Date().toISOString(),t])},updateStatus:(e,t)=>{const s=R();return s?v("UPDATE repairs SET status = ? WHERE id = ? AND retailer_id = ?",[t,e,s]):v("UPDATE repairs SET status = ? WHERE id = ?",[t,e])}},inventoryLogs:{getAll:()=>{const e=R();return e?v("SELECT * FROM inventory_logs WHERE retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM inventory_logs ORDER BY date DESC")},add:e=>{const t=R();return v("INSERT INTO inventory_logs (id, product_id, type, quantity, reason, date, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?)",[e.id,e.product_id,e.type,e.quantity,e.reason,e.date||new Date().toISOString(),t])}},settings:{getAll:()=>{const e=R();return e?v("SELECT category, settings FROM retailer_settings WHERE retailer_id = ?",[e]):Promise.resolve([])},get:e=>{const t=R();return t?v("SELECT settings FROM retailer_settings WHERE retailer_id = ? AND category = ?",[t,e]):Promise.resolve([])},save:(e,t)=>{const s=R();if(!s)return Promise.resolve();const a=`setting_${s}_${e}`;return v("INSERT OR REPLACE INTO retailer_settings (id, retailer_id, category, settings, updated_at) VALUES (?, ?, ?, ?, ?)",[a,s,e,JSON.stringify(t),new Date().toISOString()])}},teamMembers:{getAll:()=>{const e=R();return e?v("SELECT * FROM team_members WHERE retailer_id = ? ORDER BY created_at",[e]):v("SELECT * FROM team_members ORDER BY created_at")},add:e=>{const t=R(),s=new Date().toISOString();return v("INSERT INTO team_members (id, retailer_id, name, role, phone, email, status, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.id,t,e.name,e.role,e.phone||null,e.email||null,e.status||"invited",s,s])},update:(e,t)=>{const s=R();return v("UPDATE team_members SET name = ?, role = ?, phone = ?, status = ?, updated_at = ? WHERE id = ? AND retailer_id = ?",[t.name,t.role,t.phone,t.status,new Date().toISOString(),e,s])},delete:e=>{const t=R();return t?v("DELETE FROM team_members WHERE id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM team_members WHERE id = ?",[e])}},teamRoles:{getAll:()=>{const e=R();return e?v("SELECT * FROM team_roles WHERE retailer_id = ? ORDER BY created_at",[e]):v("SELECT * FROM team_roles ORDER BY created_at")},add:e=>{const t=R(),s=new Date().toISOString();return v("INSERT INTO team_roles (id, retailer_id, name, permissions, description, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?)",[e.id,t,e.name,JSON.stringify(e.permissions),e.description||null,s,s])},update:(e,t)=>{const s=R();return v("UPDATE team_roles SET name = ?, permissions = ?, description = ?, updated_at = ? WHERE id = ? AND retailer_id = ?",[t.name,JSON.stringify(t.permissions),t.description,new Date().toISOString(),e,s])},delete:e=>{const t=R();return t?v("DELETE FROM team_roles WHERE id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM team_roles WHERE id = ?",[e])}},plugins:{getAll:()=>{const e=R();return e?v("SELECT * FROM retailer_plugins WHERE retailer_id = ?",[e]):Promise.resolve([])},upsert:(e,t,s)=>{const a=R();if(!a)return Promise.resolve();const n=`plugin_${a}_${e}`,l=new Date().toISOString(),i=t==="connected"?l:null;return v("INSERT OR REPLACE INTO retailer_plugins (id, retailer_id, plugin_key, status, config, connected_at, updated_at) VALUES (?, ?, ?, ?, ?, COALESCE((SELECT connected_at FROM retailer_plugins WHERE id = ?), ?), ?)",[n,a,e,t,s?JSON.stringify(s):null,n,i,l])}},activityLogs:{getAll:(e=50)=>{const t=R();return t?v("SELECT * FROM activity_logs WHERE retailer_id = ? ORDER BY created_at DESC LIMIT ?",[t,e]):v("SELECT * FROM activity_logs ORDER BY created_at DESC LIMIT ?",[e])},add:e=>{const t=R(),s=e.id||`log_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;return v("INSERT INTO activity_logs (id, retailer_id, action, detail, user_name, icon, color, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[s,t,e.action,e.detail||null,e.user_name||null,e.icon||null,e.color||null,new Date().toISOString()])}},storeListings:{getAll:()=>{const e=R();return e?v("SELECT * FROM store_listings WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM store_listings ORDER BY created_at DESC")},getById:e=>{const t=R();return t?v("SELECT * FROM store_listings WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM store_listings WHERE id = ?",[e])},add:e=>{const t=R(),s=new Date().toISOString();return v("INSERT INTO store_listings (id, product_id, product_name, brand, category, base_price, listing_price, description, status, stock_qty, created_at, updated_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.product_id,e.product_name,e.brand||null,e.category||null,e.base_price,e.listing_price,e.description||null,e.status||"draft",e.stock_qty||0,s,s,t])},update:(e,t)=>{const s=R(),a=new Date().toISOString();return v("UPDATE store_listings SET listing_price = ?, description = ?, status = ?, stock_qty = ?, updated_at = ? WHERE id = ? AND retailer_id = ?",[t.listing_price,t.description,t.status,t.stock_qty,a,e,s])},delete:e=>{const t=R();return t?v("DELETE FROM store_listings WHERE id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM store_listings WHERE id = ?",[e])}},storeOrders:{getAll:()=>{const e=R();return e?v("SELECT * FROM store_orders WHERE retailer_id = ? ORDER BY order_date DESC",[e]):v("SELECT * FROM store_orders ORDER BY order_date DESC")},getById:e=>{const t=R();return t?v("SELECT * FROM store_orders WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM store_orders WHERE id = ?",[e])},add:e=>{const t=R();return v("INSERT INTO store_orders (id, order_number, customer_name, customer_phone, customer_email, shipping_address_line1, shipping_address_line2, shipping_city, shipping_state, shipping_pincode, order_date, total_amount, order_status, payment_status, payment_mode, payment_reference, tracking_number, courier_name, shipped_date, delivered_date, notes, sale_id, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.order_number,e.customer_name,e.customer_phone||null,e.customer_email||null,e.shipping_address_line1||null,e.shipping_address_line2||null,e.shipping_city||null,e.shipping_state||null,e.shipping_pincode||null,e.order_date,e.total_amount,e.order_status||"pending",e.payment_status||"pending",e.payment_mode||null,e.payment_reference||null,e.tracking_number||null,e.courier_name||null,e.shipped_date||null,e.delivered_date||null,e.notes||null,e.sale_id||null,t])},updateStatus:(e,t,s={})=>{const a=R(),n=["order_status = ?"],l=[t];s.tracking_number!==void 0&&(n.push("tracking_number = ?"),l.push(s.tracking_number)),s.courier_name!==void 0&&(n.push("courier_name = ?"),l.push(s.courier_name)),s.shipped_date!==void 0&&(n.push("shipped_date = ?"),l.push(s.shipped_date)),s.delivered_date!==void 0&&(n.push("delivered_date = ?"),l.push(s.delivered_date)),s.sale_id!==void 0&&(n.push("sale_id = ?"),l.push(s.sale_id)),s.payment_status!==void 0&&(n.push("payment_status = ?"),l.push(s.payment_status)),l.push(e),a&&l.push(a);const i=a?"WHERE id = ? AND retailer_id = ?":"WHERE id = ?";return v(`UPDATE store_orders SET ${n.join(", ")} ${i}`,l)},addItem:e=>v("INSERT INTO store_order_items (id, order_id, listing_id, product_id, product_name, category, quantity, unit_price, discount_amount, final_price) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.order_id,e.listing_id||null,e.product_id,e.product_name,e.category||null,e.quantity,e.unit_price,e.discount_amount||0,e.final_price]),getItems:e=>v("SELECT * FROM store_order_items WHERE order_id = ?",[e]),deleteItems:e=>v("DELETE FROM store_order_items WHERE order_id = ?",[e])},approved:{checkApproval:async e=>{const t=`
    ...
    `}let rs=!1,Ea="",T=[],Be=null,ut="Select Customer",ue=!1,Ke="",Qe="",ma=!1,W="",xt="",Ct=null;const os=e=>`${e}-${Math.random().toString(36).substr(2,8).toUpperCase()}`,Ld=["appliances","air conditioners","ac","washing machines","refrigerators","tvs","television","home theater","dishwasher","microwave","geyser","water heater"];function Dn(e){if(e.installation_required===1)return!0;const t=(e.category||"").toLowerCase();return Ld.some(s=>t.includes(s))}async function Od(e){const t=window.getCache().products,s=window.getCache().schemes||[],a=t.find(n=>n.id===e);if(a){const n=Dn(a),l=s.filter(r=>{const c=!r.brand||r.brand===a.brand,o=!r.category||r.category===a.category,u=(!r.min_price||a.mop>=r.min_price)&&(!r.max_price||a.mop<=r.max_price),m=new Date(r.start_date)<=new Date&&new Date(r.end_date)>=new Date;return c&&o&&u&&m&&r.status==="active"});T.push({...a,qty:1,imei:"",serial_number:"",mac_id:"",manufacturing_date:"",showDetails:!1,installation_required:n,installation_date:"",discount_type:null,discount_value:0,discount_amount:0,scheme_id:null,scheme_name:null,final_price:a.mop,applicableSchemes:l,showDiscount:!1,extraFields:[]});const i=document.getElementById("sales-item-search");i&&(i.value=""),window.triggerRender()}}window.toggleCartItemDiscount=e=>{if(T[e]){T[e].showDiscount=!T[e].showDiscount;const t=document.querySelector(".scrolling-content"),s=t?t.scrollTop:0;window.triggerRender(),requestAnimationFrame(()=>{t&&(t.scrollTop=s);const a=document.querySelector(`[data-cart-item="${e}"]`);a&&T[e].showDiscount&&setTimeout(()=>a.scrollIntoView({behavior:"smooth",block:"nearest"}),50)})}};window.applyStoreDiscount=(e,t)=>{if(T[e]){const s=T[e],a=parseFloat(t)||0;a>0&&a<=100?(s.discount_type="store",s.discount_value=a,s.discount_amount=Math.round(s.mop*a/100),s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop-s.discount_amount,s.showDiscount=!1):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.applySchemeDiscount=(e,t)=>{if(T[e]){const s=T[e],n=(window.getCache().schemes||[]).find(l=>l.id===t);n?(s.discount_type="scheme",s.scheme_id=n.id,s.scheme_name=n.name,n.discount_type==="percentage"?(s.discount_value=n.discount_value,s.discount_amount=Math.round(s.mop*n.discount_value/100)):(s.discount_value=n.discount_value,s.discount_amount=n.discount_value),s.final_price=s.mop-s.discount_amount,s.showDiscount=!1):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.clearItemDiscount=e=>{if(T[e]){const t=T[e];t.discount_type=null,t.discount_value=0,t.discount_amount=0,t.scheme_id=null,t.scheme_name=null,t.final_price=t.mop,window.triggerRender()}};function er(e,t){Be=e,ut=t;const s=document.getElementById("customer-dropdown-menu");s&&s.classList.add("hidden");const n=(window.getCache().companies||[]).find(l=>l.customer_id===e);n&&(Ke=n.name,Qe=n.gst_number),window.triggerRender()}window.updateCartItemDetail=(e,t,s)=>{T[e]&&(T[e][t]=s)};window.toggleCartItemDetails=e=>{if(T[e]){T[e].showDetails=!T[e].showDetails;const t=document.querySelector(".scrolling-content"),s=t?t.scrollTop:0;window.triggerRender(),requestAnimationFrame(()=>{t&&(t.scrollTop=s);const a=document.querySelector(`[data-cart-item="${e}"]`);a&&T[e].showDetails&&setTimeout(()=>a.scrollIntoView({behavior:"smooth",block:"nearest"}),50)})}};window.toggleItemInstallation=e=>{T[e]&&(T[e].installation_required=!T[e].installation_required,T[e].installation_required||(T[e].installation_date=""),window.triggerRender())};window.updateItemInstallationDate=(e,t)=>{T[e]&&(T[e].installation_date=t)};const jd="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";function Pd(){return localStorage.getItem("openai_api_key")||jd}window.captureDeviceImage=async e=>{const t=Pd(),s=document.createElement("input");s.type="file",s.accept="image/*",s.capture="environment",s.onchange=async a=>{const n=a.target.files[0];if(n){rs=!0,Ea="Reading image...",window.triggerRender(!1);try{const l=await Nd(n);Ea="AI analyzing...",qd(e,Ea);const i=T[e],r={name:i.name,brand:i.brand,category:i.category},c=await Bd(l,r,t);T[e]&&c&&(c.imei&&(T[e].imei=c.imei),c.serial_number&&(T[e].serial_number=c.serial_number),c.mac_id&&(T[e].mac_id=c.mac_id),c.manufacturing_date&&(T[e].manufacturing_date=c.manufacturing_date),c.extraFields&&c.extraFields.length>0&&(T[e].extraFields=[...T[e].extraFields||[],...c.extraFields])),rs=!1,window.triggerRender(!1);const o=[];c.imei&&o.push("IMEI"),c.serial_number&&o.push("Serial"),c.mac_id&&o.push("MAC ID"),c.manufacturing_date&&o.push("Mfg Date"),c.extraFields&&c.extraFields.forEach(u=>o.push(u.label)),o.length>0?window.toast.success(`Found: ${o.join(", ")}`):window.toast.warning("No device details found. Try a clearer image.")}catch(l){console.error("AI Vision Error:",l),rs=!1,window.triggerRender(!1),window.toast.error(l.message||"Error analyzing image")}}},s.click()};function Nd(e){return new Promise((t,s)=>{const a=new FileReader;a.onload=()=>{const n=a.result.split(",")[1];t(n)},a.onerror=s,a.readAsDataURL(e)})}function qd(e,t){const s=document.getElementById(`ocr-progress-${e}`);s&&(s.textContent=t)}async function Bd(e,t,s){var c,o,u,m;const a=`You are analyzing a product label/box image to extract device information.
...
Example response:
{
  ...
  "extraFields": [{"key": "model", "label": "Model", "value": "SM-A546E"}]
            ...
            <section class="space-y-4 text-left">
                <div class="flex items-center justify-between text-left">
                    <h3 class="text-[9px] font-black text-slate-400 uppercase tracking-widest text-left">
                        Cart (${T.length})
                        ${c>0?`<span class="ml-2 text-slate-600">${c} install</span>`:""}
                    </h3>
        ...
        `:""}
    `}function bl(e){const t=new Date(e);return t.setHours(0,0,0,0),t}function wa(e){const t=new Date(e);return t.setHours(23,59,59,999),t}function za(e,t,s,a){if(t==="all")return e;const n=new Date,l=bl(n);return e.filter(i=>{const r=new Date(i.date);switch(t){case"today":return r>=l&&r<=wa(n);case"week":{const c=new Date(l);return c.setDate(c.getDate()-c.getDay()),r>=c&&r<=wa(n)}case"month":{const c=new Date(l.getFullYear(),l.getMonth(),1);return r>=c&&r<=wa(n)}case"custom":{if(!s&&!a)return!0;const c=s?bl(new Date(s)):new Date(0),o=a?wa(new Date(a)):new Date;return r>=c&&r<=o}default:return!0}})}window.toggleDateFilterDropdown=e=>{e&&e.stopPropagation();const t=document.getElementById("date-filter-dropdown");t&&t.classList.toggle("hidden")};window.updateHistoryFromDate=e=>{p.historyFromDate=e,p.historyToDate&&(p.historyDateFilter="custom",window.triggerRender())};window.updateHistoryToDate=e=>{p.historyToDate=e,p.historyFromDate&&(p.historyDateFilter="custom",window.triggerRender())};function ar(){const e=window.getCache(),t=e.sales||[],s=e.saleItems||[],a=(e.storeOrders||[]).filter(f=>f.order_status!=="delivered"&&f.order_status!=="cancelled"),n=t.filter(f=>f.status==="draft"),l=t.filter(f=>f.status!=="draft"),i=p.historyViewMode||"completed",r=p.historyDateFilter||"all",c=za(n,r,p.historyFromDate,p.historyToDate),o=za(l,r,p.historyFromDate,p.historyToDate),u=za(a.map(f=>({...f,date:f.order_date})),r,p.historyFromDate,p.historyToDate),m=i==="drafts"?c:i==="online"?u:o,b=()=>{switch(r){case"today":return"Today";case"week":return"This Week";case"month":return"This Month";case"custom":return p.historyFromDate||p.historyToDate?"Custom Range":"All Time";default:return"All Time"}},y=f=>{switch(f){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}},w=f=>{switch(f){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Paid"}};return`
        ${Zi("history")}
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left">
            ...
            `:`
                <section class="space-y-3 text-left">
                    ${i==="online"?`
                        <!-- Online Orders List -->
                        ${u.map(f=>{const x=(e.storeOrderItems||[]).filter(E=>E.order_id===f.id),g=x[0]?x[0].product_name:"Order items",$=x.length>1?`+ ${x.length-1} more`:"",C=E=>{switch(E){case"pending":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-200 text-slate-600">Pending</span>';case"confirmed":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-300 text-slate-700">Confirmed</span>';case"shipped":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-300 text-slate-700">Shipped</span>';default:return""}};return`
                                <button type="button" onclick="window.setApp('mystore'); window.setActiveStoreOrder('${f.id}')" class="card p-4 sm:p-6 border-2 transition-all cursor-pointer text-left w-full border-transparent hover:border-slate-200">
                                    ...
                                    <div class="space-y-1 text-left">
                                        <p class="text-[10px] font-bold text-slate-500 uppercase text-left truncate">${g} ${$}</p>
                                        <div class="flex items-center justify-between text-left">
                    ...
                    `:i==="drafts"?`
                        <!-- Drafts List -->
                        ${c.map(f=>{const x=s.filter(C=>C.sale_id===f.id),g=x[0]?x[0].product_name:"No items",$=x.length>1?`+ ${x.length-1} more`:"";return`
                                <div class="card border-2 border-dashed overflow-hidden ${p.salesHistoryId===f.id?"border-slate-900 shadow-lg":"border-slate-200"}">
                                    <button type="button" onclick="window.setSalesHistoryId('${f.id}')" class="p-5 text-left w-full">
                                        ...
                                        <div class="space-y-1 text-left">
                                            <p class="text-[10px] font-bold text-slate-500 uppercase text-left">${g} ${$}</p>
                    ...
                    `:`
                        ...
                        ${o.map(f=>{const x=s.filter(L=>L.sale_id===f.id),g=x[0]?x[0].product_name:"Custom Sale",$=x.length>1?`+ ${x.length-1} more`:"",C=y(f.payment_mode),E=w(f.payment_mode);return`
...
`,t+="Powered by RetailerOS",t}function Hd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Gd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function lr(){const e=p.currentTab==="history",t=Va();if(!t)return`<div class="p-10 text-center opacity-40 flex flex-col items-center justify-center h-full">
                ...
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <span class="material-icons-outlined text-sm">${Hd(t.paymentMode)}</span>
                        </div>
                        <div class="text-left">
                            <p class="text-[9px] font-black uppercase tracking-widest text-left">Paid via ${Gd(t.paymentMode)}</p>
    ...
    `}function hl(){const e=window.getCache(),t=e.customers||[],s=p.clientSearchQuery||"",n=[...s?t.filter(l=>l.name.toLowerCase().includes(s.toLowerCase())||l.phone&&l.phone.includes(s)||l.email&&l.email.toLowerCase().includes(s.toLowerCase())):t].sort((l,i)=>new Date(i.joined_at||0)-new Date(l.joined_at||0));return`
        ...
        <div class="scrolling-content px-4 sm:px-8 space-y-6 relative text-left">
            ...
            <div class="space-y-3 pb-24 text-left">
                ...
                `:n.map(l=>{var c;const i=(e.sales||[]).filter(o=>o.customer_id===l.id&&o.status!=="draft"),r=i.reduce((o,u)=>o+(u.total_amount||0),0);return(c=i[0])==null||c.date,`
    ...
    `}window.updateClientSearch=e=>{const t=document.getElementById("client-search-input"),s=(t==null?void 0:t.selectionStart)||e.length;p.clientSearchQuery=e,window.triggerRender(!1),setTimeout(()=>{const a=document.getElementById("client-search-input");a&&(a.focus(),a.setSelectionRange(s,s))},0)};async function Wd(){const e=document.getElementById("client-name"),t=document.getElementById("client-phone"),s=document.getElementById("client-email"),a=document.getElementById("client-location");if(!e||!t){console.error("Form inputs not found"),window.toast.error("Form error. Please try again.");return}const n=e.value.trim(),l=t.value.trim(),i=s.value.trim(),r=a?a.value.trim():"";if(!n||!l){window.toast.warning("Name and Phone are required");return}const c=document.getElementById("save-client-btn");let o="";c&&(o=c.innerHTML,c.innerHTML='<span class="material-icons-outlined animate-spin text-xs">sync</span> Saving...',c.disabled=!0);try{const u="CL-"+Math.random().toString(36).substr(2,6).toUpperCase();console.log("Saving client:",{id:u,name:n,phone:l,email:i,location:r}),await A.clients.add({id:u,name:n,phone:l,email:i,location:r}),console.log("Client saved successfully"),await Y(),window.toast.success("Client added successfully!"),p.currentApp==="sales"?(er(u,n),Ul("default")):Fl("directory")}catch(u){console.error("Error saving client:",u),window.toast.error("Error saving client: "+u.message),c&&(c.innerHTML=o,c.disabled=!1)}}window.saveClient=Wd;function gn(e){const t=e==="desktop";return`
    ...
    `}function gl(e){var f;const t=e==="desktop",s=window.getCache(),a=((f=s.customers)==null?void 0:f.find(x=>x.id===p.selectedClientId||x.name===p.selectedClient))||{name:p.selectedClient||"Unknown",joined_at:new Date().toISOString()},n=a.name?a.name.split(" ").map(x=>x[0]).join("").toUpperCase():"?",l=(s.sales||[]).filter(x=>x.customer_id===a.id&&x.status!=="draft").sort((x,g)=>new Date(g.date)-new Date(x.date)),i=s.saleItems||[],r=(s.inquiries||[]).filter(x=>x.customer_id===a.id||x.customer_name===a.name),c=(s.repairs||[]).filter(x=>x.customer_id===a.id||x.customer_name===a.name),o=(s.automations||[]).filter(x=>x.customer_id===a.id),u=s.automationMessages||[],m=(s.communications||[]).filter(x=>x.customer_id===a.id),b=l.reduce((x,g)=>x+(g.total_amount||0),0),y=l.length,w=[...l.map(x=>({type:"sale",date:x.date,data:x,items:i.filter(g=>g.sale_id===x.id)})),...c.map(x=>({type:"repair",date:x.created_at||x.date,data:x})),...r.map(x=>({type:"inquiry",date:x.date||x.created_at,data:x})),...o.map(x=>({type:"automation",date:x.created_at,data:x,messages:u.filter(g=>g.automation_id===x.id)})),...m.map(x=>({type:"communication",date:x.sent_at,data:x}))].sort((x,g)=>new Date(g.date)-new Date(x.date));return`
            ...
            <div class="space-y-6 text-left">
                ...
                `:`
                    ...
                    <div class="relative pl-8 sm:pl-10 space-y-6 before:absolute before:left-3 sm:before:left-4 before:top-2 before:bottom-2 before:w-px before:bg-slate-100 before:border-l before:border-dashed before:border-slate-200 text-left">
                        ${w.map(x=>{if(x.type==="sale"){const g=x.data,$=x.items;return`
                                    <div class="relative text-left">
                                        ...
                                        <button type="button" onclick="window.viewClientInvoice('${g.id}')" class="card p-4 sm:p-5 group hover:border-slate-900 hover:shadow-lg transition-all text-left w-full cursor-pointer">
                                            <div class="flex justify-between items-start mb-3 text-left">
                                                <div class="text-left">
                                                    <div class="flex items-center gap-2 mb-1">
                                                        <h4 class="text-xs font-black text-slate-900 text-left">Purchase</h4>
                                                        ${g.gst_required?'<span class="bg-slate-200 text-slate-600 px-1.5 py-0.5 rounded text-[7px] font-black uppercase">GST</span>':""}
                                                        ${g.payment_mode?`<span class="bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded text-[7px] font-black uppercase">${g.payment_mode}</span>`:""}
                                                    </div>
                                                    <p class="text-xl font-black tracking-tighter text-left">₹${(g.total_amount||0).toLocaleString()}</p>
                                                </div>
                                                <div class="flex items-center gap-2">
                                                    <span class="text-[8px] font-black text-slate-300 tabular-nums uppercase tracking-widest text-right">${new Date(g.date).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})}</span>
                                            ...
                                            ${g.installation_required?`
                                                <div class="mt-3 pt-3 border-t border-slate-100 flex items-center gap-2 text-[9px] font-bold text-slate-500">
                                                    ...
                                                    Installation ${g.installation_date?`on ${new Date(g.installation_date).toLocaleDateString("en-GB",{day:"2-digit",month:"short"})}`:"Required"}
                                                </div>
                                            `:""}
                                        </button>
                                    </div>
                                `}if(x.type==="repair"){const g=x.data;return`
                                    <div class="relative text-left">
                                        <div class="absolute -left-8 sm:-left-10 top-0 w-6 h-6 sm:w-8 sm:h-8 bg-white border border-slate-100 rounded-xl flex items-center justify-center z-10 shadow-sm text-center">
                                        ...
                                        <div class="card p-4 sm:p-5 group hover:border-slate-300 transition-all text-left">
                                            <div class="flex justify-between items-start mb-2 text-left">
                                                <div class="text-left">
                                                    ...
                                                    <p class="text-lg font-black tracking-tighter text-left">₹${g.cost||"Estimating"}</p>
                                                </div>
                                                <span class="text-[8px] font-black text-slate-300 tabular-nums uppercase tracking-widest text-right">${new Date(g.created_at||g.date).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})}</span>
                                            </div>
                                            <p class="text-[8px] font-black text-slate-400 uppercase tracking-widest text-left">${g.device_model||"Device"} • ${g.status||"In Progress"}</p>
                                        </div>
                                    </div>
                                `}if(x.type==="inquiry"){const g=x.data;return`
                                    <div class="relative text-left">
                                        <div class="absolute -left-8 sm:-left-10 top-0 w-6 h-6 sm:w-8 sm:h-8 bg-white border border-slate-100 rounded-xl flex items-center justify-center z-10 shadow-sm text-center">
                                        ...
                                        <div class="card p-4 sm:p-5 flex justify-between items-start group hover:border-slate-300 transition-all text-left">
                                            <div class="text-left">
                                                ...
                                                <p class="text-[11px] font-bold text-slate-500 text-left">${g.request||"Product Interest"}</p>
                                                <div class="flex items-center gap-1 mt-2 text-left">
                                                    <div class="w-1.5 h-1.5 ${g.status==="PENDING"||g.status==="pending"?"bg-slate-400":"bg-slate-900"} rounded-full text-left"></div>
                                                    <p class="text-[8px] font-black text-slate-400 uppercase text-left">${g.status||"Open"}</p>
                                                </div>
                                            </div>
                                            <span class="text-[8px] font-black text-slate-300 tabular-nums uppercase tracking-widest text-right">${new Date(g.date||g.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})}</span>
                                        </div>
                                    </div>
                                `}if(x.type==="automation"){const g=x.data,$=x.messages||[],C=$.filter(L=>L.status==="sent").length,E=$.filter(L=>L.status==="pending").length;return`
                                    <div class="relative text-left">
                                            ...
                                            <div class="flex justify-between items-start mb-2 text-left">
                                                <div class="text-left">
                                                    <div class="flex items-center gap-2 mb-1">
                                                        ...
                                                        <span class="bg-slate-900 text-white px-1.5 py-0.5 rounded text-[7px] font-black uppercase">${g.status}</span>
                                                    </div>
                                                    <p class="text-sm font-black tracking-tight text-left">${g.name}</p>
                                                </div>
                                                <span class="text-[8px] font-black text-slate-300 tabular-nums uppercase tracking-widest text-right">${new Date(g.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})}</span>
                                            </div>
                                ...
                                `}if(x.type==="communication"){const g=x.data,$=g.type==="whatsapp"?"chat":g.type==="call"?"call":"mail",C=g.type==="whatsapp"?"WhatsApp":g.type==="call"?"Phone Call":"Email";return`
                                    <div class="relative text-left">
                                        <div class="absolute -left-8 sm:-left-10 top-0 w-6 h-6 sm:w-8 sm:h-8 bg-white border border-slate-100 rounded-xl flex items-center justify-center z-10 shadow-sm text-center">
                                            <span class="material-icons-outlined text-xs text-slate-500 text-center">${$}</span>
                                        </div>
                                        <div class="card p-4 sm:p-5 group hover:border-slate-300 transition-all text-left">
                                            <div class="flex justify-between items-start mb-2 text-left">
                                                <div class="text-left flex-1 min-w-0">
                                                    <div class="flex items-center gap-2 mb-1">
                                                        ...
                                                        <span class="bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded text-[7px] font-black uppercase">${g.direction}</span>
                                                        ${g.status==="delivered"?'<span class="text-slate-400"><span class="material-icons-outlined text-xs">done_all</span></span>':""}
                                                    </div>
                                                    <p class="text-[10px] font-bold text-slate-500 text-left line-clamp-2">${g.content}</p>
                                                </div>
                                                <span class="text-[8px] font-black text-slate-300 tabular-nums uppercase tracking-widest text-right shrink-0 ml-2">${new Date(g.sent_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short"})}</span>
                                            </div>
                                        </div>
                                    </div>
                                `}return""}).join("")}
                ...
                `:`
                    ${l.length>0?`
                        <div class="pt-2">
                            ...
                            ${l.map(r=>{const c=s.filter(o=>o.group_id===r.id).length;return`
                                    <button type="button" onclick="window.setSelectedGroup('${r.id}'); window.setGroupViewMode('detail');" class="card p-4 sm:p-5 border-2 transition-all flex items-center justify-between group cursor-pointer text-left w-full mb-3 ${p.selectedGroupId===r.id?"border-slate-900 shadow-lg":"border-transparent hover:border-slate-200"}">
                                        ...
                                        <div class="text-right shrink-0 ml-2">
                                            <p class="text-xs font-black text-slate-900 tracking-tighter text-right">${c}</p>
                    ...
                    ${i.length>0?`
                        <div class="pt-2">
                            ...
                            ${i.map(r=>{const c=s.filter(o=>o.group_id===r.id).length;return`
                                    <button type="button" onclick="window.setSelectedGroup('${r.id}'); window.setGroupViewMode('detail');" class="card p-4 sm:p-5 border-2 transition-all flex items-center justify-between group cursor-pointer text-left w-full mb-3 ${p.selectedGroupId===r.id?"border-slate-900 shadow-lg":"border-transparent hover:border-slate-200"}">
                                        <div class="flex items-center gap-3 sm:gap-4 text-left flex-1 min-w-0">
    ...
    `}function Kd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=e.sales||[],l=t.find(u=>u.id===p.selectedGroupId);if(!l)return`
    ...
    `}function Qd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=t.find(r=>r.id===p.selectedGroupId);if(!n)return p.groupViewMode="list","";const l=s.filter(r=>r.group_id===n.id).map(r=>r.customer_id),i=a.filter(r=>!l.includes(r.id));return`
        <div class="h-full flex flex-col overflow-hidden">
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0">
                <div class="flex items-center gap-4">
                ...
                `:`
                    <div class="space-y-2">
                        ${i.map(r=>`
                            <div class="card p-3 flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center font-black text-[8px] text-slate-400">${r.name.split(" ").map(c=>c[0]).join("").toUpperCase()}</div>
                                    <div>
    ...
    `}function wl(){return Yd()}function vl(){switch(p.groupViewMode){case"create":return Jd();case"detail":return Kd();case"add-members":return Qd();default:return`
                <div class="h-full flex items-center justify-center text-slate-300 text-center p-8">
                    <div class="text-center">
            ...
            `}}function Xd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Zd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function yl(e="desktop"){var u,m;const t=window.getCache(),s=p.clientInvoiceId,a=(t.sales||[]).find(b=>b.id===s);if(!a)return`
        ...
        `;const n=(t.saleItems||[]).filter(b=>b.sale_id===a.id),l=(u=t.customers)==null?void 0:u.find(b=>b.id===a.customer_id),i=a.company_id?(m=t.companies)==null?void 0:m.find(b=>b.id===a.company_id):null,r=a.total_amount||0,c=n.map(b=>{let y=[];if(b.extra_fields)try{y=JSON.parse(b.extra_fields)}catch{}return{name:b.product_name,category:b.category||"Standard",price:b.price,imei:b.imei,serial_number:b.serial_number,mac_id:b.mac_id,manufacturing_date:b.manufacturing_date,installation_date:b.installation_date,extraFields:y}}),o={id:a.id,status:a.status,customer:a.customer_name,phone:(l==null?void 0:l.phone)||"N/A",date:new Date(a.date).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}),time:new Date(a.date).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0})+" IST",items:c,subtotal:r/1.18,gst:r-r/1.18,total:r,paymentMode:a.payment_mode,paymentReference:a.payment_reference,gstRequired:a.gst_required,company:i,installationRequired:a.installation_required,installationDate:a.installation_date};return`
                ...
                <div class="card p-6 sm:p-8 bg-white text-slate-900 leading-relaxed shadow-sm border border-slate-100">
                    ...
                    ${o.paymentMode?`
                        <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <span class="material-icons-outlined text-sm">${Xd(o.paymentMode)}</span>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest">Paid via ${Zd(o.paymentMode)}</p>
    ...
    `}window.shareInvoiceWhatsApp=e=>{var r,c;const t=window.getCache(),s=(t.sales||[]).find(o=>o.id===e);if(!s)return;const a=(r=t.customers)==null?void 0:r.find(o=>o.id===s.customer_id),n=(t.saleItems||[]).filter(o=>o.sale_id===s.id);let l=`INVOICE #${s.id}
`;l+=`━━━━━━━━━━━━━━━━━━━━
...
`,l+="Powered by RetailerOS";const i=`https://wa.me/${((c=a==null?void 0:a.phone)==null?void 0:c.replace(/\D/g,""))||""}?text=${encodeURIComponent(l)}`;window.open(i,"_blank")};function On(e){const t=e==="desktop-secondary",s=e==="desktop-primary";return t?p.clientViewMode==="add"?gn("desktop"):p.clientViewMode==="invoice"?yl("desktop"):p.clientViewMode==="profile"?gl("desktop"):p.clientViewMode==="groups"?vl():`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:s?p.clientViewMode==="groups"?wl():hl():p.clientViewMode==="add"?gn("mobile"):p.clientViewMode==="invoice"?yl("mobile"):p.clientViewMode==="profile"?gl("mobile"):p.clientViewMode==="groups"?p.groupViewMode==="detail"||p.groupViewMode==="create"||p.groupViewMode==="add-members"?vl():wl():hl()}window._reportDateFilter||(window._reportDateFilter={from:"",to:"",show:!1});window._toggleReportsDatePicker=()=>{window._reportDateFilter.show=!window._reportDateFilter.show,window.triggerRender()};window._setReportDateFilter=()=>{var s,a;const e=(s=document.getElementById("report-date-from"))==null?void 0:s.value,t=(a=document.getElementById("report-date-to"))==null?void 0:a.value;window._reportDateFilter.from=e||"",window._reportDateFilter.to=t||"",window._reportDateFilter.show=!1,window.toast&&window.toast.success(e||t?`Filtered: ${e||"start"} to ${t||"now"}`:"Filter cleared"),window.triggerRender()};window._clearReportDateFilter=()=>{window._reportDateFilter={from:"",to:"",show:!1},window.toast&&window.toast.success("Date filter cleared"),window.triggerRender()};window._exportReportsCSV=()=>{const e=window.getCache(),t=p.reportsTab||"overview";let s,a,n;if(t==="sales"||t==="overview"){const o=e.sales||[];s=["ID","Date","Customer","Product","Amount","Status","Payment Mode"],a=o.map(u=>[u.id,u.date,u.customer_name||"",u.product_name||"",u.total_amount||u.total||"",u.status||"",u.payment_mode||""]),n="sales_report.csv"}else if(t==="inventory"){const o=e.products||[];s=["ID","Name","Brand","Category","MOP","Price","Stock"],a=o.map(u=>[u.id,u.name,u.brand||"",u.category||"",u.mop||"",u.price||"",u.stock||""]),n="inventory_report.csv"}else{const o=e.automations||[];s=["ID","Customer","Template","Status","Created"],a=o.map(u=>[u.id,u.customer_name||"",u.template_name||"",u.status||"",u.created_at||""]),n="marketing_report.csv"}const l=[s.join(","),...a.map(o=>o.map(u=>`"${u}"`).join(","))].join(`
`),i=new Blob([l],{type:"text/csv"}),r=URL.createObjectURL(i),c=document.createElement("a");c.href=r,c.download=n,c.click(),URL.revokeObjectURL(r),window.toast&&window.toast.success(`${n} downloaded`)};const Ya=(e,t,s=[])=>{const a=window._reportDateFilter||{},n=a.from||a.to;return`
...
`;window.setRepairCustomer=(e,t)=>{p.repairContext={customer_name:e,customer_phone:t},D()};function np(){const e=document.getElementById("repair-search-input"),t=e?e.value.trim():"",s=window.getCache?window.getCache():{customers:[]},a=t?s.customers.filter(n=>n.name.toLowerCase().includes(t.toLowerCase())||n.phone.includes(t)):[];return`
    ...
    `}async function rp(e){if(p.activeRepairId)try{await A.repairs.updateStatus(p.activeRepairId,e),await Y()}catch(t){alert("Update failed: "+t.message)}}window.updateRepairStatus=rp;window._showReassignPicker||(window._showReassignPicker=!1);window._toggleReassignPicker=()=>{window._showReassignPicker=!window._showReassignPicker,window.triggerRender()};window._reassignRepair=async e=>{window._showReassignPicker=!1,window.toast&&window.toast.success(`Reassigned to ${e}`),window.triggerRender()};function op(){const e=window.getCache(),t=e.repairs.find(n=>n.id===p.activeRepairId)||e.repairs[0];if(!t)return'<div class="p-20 text-center opacity-30 text-[10px] font-black uppercase">No active job selected</div>';const s=[{l:"Collected",s:"COLLECTED",i:"done"},{l:"Sent to Brand",s:"SENT_TO_BRAND",i:"shipping"},{l:"At Service Center",s:"IN_REPAIR",i:"build"},{l:"Ready for Pickup",s:"READY",i:"check_circle"},{l:"Handed Over",s:"COMPLETED",i:"person"}],a=s.findIndex(n=>n.s===t.status);return`
    ...
    `}function kl(){const t=window.getCache().repairs||[];return`
    ...
    `}function Pn(e){const t={search:{t:"RetailerOS",s:"Repairs Management",txn:null},intake:{t:"Device Intake",s:"Repair Management",txn:"TXN-4920"},status:{t:"Job ID: #REP-2024",s:"Repair Assignment",badge:"ACTIVE"},history:{t:"Job History",s:"Service Records",badge:null}},s={search:np(),intake:ip(),status:op()};if(e==="desktop-primary")return`
            ...
            <div class="scrolling-content px-8 space-y-8 pb-12">
                ${p.repairTab==="active"?s.search:kl()}
            </div>
        `;if(e==="desktop-secondary"){const r=p.repairViewMode==="search"?"status":p.repairViewMode,c=t[r],o=r==="intake"?`<span class="text-[8px] font-black text-slate-300 bg-slate-50 px-2 py-1 rounded">${c.txn}</span>`:`<span class="bg-slate-200 text-slate-600 text-[8px] font-black px-2 py-1 rounded-full">${c.badge}</span>`;return`
            ${Ja(c.t,c.s,o)}
            <div class="scrolling-content px-8 space-y-8 pb-12">
        ...
        <div class="h-full flex flex-col bg-white overflow-hidden">
            ${Ja(n.t,n.s,i,l)}
            <div class="scrolling-content px-8 space-y-8 pb-12">
                ${p.repairTab==="history"?kl():s[p.repairViewMode]}
            </div>
        </div>
    `}function cp(){return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
    ...
    `}window._marketingState||(window._marketingState={generatedImageUrl:null,generatedPrompt:null,isGenerating:!1,uploadedImages:[],currentSuggestions:[],lastError:null});const dp=["Diwali special offer poster for mobile phones under ₹15,000","New iPhone launch announcement for electronics store","Independence Day sale banner with 20% off on all appliances","Grand opening celebration poster for electronics showroom","EMI offer creative for Samsung Galaxy series smartphones","Navratri festive discount poster for home appliances","Back to school deals on laptops and tablets","Summer sale poster for air conditioners and coolers","Republic Day clearance sale for TVs and home theater","Raksha Bandhan gift guide for smartphones and watches","Year end stock clearance for washing machines and fridges","New store branch opening announcement poster","Cashback offer poster for credit card payments on electronics","Exchange offer creative for old phone trade-in program","Service center launch poster for mobile and laptop repairs","Holi celebration offer on phone cases and accessories","Wedding season deals on premium home appliances","Monsoon sale on waterproof gadgets and devices","Christmas and New Year electronics mega sale poster","Flash sale countdown poster for limited stock flagship phones"];function pp(){if(window._marketingState.currentSuggestions.length===0){const e=[...dp].sort(()=>Math.random()-.5);window._marketingState.currentSuggestions=e.slice(0,5)}return window._marketingState.currentSuggestions}window._refreshMarketingSuggestions=()=>{window._marketingState.currentSuggestions=[],window.triggerRender()};window._fillMarketingPrompt=e=>{const t=document.getElementById("marketing-prompt");t&&(t.value=e)};window._uploadMarketingImage=()=>{const e=document.createElement("input");e.type="file",e.accept="image/*",e.multiple=!0,e.onchange=t=>{Array.from(t.target.files).forEach(a=>{const n=new FileReader;n.onload=l=>{window._marketingState.uploadedImages.push({base64:l.target.result,name:a.name,size:(a.size/1024).toFixed(0)+" KB"}),window.triggerRender()},n.readAsDataURL(a)})},e.click()};window._removeMarketingImage=e=>{window._marketingState.uploadedImages.splice(e,1),window.triggerRender()};const up="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";function rr(){return localStorage.getItem("openai_api_key")||up}window._generateCreative=async()=>{var n,l,i,r,c,o,u;const e=rr(),t=document.getElementById("marketing-prompt"),s=(n=t==null?void 0:t.value)==null?void 0:n.trim();if(!s){window.toast&&window.toast.error("Enter a prompt to generate a creative");return}const a=window._marketingState;a.isGenerating=!0,a.lastError=null,a.generatedPrompt=s,window.triggerRender();try{let m=s;if(a.uploadedImages.length>0){const x=a.uploadedImages.map($=>({type:"image_url",image_url:{url:$.base64,detail:"low"}})),g=await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({model:"gpt-4o-mini",messages:[{role:"user",content:[{type:"text",text:`You are a marketing creative expert for an Indian electronics retail store. The user wants to create a marketing creative with this prompt: "${s}". They have uploaded reference images. Analyze the images and create an enhanced, detailed DALL-E prompt that incorporates visual elements from the images. Keep the Indian retail context. Output ONLY the enhanced prompt, nothing else. Max 200 words.`},...x]}],max_tokens:300})});g.ok&&(m=((r=(i=(l=(await g.json()).choices)==null?void 0:l[0])==null?void 0:i.message)==null?void 0:r.content)||s)}const b=`Create a professional marketing poster/creative for an Indian electronics retail store. Style: modern, clean, vibrant, professional. ${m}. The design should be suitable for social media, WhatsApp status, and print. Include bold typography if text is needed. Indian market context.`,y=await fetch("https://api.openai.com/v1/images/generations",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({model:"dall-e-3",prompt:b,n:1,size:"1024x1024",quality:"standard"})});if(!y.ok){const x=await y.json().catch(()=>({}));throw new Error(((c=x.error)==null?void 0:c.message)||`API error: ${y.status}`)}const f=((u=(o=(await y.json()).data)==null?void 0:o[0])==null?void 0:u.url)||null;if(a.generatedPrompt=s,f){try{const g=await(await fetch(f)).blob(),$=new FileReader;a.generatedImageUrl=await new Promise(C=>{$.onloadend=()=>C($.result),$.readAsDataURL(g)})}catch{a.generatedImageUrl=f}window.toast&&window.toast.success("Creative generated!")}else throw new Error("No image returned from API")}catch(m){console.error("Creative generation failed:",m),a.lastError=m.message,window.toast&&window.toast.error("Generation failed: "+m.message)}finally{a.isGenerating=!1,window.triggerRender()}};function _l(){rr();const e=window._marketingState,t=pp();return`
        ${cp()}
    ...
    `}function Nn(e){const t=e==="desktop-secondary",s=e==="mobile";if(t)return Sl();if(s){const a=window._marketingState||{},n=a.generatedImageUrl||a.isGenerating||a.lastError;return`
            ${_l()}
            ${n?`
                <div class="px-4 pb-8">
                    ${Sl()}
    ...
    `}if(!window._promoterCheckIns)try{window._promoterCheckIns=JSON.parse(localStorage.getItem("promoter_checkins")||"{}")}catch{window._promoterCheckIns={}}window._togglePromoterCheckIn=(e,t)=>{t&&t.stopPropagation(),window._promoterCheckIns[e]=!window._promoterCheckIns[e],localStorage.setItem("promoter_checkins",JSON.stringify(window._promoterCheckIns)),window.toast&&window.toast.success(window._promoterCheckIns[e]?"Checked in":"Checked out"),window.triggerRender()};const fp=[{id:"P1",initials:"RS",name:"Rohan S.",role:"PREMIUM BRAND"},{id:"P2",initials:"AK",name:"Ananya K.",role:"STORE STAFF"},{id:"P3",initials:"VM",name:"Vikram M.",role:"ELECTRONICS PRO"},{id:"P4",initials:"SD",name:"Sarah D.",role:"AUDIO SPECIALIST"}];function mp(){const t=(window.getCache().teamMembers||[]).filter(n=>n.status==="active"),s=[...fp,...t.map(n=>({id:n.id,initials:n.name.split(" ").map(l=>l[0]).join("").slice(0,2).toUpperCase(),name:n.name,role:(n.role||"STAFF").toUpperCase()}))],a=s.filter(n=>window._promoterCheckIns[n.id]).length;return`
        ${xp()}
    ...
    `}window._confirmPromoterHire=async()=>{var n,l,i,r,c,o,u;const e=(l=(n=document.getElementById("promoter-name"))==null?void 0:n.value)==null?void 0:l.trim(),t=(r=(i=document.getElementById("promoter-phone"))==null?void 0:i.value)==null?void 0:r.trim(),s=(o=(c=document.getElementById("promoter-hire-date"))==null?void 0:c.value)==null?void 0:o.trim(),a=(u=document.getElementById("promoter-brand"))==null?void 0:u.value;if(!e){window.toast&&window.toast.error("Full name is required");return}try{const m="TM-"+Math.random().toString(36).substr(2,8).toUpperCase();await A.teamMembers.add({id:m,name:e,role:a&&a!=="Select Brand"?`${a} Promoter`:"Store Staff",phone:t||null,email:null,status:"active",joined_at:s||new Date().toISOString().split("T")[0]});const b=(()=>{var f;const y=window.getCache(),w=localStorage.getItem("retaileros_retailer_id");return((f=y.retailers)==null?void 0:f.find(x=>x.id===w))||{}})();A.activityLogs.add({action:"team",detail:`Hired new promoter: ${e}`,user_name:b.contact_person||"Owner",icon:"person_add",color:"green"}),await Y(),window.toast&&window.toast.success(`${e} added to team`),window.setPromoterViewMode("list")}catch(m){console.error("Hire failed:",m),window.toast&&window.toast.error("Failed to add team member")}};function $l(){return`
    ...
    `}function qn(e){const t=e==="desktop-secondary";if(window.setPromoterViewMode=s=>{p.promoterViewMode=s,D()},t)return p.promoterViewMode==="onboarding"?$l():El();if(e==="mobile"){if(p.promoterViewMode==="onboarding")return $l();if(p.promoterViewMode==="performance")return El()}return mp()}function bp(){return`
    ...
    `}function gp(){const s=((window.getCache?window.getCache():{products:[]}).products||[]).reduce((i,r)=>{const c=r.category||"Uncategorized";i[c]||(i[c]={count:0,blocked:0,margin:0,icon:"category"}),i[c].count+=parseInt(r.stock)||0;const o=parseInt(r.price)||0,u=o*.9;return i[c].blocked+=(parseInt(r.stock)||0)*u,i[c].margin+=(o-u)*(parseInt(r.stock)||0),c.toLowerCase().includes("phone")?i[c].icon="smartphone":c.toLowerCase().includes("tablet")?i[c].icon="tablet_mac":c.toLowerCase().includes("audio")&&(i[c].icon="headphones"),i},{}),a=Object.keys(s),n=Object.values(s).reduce((i,r)=>i+r.blocked,0),l=Object.values(s).reduce((i,r)=>i+r.margin,0);return`
        <div class="scrolling-content px-6 space-y-4 pb-32">
    ...
    `}function Cl(){const t=(window.getCache?window.getCache():{products:[]}).products||[];return`
         <div class="h-full flex flex-col relative bg-white text-left">
            <!-- Header -->
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar bg-slate-50/50 text-left">
                ...
                `:t.map(s=>{const a=parseInt(s.stock)||0,n=parseInt(s.price)||0,l=n*1.1,i=n*.9,r=a*i,c=(n-i)*a;return`
                    <div class="card p-5 bg-white border border-slate-200 hover:border-slate-300 transition-all shadow-sm group text-left">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4 text-left">
                            <div class="text-left">
                             ...
                             <div class="text-right">
                                <p class="text-[7px] font-black text-slate-400 uppercase tracking-widest mb-0.5 text-right">EXPECTED MARGIN</p>
                                <h4 class="text-sm font-black text-slate-900 tracking-tight text-right">₹${c.toLocaleString()}</h4>
                            </div>
                        </div>
    ...
    `}function Bn(e){const t=e==="desktop-secondary";if(window.setInventoryTab=s=>{p.inventoryTab=s,D()},window.setInventoryMode=s=>{p.inventoryMode=s,D()},t)return p.inventoryMode==="inward"?Il():Cl();if(e==="mobile"){if(p.inventoryMode==="inward")return Il();if(p.inventoryMode==="details")return Cl()}return`
        <div class="h-full flex flex-col relative bg-white">
            ${bp()}
            ${p.inventoryTab==="brands"?hp():gp()}
        </div>
    ...
    `}function yp(){const e=p.settingsSubView==="add",t=p.settingsActiveRole||"Store Manager";return`
         <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
    ...
    `}function Ep(){var n;const e=p.settingsSubView==="edit",t=window.getCache(),s=localStorage.getItem("retaileros_retailer_id"),a=((n=t.retailers)==null?void 0:n.find(l=>l.id===s))||null;return a?`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
    ...
    `}function Ip(){var l;const e=(()=>{var c;const i=window.getCache(),r=localStorage.getItem("retaileros_retailer_id");return((c=i.retailers)==null?void 0:c.find(o=>o.id===r))||{}})(),s=((l=window.getCache().retailerSettings)==null?void 0:l.security)||{},a={otp_on_login:s.otp_on_login??!0,email_verification:s.email_verification??!1,auto_logout_timer:s.auto_logout_timer??"30 min",remember_device:s.remember_device??!0},n=["15 min","30 min","1 hour","4 hours","Never"];return`
                ...
                <div class="flex items-start justify-between text-left">
                    <div class="flex items-start gap-4 text-left">
                        <div class="w-12 h-12 ${o?"bg-slate-100":"bg-slate-50"} rounded-2xl flex items-center justify-center shrink-0">
                            <span class="material-icons-outlined text-slate-500 text-xl">${c.icon}</span>
                        </div>
                        <div class="text-left">
                            <p class="text-sm font-black text-slate-900">${c.name}</p>
                            <p class="text-[10px] font-bold text-slate-500 mt-1 leading-relaxed">${c.desc}</p>
                        </div>
                    </div>
                    ${o?'<span class="shrink-0 ml-3 text-[8px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full bg-slate-900 text-white">Active</span>':`<button onclick="window._togglePlugin('${c.key}','${c.name.replace(/'/g,"\\'")}','available')" class="shrink-0 ml-3 text-[8px] font-black uppercase tracking-widest px-3 py-1.5 rounded-lg bg-slate-900 text-white hover:bg-slate-800 transition-all">Connect</button>`}
                </div>
                ${o?`
                    <div class="flex gap-2 mt-4 pl-16 text-left">
                        ...
                        <button onclick="window._togglePlugin('${c.key}','${c.name.replace(/'/g,"\\'")}','connected')" class="px-4 py-2 bg-white border border-slate-200 rounded-lg text-[8px] font-black text-slate-400 uppercase tracking-widest hover:bg-slate-50 transition-all">Disconnect</button>
                    </div>
                `:""}
            </div>
        `};return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar text-left">
                ...
                ${a.map(c=>`
                    <div class="p-6 space-y-4 border-b border-dashed border-slate-200 text-left">
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 text-left">
                            <span class="w-1.5 h-1.5 bg-slate-400 rounded-full"></span> ${c.label}
                        </p>
                        <div class="space-y-3 text-left">
                            ${c.plugins.map(o=>r(o)).join("")}
                        </div>
                    </div>
                `).join("")}
    ...
    `}function Tp(){const e=(()=>{var u;const c=window.getCache(),o=localStorage.getItem("retaileros_retailer_id");return((u=c.retailers)==null?void 0:u.find(m=>m.id===o))||{}})(),t=window.getCache(),s=t.teamMembers||[],a=t.teamRoles||[],n=s.length>0?s:[{id:"owner",name:e.contact_person||"Store Owner",role:"Owner",phone:e.mobile_number||"—",status:"active"}],l=a.length>0?a.map(c=>{let o=c.permissions;try{o=typeof o=="string"?JSON.parse(o):o}catch{o={}}return{...c,permissions:o,count:n.filter(u=>u.role===c.name).length}}):[{name:"Owner",count:n.filter(c=>c.role==="Owner").length||1,color:"slate",description:"Full access to all modules, settings & billing"},{name:"Store Manager",count:n.filter(c=>c.role==="Store Manager").length,color:"slate",description:"Sales, inventory, customers, reports. No billing or team settings"},{name:"Sales Executive",count:n.filter(c=>c.role==="Sales Executive").length,color:"slate",description:"New sales, customer lookup, inquiries. No reports or settings"},{name:"Technician",count:n.filter(c=>c.role==="Technician").length,color:"slate",description:"Repairs module only. View assigned jobs, update status"}],i=l.length>0?l.map(c=>c.name):["Owner","Store Manager","Sales Executive","Technician"];window._addTeamMember=async function(){const c=prompt("Team member name:");if(!c||!c.trim())return;const o=prompt("Phone number:"),u=prompt(`Role (${i.join(", ")}):`);if(!u)return;const m=`tm_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;try{await A.teamMembers.add({id:m,name:c.trim(),role:u,phone:o||null,email:null,status:"invited"}),window._db_cache.teamMembers||(window._db_cache.teamMembers=[]),window._db_cache.teamMembers.push({id:m,name:c.trim(),role:u,phone:o,status:"invited"});const b=(()=>{var f;const y=window.getCache(),w=localStorage.getItem("retaileros_retailer_id");return((f=y.retailers)==null?void 0:f.find(x=>x.id===w))||{}})();A.activityLogs.add({action:"team",detail:`Added team member ${c.trim()}`,user_name:b.contact_person||"Owner",icon:"person_add",color:"slate"}),window.toast&&window.toast.success(`${c.trim()} invited`),window.setSettingsView&&window.setSettingsView("teams")}catch(b){console.error("Add member failed:",b),window.toast&&window.toast.error("Failed to add member")}},window._removeTeamMember=async function(c,o){if(confirm(`Remove ${o} from the team?`))try{await A.teamMembers.delete(c),window._db_cache.teamMembers&&(window._db_cache.teamMembers=window._db_cache.teamMembers.filter(m=>m.id!==c));const u=(()=>{var y;const m=window.getCache(),b=localStorage.getItem("retaileros_retailer_id");return((y=m.retailers)==null?void 0:y.find(w=>w.id===b))||{}})();A.activityLogs.add({action:"team",detail:`Removed team member ${o}`,user_name:u.contact_person||"Owner",icon:"person_remove",color:"slate"}),window.toast&&window.toast.success(`${o} removed`),window.setSettingsView&&window.setSettingsView("teams")}catch(u){console.error("Remove member failed:",u),window.toast&&window.toast.error("Failed to remove member")}};const r={Owner:"slate","Store Manager":"slate","Sales Executive":"slate",Technician:"slate"};return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-2 text-left">
                    <button onclick="window.setSettingsView(null)" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar text-left">
                ...
                <div class="p-6 pb-0 text-left">
                    <div class="grid grid-cols-3 gap-3 text-left">
                        <div class="card p-4 text-center">
                            <p class="text-2xl font-black text-slate-900">${n.filter(c=>c.status==="active").length}</p>
                            <p class="text-[8px] font-black text-slate-400 uppercase tracking-widest mt-1">Active</p>
                        </div>
                        <div class="card p-4 text-center">
                            <p class="text-2xl font-black text-slate-400">${n.filter(c=>c.status==="invited").length}</p>
                ...
                <div class="p-6 space-y-4 border-b border-dashed border-slate-200 text-left">
                    ...
                    <div class="space-y-3 text-left">
                        ${n.map((c,o)=>{const u=c.role==="Owner"&&o===0;return`
                            <div class="card p-4 flex items-center justify-between text-left ${c.status==="invited"?"border-dashed border-slate-200 bg-slate-50/20":""}">
                                <div class="flex items-center gap-3 text-left">
                                    <div class="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center">
                                    ...
                                    <div class="text-left">
                                        ...
                                        <p class="text-[9px] font-bold text-slate-400">${c.role} &middot; ${c.phone||"—"}</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2 text-left">
                                    ${c.status==="invited"?'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-200 text-slate-600">Invited</span>':'<span class="w-2 h-2 bg-slate-900 rounded-full"></span>'}
                                    ${u?"":`<button onclick="window._removeTeamMember('${c.id}','${(c.name||"").replace(/'/g,"\\'")}')" class="text-slate-300 hover:text-slate-900 transition-colors"><span class="material-icons-outlined text-sm">close</span></button>`}
                                </div>
                            </div>
                        `}).join("")}
                    </div>
                ...
                <div class="p-6 space-y-4 border-b border-dashed border-slate-200 text-left">
                    ...
                    <div class="space-y-3 text-left">
                        ${l.map(c=>{const o=c.color||r[c.name]||"slate",u=c.description||(typeof c.permissions=="object"?Object.keys(c.permissions).join(", "):String(c.permissions||"")),m=c.count||0;return`
                ...
                <div class="p-6 space-y-4 text-left">
                    ...
                    <div class="card p-4 overflow-x-auto text-left">
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                ${[{mod:"Sales Desk",o:!0,m:!0,s:!0,t:!1},{mod:"Customers",o:!0,m:!0,s:!0,t:!1},{mod:"Inventory",o:!0,m:!0,s:!1,t:!1},{mod:"Reports",o:!0,m:!0,s:!1,t:!1},{mod:"Repairs",o:!0,m:!0,s:!1,t:!0},{mod:"Automation",o:!0,m:!0,s:!1,t:!1},{mod:"Settings",o:!0,m:!1,s:!1,t:!1}].map(c=>`
                                    <tr class="border-t border-slate-50">
                                        <td class="py-2.5 pr-4 text-[10px] font-bold text-slate-900">${c.mod}</td>
                                        <td class="py-2.5 text-center"><span class="material-icons-outlined text-sm ${c.o?"text-slate-900":"text-slate-300"}">${c.o?"check_circle":"cancel"}</span></td>
                                        <td class="py-2.5 text-center"><span class="material-icons-outlined text-sm ${c.m?"text-slate-900":"text-slate-300"}">${c.m?"check_circle":"cancel"}</span></td>
                                        <td class="py-2.5 text-center"><span class="material-icons-outlined text-sm ${c.s?"text-slate-900":"text-slate-300"}">${c.s?"check_circle":"cancel"}</span></td>
                                        <td class="py-2.5 text-center"><span class="material-icons-outlined text-sm ${c.t?"text-slate-900":"text-slate-300"}">${c.t?"check_circle":"cancel"}</span></td>
                                    </tr>
                                `).join("")}
                            </tbody>
                        </table>
    ...
    `}function Mp(){(()=>{var f;const y=window.getCache(),w=localStorage.getItem("retaileros_retailer_id");return((f=y.retailers)==null?void 0:f.find(x=>x.id===w))||{}})();const t=window.getCache().activityLogs||[],s=new Date,a=t.length>0?t.map(y=>({action:y.action||"Activity",detail:y.detail||"",user:y.user_name||"System",icon:y.icon||"info",color:y.color||"slate",time:new Date(y.created_at)})):[{action:"No activity yet",detail:"Actions like sales, settings changes, and logins will appear here",user:"System",icon:"info",color:"slate",time:s}],n=y=>{const w=Math.floor((s-y)/6e4);return w<1?"Just now":w<60?`${w}m ago`:w<1440?`${Math.floor(w/60)}h ago`:w<2880?"Yesterday":`${Math.floor(w/1440)}d ago`},l=y=>y.toLocaleString("en-IN",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit",hour12:!0}),i=s.toDateString(),r=new Date(s);r.setDate(r.getDate()-1);const c=r.toDateString(),o=a.filter(y=>y.time.toDateString()===i),u=a.filter(y=>y.time.toDateString()===c),m=a.filter(y=>y.time.toDateString()!==i&&y.time.toDateString()!==c),b=(y,w)=>`
    ...
    `}function Fn(e){const t=e==="mobile",s=e==="desktop-secondary";if(window.setSettingsView=a=>{p.settingsView=a,p.settingsSubView=null,D()},window.setSettingsSubView=a=>{p.settingsSubView=a,D()},window.setSettingsRole=a=>{p.settingsActiveRole=a,p.settingsSubView="detail",D()},window.saveNewRole=()=>{const a=document.querySelector('input[placeholder="e.g. Floor Supervisor"]');a&&a.value?(p.settingsActiveRole=a.value,p.settingsSubView="detail",window.toast.success(`Role "${a.value}" created successfully!`),D()):window.toast.warning("Please enter a role name")},window.updateRole=()=>{window.toast.success("Role profile updated successfully!"),window.setSettingsSubView("detail")},s||t&&p.settingsView){if(p.settingsView==="roles")return yp();if(p.settingsView==="accounting")return kp();if(p.settingsView==="ledger")return _p();if(p.settingsView==="ai")return $p();if(p.settingsView==="store")return Ep();if(p.settingsView==="security")return Ip();if(p.settingsView==="alerts")return Cp();if(p.settingsView==="taxes")return Rp();if(p.settingsView==="plugins")return Ap();if(p.settingsView==="teams")return Tp();if(p.settingsView==="logs")return Mp();if(p.settingsView==="lang")return Dp();if(p.settingsView==="backup")return Lp();if(p.settingsView==="updates")return Op();if(p.settingsView==="theme")return jp();if(p.settingsView==="help")return Pp();if(s)return""}return vp(e)}function Np(){return`
        <div class="space-y-4 text-left">
    ...
    `}window.setSchemeViewMode=e=>{p.showSchemeDetails=e==="details",D()};window.setActiveScheme=e=>{p.activeScheme=e,D()};function qp(){const t=(window.getCache?window.getCache():{schemes:[]}).schemes||[];return`
    ...
    `}window._submitSchemeClaims=async(e,t)=>{try{const s=(()=>{var l;const a=window.getCache(),n=localStorage.getItem("retaileros_retailer_id");return((l=a.retailers)==null?void 0:l.find(i=>i.id===n))||{}})();await A.activityLogs.add({action:"schemes",detail:`Submitted ${t} claims for ${e} settlement`,user_name:s.contact_person||"Owner",icon:"send",color:"blue"}),window.toast&&window.toast.success(`${t} claims submitted for ${e}`)}catch(s){console.error("Submit claims failed:",s),window.toast&&window.toast.error("Failed to submit claims")}};window._downloadSchemeCSV=e=>{const s=((window.getCache?window.getCache():{sales:[]}).sales||[]).filter(o=>(o.product_name||"").toLowerCase().includes(e.toLowerCase()));if(s.length===0){window.toast&&window.toast.error("No transactions to export");return}const a=["Order ID","Date","Customer","Product","Amount","IMEI"],n=s.map(o=>[o.id,new Date(o.date).toLocaleDateString(),o.customer_name||"",o.product_name||"",o.total_amount||o.total||"",o.imei||"N/A"]),l=[a.join(","),...n.map(o=>o.map(u=>`"${u}"`).join(","))].join(`
`),i=new Blob([l],{type:"text/csv"}),r=URL.createObjectURL(i),c=document.createElement("a");c.href=r,c.download=`${e}_scheme_transactions.csv`,c.click(),URL.revokeObjectURL(r),window.toast&&window.toast.success("CSV downloaded")};function Bp(e){const t=e==="mobile",s=p.activeScheme;if(!s)return'<div class="p-10 text-center">Select a scheme to view details</div>';const n=((window.getCache?window.getCache():{sales:[]}).sales||[]).filter(u=>{const m=u.product_name||"",b=typeof s=="object"&&s.brand?s.brand:"";return m.includes(b)||u.items&&u.items.some(y=>(y.name||"").includes(b))}),l=typeof s=="object"&&s.brand?s.brand:s,i=typeof s=="object"&&s.name?s.name:"Scheme",r=typeof s=="object"&&s.payout?s.payout:"0",c=typeof s=="object"&&s.end_date?s.end_date:new Date,o={count:n.length,growth:"+0%",color:"bg-slate-950"};return`
                ...
                <div class="card p-5 border-slate-100 shadow-sm space-y-6 text-left">
                    ...
                    <div class="grid grid-cols-2 gap-3 text-left">
                         ...
                         <div class="bg-slate-50 border border-slate-100 rounded-xl p-3 text-left">
                            ...
                            <p class="text-[11px] font-black text-slate-900 text-left">${new Date(c).toLocaleDateString()}</p>
                        </div>
                    </div>
                </div>
    ...
    `}function Fp(){const e=p.marketplaceTab==="browse";return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
            <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function Vp(){const t=window.getCache().marketplace||[];return`
    ...
    `}window._setOfferStatus=async(e,t)=>{try{window.toast&&window.toast.success(`Listing ${t==="paused"?"paused":t==="sold"?"marked as sold":"updated"}`),window.triggerRender()}catch{window.toast&&window.toast.error("Failed to update")}};function Up(){return`
        <div class="space-y-4 animate-slide-up text-left">
    ...
    `}window._postToMarketplace=async()=>{const e=document.getElementById("mp-product-select"),t=document.getElementById("mp-quantity"),s=document.getElementById("mp-price"),a=e==null?void 0:e.value,n=parseInt(t==null?void 0:t.value)||1,l=((s==null?void 0:s.value)||"").replace(/[₹,\s]/g,""),i=parseFloat(l)||0;if(!a||a==="Choose a product..."){window.toast&&window.toast.error("Select a product");return}if(i<=0){window.toast&&window.toast.error("Enter a valid price");return}try{const r="LST-"+Math.random().toString(36).substr(2,8).toUpperCase(),c=new Date().toISOString();await A.storeListings.add({id:r,product_id:r,product_name:a,brand:a.split(" ")[0],category:"Marketplace",base_price:i,listing_price:i,description:`Marketplace listing: ${n} units`,status:"active",stock_qty:n,created_at:c,updated_at:c}),await Y(),window.toast&&window.toast.success("Listed on marketplace!"),window.setMarketplaceViewMode("list")}catch(r){console.error("Post to marketplace failed:",r),window.toast&&window.toast.error("Failed to post listing")}};function Hp(e){const t=e==="mobile",a=window.getCache().products||[];return`
        <div class="h-full flex flex-col bg-white animate-slide-up relative text-left">
    ...
    `}function Un(e){if(e==="desktop-secondary"||e==="mobile"&&p.marketplaceViewMode==="add")return Hp(e);const a=p.marketplaceTab==="browse";return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Fp()}
    ...
    `}async function Kp(e){var t;if((t=p.activeInquiry)!=null&&t.id)try{await A.inquiries.updateStatus(p.activeInquiry.id,e),await Y(),window.setInquiryViewMode("list")}catch(s){alert("Update failed: "+s.message)}}window.updateInquiryStatus=Kp;function Qp(){const e=p.activeInquiry;return e?`
    ...
    `:'<div class="p-20 text-center uppercase text-[10px] font-black opacity-30">No inquiry selected</div>'}window._inquiriesShowAll===void 0&&(window._inquiriesShowAll=!1);window._toggleShowAllInquiries=()=>{window._inquiriesShowAll=!window._inquiriesShowAll,window.triggerRender()};function Hn(e){return e==="desktop-secondary"||e==="mobile"&&p.inquiryViewMode==="add"?Jp():p.inquiryViewMode==="resolve"&&p.activeInquiry?Qp():`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Gp()}
            <div class="px-8 text-left">
                ${window._inquiriesShowAll?"":Wp()}
    ...
    `}window._publishCampaign=()=>{var n,l,i,r,c,o,u,m;const e=(l=(n=document.getElementById("pb-title"))==null?void 0:n.value)==null?void 0:l.trim();if((r=(i=document.getElementById("pb-product"))==null?void 0:i.value)==null||r.trim(),(o=(c=document.getElementById("pb-deposit"))==null?void 0:c.value)==null||o.trim(),(m=(u=document.getElementById("pb-duration"))==null?void 0:u.value)==null||m.trim(),!e){window.toast&&window.toast.error("Enter a campaign title");return}const t=(e||"campaign").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),a=`https://store.retaileros.in/${localStorage.getItem("retaileros_retailer_code")||"store"}/prebook/${t}`;navigator.clipboard.writeText(a).then(()=>{window.toast&&window.toast.success("Campaign published! Link copied to clipboard")}).catch(()=>{window.toast&&window.toast.success("Campaign published!")}),window.setPreBookingViewMode("dashboard")};function Zp(e){return`
        <div class="h-full flex flex-col bg-white dot-grid relative animate-slide-up text-left">
    ...
    `}window._convertBookingToSale=e=>{window.setTab&&window.setTab("new-sale"),window.setApp("sales"),window.toast&&window.toast.success(`Starting sale for ${e}`)};function eu(e){const t=p.activeCampaign;return t?`
    ...
    `}function Gn(e){return e==="desktop-secondary"||e==="mobile"&&p.preBookingViewMode==="create"?Zp():p.preBookingViewMode==="details"&&p.activeCampaign?eu():p.preBookingViewMode==="public"?tu():Xp()}function su(){const e=window.getCache(),t=e.automations||[],s=e.automationMessages||[],a=t.filter(i=>i.status==="active").length;t.filter(i=>i.status==="completed").length,s.length;const n=s.filter(i=>i.status==="sent").length,l=s.filter(i=>i.status==="pending").length;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
             <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
        ...
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-32 text-left">
            ...
            <section class="space-y-4 text-left">
                ...
                <div class="space-y-3 text-left">
                    ${t.map(i=>{const r=s.filter(u=>u.automation_id===i.id),c=r.filter(u=>u.status==="sent").length;r.filter(u=>u.status==="pending").length;const o=r.length>0?Math.round(c/r.length*100):0;return`
                                ...
                                <div class="flex items-center gap-4 text-left">
                                    ...
                                    <div class="flex-1 min-w-0 text-left">
                                        ...
                                        <div class="flex items-center gap-3 mt-2">
                                            ...
                                            <span class="text-[8px] font-black text-slate-400">${c}/${r.length}</span>
                                        </div>
                                    </div>
                                    <div class="text-right shrink-0">
    ...
    `}window.sendAutomationMessage=async e=>{var t,s,a,n,l;try{const i=window.getCache(),r=(t=i.automationMessages)==null?void 0:t.find(f=>f.id===e),c=(s=i.automations)==null?void 0:s.find(f=>f.id===(r==null?void 0:r.automation_id)),o=(a=i.customers)==null?void 0:a.find(f=>f.id===(c==null?void 0:c.customer_id));if(!r||!c){window.toast.error("Message not found");return}if(!(o!=null&&o.phone)){window.toast.error("Customer phone number not found");return}window.toast.info("Sending WhatsApp message...");const m=((l=(((n=i.saleItems)==null?void 0:n.filter(f=>f.sale_id===c.sale_id))||[])[0])==null?void 0:l.product_name)||"your product",b=r.content.replace(/\{product\}/g,m).replace(/\{name\}/g,o.name.split(" ")[0]);let y="sent",w=null;try{w=await window.sendWhatsAppMessage(o.phone,b),w.success?(y="delivered",window.toast.success("WhatsApp message sent!")):(y="failed",window.toast.warning("Message queued but may not have been delivered"))}catch(f){console.error("WATI Error:",f),y="failed",window.toast.error("WhatsApp send failed: "+f.message)}await A.automations.updateMessageStatus(e,y==="failed"?"pending":"sent",new Date().toISOString()),await A.communications.add({id:`COMM-${Math.random().toString(36).substr(2,8).toUpperCase()}`,customer_id:c.customer_id,type:"whatsapp",direction:"outgoing",content:b,sent_at:new Date().toISOString(),automation_id:c.id,sale_id:c.sale_id,status:y}),await Y()}catch(i){console.error("Error sending message:",i),window.toast.error("Failed to send message: "+i.message)}};window.toggleAutomationStatus=async e=>{var t;try{const a=(t=window.getCache().automations)==null?void 0:t.find(l=>l.id===e);if(!a)return;const n=a.status==="active"?"paused":"active";await A.automations.update(e,{status:n}),await Y(),window.toast.success(`Automation ${n==="active"?"resumed":"paused"}`)}catch(s){console.error("Error toggling automation:",s),window.toast.error("Failed to update automation")}};window.deleteAutomation=async e=>{window.showConfirm("Are you sure you want to delete this automation? All scheduled messages will be cancelled.",async()=>{try{await A.automations.deleteMessages(e),await A.automations.delete(e),await Y(),window.toast.success("Automation deleted"),window.setAutomationMode("dashboard")}catch(t){console.error("Error deleting automation:",t),window.toast.error("Failed to delete automation")}})};window.openWhatsAppMessage=(e,t)=>{const s=`https://wa.me/${(e==null?void 0:e.replace(/\D/g,""))||""}?text=${encodeURIComponent(t)}`;window.open(s,"_blank")};function Al(e,t=!1){var m,b,y;const s=window.getCache(),a=(m=s.automations)==null?void 0:m.find(w=>w.id===e);if(!a)return`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        <div class="h-full flex flex-col bg-white text-left">
            ...
            <div class="flex-1 overflow-y-auto px-4 sm:px-6 py-6 space-y-6">
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <div class="card p-3 text-center">
                        <p class="text-xl font-black text-slate-900">${c}</p>
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative pl-8 space-y-4 before:absolute before:left-3 before:top-4 before:bottom-4 before:w-px before:bg-slate-200">
                        ${n.map((w,f)=>{const x=u(w.message_type),g=w.status==="sent",$=new Date(w.scheduled_date).toDateString()===new Date().toDateString();return new Date(w.scheduled_date)<new Date,`
                                <div class="relative">
                                    <div class="absolute -left-8 top-4 w-6 h-6 ${g?"bg-slate-900":"bg-white border-2 border-slate-200"} rounded-full flex items-center justify-center z-10">
                                        ${g?'<span class="material-icons-outlined text-white text-xs">check</span>':`<span class="text-[9px] font-black text-slate-400">${f+1}</span>`}
                                    </div>
                                    
                                    <div class="card p-4 ${g?"bg-slate-50 border-slate-100":$?"border-slate-900 shadow-lg":"border-slate-100"}">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center justify-between mb-1">
                                                    <span class="text-[8px] font-black ${g?"text-slate-400":$?"text-slate-900":"text-slate-400"} uppercase">
                                                        Day ${w.day_offset} • ${w.message_type}
                                                    </span>
                                                    <span class="text-[8px] font-bold ${g?"text-slate-400":$?"text-slate-900":"text-slate-300"}">
                                                        ${g?"Sent":$?"Today":new Date(w.scheduled_date).toLocaleDateString("en-GB",{day:"2-digit",month:"short"})}
                                                    </span>
                                                </div>
    ...
    `}function Wn(e){const t=e==="mobile",s=e==="desktop-secondary";return window.setAutomationMode=(a,n=null)=>{p.automationViewMode=a,n!==null&&(p.activeAutomationId=n),D()},s?p.automationViewMode==="create"?Rl():p.automationViewMode==="details"&&p.activeAutomationId?Al(p.activeAutomationId):`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:t&&p.automationViewMode==="create"?Rl(!0):t&&p.automationViewMode==="details"?Al(p.activeAutomationId,!0):su()}function au(){const t=window.getCache().storeOrders||[],s=t.filter(n=>n.order_status==="pending"||n.order_status==="confirmed").length,a=t.filter(n=>n.order_status==="confirmed").length;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
            <div class="flex items-center justify-between mb-6">
                <button type="button" onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
                    <span class="material-icons-outlined">chevron_left</span>
    ...
    `}function nu(e){const t=window.getCache(),s=t.storeListings||[],a=t.storeOrders||[],n=t.storeOrderItems||[],l=localStorage.getItem("retaileros_retailer_id"),i=(t.retailers||[]).find(E=>E.id===l)||{},c=`https://store.retaileros.in/${localStorage.getItem("retaileros_retailer_code")||"your-store"}`,o=s.filter(E=>E.status==="active").length,u=a.length,b=a.filter(E=>E.order_status==="delivered").reduce((E,L)=>E+(parseInt(L.total_amount)||0),0),y=a.filter(E=>E.order_status==="pending").length,w=a.filter(E=>E.order_status==="confirmed").length,f=a.filter(E=>E.order_status==="shipped").length,x=a.slice(0,5),g={};n.forEach(E=>{const L=E.product_name||"Unknown";g[L]=(g[L]||0)+(E.quantity||1)});const $=Object.entries(g).sort((E,L)=>L[1]-E[1]).slice(0,3);window._copyStoreUrl=async()=>{try{await navigator.clipboard.writeText(c),window.toast&&window.toast.success("Store URL copied!")}catch{window.toast&&window.toast.error("Failed to copy")}};const C=E=>{switch(E){case"pending":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-200 text-slate-600">Pending</span>';case"confirmed":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-300 text-slate-700">Confirmed</span>';case"shipped":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-300 text-slate-700">Shipped</span>';case"delivered":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-900 text-white">Delivered</span>';case"cancelled":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-100 text-slate-400">Cancelled</span>';default:return""}};return`
            ...
            <div class="card p-5 border-slate-200 shadow-sm text-left">
                ...
                <div class="flex items-center gap-2 text-left">
                    <div class="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-left overflow-hidden">
                        <p class="text-[10px] font-bold text-slate-500 truncate">${c}</p>
                    </div>
            ...
            ${$.length>0?`
                <section class="space-y-3 text-left">
                    ...
                    <div class="card p-4 space-y-3">
                        ${$.map(([E,L],J)=>`
                            <div class="flex items-center justify-between ${J<$.length-1?"pb-3 border-b border-slate-50":""} text-left">
                                <div class="flex items-center gap-3 text-left">
                                    <span class="w-6 h-6 bg-slate-100 rounded-full flex items-center justify-center text-[9px] font-black text-slate-400">${J+1}</span>
                                    <p class="text-xs font-black text-slate-900 truncate">${E}</p>
                                </div>
                                <p class="text-[9px] font-black text-slate-400">${L} sold</p>
                            </div>
                        `).join("")}
                    </div>
                </section>
    ...
    `}function lu(e){const s=window.getCache().storeListings||[],a=s.filter(i=>i.status==="active").length,n=s.filter(i=>i.status==="draft").length;s.filter(i=>i.status==="inactive").length;const l=i=>{switch(i){case"active":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-900 text-white">Active</span>';case"draft":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-200 text-slate-600">Draft</span>';case"inactive":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-100 text-slate-400">Inactive</span>';default:return""}};return window._deleteStoreListing=async(i,r)=>{if(confirm(`Remove "${r}" from your store?`))try{await A.storeListings.delete(i),window._db_cache.storeListings&&(window._db_cache.storeListings=window._db_cache.storeListings.filter(o=>o.id!==i));const c=(()=>{var m;const o=window.getCache(),u=localStorage.getItem("retaileros_retailer_id");return((m=o.retailers)==null?void 0:m.find(b=>b.id===u))||{}})();A.activityLogs.add({action:"store",detail:`Removed listing: ${r}`,user_name:c.contact_person||"Owner",icon:"remove_shopping_cart",color:"red"}),window.toast&&window.toast.success("Listing removed"),window.triggerRender()}catch(c){console.error("Delete listing failed:",c),window.toast&&window.toast.error("Failed to remove listing")}},window._toggleListingStatus=async(i,r)=>{const c=r==="active"?"inactive":"active";try{const o=s.find(m=>m.id===i);if(!o)return;await A.storeListings.update(i,{listing_price:o.listing_price,description:o.description,status:c,stock_qty:o.stock_qty});const u=window._db_cache.storeListings.findIndex(m=>m.id===i);u>=0&&(window._db_cache.storeListings[u].status=c),window.toast&&window.toast.success(c==="active"?"Listing activated":"Listing deactivated"),window.triggerRender()}catch(o){console.error("Toggle listing failed:",o),window.toast&&window.toast.error("Failed to update listing")}},`
    ...
    `}function Tl(){const e=window.getCache(),t=e.products||[],a=(e.storeListings||[]).map(l=>l.product_id),n=t.filter(l=>!a.includes(l.id));return window._saveStoreListing=async()=>{var y,w,f,x,g;const l=document.getElementById("add-listing-form");if(!l)return;const i=(y=l.querySelector('[data-field="product_id"]'))==null?void 0:y.value;if(!i){window.toast&&window.toast.error("Select a product");return}const r=t.find($=>$.id===i);if(!r)return;const c=parseFloat((w=l.querySelector('[data-field="listing_price"]'))==null?void 0:w.value)||r.mop||r.price,o=((f=l.querySelector('[data-field="description"]'))==null?void 0:f.value)||"",u=parseInt((x=l.querySelector('[data-field="stock_qty"]'))==null?void 0:x.value)||0,m=((g=l.querySelector('[data-field="status"]'))==null?void 0:g.value)||"draft",b=`sl_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;try{await A.storeListings.add({id:b,product_id:r.id,product_name:r.name,brand:r.brand,category:r.category,base_price:r.price,listing_price:c,description:o,status:m,stock_qty:u}),window._db_cache.storeListings||(window._db_cache.storeListings=[]),window._db_cache.storeListings.unshift({id:b,product_id:r.id,product_name:r.name,brand:r.brand,category:r.category,base_price:r.price,listing_price:c,description:o,status:m,stock_qty:u,created_at:new Date().toISOString()});const $=(()=>{var L;const C=window.getCache(),E=localStorage.getItem("retaileros_retailer_id");return((L=C.retailers)==null?void 0:L.find(J=>J.id===E))||{}})();A.activityLogs.add({action:"store",detail:`Listed product: ${r.name}`,user_name:$.contact_person||"Owner",icon:"add_shopping_cart",color:"green"}),window.toast&&window.toast.success("Product listed on store"),window.setMyStoreViewMode("list")}catch($){console.error("Save listing failed:",$),window.toast&&window.toast.error("Failed to save listing")}},window._onProductSelect=l=>{const i=t.find(o=>o.id===l.value);if(!i)return;const r=document.querySelector('[data-field="listing_price"]'),c=document.querySelector('[data-field="stock_qty"]');r&&(r.value=i.mop||i.price||0),c&&(c.value=i.in_stock||0)},`
    ...
    `}function iu(){const e=window.getCache(),s=(e.storeListings||[]).find(o=>o.id===p.activeListingId);if(!s)return`<div class="h-full flex items-center justify-center text-slate-300">
            <div class="text-center">
        ...
        <div id="listing-detail" class="card p-6 sm:p-8 bg-white text-slate-900 leading-relaxed shadow-sm relative h-full flex flex-col border border-slate-100">
            ...
            <div class="border-t border-dashed border-slate-200 pt-4 mt-4 text-left">
                <div class="flex justify-between text-[8px] font-bold text-slate-400 uppercase tracking-widest">
                    <span>Listed: ${c(s.created_at)}</span>
                    <span>Updated: ${c(s.updated_at)}</span>
                </div>
            </div>
    ...
    `}function ru(e){const t=window.getCache(),s=t.storeOrders||[],a=t.storeOrderItems||[];window._storeOrderFilter=window._storeOrderFilter||"all",window._setOrderFilter=u=>{window._storeOrderFilter=u,window.triggerRender()};const n=window._storeOrderFilter,l=n==="all"?s:s.filter(u=>u.order_status===n),i={all:s.length,pending:s.filter(u=>u.order_status==="pending").length,confirmed:s.filter(u=>u.order_status==="confirmed").length,shipped:s.filter(u=>u.order_status==="shipped").length,delivered:s.filter(u=>u.order_status==="delivered").length,cancelled:s.filter(u=>u.order_status==="cancelled").length},r=u=>{switch(u){case"pending":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-200 text-slate-600">Pending</span>';case"confirmed":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-300 text-slate-700">Confirmed</span>';case"shipped":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-300 text-slate-700">Shipped</span>';case"delivered":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-900 text-white">Delivered</span>';case"cancelled":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-100 text-slate-400">Cancelled</span>';default:return""}},c=u=>u==="paid"?'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-900 text-white">Paid</span>':u==="failed"?'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-100 text-slate-400">Failed</span>':'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-200 text-slate-600">COD</span>';return window._createTestOrder=async()=>{const m=(window.getCache().storeListings||[]).filter(C=>C.status==="active");if(m.length===0){window.toast&&window.toast.error("No active listings to order from");return}const b=m[0],y=`so_${Date.now()}_${Math.random().toString(36).substr(2,6)}`,w=`WEB-${new Date().toISOString().slice(0,10).replace(/-/g,"")}-${String(s.length+1).padStart(4,"0")}`,f=["Aarav Patel","Sneha Gupta","Rohan Mehta","Kavya Sharma","Vikram Singh"],x=["Mumbai","Delhi","Bangalore","Pune","Chennai"],g=f[Math.floor(Math.random()*f.length)],$=x[Math.floor(Math.random()*x.length)];try{const C={id:y,order_number:w,customer_name:g,customer_phone:"98"+Math.floor(1e7+Math.random()*9e7),customer_email:g.split(" ")[0].toLowerCase()+"@gmail.com",shipping_address_line1:Math.floor(100+Math.random()*900)+", Sector "+Math.floor(1+Math.random()*30),shipping_city:$,shipping_state:$==="Mumbai"?"Maharashtra":$==="Delhi"?"Delhi":$==="Bangalore"?"Karnataka":$==="Pune"?"Maharashtra":"Tamil Nadu",shipping_pincode:String(1e5+Math.floor(Math.random()*5e5)),order_date:new Date().toISOString(),total_amount:b.listing_price,order_status:"pending",payment_status:Math.random()>.3?"paid":"pending",payment_mode:Math.random()>.5?"online":"cod"};await A.storeOrders.add(C);const E=`soi_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;await A.storeOrders.addItem({id:E,order_id:y,listing_id:b.id,product_id:b.product_id,product_name:b.product_name,category:b.category,quantity:1,unit_price:b.listing_price,final_price:b.listing_price}),window._db_cache.storeOrders||(window._db_cache.storeOrders=[]),window._db_cache.storeOrders.unshift(C),window._db_cache.storeOrderItems||(window._db_cache.storeOrderItems=[]),window._db_cache.storeOrderItems.push({id:E,order_id:y,listing_id:b.id,product_id:b.product_id,product_name:b.product_name,category:b.category,quantity:1,unit_price:b.listing_price,discount_amount:0,final_price:b.listing_price}),A.activityLogs.add({action:"store",detail:`New online order ${w} from ${g}`,user_name:"System",icon:"shopping_bag",color:"blue"}),window.toast&&window.toast.success(`Test order ${w} created`),window.triggerRender()}catch(C){console.error("Create test order failed:",C),window.toast&&window.toast.error("Failed to create test order")}},`
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left flex-1 overflow-y-auto">
            <!-- Filter Pills -->
        ...
        `:""}
    `}function ou(e){switch(e){case"cash":case"cod":return"payments";case"card":return"credit_card";case"upi":return"qr_code";case"online":return"language";default:return"account_balance_wallet"}}function cu(e){switch(e){case"cash":case"cod":return"Cash on Delivery";case"card":return"Card";case"upi":return"UPI";case"online":return"Online Payment";default:return"Payment"}}function Ml(){const e=window.getCache(),t=e.storeOrders||[],s=e.storeOrderItems||[],a=t.find(f=>f.id===p.activeStoreOrderId);if(!a)return`<div class="h-full flex items-center justify-center text-slate-300">
            <div class="text-center">
        ...
        </div>`;const n=s.filter(f=>f.order_id===a.id),l=a.order_status==="cancelled",i=a.order_status==="delivered",r=a.payment_status==="paid",c=parseInt(a.total_amount)||0,o=c/1.18,u=c-o,m=["pending","confirmed","shipped","delivered"],b=m.indexOf(a.order_status),y=f=>f?new Date(f).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}):"—",w=f=>f?new Date(f).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0}):"";return window._confirmOrder=async f=>{try{await A.storeOrders.updateStatus(f,"confirmed");const x=window._db_cache.storeOrders.findIndex($=>$.id===f);x>=0&&(window._db_cache.storeOrders[x].order_status="confirmed");const g=(()=>{var E;const $=window.getCache(),C=localStorage.getItem("retaileros_retailer_id");return((E=$.retailers)==null?void 0:E.find(L=>L.id===C))||{}})();A.activityLogs.add({action:"store",detail:`Confirmed order ${a.order_number}`,user_name:g.contact_person||"Owner",icon:"check_circle",color:"blue"}),window.toast&&window.toast.success("Order confirmed"),window.triggerRender()}catch(x){console.error("Confirm order failed:",x),window.toast&&window.toast.error("Failed to confirm order")}},window._shipOrder=async f=>{var C,E;const x=document.getElementById("shipping-form"),g=((C=x==null?void 0:x.querySelector('[data-field="tracking_number"]'))==null?void 0:C.value)||"",$=((E=x==null?void 0:x.querySelector('[data-field="courier_name"]'))==null?void 0:E.value)||"";if(!g){window.toast&&window.toast.error("Enter tracking number");return}if(!$){window.toast&&window.toast.error("Enter courier name");return}try{const L=new Date().toISOString();await A.storeOrders.updateStatus(f,"shipped",{tracking_number:g,courier_name:$,shipped_date:L});const J=window._db_cache.storeOrders.findIndex(Xe=>Xe.id===f);J>=0&&(window._db_cache.storeOrders[J].order_status="shipped",window._db_cache.storeOrders[J].tracking_number=g,window._db_cache.storeOrders[J].courier_name=$,window._db_cache.storeOrders[J].shipped_date=L);const mt=(()=>{var M;const Xe=window.getCache(),xe=localStorage.getItem("retaileros_retailer_id");return((M=Xe.retailers)==null?void 0:M.find(Dt=>Dt.id===xe))||{}})();A.activityLogs.add({action:"store",detail:`Shipped order ${a.order_number} via ${$}`,user_name:mt.contact_person||"Owner",icon:"local_shipping",color:"purple"}),window.toast&&window.toast.success("Order marked as shipped"),window.triggerRender()}catch(L){console.error("Ship order failed:",L),window.toast&&window.toast.error("Failed to update shipping")}},window._deliverOrder=async f=>{try{const x=new Date().toISOString(),g=`sale_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;await A.sales.add({id:g,customer_id:null,customer_name:a.customer_name,date:x,total_amount:a.total_amount,status:"completed",payment_mode:a.payment_mode==="cod"?"cash":a.payment_mode==="upi"?"upi":"card",payment_reference:a.payment_reference||a.order_number,gst_required:0,company_id:null,installation_required:0,installation_date:null,source:"online"});for(const C of n){const E=`si_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;await A.sales.addItem({id:E,sale_id:g,product_id:C.product_id,product_name:C.product_name,category:C.category||null,quantity:C.quantity,price:C.unit_price,discount_type:null,discount_value:0,discount_amount:C.discount_amount||0,scheme_id:null,final_price:C.final_price,imei:null,serial_number:null,mac_id:null,manufacturing_date:null,installation_date:null,extra_fields:null})}await A.storeOrders.updateStatus(f,"delivered",{delivered_date:x,sale_id:g,payment_status:"paid"}),await Y();const $=(()=>{var L;const C=window.getCache(),E=localStorage.getItem("retaileros_retailer_id");return((L=C.retailers)==null?void 0:L.find(J=>J.id===E))||{}})();A.activityLogs.add({action:"store",detail:`Order ${a.order_number} delivered & invoice created`,user_name:$.contact_person||"Owner",icon:"check_circle",color:"green"}),window.toast&&window.toast.success("Order delivered & sale recorded")}catch(x){console.error("Deliver order failed:",x),window.toast&&window.toast.error("Failed to mark as delivered")}},window._cancelOrder=async f=>{if(confirm("Cancel this order?"))try{await A.storeOrders.updateStatus(f,"cancelled");const x=window._db_cache.storeOrders.findIndex($=>$.id===f);x>=0&&(window._db_cache.storeOrders[x].order_status="cancelled");const g=(()=>{var E;const $=window.getCache(),C=localStorage.getItem("retaileros_retailer_id");return((E=$.retailers)==null?void 0:E.find(L=>L.id===C))||{}})();A.activityLogs.add({action:"store",detail:`Cancelled order ${a.order_number}`,user_name:g.contact_person||"Owner",icon:"cancel",color:"red"}),window.toast&&window.toast.success("Order cancelled"),window.triggerRender()}catch(x){console.error("Cancel order failed:",x),window.toast&&window.toast.error("Failed to cancel order")}},window._shareOrderWhatsApp=()=>{let f=`ORDER #${a.order_number}
`;f+=`━━━━━━━━━━━━━━━━━━━━
`,f+=`${y(a.order_date)}
...
Powered by RetailerOS`,window.open(`https://wa.me/?text=${encodeURIComponent(f)}`,"_blank")},window._printOrder=()=>{window.print()},`
        <div id="order-detail" class="bg-white text-slate-900 leading-relaxed relative h-full flex flex-col print:shadow-none print:border-0">
            ...
            <div class="border-t border-dashed border-slate-200 pt-6 mt-4 space-y-2">
                ...
                <div class="flex justify-between text-xl font-black text-slate-900 mt-4 items-center">
                    <span>Grand Total</span>
                    <span class="text-slate-900">₹${c.toLocaleString()}</span>
                </div>
            </div>
            ...
            ${r?`
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <span class="material-icons-outlined text-sm">${ou(a.payment_mode)}</span>
                        </div>
                        <div class="text-left">
                            <p class="text-[9px] font-black uppercase tracking-widest text-left">Paid via ${cu(a.payment_mode)}</p>
    ...
    `}function du(e){const t=window.getCache(),s=t.storeOrders||[],a=t.storeOrderItems||[],n=s.filter(c=>c.order_status==="confirmed"),l=s.filter(c=>c.order_status==="shipped"),i=s.filter(c=>c.order_status==="delivered"),r=(c,o)=>{const u=a.filter(b=>b.order_id===c.id),m=u[0]?u[0].product_name:"Order items";return`
            <button type="button" onclick="window.setActiveStoreOrder('${c.id}')" class="card p-4 border-2 transition-all cursor-pointer text-left w-full ${p.activeStoreOrderId===c.id?"border-slate-900 shadow-lg":"border-transparent hover:border-slate-200"}">
                <div class="flex justify-between items-start mb-2 text-left">
                    <div class="text-left flex-1 min-w-0">
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-tighter">${c.order_number}</p>
                        <h4 class="text-sm font-black text-slate-900 tracking-tight truncate text-left">${c.customer_name}</h4>
                    </div>
                    <p class="text-sm font-black text-slate-900 tracking-tighter shrink-0 ml-2">₹${parseInt(c.total_amount).toLocaleString()}</p>
                </div>
                <div class="flex items-center justify-between text-left">
                    <p class="text-[10px] font-bold text-slate-500 truncate">${m}</p>
                    <div class="flex items-center gap-2 shrink-0 ml-2">
                        ${o==="transit"&&c.courier_name?`
                            <span class="text-[8px] font-bold text-slate-500">${c.courier_name}</span>
                        `:""}
                        ${o==="delivered"?`
                            <span class="text-[8px] font-bold text-slate-500">${c.delivered_date?new Date(c.delivered_date).toLocaleDateString("en-GB",{day:"2-digit",month:"short"}):"Delivered"}</span>
                        `:""}
                        <p class="text-[9px] font-black text-slate-300">${[c.shipping_city,c.shipping_pincode].filter(Boolean).join(" ")}</p>
                    </div>
                </div>
            </button>
        `};return`
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left flex-1 overflow-y-auto">
            ...
            ${i.length>0?`
                <section class="space-y-3 text-left">
                    ...
                    ${i.slice(0,5).map(c=>r(c,"delivered")).join("")}
                </section>
            `:""}
        </div>
    `}function zn(e){const t=e==="mobile";if(e==="desktop-secondary"){if(p.myStoreViewMode==="order-detail"&&p.activeStoreOrderId)return Ml();if(p.myStoreViewMode==="add-listing")return Tl();if(p.activeListingId&&p.myStoreTab==="listings")return iu();if(p.myStoreTab==="dashboard"){const l=window.getCache().storeListings||[];return`<div class="h-full flex flex-col p-6 sm:p-8 text-left">
                <div class="text-center border-b border-dashed border-slate-200 pb-6 mb-6">
        ...
        </div>`}if(t){if(p.myStoreViewMode==="order-detail"&&p.activeStoreOrderId)return Ml();if(p.myStoreViewMode==="add-listing")return Tl()}const a=()=>{switch(p.myStoreTab){case"dashboard":return nu();case"orders":return ru();case"shipping":return du();default:return lu()}};return`
        <div class="h-full flex flex-col relative bg-white">
            ${au()}
            ${a()}
        </div>
    `}function Yn(){const e=window.getCache(),t=[],s=new Date,a=(e.storeOrders||[]).filter(x=>x.order_status==="pending");if(a.length>0){const x=e.storeOrderItems||[];t.push({key:"store-orders",icon:"local_shipping",title:"Pending Orders",subtitle:`${a.length} order${a.length!==1?"s":""} awaiting action`,items:a.map(g=>{const $=x.filter(L=>L.order_id===g.id),C=$[0],E=g.created_at?new Date(g.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}):"";return{id:g.id,primary:g.customer_name||"Walk-in Customer",secondary:C?`${C.product_name}${$.length>1?` +${$.length-1} more`:""}`:`Order #${g.order_number||g.id}`,amount:`₹${Number(g.total_amount||0).toLocaleString()}`,date:E,status:"Pending",actions:[{label:"View Order",icon:"visibility",handler:()=>{window.setMyStoreTab("orders"),window.setActiveStoreOrder(g.id),window.setApp("mystore")}}]}})})}const n=e.products||[],l=e.inventoryLogs||[],i=n.filter(x=>{const g=l.filter(E=>E.product_id===x.id&&E.type==="inward").reduce((E,L)=>E+(parseInt(L.quantity)||0),0),$=l.filter(E=>E.product_id===x.id&&E.type==="outward").reduce((E,L)=>E+(parseInt(L.quantity)||0),0),C=g-$;return C<=5&&C>=0}).map(x=>{const g=l.filter(C=>C.product_id===x.id&&C.type==="inward").reduce((C,E)=>C+(parseInt(E.quantity)||0),0),$=l.filter(C=>C.product_id===x.id&&C.type==="outward").reduce((C,E)=>C+(parseInt(E.quantity)||0),0);return{...x,netStock:g-$}});i.length>0&&t.push({key:"low-stock",icon:"inventory_2",title:"Low Stock",subtitle:`${i.length} item${i.length!==1?"s":""} running low`,items:i.map(x=>({id:x.id,primary:x.name,secondary:`${x.brand||""} · ${x.category||"General"}`.replace(/^ · /,""),amount:x.mop?`MOP ₹${Number(x.mop).toLocaleString()}`:"",date:`${x.netStock} unit${x.netStock!==1?"s":""} remaining`,status:x.netStock<=2?"Critical":"Low",actions:[{label:"Restock",icon:"add_circle",handler:()=>{window.setInventoryMode&&window.setInventoryMode("inward"),window.setApp("inventory")}}]}))});const r=(e.sales||[]).filter(x=>x.status==="draft");if(r.length>0){const x=e.saleItems||[];t.push({key:"draft-sales",icon:"edit_note",title:"Incomplete Drafts",subtitle:`${r.length} sale${r.length!==1?"s":""} waiting to complete`,items:r.map(g=>{const $=x.filter(L=>L.sale_id===g.id),C=$[0],E=g.created_at?new Date(g.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short"}):"";return{id:g.id,primary:g.customer_name||"Draft Sale",secondary:C?`${C.product_name}${$.length>1?` +${$.length-1} more`:""}`:`${$.length} item${$.length!==1?"s":""}`,amount:`₹${Number(g.total||0).toLocaleString()}`,date:E,status:"Draft",actions:[{label:"Complete Sale",icon:"shopping_cart_checkout",handler:()=>{window.setHistoryViewMode("drafts"),window.setHistoryDateFilter("all"),window.setSalesHistoryId(g.id),window.setTab("history"),window.setApp("sales")}}]}})})}const c=(e.inquiries||[]).filter(x=>x.status==="PENDING");c.length>0&&t.push({key:"inquiries",icon:"help_outline",title:"Unresolved Inquiries",subtitle:`${c.length} question${c.length!==1?"s":""} needing response`,items:c.map(x=>{const g=x.created_at?new Date(x.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short"}):"";return{id:x.id,primary:x.customer_name||"Unknown Customer",secondary:x.product_name||x.description||"General inquiry",amount:"",date:g,status:"Pending",actions:[{label:"Resolve",icon:"check_circle",handler:()=>{window.setActiveInquiry(x),window.setInquiryViewMode("resolve"),window.setApp("inquiries")}},...x.phone?[{label:"Call",icon:"phone",handler:()=>{window.open(`tel:${x.phone}`)}}]:[]]}})});const o=(e.repairs||[]).filter(x=>x.status&&x.status!=="COMPLETED"&&x.status!=="DELIVERED");o.length>0&&t.push({key:"repairs",icon:"build",title:"Active Repairs",subtitle:`${o.length} device${o.length!==1?"s":""} being serviced`,items:o.map(x=>{const g=x.created_at?new Date(x.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short"}):"";return{id:x.id,primary:x.customer_name||"Walk-in",secondary:`${x.device||"Device"} — ${x.issue||"Repair"}`,amount:x.estimated_cost?`₹${Number(x.estimated_cost).toLocaleString()}`:"",date:g,status:"In Progress",actions:[{label:"View Status",icon:"visibility",handler:()=>{window.setActiveRepairJob&&window.setActiveRepairJob(x.id),window.setRepairTab("active"),window.setApp("repairs")}}]}})});const u=new Date(s.getTime()+7*864e5),m=e.automations||[],b=(e.automationMessages||[]).filter(x=>{if(x.status!=="pending")return!1;const g=new Date(x.scheduled_date);return g>=s&&g<=u}).sort((x,g)=>new Date(x.scheduled_date)-new Date(g.scheduled_date));b.length>0&&t.push({key:"automation",icon:"smart_toy",title:"Scheduled Messages",subtitle:`${b.length} message${b.length!==1?"s":""} queued this week`,iconSymbol:!0,items:b.map(x=>{const g=m.find(J=>J.id===x.automation_id),$=new Date(x.scheduled_date),C=$.toDateString()===s.toDateString(),E=$.toDateString()===new Date(Date.now()+864e5).toDateString(),L=C?"Today":E?"Tomorrow":$.toLocaleDateString("en-GB",{day:"2-digit",month:"short"});return{id:x.id,primary:(g==null?void 0:g.customer_name)||"Customer",secondary:x.title||"Scheduled Message",amount:"",date:L,status:"Scheduled",actions:[{label:"View",icon:"visibility",handler:()=>{window.setActiveAutomation(x.automation_id),window.setAutomationViewMode("details"),window.setApp("automation")}}]}})});const y=(e.campaigns||[]).filter(x=>{if(!x.start_date||!x.end_date)return x.status==="active";const g=new Date(x.start_date),$=new Date(x.end_date);return s>=g&&s<=$});y.length>0&&t.push({key:"campaigns",icon:"rocket_launch",title:"Live Campaigns",subtitle:`${y.length} active pre-booking campaign${y.length!==1?"s":""}`,items:y.map(x=>({id:x.id,primary:x.name||x.title||"Campaign",secondary:x.product_name||"Pre-booking",amount:x.deposit_amount?`₹${Number(x.deposit_amount).toLocaleString()} deposit`:"",date:x.end_date?`Ends ${new Date(x.end_date).toLocaleDateString("en-GB",{day:"2-digit",month:"short"})}`:"Active",status:"Live",actions:[{label:"View Campaign",icon:"visibility",handler:()=>{window.setActiveCampaign(x),window.setPreBookingViewMode("details"),window.setApp("prebooking")}}]}))});const w=`${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`,f=(e.customers||[]).filter(x=>{if(!x.dob)return!1;const $=(x.dob.includes("T")?x.dob.split("T")[0]:x.dob).split("-");return $.length<3?!1:`${$[1]}-${$[2]}`===w});return f.length>0&&t.push({key:"birthdays",icon:"cake",title:"Birthdays Today",subtitle:`${f.length} customer${f.length!==1?"s":""} celebrating today`,items:f.map(x=>({id:x.id,primary:x.name,secondary:x.phone||x.email||"No contact info",amount:"",date:"Today",status:"Birthday",actions:[{label:"View Profile",icon:"person",handler:()=>{window.setClientMode("profile",x.name,x.id),window.setApp("clients")}},...x.phone?[{label:"Wish",icon:"chat",handler:()=>{window.open(`https://wa.me/91${x.phone.replace(/\D/g,"").slice(-10)}?text=${encodeURIComponent(`Happy Birthday, ${x.name}! Wishing you a wonderful day. 🎂`)}`)}}]:[]]}))}),t}function or(){return Yn().reduce((e,t)=>e+t.items.length,0)}window.getNotificationCount=or;window._notifExpanded||(window._notifExpanded={});window._toggleNotifGroup=function(e){window._notifExpanded[e]=!window._notifExpanded[e];const t=document.getElementById("notif-scroll"),s=t?t.scrollTop:0;window.triggerRender(),requestAnimationFrame(()=>{const a=document.getElementById("notif-scroll");a&&(a.scrollTop=s)})};window._notifActions=[];function pu(){const e=window._pushNotificationsEnabled!==!1,t=or();return`
        <header class="px-5 sm:px-8 pt-5 sm:pt-8 pb-3 shrink-0 text-left">
            <div class="flex items-center justify-between mb-4 text-left">
                ...
                <button onclick="window.togglePushNotifications()" class="w-9 h-9 flex items-center justify-center rounded-xl ${e?"bg-slate-900":"bg-slate-100"} transition-all" title="Push Notifications">
                    <span class="material-icons-outlined text-sm ${e?"text-white":"text-slate-400"}">${e?"notifications_active":"notifications_off"}</span>
                </button>
            </div>
            <div class="text-left">
                <h1 class="text-2xl font-black tracking-tight text-slate-900">Alerts</h1>
                <p class="text-[10px] font-bold text-slate-400 mt-0.5">${t>0?`${t} item${t!==1?"s":""} need${t===1?"s":""} your attention`:"You're all caught up"}</p>
            </div>
        </header>
    `}function uu(e){return e.length===0?"":`
        <div class="flex gap-2 overflow-x-auto pb-1 px-5 sm:px-8 no-scrollbar" style="scrollbar-width:none;-ms-overflow-style:none;">
            ${e.map(t=>`
                <button type="button" onclick="window._toggleNotifGroup('${t.key}');document.getElementById('notif-group-${t.key}')?.scrollIntoView({behavior:'smooth',block:'nearest'})" class="flex items-center gap-2 px-3 py-2 rounded-xl bg-white border border-slate-200 shrink-0 hover:border-slate-900 hover:bg-slate-50 active:scale-[0.97] transition-all">
                    <span class="${t.iconSymbol?"material-symbols-outlined":"material-icons-outlined"} text-slate-500 text-sm">${t.icon}</span>
                    <span class="text-[10px] font-black text-slate-900">${t.items.length}</span>
                    <span class="text-[8px] font-bold text-slate-400 uppercase tracking-wider">${t.title}</span>
                </button>
            `).join("")}
        </div>
    `}function xu(e,t){return`
        <div class="bg-white border border-slate-200 rounded-2xl p-4 space-y-3 text-left hover:border-slate-300 transition-all">
            ...
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
                    <h4 class="text-sm font-black text-slate-900 tracking-tight truncate">${e.primary}</h4>
                    <p class="text-[10px] font-bold text-slate-400 truncate mt-0.5">${e.secondary}</p>
                </div>
                <div class="text-right shrink-0">
                    ${e.amount?`<p class="text-sm font-black text-slate-900 tracking-tight">${e.amount}</p>`:""}
                    ${e.status?`<span class="text-[7px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full ${e.status==="Critical"?"bg-slate-900 text-white":"bg-slate-100 text-slate-500"}">${e.status}</span>`:""}
                </div>
            </div>
            <!-- Date -->
            ${e.date?`<p class="text-[9px] font-bold text-slate-300">${e.date}</p>`:""}
            <!-- Action Buttons -->
            ${e.actions&&e.actions.length>0?`
                <div class="flex gap-2 pt-1">
                    ${e.actions.map((s,a)=>`
                            <button type="button" onclick="window._notifActions[${t+a}]()" class="${a===0?"bg-slate-900 text-white hover:bg-slate-800":"bg-slate-100 text-slate-600 hover:bg-slate-200"} px-3.5 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all flex items-center gap-1.5">
                                <span class="material-icons-outlined text-xs">${s.icon}</span>
                                ${s.label}
                            </button>
                        `).join("")}
                </div>
    ...
    `}function fu(e,t){const s=window._notifExpanded[e.key]||!1;return`
        <section id="notif-group-${e.key}" class="text-left">
            <!-- Accordion Header -->
            <button type="button" onclick="window._toggleNotifGroup('${e.key}')" class="w-full flex items-center gap-3 px-4 py-3.5 bg-white border ${s?"border-slate-300 shadow-sm":"border-slate-200"} ${s?"rounded-t-2xl border-b-0":"rounded-2xl"} hover:border-slate-300 transition-all cursor-pointer group">
                <div class="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-slate-200 transition-colors">
                    <span class="${e.iconSymbol?"material-symbols-outlined":"material-icons-outlined"} text-slate-600 text-base">${e.icon}</span>
                </div>
                <div class="flex-1 min-w-0 text-left">
                    <h3 class="text-xs font-black text-slate-900 tracking-tight">${e.title}</h3>
                    <p class="text-[9px] font-bold text-slate-400">${e.subtitle||""}</p>
                </div>
                <div class="flex items-center gap-2 shrink-0">
                    <span class="min-w-[22px] h-[22px] bg-slate-900 text-white rounded-full flex items-center justify-center text-[9px] font-black px-1.5">${e.items.length}</span>
                    <span class="material-icons-outlined text-base text-slate-300 transition-transform duration-200 ${s?"rotate-180":""}">${s?"expand_less":"expand_more"}</span>
                </div>
            </button>
            ${s?`
                <div class="bg-slate-50 border border-t-0 border-slate-300 rounded-b-2xl p-3 space-y-2.5">
                    ${e.items.map((a,n)=>{const l=t+e.items.slice(0,n).reduce((i,r)=>i+(r.actions?r.actions.length:0),0);return xu(a,l)}).join("")}
                </div>
            `:""}
        </section>
    `}function mu(){return`
    ...
    `}function bu(){const e=Yn(),t=e.reduce((s,a)=>s+a.items.length,0);return`
        <div class="h-full flex flex-col items-center justify-center text-center p-8">
            <div class="relative mb-5">
                <div class="w-24 h-24 ${t>0?"bg-slate-900":"bg-slate-100"} rounded-3xl flex items-center justify-center shadow-xl">
                    <span class="material-icons-outlined text-5xl ${t>0?"text-white":"text-slate-300"}">${t>0?"notifications_active":"task_alt"}</span>
                </div>
                ${t>0?`
                    <div class="absolute -top-2 -right-2 min-w-[28px] h-7 bg-white border-2 border-slate-900 text-slate-900 rounded-full flex items-center justify-center text-xs font-black px-2">${t}</div>
                `:""}
            </div>
            <p class="text-4xl font-black text-slate-900 tracking-tighter mb-1">${t}</p>
            <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">${t===1?"Pending Alert":"Pending Alerts"}</p>
            ${t>0?`
                    ...
                    ${e.map(s=>`
                        <div class="flex items-center gap-3 px-3.5 py-2.5 bg-white rounded-xl border border-slate-200">
                            <div class="w-7 h-7 bg-slate-100 rounded-lg flex items-center justify-center shrink-0">
                                <span class="${s.iconSymbol?"material-symbols-outlined":"material-icons-outlined"} text-slate-500 text-[10px]">${s.icon}</span>
                            </div>
                            <span class="text-[9px] font-black text-slate-600 uppercase tracking-wider flex-1 text-left">${s.title}</span>
                            <span class="text-xs font-black text-slate-900">${s.items.length}</span>
                        </div>
                    `).join("")}
                </div>
            `:`
    ...
    `}function Jn(e){if(e==="desktop-secondary")return bu();const t=Yn();window._notifActions=[],t.forEach(n=>n.items.forEach(l=>{l.actions&&l.actions.forEach(i=>window._notifActions.push(i.handler))}));let s=0;const a=t.map(n=>{const l=fu(n,s);return s+=n.items.reduce((i,r)=>i+(r.actions?r.actions.length:0),0),l}).join("");return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            ${pu()}
    ...
    `,(t==="error"||e.length>50)&&(n.innerHTML+=`
        ...
        `),qt.innerHTML="",qt.appendChild(n),requestAnimationFrame(()=>{n.classList.remove("opacity-0","translate-y-[-20px]","scale-95"),n.classList.add("opacity-100","translate-y-0","scale-100")}),Ka=setTimeout(()=>{$u(n)},s),n}function $u(e){!e||!e.parentElement||(e.classList.remove("opacity-100","translate-y-0","scale-100"),e.classList.add("opacity-0","translate-y-[-20px]","scale-95"),setTimeout(()=>{e.remove()},300))}function La(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const Eu={success:(e,t)=>Gs(e,"success",t),error:(e,t)=>Gs(e,"error",t||5e3),warning:(e,t)=>Gs(e,"warning",t||4e3),info:(e,t)=>Gs(e,"info",t)};function Iu(e,t,s){const a=document.createElement("div");a.className="fixed inset-0 z-[9998] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4",a.innerHTML=`
    ...
    `,document.body.appendChild(n);const l=n.querySelector("div > div"),i=n.querySelector("#prompt-input");requestAnimationFrame(()=>{l.classList.remove("scale-95","opacity-0"),l.classList.add("scale-100","opacity-100"),i.focus(),i.select()}),i.onkeydown=r=>{if(r.key==="Enter"){const c=i.value.trim();ht(n),c&&s&&s(c)}else r.key==="Escape"&&(ht(n),a&&a())},n.querySelector("#prompt-cancel").onclick=()=>{ht(n),a&&a()},n.querySelector("#prompt-ok").onclick=()=>{const r=i.value.trim();ht(n),r&&s&&s(r)},n.onclick=r=>{r.target===n&&(ht(n),a&&a())}}window.toast=Eu;window.showToast=Gs;window.showConfirm=Iu;window.showPrompt=Cu;function Kn(){const e=localStorage.getItem("retaileros_theme")||"light",t=parseInt(localStorage.getItem("retaileros_font_size")||"100"),s=localStorage.getItem("retaileros_density")||"comfortable",a=localStorage.getItem("retaileros_animations")!=="false",n=document.documentElement;let l=e;e==="system"&&(l=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),n.classList.remove("light","dark"),n.classList.add(l);const i=s==="compact"?-5:s==="spacious"?5:0;n.style.setProperty("--font-scale",(t+i)/100),n.classList.toggle("no-animations",!a);const r=document.querySelector('meta[name="theme-color"]');r&&(r.content=l==="dark"?"#020617":"#0F172A")}window.applyTheme=Kn;window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{localStorage.getItem("retaileros_theme")==="system"&&Kn()});Kn();function Ru(){return p.currentApp==="sales"?p.currentTab==="new-sale"?sr():ar():p.currentApp==="clients"?On("desktop-primary"):p.currentApp==="reports"?jn("desktop-primary"):p.currentApp==="repairs"?Pn("desktop-primary"):p.currentApp==="marketing"?Nn("desktop-primary"):p.currentApp==="promoters"?qn("desktop-primary"):p.currentApp==="inventory"?Bn("desktop-primary"):p.currentApp==="settings"?Fn("desktop-primary"):p.currentApp==="schemes"?Vn("desktop-primary"):p.currentApp==="marketplace"?Un("desktop-primary"):p.currentApp==="inquiries"?Hn("desktop-primary"):p.currentApp==="prebooking"?Gn("desktop-primary"):p.currentApp==="automation"?Wn("desktop-primary"):p.currentApp==="mystore"?zn("desktop-primary"):p.currentApp==="notifications"?Jn("desktop-primary"):'<div class="p-10 flex items-center justify-center h-full text-slate-300 font-bold uppercase tracking-widest">App Module Not Found</div>'}function Au(){return p.currentApp==="sales"?p.salesMode==="add-customer"?gn("desktop"):lr():p.currentApp==="clients"?On("desktop-secondary"):p.currentApp==="reports"?jn("desktop-secondary"):p.currentApp==="repairs"?Pn("desktop-secondary"):p.currentApp==="marketing"?Nn("desktop-secondary"):p.currentApp==="promoters"?qn("desktop-secondary"):p.currentApp==="inventory"?Bn("desktop-secondary"):p.currentApp==="settings"?Fn("desktop-secondary"):p.currentApp==="schemes"?Vn("desktop-secondary"):p.currentApp==="marketplace"?Un("desktop-secondary"):p.currentApp==="inquiries"?Hn("desktop-secondary"):p.currentApp==="prebooking"?Gn("desktop-secondary"):p.currentApp==="automation"?Wn("desktop-secondary"):p.currentApp==="mystore"?zn("desktop-secondary"):p.currentApp==="notifications"?Jn("desktop-secondary"):'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">Select an app to view details</p></div></div>'}function cr(){return Wl("desktop")}function Tu(){return`
    ...
    `}function Mu(){return`
        <div class="h-full flex flex-row divide-x divide-slate-200 bg-white">
            ...
            <div class="flex-1 bg-white h-full overflow-hidden flex flex-col relative">
                ${p.isLoggedIn?p.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-4 opacity-20">arrow_back</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Select an App from the Menu</p></div></div>':dr():'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'}
            </div>
        </div>
    `}function pr(){return p.isLoggedIn?p.currentApp==="launcher"?Wl("mobile"):dr():`
            <div class="h-full w-full bg-white">
                ${Gl()}
            </div>
        `}function Oa(){const e=document.getElementById("app");if(e)try{const t=window.innerWidth;t<768?e.innerHTML=pr():t>=768&&t<1024?e.innerHTML=Mu():e.innerHTML=Tu()}catch(t){console.error(t),e.innerHTML=`<div class="p-4 text-slate-500 font-bold">Error: ${t.message}<br><small>${t.stack}</small></div>`}}function Du(){const e=window.innerWidth;if(e<768){const t=document.getElementById("app");t&&(t.innerHTML=pr())}else{const t=document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10")||document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative"),s=document.querySelector(".w-\\[30\\%\\].shrink-0.bg-slate-50\\/50.h-full.overflow-hidden.flex.flex-col.relative.dot-grid.border-l.border-slate-200");t&&(t.innerHTML=p.authMode==="register"?Js("desktop-primary"):'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'),s&&e>=1024&&(s.innerHTML=p.authMode==="register"?Js("desktop-secondary"):'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>')}}window.updateAuthContent=Du;Bl(Oa);Bl(hu);gu();window.addEventListener("resize",()=>{window.innerWidth!==p.viewportWidth&&(p.viewportWidth=window.innerWidth,p.gridCols=window.innerWidth<768?4:3,Oa())});Y().then(()=>{console.log("Initial data sync complete"),Oa()}).catch(e=>{console.error("Initial sync failed:",e),Oa()});
