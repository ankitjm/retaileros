var cr=Object.defineProperty;var tl=e=>{throw TypeError(e)};var dr=(e,t,s)=>t in e?cr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var q=(e,t,s)=>dr(e,typeof t!="symbol"?t+"":t,s),Wa=(e,t,s)=>t.has(e)||tl("Cannot "+s);var c=(e,t,s)=>(Wa(e,t,"read from private field"),s?s.call(e):t.get(e)),_=(e,t,s)=>t.has(e)?tl("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),h=(e,t,s,a)=>(Wa(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),S=(e,t,s)=>(Wa(e,t,"access private method"),s);var es=(e,t,s,a)=>({set _(n){h(e,t,n,s)},get _(){return c(e,t,a)}});(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();const pr=localStorage.getItem("retaileros_logged_in")==="true",ur=localStorage.getItem("retaileros_retailer_id")||null,xr=localStorage.getItem("retaileros_retailer_code")||null,fr=localStorage.getItem("retaileros_retailer_name")||null,br=localStorage.getItem("retaileros_push_notifications")!=="false";window._pushNotificationsEnabled=br;const p={retailerId:ur,retailerCode:xr,retailerName:fr,currentApp:window.innerWidth<768?"launcher":"sales",currentTab:"new-sale",salesMode:"default",salesHistoryId:"ORD-99281",historyViewMode:"completed",historyDateFilter:"today",historyFromDate:"",historyToDate:"",showMobileReceipt:!1,reportsTab:"sales",repairTab:"active",repairViewMode:"search",selectedRepairDevice:null,activeRepairId:null,repairContext:null,selectedClient:null,selectedClientId:null,clientViewMode:"directory",clientSearchQuery:"",clientInvoiceId:null,selectedGroupId:null,groupViewMode:"list",groupSearchQuery:"",promoterViewMode:"performance",inventoryTab:"brands",inventoryMode:"details",activeCategory:null,settingsView:null,viewportWidth:window.innerWidth,gridCols:window.innerWidth<768?4:3,schemesTab:"list",activeSchemeBrand:"Apple",activeScheme:"June Activation Bonus",showSchemeDetails:!1,marketplaceTab:"browse",marketplaceViewMode:"list",myStoreTab:"dashboard",myStoreViewMode:"list",activeStoreOrderId:null,activeListingId:null,isLoggedIn:pr,authMode:"login",registrationStep:1,inquiryViewMode:"list",activeInquiry:null,preBookingViewMode:"dashboard",activeCampaign:null,automationViewMode:"dashboard",activeAutomationId:null},jl=[],Pl=e=>{jl.push(e)},D=(e=!0)=>{jl.forEach(t=>t(e))};function mr(e){p.currentApp=e,e==="clients"&&(p.clientViewMode="directory"),D()}function hr(e){p.currentTab=e,D()}function gr(e){p.salesHistoryId=e,e&&window.innerWidth<768&&(p.showMobileReceipt=!0),D()}function wr(e){p.showMobileReceipt=e,D()}function vr(e){p.reportsTab=e,D()}function yr(e){p.repairTab=e,D()}function kr(e,t=null){p.repairViewMode=e,t&&(p.selectedRepairDevice=t),D()}function _r(e){p.gridCols=e,D()}function Nl(e,t=null,s=null){p.clientViewMode=e,t&&(p.selectedClient=t),s&&(p.selectedClientId=s),e!=="invoice"&&(p.clientInvoiceId=null),D()}function Sr(e){p.clientInvoiceId=e,p.clientViewMode="invoice",D()}function $r(e){p.schemesTab=e,D()}function Er(e){p.activeSchemeBrand=e,D()}function Ir(e){p.activeScheme=e,D()}function Cr(e){p.showSchemeDetails=e,D()}function Rr(e){p.marketplaceTab=e,D()}function Ar(e){p.marketplaceViewMode=e,D()}function Tr(e,t,s){p.retailerId=e,p.retailerCode=t,p.retailerName=s,localStorage.setItem("retaileros_retailer_id",e),localStorage.setItem("retaileros_retailer_code",t),localStorage.setItem("retaileros_retailer_name",s)}function ql(){p.retailerId=null,p.retailerCode=null,p.retailerName=null,localStorage.removeItem("retaileros_retailer_id"),localStorage.removeItem("retaileros_retailer_code"),localStorage.removeItem("retaileros_retailer_name")}function Mr(){return p.retailerId}function Dr(e){p.isLoggedIn=e,e?localStorage.setItem("retaileros_logged_in","true"):(localStorage.removeItem("retaileros_logged_in"),ql());const t=window.innerWidth<768;p.currentApp=e?t?"launcher":"sales":"launcher",D()}function Or(e){p.authMode=e,p.registrationStep=1,D()}function Lr(e){p.registrationStep=e,window.updateAuthContent?window.updateAuthContent():D()}function jr(e){p.inquiryViewMode=e,D()}function Pr(e){p.activeInquiry=e,D()}function Nr(e){p.preBookingViewMode=e,D()}function qr(e){p.activeCampaign=e,D()}function Br(e){p.automationViewMode=e,D()}function Fr(e){p.activeAutomationId=e,D()}window.triggerRender=D;window.setApp=mr;window.setTab=hr;window.setSalesHistoryId=gr;window.toggleMobileReceipt=wr;window.setReportsTab=vr;window.setRepairTab=yr;function Bl(e){p.salesMode=e,D()}window.setSalesMode=Bl;function Vr(e){p.historyViewMode=e,D()}function Ur(e){p.historyDateFilter=e,e!=="custom"&&(p.historyFromDate="",p.historyToDate=""),D()}function Hr(e,t){p.historyFromDate=e,p.historyToDate=t,p.historyDateFilter="custom",D()}window.setHistoryViewMode=Vr;window.setHistoryDateFilter=Ur;window.setHistoryCustomDates=Hr;window.setRepairMode=kr;window.setGridCols=_r;window.setClientMode=Nl;window.viewClientInvoice=Sr;window.setSchemesTab=$r;window.setSchemeBrand=Er;window.setScheme=Ir;window.toggleSchemeDetails=Cr;window.setMarketplaceTab=Rr;window.setMarketplaceViewMode=Ar;function Gr(e){p.myStoreTab=e,p.myStoreViewMode="list",D()}function Wr(e){p.myStoreViewMode=e,D()}function zr(e){p.activeStoreOrderId=e,p.myStoreViewMode="order-detail",D()}function Yr(e){p.activeListingId=e,D()}window.setMyStoreTab=Gr;window.setMyStoreViewMode=Wr;window.setActiveStoreOrder=zr;window.setActiveListing=Yr;window.setRetailer=Tr;window.clearRetailer=ql;window.getRetailerId=Mr;window.setLoginStatus=Dr;window.setAuthMode=Or;window.setRegistrationStep=Lr;window.setInquiryViewMode=jr;window.setActiveInquiry=Pr;window.setPreBookingViewMode=Nr;window.setActiveCampaign=qr;window.setAutomationViewMode=Br;window.setActiveAutomation=Fr;function Jr(e){p.groupViewMode=e,D()}function Kr(e){p.selectedGroupId=e,D()}window.setGroupViewMode=Jr;window.setSelectedGroup=Kr;function Qr(){const e=window._pushNotificationsEnabled!==!1;window._pushNotificationsEnabled=!e,localStorage.setItem("retaileros_push_notifications",e?"false":"true"),D()}window.togglePushNotifications=Qr;const Xr="modulepreload",Zr=function(e){return"/"+e},sl={},Ys=function(t,s,a){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=Promise.allSettled(s.map(d=>{if(d=Zr(d),d in sl)return;sl[d]=!0;const o=d.endsWith(".css"),u=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const m=document.createElement("link");if(m.rel=o?"stylesheet":Xr,o||(m.as="script"),m.crossOrigin="",m.href=d,r&&m.setAttribute("nonce",r),document.head.appendChild(m),o)return new Promise((b,y)=>{m.addEventListener("load",b),m.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${d}`)))})}))}function l(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return n.then(i=>{for(const r of i||[])r.status==="rejected"&&l(r.reason);return t().catch(l)})};function Fl(){return`
...
Error: `+s.message)}};window.verifyOtp=function(){const e=[];for(let a=0;a<6;a++){const n=document.getElementById(`otp-${a}`);n&&e.push(n.value)}const t=e.join("");if(t.length!==6){alert("Please enter all 6 digits");return}const s="444619";console.log("Verifying OTP:",t),t===s?console.log("✅ Default OTP accepted:",s):console.log("ℹ️  Development mode: Any OTP accepted"),window.setRegistrationStep(3)};window.resendOtp=function(){for(let t=0;t<6;t++){const s=document.getElementById(`otp-${t}`);s&&(s.value="")}const e=document.getElementById("otp-0");e&&e.focus(),console.log("Resending OTP..."),alert("OTP has been resent successfully!")};window.finalizeRegistration=async function(){try{const e=window._approvedRetailerData;if(!e){alert("Session expired. Please start registration again."),window.setRegistrationStep(1);return}const{db:t}=await Ys(async()=>{const{db:n}=await Promise.resolve().then(()=>Mn);return{db:n}},void 0),s=await t.retailers.add(e);window.setRetailer(s.id,s.retailerCode,e.RetailerName),localStorage.setItem("retaileros_logged_in","true"),delete window._approvedRetailerData;const{syncData:a}=await Ys(async()=>{const{syncData:n}=await Promise.resolve().then(()=>Ji);return{syncData:n}},void 0);await a(),window.setLoginStatus(!0),console.log("Registration completed successfully:",s)}catch(e){console.error("Registration failed:",e),alert("Registration failed. Please try again.")}};function Vl(){return p.authMode==="register"?Js():Fl()}const ao=[{n:"ALERTS",i:"notifications",k:"notifications"},{n:"SALES DESK",i:"account_balance_wallet",k:"sales"},{n:"CLIENTS",i:"group",k:"clients"},{n:"INQUIRIES",i:"help_outline",k:"inquiries"},{n:"PROMOTERS",i:"business_center",k:"promoters"},{n:"MY STORE",i:"storefront",k:"mystore"},{n:"INVENTORY",i:"inventory_2",k:"inventory"},{n:"REPAIRS",i:"build",k:"repairs"},{n:"MARKETPLACE",i:"swap_horizontal_circle",k:"marketplace"},{n:"CLAIMS",i:"verified_user"},{n:"SCHEMES",i:"percent",k:"schemes"},{n:"MARKETING",i:"campaign",k:"marketing"},{n:"AUTOMATION",i:"smart_toy",s:!0,k:"automation"},{n:"PRE-BOOKING",i:"rocket_launch",k:"prebooking"},{n:"REPORTS",i:"bar_chart",k:"reports"},{n:"SETTINGS",i:"settings",k:"settings"}];function no(e){const t=e?p.gridCols:4,s=e&&{2:"grid-cols-2",3:"grid-cols-3",4:"grid-cols-4"}[t]||"grid-cols-4",a=window.getNotificationCount?window.getNotificationCount():0;return`
    ...
    `}function Ul(e){const t=e==="mobile";return`
    ...
    `}class F extends Error{constructor(s,a,n,l,i){a!==void 0&&(s=`${a}: ${s}`);super(s,{cause:i});q(this,"code");q(this,"extendedCode");q(this,"rawCode");this.code=a,this.extendedCode=n,this.rawCode=l,this.name="LibsqlError"}}class ls extends F{constructor(s,a,n,l,i,r){super(s,n,l,i,r);q(this,"statementIndex");this.statementIndex=a,this.name="LibsqlBatchError"}}function io(e){const t=ro.exec(e);if(t===null)throw new F(`The URL '${e}' is not in a valid format`,"URL_INVALID");const s=t.groups,a=s.scheme,n=s.authority!==void 0?oo(s.authority):void 0,l=Qt(s.path),i=s.query!==void 0?po(s.query):void 0,r=s.fragment!==void 0?Qt(s.fragment):void 0;return{scheme:a,authority:n,path:l,query:i,fragment:r}}const ro=(()=>{const e="(?<scheme>[A-Za-z][A-Za-z.+-]*)",t="(?<authority>[^/?#]*)",s="(?<path>[^?#]*)",a="(?<query>[^#]*)",n="(?<fragment>.*)";return new RegExp(`^${e}:(//${t})?${s}(\\?${a})?(#${n})?$`,"su")})();function oo(e){const t=co.exec(e);if(t===null)throw new F("The authority part of the URL is not in a valid format","URL_INVALID");const s=t.groups,a=Qt(s.host_br??s.host),n=s.port?parseInt(s.port,10):void 0,l=s.username!==void 0?{username:Qt(s.username),password:s.password!==void 0?Qt(s.password):void 0}:void 0;return{host:a,port:n,userinfo:l}}const co=new RegExp("^((?<username>[^:]*)(:(?<password>.*))?@)?((?<host>[^:\\[\\]]*)|(\\[(?<host_br>[^\\[\\]]*)\\]))(:(?<port>[0-9]*))?$","su");function po(e){const t=e.split("&"),s=[];for(const a of t){if(a==="")continue;let n,l;const i=a.indexOf("=");i<0?(n=a,l=""):(n=a.substring(0,i),l=a.substring(i+1)),s.push({key:Qt(n.replaceAll("+"," ")),value:Qt(l.replaceAll("+"," "))})}return{pairs:s}}function Qt(e){try{return decodeURIComponent(e)}catch(t){throw t instanceof URIError?new F(`URL component has invalid percent encoding: ${t}`,"URL_INVALID",void 0,void 0,t):t}}function Qa(e,t,s){if(t===void 0)throw new F(`URL with scheme ${JSON.stringify(e+":")} requires authority (the "//" part)`,"URL_INVALID");const a=`${e}:`,n=uo(t.host),l=xo(t.port),r=`//${fo(t.userinfo)}${n}${l}`;let d=s.split("/").map(encodeURIComponent).join("/");return d!==""&&!d.startsWith("/")&&(d="/"+d),new URL(`${a}${r}${d}`)}function uo(e){return e.includes(":")?`[${encodeURI(e)}]`:encodeURI(e)}function xo(e){return e!==void 0?`:${e}`:""}function fo(e){if(e===void 0)return"";const t=encodeURIComponent(e.username),s=e.password!==void 0?`:${encodeURIComponent(e.password)}`:"";return`${t}${s}@`}const Hl="3.7.8",bo=Hl,Ds=typeof Buffer=="function",al=typeof TextDecoder=="function"?new TextDecoder:void 0,nl=typeof TextEncoder=="function"?new TextEncoder:void 0,mo="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",js=Array.prototype.slice.call(mo),ha=(e=>{let t={};return e.forEach((s,a)=>t[s]=a),t})(js),ho=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,le=String.fromCharCode.bind(String),ll=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),Gl=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),Wl=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),zl=e=>{let t,s,a,n,l="";const i=e.length%3;for(let r=0;r<e.length;){if((s=e.charCodeAt(r++))>255||(a=e.charCodeAt(r++))>255||(n=e.charCodeAt(r++))>255)throw new TypeError("invalid character found");t=s<<16|a<<8|n,l+=js[t>>18&63]+js[t>>12&63]+js[t>>6&63]+js[t&63]}return i?l.slice(0,i-3)+"===".substring(i):l},kn=typeof btoa=="function"?e=>btoa(e):Ds?e=>Buffer.from(e,"binary").toString("base64"):zl,Xa=Ds?e=>Buffer.from(e).toString("base64"):e=>{let s=[];for(let a=0,n=e.length;a<n;a+=4096)s.push(le.apply(null,e.subarray(a,a+4096)));return kn(s.join(""))},va=(e,t=!1)=>t?Gl(Xa(e)):Xa(e),go=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?le(192|t>>>6)+le(128|t&63):le(224|t>>>12&15)+le(128|t>>>6&63)+le(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return le(240|t>>>18&7)+le(128|t>>>12&63)+le(128|t>>>6&63)+le(128|t&63)}},wo=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Yl=e=>e.replace(wo,go),il=Ds?e=>Buffer.from(e,"utf8").toString("base64"):nl?e=>Xa(nl.encode(e)):e=>kn(Yl(e)),is=(e,t=!1)=>t?Gl(il(e)):il(e),rl=e=>is(e,!0),vo=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,yo=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),s=t-65536;return le((s>>>10)+55296)+le((s&1023)+56320);case 3:return le((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return le((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},Jl=e=>e.replace(vo,yo),Kl=e=>{if(e=e.replace(/\s+/g,""),!ho.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,s,a,n=[];for(let l=0;l<e.length;)t=ha[e.charAt(l++)]<<18|ha[e.charAt(l++)]<<12|(s=ha[e.charAt(l++)])<<6|(a=ha[e.charAt(l++)]),s===64?n.push(le(t>>16&255)):a===64?n.push(le(t>>16&255,t>>8&255)):n.push(le(t>>16&255,t>>8&255,t&255));return n.join("")},_n=typeof atob=="function"?e=>atob(Wl(e)):Ds?e=>Buffer.from(e,"base64").toString("binary"):Kl,Ql=Ds?e=>ll(Buffer.from(e,"base64")):e=>ll(_n(e).split("").map(t=>t.charCodeAt(0))),Xl=e=>Ql(Zl(e)),ko=Ds?e=>Buffer.from(e,"base64").toString("utf8"):al?e=>al.decode(Ql(e)):e=>Jl(_n(e)),Zl=e=>Wl(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),Za=e=>ko(Zl(e)),_o=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},ei=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),ti=function(){const e=(t,s)=>Object.defineProperty(String.prototype,t,ei(s));e("fromBase64",function(){return Za(this)}),e("toBase64",function(t){return is(this,t)}),e("toBase64URI",function(){return is(this,!0)}),e("toBase64URL",function(){return is(this,!0)}),e("toUint8Array",function(){return Xl(this)})},si=function(){const e=(t,s)=>Object.defineProperty(Uint8Array.prototype,t,ei(s));e("toBase64",function(t){return va(this,t)}),e("toBase64URI",function(){return va(this,!0)}),e("toBase64URL",function(){return va(this,!0)})},So=()=>{ti(),si()},Sn={version:Hl,VERSION:bo,atob:_n,atobPolyfill:Kl,btoa:kn,btoaPolyfill:zl,fromBase64:Za,toBase64:is,encode:is,encodeURI:rl,encodeURL:rl,utob:Yl,btou:Jl,decode:Za,isValid:_o,fromUint8Array:va,toUint8Array:Xl,extendString:ti,extendUint8Array:si,extendBuiltins:So},Ks="https://github.com/libsql/libsql-client-ts#supported-urls";function en(e){if(e==="write")return"BEGIN IMMEDIATE";if(e==="read")return"BEGIN TRANSACTION READONLY";if(e==="deferred")return"BEGIN DEFERRED";throw RangeError('Unknown transaction mode, supported values are "write", "read" and "deferred"')}class $o{constructor(t,s,a,n,l){q(this,"columns");q(this,"columnTypes");q(this,"rows");q(this,"rowsAffected");q(this,"lastInsertRowid");this.columns=t,this.columnTypes=s,this.rows=a,this.rowsAffected=n,this.lastInsertRowid=l}toJSON(){return{columns:this.columns,columnTypes:this.columnTypes,rows:this.rows.map(Eo),rowsAffected:this.rowsAffected,lastInsertRowid:this.lastInsertRowid!==void 0?""+this.lastInsertRowid:null}}}function Eo(e){return Array.prototype.map.call(e,Io)}function Io(e){return typeof e=="bigint"?""+e:e instanceof ArrayBuffer?Sn.fromUint8Array(new Uint8Array(e)):e}const ol=":memory:";function Co(e,t){var f,x;if(typeof e!="object")throw new TypeError(`Expected client configuration as object, got ${typeof e}`);let{url:s,authToken:a,tls:n,intMode:l,concurrency:i}=e;i=Math.max(0,i||20),l??(l="number");let r=[];s===ol&&(s="file::memory:");const d=io(s),o=d.scheme.toLowerCase(),u=o==="file"&&d.path===ol&&d.authority===void 0;let m;u?m={cache:{values:["shared","private"],update:(k,I)=>r.push(`${k}=${I}`)}}:m={tls:{values:["0","1"],update:(k,I)=>n=I==="1"},authToken:{update:(k,I)=>a=I}};for(const{key:k,value:I}of((f=d.query)==null?void 0:f.pairs)??[]){if(!Object.hasOwn(m,k))throw new F(`Unsupported URL query parameter ${JSON.stringify(k)}`,"URL_PARAM_NOT_SUPPORTED");const C=m[k];if(C.values!==void 0&&!C.values.includes(I))throw new F(`Unknown value for the "${k}" query argument: ${JSON.stringify(I)}. Supported values are: [${C.values.map($=>'"'+$+'"').join(", ")}]`,"URL_INVALID");C.update!==void 0&&(C==null||C.update(k,I))}const b=r.length===0?"":`?${r.join("&")}`,y=d.path+b;let w;if(o==="libsql")if(n===!1){if(((x=d.authority)==null?void 0:x.port)===void 0)throw new F('A "libsql:" URL with ?tls=0 must specify an explicit port',"URL_INVALID");w="http"}else w="https";else w=o;if(w==="http"||w==="ws"?n??(n=!1):n??(n=!0),w!=="http"&&w!=="ws"&&w!=="https"&&w!=="wss"&&w!=="file")throw new F(`The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${JSON.stringify(d.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(l!=="number"&&l!=="bigint"&&l!=="string")throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(l)}`);if(d.fragment!==void 0)throw new F(`URL fragments are not supported: ${JSON.stringify("#"+d.fragment)}`,"URL_INVALID");return u?{scheme:"file",tls:!1,path:y,intMode:l,concurrency:i,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch,authToken:void 0,encryptionKey:void 0,remoteEncryptionKey:void 0,authority:void 0}:{scheme:w,tls:n,authority:d.authority,path:y,authToken:a,intMode:l,concurrency:i,encryptionKey:e.encryptionKey,remoteEncryptionKey:e.remoteEncryptionKey,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch}}let as;typeof WebSocket<"u"?as=WebSocket:typeof global<"u"?as=global.WebSocket:typeof window<"u"?as=window.WebSocket:typeof self<"u"&&(as=self.WebSocket);class ai{constructor(){q(this,"intMode");this.intMode="number"}}class J extends Error{constructor(t){super(t),this.name="ClientError"}}class j extends J{constructor(t){super(t),this.name="ProtoError"}}class ni extends J{constructor(s,a){super(s);q(this,"code");q(this,"proto");this.name="ResponseError",this.code=a.code,this.proto=a,this.stack=void 0}}class Ae extends J{constructor(t,s){s!==void 0?(super(`${t}: ${s}`),this.cause=s):super(t),this.name="ClosedError"}}class li extends J{constructor(t){super(t),this.name="WebSocketUnsupportedError"}}class tn extends J{constructor(t){super(t),this.name="WebSocketError"}}class ya extends J{constructor(s,a){super(s);q(this,"status");this.status=a,this.name="HttpServerError"}}class Rs extends J{constructor(t){super(t),this.name="ProtocolVersionError"}}class At extends J{constructor(t){super(t),this.name="InternalError"}}class Os extends J{constructor(t){super(t),this.name="MisuseError"}}function qe(e){if(typeof e=="string")return e;throw Ls(e,"string")}function Fe(e){if(e!=null){if(typeof e=="string")return e;throw Ls(e,"string or null")}}function Xt(e){if(typeof e=="number")return e;throw Ls(e,"number")}function Qs(e){if(typeof e=="boolean")return e;throw Ls(e,"boolean")}function Ia(e){if(Array.isArray(e))return e;throw Ls(e,"array")}function ie(e){if(e!==null&&typeof e=="object"&&!Array.isArray(e))return e;throw Ls(e,"object")}function Tt(e,t){return Ia(e).map(s=>t(ie(s)))}function Ls(e,t){if(e===void 0)return new j(`Expected ${t}, but the property was missing`);let s=typeof e;return e===null?s="null":Array.isArray(e)&&(s="array"),new j(`Expected ${t}, received ${s}`)}function $n(e,t){return t(ie(e))}var X,gt,Ze,Lt;class Ro{constructor(t){_(this,Ze);_(this,X);_(this,gt);h(this,X,t),h(this,gt,!1)}begin(){c(this,X).push("{"),h(this,gt,!0)}end(){c(this,X).push("}"),h(this,gt,!1)}string(t,s){S(this,Ze,Lt).call(this,t),c(this,X).push(JSON.stringify(s))}stringRaw(t,s){S(this,Ze,Lt).call(this,t),c(this,X).push('"'),c(this,X).push(s),c(this,X).push('"')}number(t,s){S(this,Ze,Lt).call(this,t),c(this,X).push(""+s)}boolean(t,s){S(this,Ze,Lt).call(this,t),c(this,X).push(s?"true":"false")}object(t,s,a){S(this,Ze,Lt).call(this,t),this.begin(),a(this,s),this.end()}arrayObjects(t,s,a){S(this,Ze,Lt).call(this,t),c(this,X).push("[");for(let n=0;n<s.length;++n)n!==0&&c(this,X).push(","),this.begin(),a(this,s[n]),this.end();c(this,X).push("]")}}X=new WeakMap,gt=new WeakMap,Ze=new WeakSet,Lt=function(t){c(this,gt)?(c(this,X).push('"'),h(this,gt,!1)):c(this,X).push(',"'),c(this,X).push(t),c(this,X).push('":')};function ii(e,t){const s=[],a=new Ro(s);return a.begin(),t(a,e),a.end(),s.join("")}const Ws=0,sn=1,an=2,Ao=5;var Ue,Xs,_e;class To{constructor(t){_(this,Ue);_(this,Xs);_(this,_e);h(this,Ue,t),h(this,Xs,new DataView(t.buffer,t.byteOffset,t.byteLength)),h(this,_e,0)}varint(){let t=0;for(let s=0;;s+=7){const a=c(this,Ue)[es(this,_e)._++];if(t|=(a&127)<<s,!(a&128))break}return t}varintBig(){let t=0n;for(let s=0n;;s+=7n){const a=c(this,Ue)[es(this,_e)._++];if(t|=BigInt(a&127)<<s,!(a&128))break}return t}bytes(t){const s=new Uint8Array(c(this,Ue).buffer,c(this,Ue).byteOffset+c(this,_e),t);return h(this,_e,c(this,_e)+t),s}double(){const t=c(this,Xs).getFloat64(c(this,_e),!0);return h(this,_e,c(this,_e)+8),t}skipVarint(){for(;c(this,Ue)[es(this,_e)._++]&128;);}skip(t){h(this,_e,c(this,_e)+t)}eof(){return c(this,_e)>=c(this,Ue).byteLength}}Ue=new WeakMap,Xs=new WeakMap,_e=new WeakMap;var be,ce,Bt,Ps;class Mo{constructor(t){_(this,Bt);_(this,be);_(this,ce);h(this,be,t),h(this,ce,-1)}setup(t){h(this,ce,t)}bytes(){S(this,Bt,Ps).call(this,an);const t=c(this,be).varint();return c(this,be).bytes(t)}string(){return new TextDecoder().decode(this.bytes())}message(t){return qa(this.bytes(),t)}int32(){return S(this,Bt,Ps).call(this,Ws),c(this,be).varint()}uint32(){return this.int32()}bool(){return this.int32()!==0}uint64(){return S(this,Bt,Ps).call(this,Ws),c(this,be).varintBig()}sint64(){const t=this.uint64();return t>>1n^-(t&1n)}double(){return S(this,Bt,Ps).call(this,sn),c(this,be).double()}maybeSkip(){if(!(c(this,ce)<0)){if(c(this,ce)===Ws)c(this,be).skipVarint();else if(c(this,ce)===sn)c(this,be).skip(8);else if(c(this,ce)===an){const t=c(this,be).varint();c(this,be).skip(t)}else if(c(this,ce)===Ao)c(this,be).skip(4);else throw new j(`Unexpected wire type ${c(this,ce)}`);h(this,ce,-1)}}}be=new WeakMap,ce=new WeakMap,Bt=new WeakSet,Ps=function(t){if(c(this,ce)!==t)throw new j(`Expected wire type ${t}, got ${c(this,ce)}`);h(this,ce,-1)};function qa(e,t){const s=new To(e),a=new Mo(s);let n=t.default();for(;!s.eof();){const l=s.varint(),i=l>>3,r=l&7;a.setup(r);const d=t[i];if(d!==void 0){const o=d(a,n);o!==void 0&&(n=o)}a.maybeSkip()}return n}var Te,wt,cs,me,se,Ns,ka,ri,qs;const Xn=class Xn{constructor(){_(this,se);_(this,Te);_(this,wt);_(this,cs);_(this,me);h(this,Te,new ArrayBuffer(256)),h(this,wt,new Uint8Array(c(this,Te))),h(this,cs,new DataView(c(this,Te))),h(this,me,0)}bytes(t,s){S(this,se,qs).call(this,t,an),S(this,se,ka).call(this,s.byteLength),S(this,se,Ns).call(this,s.byteLength),c(this,wt).set(s,c(this,me)),h(this,me,c(this,me)+s.byteLength)}string(t,s){this.bytes(t,new TextEncoder().encode(s))}message(t,s,a){const n=new Xn;a(n,s),this.bytes(t,n.data())}int32(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,ka).call(this,s)}uint32(t,s){this.int32(t,s)}bool(t,s){this.int32(t,s?1:0)}sint64(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,ri).call(this,s<<1n^s>>63n)}double(t,s){S(this,se,qs).call(this,t,sn),S(this,se,Ns).call(this,8),c(this,cs).setFloat64(c(this,me),s,!0),h(this,me,c(this,me)+8)}data(){return new Uint8Array(c(this,Te),0,c(this,me))}};Te=new WeakMap,wt=new WeakMap,cs=new WeakMap,me=new WeakMap,se=new WeakSet,Ns=function(t){if(c(this,me)+t<=c(this,Te).byteLength)return;let s=c(this,Te).byteLength;for(;s<c(this,me)+t;)s*=2;const a=new ArrayBuffer(s),n=new Uint8Array(a),l=new DataView(a);n.set(new Uint8Array(c(this,Te),0,c(this,me))),h(this,Te,a),h(this,wt,n),h(this,cs,l)},ka=function(t){S(this,se,Ns).call(this,5),t=0|t;do{let s=t&127;t>>>=7,s|=t?128:0,c(this,wt)[es(this,me)._++]=s}while(t)},ri=function(t){S(this,se,Ns).call(this,10),t=t&0xffffffffffffffffn;do{let s=Number(t&0x7fn);t>>=7n,s|=t?128:0,c(this,wt)[es(this,me)._++]=s}while(t)},qs=function(t,s){S(this,se,ka).call(this,t<<3|s)};let nn=Xn;function oi(e,t){const s=new nn;return t(s,e),s.data()}var Se,et;class Bs{constructor(){_(this,Se);_(this,et);h(this,Se,new Set),h(this,et,new Set)}alloc(){for(const s of c(this,et))return c(this,et).delete(s),c(this,Se).add(s),c(this,Se).has(c(this,Se).size-1)||c(this,et).add(c(this,Se).size-1),s;const t=c(this,Se).size;return c(this,Se).add(t),t}free(t){if(!c(this,Se).delete(t))throw new At("Freeing an id that is not allocated");c(this,et).delete(c(this,Se).size),t<c(this,Se).size&&c(this,et).add(t)}}Se=new WeakMap,et=new WeakMap;function K(e,t){throw new At(t)}function zs(e){if(e===null)return null;if(typeof e=="string")return e;if(typeof e=="number"){if(!Number.isFinite(e))throw new RangeError("Only finite numbers (not Infinity or NaN) can be passed as arguments");return e}else if(typeof e=="bigint"){if(e<Do||e>Oo)throw new RangeError("This bigint value is too large to be represented as a 64-bit integer and passed as argument");return e}else{if(typeof e=="boolean")return e?1n:0n;if(e instanceof ArrayBuffer)return new Uint8Array(e);if(e instanceof Uint8Array)return e;if(e instanceof Date)return+e.valueOf();if(typeof e=="object")return""+e.toString();throw new TypeError("Unsupported type of value")}}const Do=-9223372036854775808n,Oo=9223372036854775807n;function ci(e,t){if(e===null)return null;if(typeof e=="number")return e;if(typeof e=="string")return e;if(typeof e=="bigint")if(t==="number"){const s=Number(e);if(!Number.isSafeInteger(s))throw new RangeError("Received integer which is too large to be safely represented as a JavaScript number");return s}else{if(t==="bigint")return e;if(t==="string")return""+e;throw new Os("Invalid value for IntMode")}else{if(e instanceof Uint8Array)return e.slice().buffer;throw e===void 0?new j("Received unrecognized type of Value"):K(e,"Impossible type of Value")}}function fa(e){return{affectedRowCount:e.affectedRowCount,lastInsertRowid:e.lastInsertRowid,columnNames:e.cols.map(t=>t.name),columnDecltypes:e.cols.map(t=>t.decltype)}}function di(e,t){const s=fa(e),a=e.rows.map(n=>xi(s.columnNames,n,t));return{...s,rows:a}}function pi(e,t){const s=fa(e);let a;return e.rows.length>0&&(a=xi(s.columnNames,e.rows[0],t)),{...s,row:a}}function ui(e,t){const s=fa(e);let a;return e.rows.length>0&&s.columnNames.length>0&&(a=ci(e.rows[0][0],t)),{...s,value:a}}function xi(e,t,s){const a={};Object.defineProperty(a,"length",{value:t.length});for(let n=0;n<t.length;++n){const l=ci(t[n],s);Object.defineProperty(a,n,{value:l});const i=e[n];i!==void 0&&!Object.hasOwn(a,i)&&Object.defineProperty(a,i,{value:l,enumerable:!0,configurable:!0,writable:!0})}return a}function As(e){return new ni(e.message,e)}var ds,ps,tt;class En{constructor(t,s){_(this,ds);_(this,ps);_(this,tt);h(this,ds,t),h(this,ps,s),h(this,tt,void 0)}_getSqlId(t){if(c(this,ds)!==t)throw new Os("Attempted to use SQL text opened with other object");if(c(this,tt)!==void 0)throw new Ae("SQL text is closed",c(this,tt));return c(this,ps)}close(){this._setClosed(new J("SQL text was manually closed"))}_setClosed(t){c(this,tt)===void 0&&(h(this,tt,t),c(this,ds)._closeSql(c(this,ps)))}get closed(){return c(this,tt)!==void 0}}ds=new WeakMap,ps=new WeakMap,tt=new WeakMap;function ln(e,t){return t instanceof En?{sqlId:t._getSqlId(e)}:{sql:""+t}}var He,Me;class Ca{constructor(){_(this,He);_(this,Me);h(this,He,[]),h(this,Me,[])}get length(){return c(this,He).length+c(this,Me).length}push(t){c(this,He).push(t)}shift(){return c(this,Me).length===0&&c(this,He).length>0&&(h(this,Me,c(this,He).reverse()),h(this,He,[])),c(this,Me).pop()}first(){return c(this,Me).length!==0?c(this,Me)[c(this,Me).length-1]:c(this,He)[0]}}He=new WeakMap,Me=new WeakMap;let fi=class{constructor(t){q(this,"sql");q(this,"_args");q(this,"_namedArgs");this.sql=t,this._args=[],this._namedArgs=new Map}bindIndexes(t){this._args.length=0;for(const s of t)this._args.push(zs(s));return this}bindIndex(t,s){if(t!==(t|0)||t<=0)throw new RangeError("Index of a positional argument must be positive integer");for(;this._args.length<t;)this._args.push(null);return this._args[t-1]=zs(s),this}bindName(t,s){return this._namedArgs.set(t,zs(s)),this}unbindAll(){return this._args.length=0,this._namedArgs.clear(),this}};function bi(e,t,s){let a,n=[],l=[];if(t instanceof fi){a=t.sql,n=t._args;for(const[d,o]of t._namedArgs.entries())l.push({name:d,value:o})}else Array.isArray(t)?(a=t[0],Array.isArray(t[1])?n=t[1].map(d=>zs(d)):l=Object.entries(t[1]).map(([d,o])=>({name:d,value:zs(o)}))):a=t;const{sql:i,sqlId:r}=ln(e,a);return{sql:i,sqlId:r,args:n,namedArgs:l,wantRows:s}}var Zs,us,Ml;let Lo=(Ml=class{constructor(t,s){q(this,"_stream");_(this,Zs);q(this,"_steps");_(this,us);this._stream=t,h(this,Zs,s),this._steps=[],h(this,us,!1)}step(){return new No(this)}execute(){if(c(this,us))throw new Os("This batch has already been executed");h(this,us,!0);const t={steps:this._steps.map(s=>s.proto)};return c(this,Zs)?Po(this._stream,this._steps,t):jo(this._stream,this._steps,t)}},Zs=new WeakMap,us=new WeakMap,Ml);function jo(e,t,s){return e._batch(s).then(a=>{for(let n=0;n<t.length;++n){const l=a.stepResults.get(n),i=a.stepErrors.get(n);t[n].callback(l,i)}})}async function Po(e,t,s){const a=await e._openCursor(s);try{let n=0,l,i=[];for(;;){const r=await a.next();if(r===void 0)break;if(r.type==="step_begin"){if(r.step<n||r.step>=t.length)throw new j("Server produced StepBeginEntry for unexpected step");if(l!==void 0)throw new j("Server produced StepBeginEntry before terminating previous step");for(let d=n;d<r.step;++d)t[d].callback(void 0,void 0);n=r.step+1,l=r,i=[]}else if(r.type==="step_end"){if(l===void 0)throw new j("Server produced StepEndEntry but no step is active");const d={cols:l.cols,rows:i,affectedRowCount:r.affectedRowCount,lastInsertRowid:r.lastInsertRowid};t[l.step].callback(d,void 0),l=void 0,i=[]}else if(r.type==="step_error"){if(l===void 0){if(r.step>=t.length)throw new j("Server produced StepErrorEntry for unexpected step");for(let d=n;d<r.step;++d)t[d].callback(void 0,void 0)}else{if(r.step!==l.step)throw new j("Server produced StepErrorEntry for unexpected step");l=void 0,i=[]}t[r.step].callback(void 0,r.error),n=r.step+1}else if(r.type==="row"){if(l===void 0)throw new j("Server produced RowEntry but no step is active");i.push(r.row)}else throw r.type==="error"?As(r.error):r.type==="none"?new j("Server produced unrecognized CursorEntry"):K(r,"Impossible CursorEntry")}if(l!==void 0)throw new j("Server closed Cursor before terminating active step");for(let r=n;r<t.length;++r)t[r].callback(void 0,void 0)}finally{a.close()}}var st,Ft,Fs,Dl;let No=(Dl=class{constructor(t){_(this,Ft);q(this,"_batch");_(this,st);q(this,"_index");this._batch=t,h(this,st,[]),this._index=void 0}condition(t){return c(this,st).push(t._proto),this}query(t){return S(this,Ft,Fs).call(this,t,!0,di)}queryRow(t){return S(this,Ft,Fs).call(this,t,!0,pi)}queryValue(t){return S(this,Ft,Fs).call(this,t,!0,ui)}run(t){return S(this,Ft,Fs).call(this,t,!1,fa)}},st=new WeakMap,Ft=new WeakSet,Fs=function(t,s,a){if(this._index!==void 0)throw new Os("This BatchStep has already been added to the batch");const n=bi(this._batch._stream._sqlOwner(),t,s);let l;c(this,st).length===0?l=void 0:c(this,st).length===1?l=c(this,st)[0]:l={type:"and",conds:c(this,st).slice()};const i={stmt:n,condition:l};return new Promise((r,d)=>{const o=(u,m)=>{u!==void 0&&m!==void 0?d(new j("Server returned both result and error")):m!==void 0?d(As(m)):r(u!==void 0?a(u,this._batch._stream.intMode):void 0)};this._index=this._batch._steps.length,this._batch._steps.push({proto:i,callback:o})})},Dl),ve=class jt{constructor(t,s){q(this,"_batch");q(this,"_proto");this._batch=t,this._proto=s}static ok(t){return new jt(t._batch,{type:"ok",step:cl(t)})}static error(t){return new jt(t._batch,{type:"error",step:cl(t)})}static not(t){return new jt(t._batch,{type:"not",cond:t._proto})}static and(t,s){for(const a of s)dl(t,a);return new jt(t,{type:"and",conds:s.map(a=>a._proto)})}static or(t,s){for(const a of s)dl(t,a);return new jt(t,{type:"or",conds:s.map(a=>a._proto)})}static isAutocommit(t){return t._stream.client()._ensureVersion(3,"BatchCond.isAutocommit()"),new jt(t,{type:"is_autocommit"})}};function cl(e){if(e._index===void 0)throw new Os("Cannot add a condition referencing a step that has not been added to the batch");return e._index}function dl(e,t){if(t._batch!==e)throw new Os("Cannot mix BatchCond objects for different Batch objects")}function qo(e){return{paramNames:e.params.map(t=>t.name),columns:e.cols,isExplain:e.isExplain,isReadonly:e.isReadonly}}var Vt,Vs;class mi{constructor(t){_(this,Vt);q(this,"intMode");this.intMode=t}query(t){return S(this,Vt,Vs).call(this,t,!0,di)}queryRow(t){return S(this,Vt,Vs).call(this,t,!0,pi)}queryValue(t){return S(this,Vt,Vs).call(this,t,!0,ui)}run(t){return S(this,Vt,Vs).call(this,t,!1,fa)}batch(t=!1){return new Lo(this,t)}describe(t){const s=ln(this._sqlOwner(),t);return this._describe(s).then(qo)}sequence(t){const s=ln(this._sqlOwner(),t);return this._sequence(s)}}Vt=new WeakSet,Vs=function(t,s,a){const n=bi(this._sqlOwner(),t,s);return this._execute(n).then(l=>a(l,this.intMode))};class hi{}const Bo=1e3,Fo=10;var ja,Ut,xs,fs,Ht,at,Gt,Pa,gi;class Vo extends hi{constructor(s,a,n){super();_(this,Pa);_(this,ja);_(this,Ut);_(this,xs);_(this,fs);_(this,Ht);_(this,at);_(this,Gt);h(this,ja,s),h(this,Ut,a),h(this,xs,n),h(this,fs,new Ca),h(this,Ht,new Ca),h(this,at,void 0),h(this,Gt,!1)}async next(){for(;;){if(c(this,at)!==void 0)throw new Ae("Cursor is closed",c(this,at));for(;!c(this,Gt)&&c(this,Ht).length<Fo;)c(this,Ht).push(S(this,Pa,gi).call(this));const s=c(this,fs).shift();if(c(this,Gt)||s!==void 0)return s;await c(this,Ht).shift().then(a=>{if(a!==void 0){for(const n of a.entries)c(this,fs).push(n);c(this,Gt)||h(this,Gt,a.done)}})}}_setClosed(s){c(this,at)===void 0&&(h(this,at,s),c(this,Ut)._sendCursorRequest(this,{type:"close_cursor",cursorId:c(this,xs)}).catch(()=>{}),c(this,Ut)._cursorClosed(this))}close(){this._setClosed(new J("Cursor was manually closed"))}get closed(){return c(this,at)!==void 0}}ja=new WeakMap,Ut=new WeakMap,xs=new WeakMap,fs=new WeakMap,Ht=new WeakMap,at=new WeakMap,Gt=new WeakMap,Pa=new WeakSet,gi=function(){return c(this,Ut)._sendCursorRequest(this,{type:"fetch_cursor",cursorId:c(this,xs),maxCount:Bo}).then(s=>s,s=>{this._setClosed(s)})};var ne,Ce,nt,$e,vt,De,Z,ts,on,_a,Sa;const Zn=class Zn extends mi{constructor(s,a){super(s.intMode);_(this,Z);_(this,ne);_(this,Ce);_(this,nt);_(this,$e);_(this,vt);_(this,De);h(this,ne,s),h(this,Ce,a),h(this,nt,new Ca),h(this,$e,void 0),h(this,vt,!1),h(this,De,void 0)}static open(s){const a=s._streamIdAlloc.alloc(),n=new Zn(s,a),l=()=>{},i=d=>{var o;return S(o=n,Z,Sa).call(o,d)},r={type:"open_stream",streamId:a};return s._sendRequest(r,{responseCallback:l,errorCallback:i}),n}client(){return c(this,ne)}_sqlOwner(){return c(this,ne)}_execute(s){return S(this,Z,ts).call(this,{type:"execute",streamId:c(this,Ce),stmt:s}).then(a=>a.result)}_batch(s){return S(this,Z,ts).call(this,{type:"batch",streamId:c(this,Ce),batch:s}).then(a=>a.result)}_describe(s){return c(this,ne)._ensureVersion(2,"describe()"),S(this,Z,ts).call(this,{type:"describe",streamId:c(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return c(this,ne)._ensureVersion(2,"sequence()"),S(this,Z,ts).call(this,{type:"sequence",streamId:c(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return c(this,ne)._ensureVersion(3,"getAutocommit()"),S(this,Z,ts).call(this,{type:"get_autocommit",streamId:c(this,Ce)}).then(s=>s.isAutocommit)}_openCursor(s){return c(this,ne)._ensureVersion(3,"cursor"),new Promise((a,n)=>{S(this,Z,on).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_sendCursorRequest(s,a){if(s!==c(this,$e))throw new At("Cursor not associated with the stream attempted to execute a request");return new Promise((n,l)=>{c(this,De)!==void 0?l(new Ae("Stream is closed",c(this,De))):c(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})})}_cursorClosed(s){if(s!==c(this,$e))throw new At("Cursor was closed, but it was not associated with the stream");h(this,$e,void 0),S(this,Z,_a).call(this)}close(){S(this,Z,Sa).call(this,new J("Stream was manually closed"))}closeGracefully(){h(this,vt,!0),S(this,Z,_a).call(this)}get closed(){return c(this,De)!==void 0||c(this,vt)}};ne=new WeakMap,Ce=new WeakMap,nt=new WeakMap,$e=new WeakMap,vt=new WeakMap,De=new WeakMap,Z=new WeakSet,ts=function(s){return new Promise((a,n)=>{S(this,Z,on).call(this,{type:"request",request:s,responseCallback:a,errorCallback:n})})},on=function(s){c(this,De)!==void 0?s.errorCallback(new Ae("Stream is closed",c(this,De))):c(this,vt)?s.errorCallback(new Ae("Stream is closing",void 0)):(c(this,nt).push(s),S(this,Z,_a).call(this))},_a=function(){for(;;){const s=c(this,nt).first();if(s===void 0&&c(this,$e)===void 0&&c(this,vt)){S(this,Z,Sa).call(this,new J("Stream was gracefully closed"));break}else if((s==null?void 0:s.type)==="request"&&c(this,$e)===void 0){const{request:a,responseCallback:n,errorCallback:l}=s;c(this,nt).shift(),c(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})}else if((s==null?void 0:s.type)==="cursor"&&c(this,$e)===void 0){const{batch:a,cursorCallback:n}=s;c(this,nt).shift();const l=c(this,ne)._cursorIdAlloc.alloc(),i=new Vo(c(this,ne),this,l),r={type:"open_cursor",streamId:c(this,Ce),cursorId:l,batch:a},d=()=>{},o=u=>i._setClosed(u);c(this,ne)._sendRequest(r,{responseCallback:d,errorCallback:o}),h(this,$e,i),n(i)}else break}},Sa=function(s){if(c(this,De)!==void 0)return;for(h(this,De,s),c(this,$e)!==void 0&&c(this,$e)._setClosed(s);;){const i=c(this,nt).shift();if(i!==void 0)i.errorCallback(s);else break}const a={type:"close_stream",streamId:c(this,Ce)},n=()=>c(this,ne)._streamIdAlloc.free(c(this,Ce)),l=()=>{};c(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})};let rn=Zn;function In(e,t){t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId),e.arrayObjects("args",t.args,wi),e.arrayObjects("named_args",t.namedArgs,Uo),e.boolean("want_rows",t.wantRows)}function Uo(e,t){e.string("name",t.name),e.object("value",t.value,wi)}function Ra(e,t){e.arrayObjects("steps",t.steps,Ho)}function Ho(e,t){t.condition!==void 0&&e.object("condition",t.condition,cn),e.object("stmt",t.stmt,In)}function cn(e,t){if(e.stringRaw("type",t.type),t.type==="ok"||t.type==="error")e.number("step",t.step);else if(t.type==="not")e.object("cond",t.cond,cn);else if(t.type==="and"||t.type==="or")e.arrayObjects("conds",t.conds,cn);else if(t.type!=="is_autocommit")throw K(t,"Impossible type of BatchCond")}function wi(e,t){if(t===null)e.stringRaw("type","null");else if(typeof t=="bigint")e.stringRaw("type","integer"),e.stringRaw("value",""+t);else if(typeof t=="number")e.stringRaw("type","float"),e.number("value",t);else if(typeof t=="string")e.stringRaw("type","text"),e.string("value",t);else if(t instanceof Uint8Array)e.stringRaw("type","blob"),e.stringRaw("base64",Sn.fromUint8Array(t));else if(t!==void 0)throw K(t,"Impossible type of Value")}function Go(e,t){if(e.stringRaw("type",t.type),t.type==="hello")t.jwt!==void 0&&e.string("jwt",t.jwt);else if(t.type==="request")e.number("request_id",t.requestId),e.object("request",t.request,Wo);else throw K(t,"Impossible type of ClientMsg")}function Wo(e,t){if(e.stringRaw("type",t.type),t.type==="open_stream")e.number("stream_id",t.streamId);else if(t.type==="close_stream")e.number("stream_id",t.streamId);else if(t.type==="execute")e.number("stream_id",t.streamId),e.object("stmt",t.stmt,In);else if(t.type==="batch")e.number("stream_id",t.streamId),e.object("batch",t.batch,Ra);else if(t.type==="open_cursor")e.number("stream_id",t.streamId),e.number("cursor_id",t.cursorId),e.object("batch",t.batch,Ra);else if(t.type==="close_cursor")e.number("cursor_id",t.cursorId);else if(t.type==="fetch_cursor")e.number("cursor_id",t.cursorId),e.number("max_count",t.maxCount);else if(t.type==="sequence")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type==="get_autocommit")e.number("stream_id",t.streamId);else throw K(t,"Impossible type of Request")}function Cn(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId);for(const s of t.args)e.message(3,s,vi);for(const s of t.namedArgs)e.message(4,s,zo);e.bool(5,t.wantRows)}function zo(e,t){e.string(1,t.name),e.message(2,t.value,vi)}function Ba(e,t){for(const s of t.steps)e.message(1,s,Yo)}function Yo(e,t){t.condition!==void 0&&e.message(1,t.condition,Rn),e.message(2,t.stmt,Cn)}function Rn(e,t){if(t.type==="ok")e.uint32(1,t.step);else if(t.type==="error")e.uint32(2,t.step);else if(t.type==="not")e.message(3,t.cond,Rn);else if(t.type==="and")e.message(4,t.conds,pl);else if(t.type==="or")e.message(5,t.conds,pl);else if(t.type==="is_autocommit")e.message(6,void 0,yi);else throw K(t,"Impossible type of BatchCond")}function pl(e,t){for(const s of t)e.message(1,s,Rn)}function vi(e,t){if(t===null)e.message(1,void 0,yi);else if(typeof t=="bigint")e.sint64(2,t);else if(typeof t=="number")e.double(3,t);else if(typeof t=="string")e.string(4,t);else if(t instanceof Uint8Array)e.bytes(5,t);else if(t!==void 0)throw K(t,"Impossible type of Value")}function yi(e,t){}function Jo(e,t){if(t.type==="hello")e.message(1,t,Ko);else if(t.type==="request")e.message(2,t,Qo);else throw K(t,"Impossible type of ClientMsg")}function Ko(e,t){t.jwt!==void 0&&e.string(1,t.jwt)}function Qo(e,t){e.int32(1,t.requestId);const s=t.request;if(s.type==="open_stream")e.message(2,s,Xo);else if(s.type==="close_stream")e.message(3,s,Zo);else if(s.type==="execute")e.message(4,s,ec);else if(s.type==="batch")e.message(5,s,tc);else if(s.type==="open_cursor")e.message(6,s,sc);else if(s.type==="close_cursor")e.message(7,s,ac);else if(s.type==="fetch_cursor")e.message(8,s,nc);else if(s.type==="sequence")e.message(9,s,lc);else if(s.type==="describe")e.message(10,s,ic);else if(s.type==="store_sql")e.message(11,s,rc);else if(s.type==="close_sql")e.message(12,s,oc);else if(s.type==="get_autocommit")e.message(13,s,cc);else throw K(s,"Impossible type of Request")}function Xo(e,t){e.int32(1,t.streamId)}function Zo(e,t){e.int32(1,t.streamId)}function ec(e,t){e.int32(1,t.streamId),e.message(2,t.stmt,Cn)}function tc(e,t){e.int32(1,t.streamId),e.message(2,t.batch,Ba)}function sc(e,t){e.int32(1,t.streamId),e.int32(2,t.cursorId),e.message(3,t.batch,Ba)}function ac(e,t){e.int32(1,t.cursorId)}function nc(e,t){e.int32(1,t.cursorId),e.uint32(2,t.maxCount)}function lc(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function ic(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function rc(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function oc(e,t){e.int32(1,t.sqlId)}function cc(e,t){e.int32(1,t.streamId)}function Ts(e){const t=qe(e.message),s=Fe(e.code);return{message:t,code:s}}function An(e){const t=Tt(e.cols,ki),s=Ia(e.rows).map(i=>Tt(i,Ei)),a=Xt(e.affected_row_count),n=Fe(e.last_insert_rowid),l=n!==void 0?BigInt(n):void 0;return{cols:t,rows:s,affectedRowCount:a,lastInsertRowid:l}}function ki(e){const t=Fe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function _i(e){const t=new Map;Ia(e.step_results).forEach((a,n)=>{a!==null&&t.set(n,An(ie(a)))});const s=new Map;return Ia(e.step_errors).forEach((a,n)=>{a!==null&&s.set(n,Ts(ie(a)))}),{stepResults:t,stepErrors:s}}function Si(e){const t=qe(e.type);if(t==="step_begin"){const s=Xt(e.step),a=Tt(e.cols,ki);return{type:"step_begin",step:s,cols:a}}else if(t==="step_end"){const s=Xt(e.affected_row_count),a=Fe(e.last_insert_rowid),n=a!==void 0?BigInt(a):void 0;return{type:"step_end",affectedRowCount:s,lastInsertRowid:n}}else if(t==="step_error"){const s=Xt(e.step),a=Ts(ie(e.error));return{type:"step_error",step:s,error:a}}else{if(t==="row")return{type:"row",row:Tt(e.row,Ei)};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of CursorEntry")}}function $i(e){const t=Tt(e.params,dc),s=Tt(e.cols,pc),a=Qs(e.is_explain),n=Qs(e.is_readonly);return{params:t,cols:s,isExplain:a,isReadonly:n}}function dc(e){return{name:Fe(e.name)}}function pc(e){const t=qe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function Ei(e){const t=qe(e.type);if(t==="null")return null;if(t==="integer"){const s=qe(e.value);return BigInt(s)}else{if(t==="float")return Xt(e.value);if(t==="text")return qe(e.value);if(t==="blob")return Sn.toUint8Array(qe(e.base64));throw new j("Unexpected type of Value")}}function uc(e){const t=qe(e.type);if(t==="hello_ok")return{type:"hello_ok"};if(t==="hello_error")return{type:"hello_error",error:Ts(ie(e.error))};if(t==="response_ok"){const s=Xt(e.request_id),a=xc(ie(e.response));return{type:"response_ok",requestId:s,response:a}}else if(t==="response_error"){const s=Xt(e.request_id),a=Ts(ie(e.error));return{type:"response_error",requestId:s,error:a}}else throw new j("Unexpected type of ServerMsg")}function xc(e){const t=qe(e.type);if(t==="open_stream")return{type:"open_stream"};if(t==="close_stream")return{type:"close_stream"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:_i(ie(e.result))};if(t==="open_cursor")return{type:"open_cursor"};if(t==="close_cursor")return{type:"close_cursor"};if(t==="fetch_cursor"){const s=Tt(e.entries,Si),a=Qs(e.done);return{type:"fetch_cursor",entries:s,done:a}}else{if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:$i(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of Response")}}const Je={default(){return{message:"",code:void 0}},1(e,t){t.message=e.string()},2(e,t){t.code=e.string()}},Ms={default(){return{cols:[],rows:[],affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.cols.push(e.message(Ii))},2(e,t){t.rows.push(e.message(Ci))},3(e,t){t.affectedRowCount=Number(e.uint64())},4(e,t){t.lastInsertRowid=e.sint64()}},Ii={default(){return{name:void 0,decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},Ci={default(){return[]},1(e,t){t.push(e.message(yc))}},Aa={default(){return{stepResults:new Map,stepErrors:new Map}},1(e,t){const[s,a]=e.message(fc);t.stepResults.set(s,a)},2(e,t){const[s,a]=e.message(bc);t.stepErrors.set(s,a)}},fc={default(){return[0,Ms.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Ms)}},bc={default(){return[0,Je.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Je)}},Ri={default(){return{type:"none"}},1(e){return e.message(mc)},2(e){return e.message(hc)},3(e){return e.message(gc)},4(e){return{type:"row",row:e.message(Ci)}},5(e){return{type:"error",error:e.message(Je)}}},mc={default(){return{type:"step_begin",step:0,cols:[]}},1(e,t){t.step=e.uint32()},2(e,t){t.cols.push(e.message(Ii))}},hc={default(){return{type:"step_end",affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.affectedRowCount=e.uint32()},2(e,t){t.lastInsertRowid=e.uint64()}},gc={default(){return{type:"step_error",step:0,error:Je.default()}},1(e,t){t.step=e.uint32()},2(e,t){t.error=e.message(Je)}},Ta={default(){return{params:[],cols:[],isExplain:!1,isReadonly:!1}},1(e,t){t.params.push(e.message(wc))},2(e,t){t.cols.push(e.message(vc))},3(e,t){t.isExplain=e.bool()},4(e,t){t.isReadonly=e.bool()}},wc={default(){return{name:void 0}},1(e,t){t.name=e.string()}},vc={default(){return{name:"",decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},yc={default(){},1(e){return null},2(e){return e.sint64()},3(e){return e.double()},4(e){return e.string()},5(e){return e.bytes()}},kc={default(){return{type:"none"}},1(e){return{type:"hello_ok"}},2(e){return e.message(_c)},3(e){return e.message($c)},4(e){return e.message(Sc)}},_c={default(){return{type:"hello_error",error:Je.default()}},1(e,t){t.error=e.message(Je)}},Sc={default(){return{type:"response_error",requestId:0,error:Je.default()}},1(e,t){t.requestId=e.int32()},2(e,t){t.error=e.message(Je)}},$c={default(){return{type:"response_ok",requestId:0,response:{type:"none"}}},1(e,t){t.requestId=e.int32()},2(e,t){t.response={type:"open_stream"}},3(e,t){t.response={type:"close_stream"}},4(e,t){t.response=e.message(Ec)},5(e,t){t.response=e.message(Ic)},6(e,t){t.response={type:"open_cursor"}},7(e,t){t.response={type:"close_cursor"}},8(e,t){t.response=e.message(Cc)},9(e,t){t.response={type:"sequence"}},10(e,t){t.response=e.message(Rc)},11(e,t){t.response={type:"store_sql"}},12(e,t){t.response={type:"close_sql"}},13(e,t){t.response=e.message(Ac)}},Ec={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},Ic={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},Cc={default(){return{type:"fetch_cursor",entries:[],done:!1}},1(e,t){t.entries.push(e.message(Ri))},2(e,t){t.done=e.bool()}},Rc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Ac={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Tc=new Map([["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]),Ai=new Map([["hrana3-protobuf",{version:3,encoding:"protobuf"}],["hrana3",{version:3,encoding:"json"}],["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]);var re,Ge,Wt,he,zt,ge,bs,Oe,yt,ms,V,dn,Ti,pn,Mi,Di,Ve,Oi,Li,Ol;let Mc=(Ol=class extends ai{constructor(s,a){super();_(this,V);_(this,re);_(this,Ge);_(this,Wt);_(this,he);_(this,zt);_(this,ge);_(this,bs);_(this,Oe);_(this,yt);q(this,"_streamIdAlloc");q(this,"_cursorIdAlloc");_(this,ms);h(this,re,s),h(this,Ge,[]),h(this,Wt,!1),h(this,he,void 0),h(this,zt,!1),h(this,ge,void 0),h(this,bs,!1),h(this,Oe,new Map),h(this,yt,new Bs),this._streamIdAlloc=new Bs,this._cursorIdAlloc=new Bs,h(this,ms,new Bs),c(this,re).binaryType="arraybuffer",c(this,re).addEventListener("open",()=>S(this,V,Ti).call(this)),c(this,re).addEventListener("close",n=>S(this,V,Di).call(this,n)),c(this,re).addEventListener("error",n=>S(this,V,Mi).call(this,n)),c(this,re).addEventListener("message",n=>S(this,V,Oi).call(this,n)),S(this,V,dn).call(this,{type:"hello",jwt:a})}getVersion(){return new Promise((s,a)=>{if(h(this,bs,!0),c(this,he)!==void 0)a(c(this,he));else if(c(this,Wt))s(c(this,ge).version);else{const n=()=>s(c(this,ge).version);c(this,Ge).push({openCallback:n,errorCallback:a})}})}_ensureVersion(s,a){if(c(this,ge)===void 0||!c(this,bs))throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the WebSocket server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(c(this,ge).version<s)throw new Rs(`${a} is supported on protocol version ${s} and higher, but the WebSocket server only supports version ${c(this,ge).version}`)}_sendRequest(s,a){if(c(this,he)!==void 0){a.errorCallback(new Ae("Client is closed",c(this,he)));return}const n=c(this,yt).alloc();c(this,Oe).set(n,{...a,type:s.type}),S(this,V,dn).call(this,{type:"request",requestId:n,request:s})}openStream(){return rn.open(this)}storeSql(s){this._ensureVersion(2,"storeSql()");const a=c(this,ms).alloc(),n=new En(this,a),l=()=>{},i=d=>n._setClosed(d),r={type:"store_sql",sqlId:a,sql:s};return this._sendRequest(r,{responseCallback:l,errorCallback:i}),n}_closeSql(s){if(c(this,he)!==void 0)return;const a=()=>c(this,ms).free(s),n=i=>S(this,V,Ve).call(this,i),l={type:"close_sql",sqlId:s};this._sendRequest(l,{responseCallback:a,errorCallback:n})}close(){S(this,V,Ve).call(this,new J("Client was manually closed"))}get closed(){return c(this,he)!==void 0}},re=new WeakMap,Ge=new WeakMap,Wt=new WeakMap,he=new WeakMap,zt=new WeakMap,ge=new WeakMap,bs=new WeakMap,Oe=new WeakMap,yt=new WeakMap,ms=new WeakMap,V=new WeakSet,dn=function(s){if(c(this,he)!==void 0)throw new At("Trying to send a message on a closed client");if(c(this,Wt))S(this,V,pn).call(this,s);else{const a=()=>S(this,V,pn).call(this,s),n=()=>{};c(this,Ge).push({openCallback:a,errorCallback:n})}},Ti=function(){const s=c(this,re).protocol;if(s===void 0){S(this,V,Ve).call(this,new J("The `WebSocket.protocol` property is undefined. This most likely means that the WebSocket implementation provided by the environment is broken. If you are using Miniflare 2, please update to Miniflare 3, which fixes this problem."));return}else if(s==="")h(this,ge,{version:1,encoding:"json"});else if(h(this,ge,Ai.get(s)),c(this,ge)===void 0){S(this,V,Ve).call(this,new j(`Unrecognized WebSocket subprotocol: ${JSON.stringify(s)}`));return}for(const a of c(this,Ge))a.openCallback();c(this,Ge).length=0,h(this,Wt,!0)},pn=function(s){const a=c(this,ge).encoding;if(a==="json"){const n=ii(s,Go);c(this,re).send(n)}else if(a==="protobuf"){const n=oi(s,Jo);c(this,re).send(n)}else throw K(a,"Impossible encoding")},Mi=function(s){const n=s.message??"WebSocket was closed due to an error";S(this,V,Ve).call(this,new tn(n))},Di=function(s){let a=`WebSocket was closed with code ${s.code}`;s.reason&&(a+=`: ${s.reason}`),S(this,V,Ve).call(this,new tn(a))},Ve=function(s){if(c(this,he)===void 0){h(this,he,s);for(const a of c(this,Ge))a.errorCallback(s);c(this,Ge).length=0;for(const[a,n]of c(this,Oe).entries())n.errorCallback(s),c(this,yt).free(a);c(this,Oe).clear(),c(this,re).close()}},Oi=function(s){if(c(this,he)===void 0)try{let a;const n=c(this,ge).encoding;if(n==="json"){if(typeof s.data!="string"){c(this,re).close(3003,"Only text messages are accepted with JSON encoding"),S(this,V,Ve).call(this,new j("Received non-text message from server with JSON encoding"));return}a=$n(JSON.parse(s.data),uc)}else if(n==="protobuf"){if(!(s.data instanceof ArrayBuffer)){c(this,re).close(3003,"Only binary messages are accepted with Protobuf encoding"),S(this,V,Ve).call(this,new j("Received non-binary message from server with Protobuf encoding"));return}a=qa(new Uint8Array(s.data),kc)}else throw K(n,"Impossible encoding");S(this,V,Li).call(this,a)}catch(a){c(this,re).close(3007,"Could not handle message"),S(this,V,Ve).call(this,a)}},Li=function(s){if(s.type==="none")throw new j("Received an unrecognized ServerMsg");if(s.type==="hello_ok"||s.type==="hello_error"){if(c(this,zt))throw new j("Received a duplicated hello response");if(h(this,zt,!0),s.type==="hello_error")throw As(s.error);return}else if(!c(this,zt))throw new j("Received a non-hello message before a hello response");if(s.type==="response_ok"){const a=s.requestId,n=c(this,Oe).get(a);if(c(this,Oe).delete(a),n===void 0)throw new j("Received unexpected OK response");c(this,yt).free(a);try{if(n.type!==s.response.type)throw console.dir({responseState:n,msg:s}),new j("Received unexpected type of response");n.responseCallback(s.response)}catch(l){throw n.errorCallback(l),l}}else if(s.type==="response_error"){const a=s.requestId,n=c(this,Oe).get(a);if(c(this,Oe).delete(a),n===void 0)throw new j("Received unexpected error response");c(this,yt).free(a),n.errorCallback(As(s.error))}else throw K(s,"Impossible ServerMsg type")},Ol);var ga=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Dc(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var un={exports:{}};(function(e,t){var s=typeof globalThis<"u"&&globalThis||typeof self<"u"&&self||typeof ga<"u"&&ga,a=function(){function l(){this.fetch=!1,this.DOMException=s.DOMException}return l.prototype=s,new l}();(function(l){(function(i){var r=typeof l<"u"&&l||typeof self<"u"&&self||typeof ga<"u"&&ga||{},d={searchParams:"URLSearchParams"in r,iterable:"Symbol"in r&&"iterator"in Symbol,blob:"FileReader"in r&&"Blob"in r&&function(){try{return new Blob,!0}catch{return!1}}(),formData:"FormData"in r,arrayBuffer:"ArrayBuffer"in r};function o(v){return v&&DataView.prototype.isPrototypeOf(v)}if(d.arrayBuffer)var u=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]"],m=ArrayBuffer.isView||function(v){return v&&u.indexOf(Object.prototype.toString.call(v))>-1};function b(v){if(typeof v!="string"&&(v=String(v)),/[^a-z0-9\-#$%&'*+.^_`|~!]/i.test(v)||v==="")throw new TypeError('Invalid character in header field name: "'+v+'"');return v.toLowerCase()}function y(v){return typeof v!="string"&&(v=String(v)),v}function w(v){var E={next:function(){var L=v.shift();return{done:L===void 0,value:L}}};return d.iterable&&(E[Symbol.iterator]=function(){return E}),E}function f(v){this.map={},v instanceof f?v.forEach(function(E,L){this.append(L,E)},this):Array.isArray(v)?v.forEach(function(E){if(E.length!=2)throw new TypeError("Headers constructor: expected name/value pair to be length 2, found"+E.length);this.append(E[0],E[1])},this):v&&Object.getOwnPropertyNames(v).forEach(function(E){this.append(E,v[E])},this)}f.prototype.append=function(v,E){v=b(v),E=y(E);var L=this.map[v];this.map[v]=L?L+", "+E:E},f.prototype.delete=function(v){delete this.map[b(v)]},f.prototype.get=function(v){return v=b(v),this.has(v)?this.map[v]:null},f.prototype.has=function(v){return this.map.hasOwnProperty(b(v))},f.prototype.set=function(v,E){this.map[b(v)]=y(E)},f.prototype.forEach=function(v,E){for(var L in this.map)this.map.hasOwnProperty(L)&&v.call(E,this.map[L],L,this)},f.prototype.keys=function(){var v=[];return this.forEach(function(E,L){v.push(L)}),w(v)},f.prototype.values=function(){var v=[];return this.forEach(function(E){v.push(E)}),w(v)},f.prototype.entries=function(){var v=[];return this.forEach(function(E,L){v.push([L,E])}),w(v)},d.iterable&&(f.prototype[Symbol.iterator]=f.prototype.entries);function x(v){if(!v._noBody){if(v.bodyUsed)return Promise.reject(new TypeError("Already read"));v.bodyUsed=!0}}function k(v){return new Promise(function(E,L){v.onload=function(){E(v.result)},v.onerror=function(){L(v.error)}})}function I(v){var E=new FileReader,L=k(E);return E.readAsArrayBuffer(v),L}function C(v){var E=new FileReader,L=k(E),U=/charset=([A-Za-z0-9_-]+)/.exec(v.type),G=U?U[1]:"utf-8";return E.readAsText(v,G),L}function $(v){for(var E=new Uint8Array(v),L=new Array(E.length),U=0;U<E.length;U++)L[U]=String.fromCharCode(E[U]);return L.join("")}function O(v){if(v.slice)return v.slice(0);var E=new Uint8Array(v.byteLength);return E.set(new Uint8Array(v)),E.buffer}function Y(){return this.bodyUsed=!1,this._initBody=function(v){this.bodyUsed=this.bodyUsed,this._bodyInit=v,v?typeof v=="string"?this._bodyText=v:d.blob&&Blob.prototype.isPrototypeOf(v)?this._bodyBlob=v:d.formData&&FormData.prototype.isPrototypeOf(v)?this._bodyFormData=v:d.searchParams&&URLSearchParams.prototype.isPrototypeOf(v)?this._bodyText=v.toString():d.arrayBuffer&&d.blob&&o(v)?(this._bodyArrayBuffer=O(v.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):d.arrayBuffer&&(ArrayBuffer.prototype.isPrototypeOf(v)||m(v))?this._bodyArrayBuffer=O(v):this._bodyText=v=Object.prototype.toString.call(v):(this._noBody=!0,this._bodyText=""),this.headers.get("content-type")||(typeof v=="string"?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):d.searchParams&&URLSearchParams.prototype.isPrototypeOf(v)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},d.blob&&(this.blob=function(){var v=x(this);if(v)return v;if(this._bodyBlob)return Promise.resolve(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]));if(this._bodyFormData)throw new Error("could not read FormData body as blob");return Promise.resolve(new Blob([this._bodyText]))}),this.arrayBuffer=function(){if(this._bodyArrayBuffer){var v=x(this);return v||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer))}else{if(d.blob)return this.blob().then(I);throw new Error("could not read as ArrayBuffer")}},this.text=function(){var v=x(this);if(v)return v;if(this._bodyBlob)return C(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve($(this._bodyArrayBuffer));if(this._bodyFormData)throw new Error("could not read FormData body as text");return Promise.resolve(this._bodyText)},d.formData&&(this.formData=function(){return this.text().then(M)}),this.json=function(){return this.text().then(JSON.parse)},this}var bt=["CONNECT","DELETE","GET","HEAD","OPTIONS","PATCH","POST","PUT","TRACE"];function Xe(v){var E=v.toUpperCase();return bt.indexOf(E)>-1?E:v}function xe(v,E){if(!(this instanceof xe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');E=E||{};var L=E.body;if(v instanceof xe){if(v.bodyUsed)throw new TypeError("Already read");this.url=v.url,this.credentials=v.credentials,E.headers||(this.headers=new f(v.headers)),this.method=v.method,this.mode=v.mode,this.signal=v.signal,!L&&v._bodyInit!=null&&(L=v._bodyInit,v.bodyUsed=!0)}else this.url=String(v);if(this.credentials=E.credentials||this.credentials||"same-origin",(E.headers||!this.headers)&&(this.headers=new f(E.headers)),this.method=Xe(E.method||this.method||"GET"),this.mode=E.mode||this.mode||null,this.signal=E.signal||this.signal||function(){if("AbortController"in r){var P=new AbortController;return P.signal}}(),this.referrer=null,(this.method==="GET"||this.method==="HEAD")&&L)throw new TypeError("Body not allowed for GET or HEAD requests");if(this._initBody(L),(this.method==="GET"||this.method==="HEAD")&&(E.cache==="no-store"||E.cache==="no-cache")){var U=/([?&])_=[^&]*/;if(U.test(this.url))this.url=this.url.replace(U,"$1_="+new Date().getTime());else{var G=/\?/;this.url+=(G.test(this.url)?"&":"?")+"_="+new Date().getTime()}}}xe.prototype.clone=function(){return new xe(this,{body:this._bodyInit})};function M(v){var E=new FormData;return v.trim().split("&").forEach(function(L){if(L){var U=L.split("="),G=U.shift().replace(/\+/g," "),P=U.join("=").replace(/\+/g," ");E.append(decodeURIComponent(G),decodeURIComponent(P))}}),E}function Dt(v){var E=new f,L=v.replace(/\r?\n[\t ]+/g," ");return L.split("\r").map(function(U){return U.indexOf(`
`)===0?U.substr(1,U.length):U}).forEach(function(U){var G=U.split(":"),P=G.shift().trim();if(P){var ma=G.join(":").trim();try{E.append(P,ma)}catch(Ga){console.warn("Response "+Ga.message)}}}),E}Y.call(xe.prototype);function fe(v,E){if(!(this instanceof fe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');if(E||(E={}),this.type="default",this.status=E.status===void 0?200:E.status,this.status<200||this.status>599)throw new RangeError("Failed to construct 'Response': The status provided (0) is outside the range [200, 599].");this.ok=this.status>=200&&this.status<300,this.statusText=E.statusText===void 0?"":""+E.statusText,this.headers=new f(E.headers),this.url=E.url||"",this._initBody(v)}Y.call(fe.prototype),fe.prototype.clone=function(){return new fe(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new f(this.headers),url:this.url})},fe.error=function(){var v=new fe(null,{status:200,statusText:""});return v.ok=!1,v.status=0,v.type="error",v};var or=[301,302,303,307,308];fe.redirect=function(v,E){if(or.indexOf(E)===-1)throw new RangeError("Invalid status code");return new fe(null,{status:E,headers:{location:v}})},i.DOMException=r.DOMException;try{new i.DOMException}catch{i.DOMException=function(E,L){this.message=E,this.name=L;var U=Error(E);this.stack=U.stack},i.DOMException.prototype=Object.create(Error.prototype),i.DOMException.prototype.constructor=i.DOMException}function Ha(v,E){return new Promise(function(L,U){var G=new xe(v,E);if(G.signal&&G.signal.aborted)return U(new i.DOMException("Aborted","AbortError"));var P=new XMLHttpRequest;function ma(){P.abort()}P.onload=function(){var ae={statusText:P.statusText,headers:Dt(P.getAllResponseHeaders()||"")};G.url.indexOf("file://")===0&&(P.status<200||P.status>599)?ae.status=200:ae.status=P.status,ae.url="responseURL"in P?P.responseURL:ae.headers.get("X-Request-URL");var Ot="response"in P?P.response:P.responseText;setTimeout(function(){L(new fe(Ot,ae))},0)},P.onerror=function(){setTimeout(function(){U(new TypeError("Network request failed"))},0)},P.ontimeout=function(){setTimeout(function(){U(new TypeError("Network request timed out"))},0)},P.onabort=function(){setTimeout(function(){U(new i.DOMException("Aborted","AbortError"))},0)};function Ga(ae){try{return ae===""&&r.location.href?r.location.href:ae}catch{return ae}}if(P.open(G.method,Ga(G.url),!0),G.credentials==="include"?P.withCredentials=!0:G.credentials==="omit"&&(P.withCredentials=!1),"responseType"in P&&(d.blob?P.responseType="blob":d.arrayBuffer&&(P.responseType="arraybuffer")),E&&typeof E.headers=="object"&&!(E.headers instanceof f||r.Headers&&E.headers instanceof r.Headers)){var el=[];Object.getOwnPropertyNames(E.headers).forEach(function(ae){el.push(b(ae)),P.setRequestHeader(ae,y(E.headers[ae]))}),G.headers.forEach(function(ae,Ot){el.indexOf(Ot)===-1&&P.setRequestHeader(Ot,ae)})}else G.headers.forEach(function(ae,Ot){P.setRequestHeader(Ot,ae)});G.signal&&(G.signal.addEventListener("abort",ma),P.onreadystatechange=function(){P.readyState===4&&G.signal.removeEventListener("abort",ma)}),P.send(typeof G._bodyInit>"u"?null:G._bodyInit)})}return Ha.polyfill=!0,r.fetch||(r.fetch=Ha,r.Headers=f,r.Request=xe,r.Response=fe),i.Headers=f,i.Request=xe,i.Response=fe,i.fetch=Ha,i})({})})(a),a.fetch.ponyfill=!0,delete a.fetch.polyfill;var n=s.fetch?s:a;t=n.fetch,t.default=n.fetch,t.fetch=n.fetch,t.Headers=n.Headers,t.Request=n.Request,t.Response=n.Response,e.exports=t})(un,un.exports);var Ma=un.exports;let ns;if(typeof queueMicrotask<"u")ns=queueMicrotask;else{const e=Promise.resolve();ns=t=>{e.then(t)}}var Ee,Le,we,Na,ji;class Oc{constructor(t){_(this,Na);_(this,Ee);_(this,Le);_(this,we);h(this,Ee,new Uint8Array(new ArrayBuffer(t))),h(this,Le,0),h(this,we,0)}get length(){return c(this,we)-c(this,Le)}data(){return c(this,Ee).slice(c(this,Le),c(this,we))}push(t){S(this,Na,ji).call(this,t.byteLength),c(this,Ee).set(t,c(this,we)),h(this,we,c(this,we)+t.byteLength)}shift(t){h(this,Le,c(this,Le)+t)}}Ee=new WeakMap,Le=new WeakMap,we=new WeakMap,Na=new WeakSet,ji=function(t){if(c(this,we)+t<=c(this,Ee).byteLength)return;const s=c(this,we)-c(this,Le);if(s+t<=c(this,Ee).byteLength&&2*c(this,we)>=c(this,Ee).byteLength)c(this,Ee).copyWithin(0,c(this,Le),c(this,we));else{let a=c(this,Ee).byteLength;do a*=2;while(s+t>a);const n=new Uint8Array(new ArrayBuffer(a));n.set(c(this,Ee).slice(c(this,Le),c(this,we)),0),h(this,Ee,n)}h(this,we,s),h(this,Le,0)};function Lc(e){const t=Fe(e.baton),s=Fe(e.base_url),a=Tt(e.results,jc);return{baton:t,baseUrl:s,results:a}}function jc(e){const t=qe(e.type);if(t==="ok")return{type:"ok",response:Pc(ie(e.response))};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of StreamResult")}function Pc(e){const t=qe(e.type);if(t==="close")return{type:"close"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:_i(ie(e.result))};if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:$i(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of StreamResponse")}function Nc(e){const t=Fe(e.baton),s=Fe(e.base_url);return{baton:t,baseUrl:s}}const qc={default(){return{baton:void 0,baseUrl:void 0,results:[]}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()},3(e,t){t.results.push(e.message(Bc))}},Bc={default(){return{type:"none"}},1(e){return{type:"ok",response:e.message(Fc)}},2(e){return{type:"error",error:e.message(Je)}}},Fc={default(){return{type:"none"}},1(e){return{type:"close"}},2(e){return e.message(Vc)},3(e){return e.message(Uc)},4(e){return{type:"sequence"}},5(e){return e.message(Hc)},6(e){return{type:"store_sql"}},7(e){return{type:"close_sql"}},8(e){return e.message(Gc)}},Vc={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},Uc={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},Hc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Gc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Wc={default(){return{baton:void 0,baseUrl:void 0}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()}};var ea,Yt,lt,We,it,hs,ft,xn,Pi,Ni;class zc extends hi{constructor(s,a){super();_(this,ft);_(this,ea);_(this,Yt);_(this,lt);_(this,We);_(this,it);_(this,hs);h(this,ea,s),h(this,Yt,a),h(this,lt,void 0),h(this,We,new Oc(16*1024)),h(this,it,void 0),h(this,hs,!1)}async open(s){if(s.body===null)throw new j("No response body for cursor request");h(this,lt,s.body[Symbol.asyncIterator]());const a=await S(this,ft,xn).call(this,Nc,Wc);if(a===void 0)throw new j("Empty response to cursor request");return a}next(){return S(this,ft,xn).call(this,Si,Ri)}close(){this._setClosed(new J("Cursor was manually closed"))}_setClosed(s){c(this,it)===void 0&&(h(this,it,s),c(this,ea)._cursorClosed(this),c(this,lt)!==void 0&&c(this,lt).return())}get closed(){return c(this,it)!==void 0}}ea=new WeakMap,Yt=new WeakMap,lt=new WeakMap,We=new WeakMap,it=new WeakMap,hs=new WeakMap,ft=new WeakSet,xn=async function(s,a){for(;;){if(c(this,hs))return;if(c(this,it)!==void 0)throw new Ae("Cursor is closed",c(this,it));if(c(this,Yt)==="json"){const i=S(this,ft,Pi).call(this);if(i!==void 0){const r=new TextDecoder().decode(i),d=JSON.parse(r);return $n(d,s)}}else if(c(this,Yt)==="protobuf"){const i=S(this,ft,Ni).call(this);if(i!==void 0)return qa(i,a)}else throw K(c(this,Yt),"Impossible encoding");if(c(this,lt)===void 0)throw new At("Attempted to read from HTTP cursor before it was opened");const{value:n,done:l}=await c(this,lt).next();if(l&&c(this,We).length===0)h(this,hs,!0);else{if(l)throw new j("Unexpected end of cursor stream");c(this,We).push(n)}}},Pi=function(){const s=c(this,We).data(),n=s.indexOf(10);if(n<0)return;const l=s.slice(0,n);return c(this,We).shift(n+1),l},Ni=function(){const s=c(this,We).data();let a=0,n=0;for(;;){if(n>=s.byteLength)return;const i=s[n];if(a|=(i&127)<<7*n,n+=1,!(i&128))break}if(s.byteLength<n+a)return;const l=s.slice(n,n+a);return c(this,We).shift(n+a),l};function Yc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.arrayObjects("requests",t.requests,Jc)}function Jc(e,t){if(e.stringRaw("type",t.type),t.type!=="close"){if(t.type==="execute")e.object("stmt",t.stmt,In);else if(t.type==="batch")e.object("batch",t.batch,Ra);else if(t.type==="sequence")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type!=="get_autocommit")throw K(t,"Impossible type of StreamRequest")}}function Kc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.object("batch",t.batch,Ra)}function Qc(e,t){t.baton!==void 0&&e.string(1,t.baton);for(const s of t.requests)e.message(2,s,Xc)}function Xc(e,t){if(t.type==="close")e.message(1,t,Zc);else if(t.type==="execute")e.message(2,t,ed);else if(t.type==="batch")e.message(3,t,td);else if(t.type==="sequence")e.message(4,t,sd);else if(t.type==="describe")e.message(5,t,ad);else if(t.type==="store_sql")e.message(6,t,nd);else if(t.type==="close_sql")e.message(7,t,ld);else if(t.type==="get_autocommit")e.message(8,t,id);else throw K(t,"Impossible type of StreamRequest")}function Zc(e,t){}function ed(e,t){e.message(1,t.stmt,Cn)}function td(e,t){e.message(1,t.batch,Ba)}function sd(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function ad(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function nd(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function ld(e,t){e.int32(1,t.sqlId)}function id(e,t){}function rd(e,t){t.baton!==void 0&&e.string(1,t.baton),e.message(2,t.batch,Ba)}var rt,kt,gs,ta,ws,_t,je,St,ot,ct,$t,ze,vs,N,mt,fn,Pt,qi,Bi,bn,Fi,Vi,mn;class od extends mi{constructor(s,a,n,l,i){super(s.intMode);_(this,N);_(this,rt);_(this,kt);_(this,gs);_(this,ta);_(this,ws);_(this,_t);_(this,je);_(this,St);_(this,ot);_(this,ct);_(this,$t);_(this,ze);_(this,vs);h(this,rt,s),h(this,kt,a.toString()),h(this,gs,n),h(this,ta,l),h(this,ws,i),h(this,_t,void 0),h(this,je,new Ca),h(this,St,!1),h(this,ct,!1),h(this,$t,!1),h(this,ze,void 0),h(this,vs,new Bs)}client(){return c(this,rt)}_sqlOwner(){return this}storeSql(s){const a=c(this,vs).alloc();return S(this,N,mt).call(this,{type:"store_sql",sqlId:a,sql:s}).then(()=>{},n=>this._setClosed(n)),new En(this,a)}_closeSql(s){c(this,ze)===void 0&&S(this,N,mt).call(this,{type:"close_sql",sqlId:s}).then(()=>c(this,vs).free(s),a=>this._setClosed(a))}_execute(s){return S(this,N,mt).call(this,{type:"execute",stmt:s}).then(a=>a.result)}_batch(s){return S(this,N,mt).call(this,{type:"batch",batch:s}).then(a=>a.result)}_describe(s){return S(this,N,mt).call(this,{type:"describe",sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return S(this,N,mt).call(this,{type:"sequence",sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return c(this,rt)._ensureVersion(3,"getAutocommit()"),S(this,N,mt).call(this,{type:"get_autocommit"}).then(s=>s.isAutocommit)}_openCursor(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_cursorClosed(s){if(s!==c(this,ot))throw new At("Cursor was closed, but it was not associated with the stream");h(this,ot,void 0),ns(()=>S(this,N,Pt).call(this))}close(){this._setClosed(new J("Stream was manually closed"))}closeGracefully(){h(this,ct,!0),ns(()=>S(this,N,Pt).call(this))}get closed(){return c(this,ze)!==void 0||c(this,ct)}_setClosed(s){if(c(this,ze)===void 0){for(h(this,ze,s),c(this,ot)!==void 0&&c(this,ot)._setClosed(s),c(this,rt)._streamClosed(this);;){const a=c(this,je).shift();if(a!==void 0)a.errorCallback(s);else break}(c(this,_t)!==void 0||c(this,St))&&!c(this,$t)&&(c(this,je).push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),h(this,$t,!0),ns(()=>S(this,N,Pt).call(this)))}}}rt=new WeakMap,kt=new WeakMap,gs=new WeakMap,ta=new WeakMap,ws=new WeakMap,_t=new WeakMap,je=new WeakMap,St=new WeakMap,ot=new WeakMap,ct=new WeakMap,$t=new WeakMap,ze=new WeakMap,vs=new WeakMap,N=new WeakSet,mt=function(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"pipeline",request:s,responseCallback:a,errorCallback:n})})},fn=function(s){if(c(this,ze)!==void 0)throw new Ae("Stream is closed",c(this,ze));if(c(this,ct))throw new Ae("Stream is closing",void 0);c(this,je).push(s),ns(()=>S(this,N,Pt).call(this))},Pt=function(){if(c(this,St)||c(this,ot)!==void 0)return;if(c(this,ct)&&c(this,je).length===0){this._setClosed(new J("Stream was gracefully closed"));return}const s=c(this,rt)._endpoint;if(s===void 0){c(this,rt)._endpointPromise.then(()=>S(this,N,Pt).call(this),n=>this._setClosed(n));return}const a=c(this,je).shift();if(a!==void 0)if(a.type==="pipeline"){const n=[a];for(;;){const l=c(this,je).first();if(l!==void 0&&l.type==="pipeline")n.push(l),c(this,je).shift();else if(l===void 0&&c(this,ct)&&!c(this,$t)){n.push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),h(this,$t,!0);break}else break}S(this,N,qi).call(this,s,n)}else if(a.type==="cursor")S(this,N,Bi).call(this,s,a);else throw K(a,"Impossible type of QueueEntry")},qi=function(s,a){S(this,N,bn).call(this,()=>S(this,N,Fi).call(this,a,s),n=>dd(n,s.encoding),n=>n.baton,n=>n.baseUrl,n=>cd(a,n),n=>a.forEach(l=>l.errorCallback(n)))},Bi=function(s,a){const n=new zc(this,s.encoding);h(this,ot,n),S(this,N,bn).call(this,()=>S(this,N,Vi).call(this,a,s),l=>n.open(l),l=>l.baton,l=>l.baseUrl,l=>a.cursorCallback(n),l=>a.errorCallback(l))},bn=function(s,a,n,l,i,r){let d;try{const o=s();d=c(this,ta)(o)}catch(o){d=Promise.reject(o)}h(this,St,!0),d.then(o=>o.ok?a(o):pd(o).then(u=>{throw u})).then(o=>{h(this,_t,n(o)),h(this,kt,l(o)??c(this,kt)),i(o)}).catch(o=>{this._setClosed(o),r(o)}).finally(()=>{h(this,St,!1),S(this,N,Pt).call(this)})},Fi=function(s,a){return S(this,N,mn).call(this,new URL(a.pipelinePath,c(this,kt)),{baton:c(this,_t),requests:s.map(n=>n.request)},a.encoding,Yc,Qc)},Vi=function(s,a){if(a.cursorPath===void 0)throw new Rs(`Cursors are supported only on protocol version 3 and higher, but the HTTP server only supports version ${a.version}.`);return S(this,N,mn).call(this,new URL(a.cursorPath,c(this,kt)),{baton:c(this,_t),batch:s.batch},a.encoding,Kc,rd)},mn=function(s,a,n,l,i){let r,d;if(n==="json")r=ii(a,l),d="application/json";else if(n==="protobuf")r=oi(a,i),d="application/x-protobuf";else throw K(n,"Impossible encoding");const o=new Ma.Headers;return o.set("content-type",d),c(this,gs)!==void 0&&o.set("authorization",`Bearer ${c(this,gs)}`),c(this,ws)!==void 0&&o.set("x-turso-encryption-key",c(this,ws)),new Ma.Request(s.toString(),{method:"POST",headers:o,body:r})};function cd(e,t){if(t.results.length!==e.length)throw new j("Server returned unexpected number of pipeline results");for(let s=0;s<e.length;++s){const a=t.results[s],n=e[s];if(a.type==="ok"){if(a.response.type!==n.request.type)throw new j("Received unexpected type of response");n.responseCallback(a.response)}else if(a.type==="error")n.errorCallback(As(a.error));else throw a.type==="none"?new j("Received unrecognized type of StreamResult"):K(a,"Received impossible type of StreamResult")}}async function dd(e,t){var s;if(t==="json"){const a=await e.json();return $n(a,Lc)}if(t==="protobuf"){const a=await e.arrayBuffer();return qa(new Uint8Array(a),qc)}throw await((s=e.body)==null?void 0:s.cancel()),K(t,"Impossible encoding")}async function pd(e){var a;const t=e.headers.get("content-type")??"text/plain";let s=`Server returned HTTP status ${e.status}`;if(t==="application/json"){const n=await e.json();return"message"in n?As(n):new ya(s,e.status)}if(t==="text/plain"){const n=(await e.text()).trim();return n!==""&&(s+=`: ${n}`),new ya(s,e.status)}return await((a=e.body)==null?void 0:a.cancel()),new ya(s,e.status)}const ud=[{versionPath:"v3-protobuf",pipelinePath:"v3-protobuf/pipeline",cursorPath:"v3-protobuf/cursor",version:3,encoding:"protobuf"}],hn={versionPath:"v2",pipelinePath:"v2/pipeline",cursorPath:void 0,version:2,encoding:"json"};var ys,sa,ks,aa,dt,Jt,_s,$a,Ll;let xd=(Ll=class extends ai{constructor(s,a,n,l,i=2){super();_(this,_s);_(this,ys);_(this,sa);_(this,ks);_(this,aa);_(this,dt);_(this,Jt);q(this,"_endpointPromise");q(this,"_endpoint");h(this,ys,s),h(this,sa,a),h(this,ks,n??Ma.fetch),h(this,aa,l),h(this,dt,void 0),h(this,Jt,new Set),i==3?(this._endpointPromise=fd(c(this,ks),c(this,ys)),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r))):(this._endpointPromise=Promise.resolve(hn),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r)))}async getVersion(){return this._endpoint!==void 0?this._endpoint.version:(await this._endpointPromise).version}_ensureVersion(s,a){if(!(s<=hn.version)){if(this._endpoint===void 0)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the HTTP server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(this._endpoint.version<s)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the HTTP server only supports version ${this._endpoint.version}.`)}}openStream(){if(c(this,dt)!==void 0)throw new Ae("Client is closed",c(this,dt));const s=new od(this,c(this,ys),c(this,sa),c(this,ks),c(this,aa));return c(this,Jt).add(s),s}_streamClosed(s){c(this,Jt).delete(s)}close(){S(this,_s,$a).call(this,new J("Client was manually closed"))}get closed(){return c(this,dt)!==void 0}},ys=new WeakMap,sa=new WeakMap,ks=new WeakMap,aa=new WeakMap,dt=new WeakMap,Jt=new WeakMap,_s=new WeakSet,$a=function(s){if(c(this,dt)===void 0){h(this,dt,s);for(const a of Array.from(c(this,Jt)))a._setClosed(new Ae("Client was closed",s))}},Ll);async function fd(e,t){const s=e;for(const a of ud){const n=new URL(a.versionPath,t),l=new Ma.Request(n.toString(),{method:"GET"}),i=await s(l);if(await i.arrayBuffer(),i.ok)return a}return hn}function Ui(e,t,s=2){if(typeof as>"u")throw new li("WebSockets are not supported in this environment");var a=void 0;s==3?a=Array.from(Ai.keys()):a=Array.from(Tc.keys());const n=new as(e,a);return new Mc(n,t)}function ul(e,t,s,a,n=2){return new xd(e instanceof URL?e:new URL(e),t,s,a,n)}var Ss,pt,de;class Hi{constructor(t,s){_(this,Ss);_(this,pt);_(this,de);h(this,Ss,t),h(this,pt,s),h(this,de,void 0)}execute(t){return this.batch([t]).then(s=>s[0])}async batch(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{const a=t.map(Zt);let n;if(c(this,de)===void 0){this._getSqlCache().apply(a);const i=s.batch(c(this,pt)>=3),r=i.step(),d=r.run(en(c(this,Ss)));let o=r;n=a.map(u=>{const m=i.step().condition(ve.ok(o));c(this,pt)>=3&&m.condition(ve.not(ve.isAutocommit(i)));const b=m.query(u);return b.catch(()=>{}),o=m,b}),h(this,de,i.execute().then(()=>d).then(()=>{}));try{await c(this,de)}catch(u){throw this.close(),u}}else{c(this,pt)<3&&await c(this,de),this._getSqlCache().apply(a);const i=s.batch(c(this,pt)>=3);let r;n=a.map(d=>{const o=i.step();r!==void 0&&o.condition(ve.ok(r)),c(this,pt)>=3&&o.condition(ve.not(ve.isAutocommit(i)));const u=o.query(d);return u.catch(()=>{}),r=o,u}),await i.execute()}const l=[];for(let i=0;i<n.length;i++)try{const r=await n[i];if(r===void 0)throw new ls("Statement in a transaction was not executed, probably because the transaction has been rolled back",i,"TRANSACTION_CLOSED");l.push(Fa(r))}catch(r){if(r instanceof ls)throw r;const d=z(r);throw d instanceof F?new ls(d.message,i,d.code,d.extendedCode,d.rawCode,d.cause instanceof Error?d.cause:void 0):d}return l}catch(a){throw z(a)}}async executeMultiple(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{if(c(this,de)===void 0){h(this,de,s.run(en(c(this,Ss))).then(()=>{}));try{await c(this,de)}catch(a){throw this.close(),a}}else await c(this,de);await s.sequence(t)}catch(a){throw z(a)}}async rollback(){try{const t=this._getStream();if(t.closed||c(this,de)===void 0)return;const s=t.run("ROLLBACK").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}async commit(){try{const t=this._getStream();if(t.closed)throw new F("Cannot commit the transaction because it is already closed","TRANSACTION_CLOSED");if(c(this,de)!==void 0)await c(this,de);else return;const s=t.run("COMMIT").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}}Ss=new WeakMap,pt=new WeakMap,de=new WeakMap;async function Da(e,t,s,a,n=!1){n&&s.step().run("PRAGMA foreign_keys=off");const l=s.step(),i=l.run(en(e));let r=l;const d=a.map(y=>{const w=s.step().condition(ve.ok(r));t>=3&&w.condition(ve.not(ve.isAutocommit(s)));const f=w.query(y);return r=w,f}),o=s.step().condition(ve.ok(r));t>=3&&o.condition(ve.not(ve.isAutocommit(s)));const u=o.run("COMMIT");s.step().condition(ve.not(ve.ok(o))).run("ROLLBACK").catch(y=>{}),n&&s.step().run("PRAGMA foreign_keys=on"),await s.execute();const b=[];await i;for(let y=0;y<d.length;y++)try{const w=await d[y];if(w===void 0)throw new ls("Statement in a batch was not executed, probably because the transaction has been rolled back",y,"TRANSACTION_CLOSED");b.push(Fa(w))}catch(w){if(w instanceof ls)throw w;const f=z(w);throw f instanceof F?new ls(f.message,y,f.code,f.extendedCode,f.rawCode,f.cause instanceof Error?f.cause:void 0):f}return await u,b}function Zt(e){let t,s;Array.isArray(e)?[t,s]=e:typeof e=="string"?t=e:(t=e.sql,s=e.args);const a=new fi(t);if(s)if(Array.isArray(s))a.bindIndexes(s);else for(const[n,l]of Object.entries(s))a.bindName(n,l);return a}function Fa(e){const t=e.columnNames.map(i=>i??""),s=e.columnDecltypes.map(i=>i??""),a=e.rows,n=e.affectedRowCount,l=e.lastInsertRowid!==void 0?e.lastInsertRowid:void 0;return new $o(t,s,a,n,l)}function z(e){if(e instanceof J){const t=Gi(e);return new F(e.message,t,void 0,void 0,e)}return e}function Gi(e){return e instanceof ni&&e.code!==void 0?e.code:e instanceof j?"HRANA_PROTO_ERROR":e instanceof Ae?e.cause instanceof J?Gi(e.cause):"HRANA_CLOSED_ERROR":e instanceof tn?"HRANA_WEBSOCKET_ERROR":e instanceof ya?"SERVER_ERROR":e instanceof Rs?"PROTOCOL_VERSION_ERROR":e instanceof At?"INTERNAL_ERROR":"UNKNOWN"}var na,Ye;class Tn{constructor(t,s){_(this,na);_(this,Ye);q(this,"capacity");h(this,na,t),h(this,Ye,new bd),this.capacity=s}apply(t){if(this.capacity<=0)return;const s=new Set;for(const a of t){if(typeof a.sql!="string")continue;const n=a.sql;if(n.length>=5e3)continue;let l=c(this,Ye).get(n);if(l===void 0){for(;c(this,Ye).size+1>this.capacity;){const[i,r]=c(this,Ye).peekLru();if(s.has(r))break;r.close(),c(this,Ye).delete(i)}c(this,Ye).size+1<=this.capacity&&(l=c(this,na).storeSql(n),c(this,Ye).set(n,l))}l!==void 0&&(a.sql=l,s.add(l))}}}na=new WeakMap,Ye=new WeakMap;var Pe;class bd{constructor(){_(this,Pe);h(this,Pe,new Map)}get(t){const s=c(this,Pe).get(t);return s!==void 0&&(c(this,Pe).delete(t),c(this,Pe).set(t,s)),s}set(t,s){c(this,Pe).set(t,s)}peekLru(){for(const t of c(this,Pe).entries())return t}delete(t){c(this,Pe).delete(t)}get size(){return c(this,Pe).size}}Pe=new WeakMap;function md(e){var t=0,s=[];function a(){t--,t<e&&n()}function n(){var d=s.shift();r.queue=s.length,d&&i(d.fn).then(d.resolve).catch(d.reject)}function l(d){return new Promise(function(o,u){s.push({fn:d,resolve:o,reject:u}),r.queue=s.length})}function i(d){t++;try{return Promise.resolve(d()).then(function(o){return a(),o},function(o){throw a(),o})}catch(o){return a(),Promise.reject(o)}}var r=function(d){return t>=e?l(d):i(d)};return r}function hd(e,t){var s=!1,a=this;return Promise.all(e.map(function(){var n=arguments;return a(function(){if(!s)return t.apply(void 0,n).catch(function(l){throw s=!0,l})})}))}function xl(e){return e.queue=0,e.map=hd,e}var gd=function(e){return xl(e?md(e):function(t){return t()})};const Wi=Dc(gd);function wd(e){if(e.scheme!=="wss"&&e.scheme!=="ws")throw new F(`The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="ws"&&e.tls)throw new F('A "ws:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="wss"&&!e.tls)throw new F('A "wss:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);let s;try{s=Ui(t,e.authToken)}catch(a){if(a instanceof li){const n=e.scheme==="wss"?"https":"http",l=Qa(n,e.authority,e.path);throw new F(`This environment does not support WebSockets, please switch to the HTTP client by using a "${n}:" URL (${JSON.stringify(l)}). For more information, please read ${Ks}`,"WEBSOCKETS_NOT_SUPPORTED")}throw z(a)}return new yd(s,t,e.authToken,e.intMode,e.concurrency)}const vd=60*1e3,fl=100;var la,ia,ra,ee,oe,vn,oa,Ie,ss,Us;class yd{constructor(t,s,a,n,l){_(this,Ie);_(this,la);_(this,ia);_(this,ra);_(this,ee);_(this,oe);q(this,"closed");q(this,"protocol");_(this,vn);_(this,oa);h(this,la,s),h(this,ia,a),h(this,ra,n),h(this,ee,S(this,Ie,Us).call(this,t)),h(this,oe,void 0),this.closed=!1,this.protocol="ws",h(this,oa,Wi(l))}async limit(t){return c(this,oa).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{const n=await S(this,Ie,ss).call(this);try{const l=Zt(a);n.conn.sqlCache.apply([l]);const i=n.stream.query(l);n.stream.closeGracefully();const r=await i;return Fa(r)}catch(l){throw z(l)}finally{this._closeStream(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{const a=await S(this,Ie,ss).call(this);try{const l=t.map(u=>Array.isArray(u)?{sql:u[0],args:u[1]||[]}:u).map(Zt),i=await a.conn.client.getVersion();a.conn.sqlCache.apply(l);const r=a.stream.batch(i>=3);return await Da(s,i,r,l)}catch(n){throw z(n)}finally{this._closeStream(a)}})}async migrate(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=t.map(Zt),n=await s.conn.client.getVersion(),l=s.stream.batch(n>=3);return await Da("deferred",n,l,a,!0)}catch(a){throw z(a)}finally{this._closeStream(s)}})}async transaction(t="write"){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=await s.conn.client.getVersion();return new kd(this,s,t,a)}catch(a){throw this._closeStream(s),z(a)}})}async executeMultiple(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=s.stream.sequence(t);s.stream.closeGracefully(),await a}catch(a){throw z(a)}finally{this._closeStream(s)}})}sync(){throw new F("sync not supported in ws mode","SYNC_NOT_SUPPORTED")}async reconnect(){try{for(const a of Array.from(c(this,ee).streamStates))try{a.stream.close()}catch{}c(this,ee).client.close()}catch{}if(c(this,oe)){try{c(this,oe).client.close()}catch{}h(this,oe,void 0)}const t=S(this,Ie,Us).call(this),s=await t.client.getVersion();t.useSqlCache=s>=2,t.useSqlCache&&(t.sqlCache.capacity=fl),h(this,ee,t),this.closed=!1}_closeStream(t){t.stream.close();const s=t.conn;s.streamStates.delete(t),s.streamStates.size===0&&s!==c(this,ee)&&s.client.close()}close(){if(c(this,ee).client.close(),this.closed=!0,c(this,oe)){try{c(this,oe).client.close()}catch{}h(this,oe,void 0)}this.closed=!0}}la=new WeakMap,ia=new WeakMap,ra=new WeakMap,ee=new WeakMap,oe=new WeakMap,vn=new WeakMap,oa=new WeakMap,Ie=new WeakSet,ss=async function(){if(this.closed)throw new F("The client is closed","CLIENT_CLOSED");if(new Date().valueOf()-c(this,ee).openTime.valueOf()>vd&&c(this,oe)===void 0){const n=S(this,Ie,Us).call(this);h(this,oe,n),n.client.getVersion().then(l=>{c(this,ee)!==n&&c(this,ee).streamStates.size===0&&c(this,ee).client.close(),h(this,ee,n),h(this,oe,void 0)},l=>{h(this,oe,void 0)})}if(c(this,ee).client.closed)try{c(this,oe)!==void 0?h(this,ee,c(this,oe)):h(this,ee,S(this,Ie,Us).call(this))}catch(n){throw z(n)}const a=c(this,ee);try{a.useSqlCache===void 0&&(a.useSqlCache=await a.client.getVersion()>=2,a.useSqlCache&&(a.sqlCache.capacity=fl));const n=a.client.openStream();n.intMode=c(this,ra);const l={conn:a,stream:n};return a.streamStates.add(l),l}catch(n){throw z(n)}},Us=function(t){try{return t??(t=Ui(c(this,la),c(this,ia))),{client:t,useSqlCache:void 0,sqlCache:new Tn(t,0),openTime:new Date,streamStates:new Set}}catch(s){throw z(s)}};var ca,Et;class kd extends Hi{constructor(s,a,n,l){super(n,l);_(this,ca);_(this,Et);h(this,ca,s),h(this,Et,a)}_getStream(){return c(this,Et).stream}_getSqlCache(){return c(this,Et).conn.sqlCache}close(){c(this,ca)._closeStream(c(this,Et))}get closed(){return c(this,Et).stream.closed}}ca=new WeakMap,Et=new WeakMap;function _d(e){if(e.scheme!=="https"&&e.scheme!=="http")throw new F(`The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="http"&&e.tls)throw new F('A "http:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="https"&&!e.tls)throw new F('A "https:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);return new Sd(t,e.authToken,e.intMode,e.fetch,e.concurrency,e.remoteEncryptionKey)}const zi=30;var te,$s,Es,Is,da,Cs,pa,ua;class Sd{constructor(t,s,a,n,l,i){_(this,te);q(this,"protocol");_(this,$s);_(this,Es);_(this,Is);_(this,da);_(this,Cs);_(this,pa);_(this,ua);h(this,$s,t),h(this,Cs,s),h(this,Es,a),h(this,Is,n),h(this,da,l),h(this,pa,i),h(this,te,ul(c(this,$s),c(this,Cs),c(this,Is),i)),c(this,te).intMode=c(this,Es),this.protocol="http",h(this,ua,Wi(c(this,da)))}async limit(t){return c(this,ua).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{try{const n=Zt(a);let l;const i=c(this,te).openStream();try{l=i.query(n)}finally{i.closeGracefully()}const r=await l;return Fa(r)}catch(n){throw z(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{try{const n=t.map(o=>Array.isArray(o)?{sql:o[0],args:o[1]||[]}:o).map(Zt),l=await c(this,te).getVersion();let i;const r=c(this,te).openStream();try{new Tn(r,zi).apply(n);const u=r.batch(!1);i=Da(s,l,u,n)}finally{r.closeGracefully()}return await i}catch(a){throw z(a)}})}async migrate(t){return this.limit(async()=>{try{const s=t.map(Zt),a=await c(this,te).getVersion();let n;const l=c(this,te).openStream();try{const r=l.batch(!1);n=Da("deferred",a,r,s,!0)}finally{l.closeGracefully()}return await n}catch(s){throw z(s)}})}async transaction(t="write"){return this.limit(async()=>{try{const s=await c(this,te).getVersion();return new $d(c(this,te).openStream(),t,s)}catch(s){throw z(s)}})}async executeMultiple(t){return this.limit(async()=>{try{let s;const a=c(this,te).openStream();try{s=a.sequence(t)}finally{a.closeGracefully()}await s}catch(s){throw z(s)}})}sync(){throw new F("sync not supported in http mode","SYNC_NOT_SUPPORTED")}close(){c(this,te).close()}async reconnect(){try{this.closed||c(this,te).close()}finally{h(this,te,ul(c(this,$s),c(this,Cs),c(this,Is),c(this,pa))),c(this,te).intMode=c(this,Es)}}get closed(){return c(this,te).closed}}te=new WeakMap,$s=new WeakMap,Es=new WeakMap,Is=new WeakMap,da=new WeakMap,Cs=new WeakMap,pa=new WeakMap,ua=new WeakMap;var Kt,xa;class $d extends Hi{constructor(s,a,n){super(a,n);_(this,Kt);_(this,xa);h(this,Kt,s),h(this,xa,new Tn(s,zi))}_getStream(){return c(this,Kt)}_getSqlCache(){return c(this,xa)}close(){c(this,Kt).close()}get closed(){return c(this,Kt).closed}}Kt=new WeakMap,xa=new WeakMap;function Yi(e){return Ed(Co(e))}function Ed(e){if(e.scheme==="ws"||e.scheme==="wss")return wd(e);if(e.scheme==="http"||e.scheme==="https")return _d(e);throw new F(`The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED")}const Id={url:"libsql://retailer-os-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAxODY2NzMsImlkIjoiNDcwMDliODAtYmJlYS00YzQ3LTk1MzQtY2NlYjg4OWUzYjFjIiwicmlkIjoiNTk1ODMwNWEtMjlkNy00OGU5LWJkNTctN2FiZWVjNzVjMWYwIn0.381aJkYkBtcCsSDyQkFNLZud9lOPi9TuT3uRZgLYS9BqrjLFb0Zc7P1qRWN0k16XkHQ7raDwhCUE9H1G8Q80BA"},Cd={url:"libsql://retailer-data-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAyODMwNTgsImlkIjoiZTVmNzQ5MjMtMDFiMi00YzkxLTlmMjEtZTJhZDIxMzBmMmZmIiwicmlkIjoiZjQzNTc5NTMtN2E2OS00M2UzLWE3MWUtNDcyYzk1MWM1NTRiIn0.8dOIX1XeNnJswuRGhacgPypg_h_9_-bRAwBxtKhBX7rJ4bQuEtSz9Z6igZsvGrWxDlsYlHMo4V3KKIuIZRSuBA"},Nt=Yi(Id),bl=Yi(Cd);async function g(e,t=[]){try{return(await Nt.execute({sql:e,args:t})).rows}catch(s){throw console.error("DB Query Error:",s.message,"SQL:",e,"Params:",t),s}}async function Rd(e){try{return await Nt.batch(e)}catch(t){throw console.error("DB Transaction Error:",t),t}}function R(){return localStorage.getItem("retaileros_retailer_id")}const A={clients:{getAll:()=>{const e=R();return e?g("SELECT * FROM customers WHERE retailer_id = ?",[e]):g("SELECT * FROM customers")},add:e=>{const t=R();return g("INSERT INTO customers (id, name, phone, email, joined_at, dob, location, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.name,e.phone||"",e.email||"",new Date().toISOString(),e.dob||null,e.location||"",t])},getById:e=>{const t=R();return t?g("SELECT * FROM customers WHERE id = ? AND retailer_id = ?",[e,t]):g("SELECT * FROM customers WHERE id = ?",[e])}},companies:{getAll:()=>{const e=R();return e?g("SELECT * FROM companies WHERE retailer_id = ?",[e]):g("SELECT * FROM companies")},add:e=>{const t=R();return g("INSERT INTO companies (id, name, gst_number, customer_id, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?)",[e.id,e.name,e.gst_number,e.customer_id,new Date().toISOString(),t])},getByCustomerId:e=>{const t=R();return t?g("SELECT * FROM companies WHERE customer_id = ? AND retailer_id = ?",[e,t]):g("SELECT * FROM companies WHERE customer_id = ?",[e])},getById:e=>{const t=R();return t?g("SELECT * FROM companies WHERE id = ? AND retailer_id = ?",[e,t]):g("SELECT * FROM companies WHERE id = ?",[e])}},sales:{getAll:()=>{const e=R();return e?g("SELECT * FROM sales WHERE retailer_id = ? ORDER BY date DESC",[e]):g("SELECT * FROM sales ORDER BY date DESC")},getById:e=>{const t=R();return t?g("SELECT * FROM sales WHERE id = ? AND retailer_id = ?",[e,t]):g("SELECT * FROM sales WHERE id = ?",[e])},getDrafts:()=>{const e=R();return e?g("SELECT * FROM sales WHERE status = 'draft' AND retailer_id = ? ORDER BY date DESC",[e]):g("SELECT * FROM sales WHERE status = 'draft' ORDER BY date DESC")},add:e=>{const t=R();return g(`INSERT INTO sales (id, customer_id, customer_name, date, total_amount, status, payment_mode, payment_reference, gst_required, company_id, installation_required, installation_date, retailer_id)
...
`,t+="Powered by RetailerOS",t}function Bd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Fd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function sr(){const e=p.currentTab==="history",t=Va();if(!t)return`<div class="p-10 text-center opacity-40 flex flex-col items-center justify-center h-full">
    ...
    `}function gl(){const e=window.getCache(),t=e.customers||[],s=p.clientSearchQuery||"",n=[...s?t.filter(l=>l.name.toLowerCase().includes(s.toLowerCase())||l.phone&&l.phone.includes(s)||l.email&&l.email.toLowerCase().includes(s.toLowerCase())):t].sort((l,i)=>new Date(i.joined_at||0)-new Date(l.joined_at||0));return`
    ...
    `}window.updateClientSearch=e=>{const t=document.getElementById("client-search-input"),s=(t==null?void 0:t.selectionStart)||e.length;p.clientSearchQuery=e,window.triggerRender(!1),setTimeout(()=>{const a=document.getElementById("client-search-input");a&&(a.focus(),a.setSelectionRange(s,s))},0)};async function Vd(){const e=document.getElementById("client-name"),t=document.getElementById("client-phone"),s=document.getElementById("client-email"),a=document.getElementById("client-location");if(!e||!t){console.error("Form inputs not found"),window.toast.error("Form error. Please try again.");return}const n=e.value.trim(),l=t.value.trim(),i=s.value.trim(),r=a?a.value.trim():"";if(!n||!l){window.toast.warning("Name and Phone are required");return}const d=document.getElementById("save-client-btn");let o="";d&&(o=d.innerHTML,d.innerHTML='<span class="material-icons-outlined animate-spin text-xs">sync</span> Saving...',d.disabled=!0);try{const u="CL-"+Math.random().toString(36).substr(2,6).toUpperCase();console.log("Saving client:",{id:u,name:n,phone:l,email:i,location:r}),await A.clients.add({id:u,name:n,phone:l,email:i,location:r}),console.log("Client saved successfully"),await Q(),window.toast.success("Client added successfully!"),p.currentApp==="sales"?(Qi(u,n),Bl("default")):Nl("directory")}catch(u){console.error("Error saving client:",u),window.toast.error("Error saving client: "+u.message),d&&(d.innerHTML=o,d.disabled=!1)}}window.saveClient=Vd;function gn(e){const t=e==="desktop";return`
    ...
    `}function wl(e){var f;const t=e==="desktop",s=window.getCache(),a=((f=s.customers)==null?void 0:f.find(x=>x.id===p.selectedClientId||x.name===p.selectedClient))||{name:p.selectedClient||"Unknown",joined_at:new Date().toISOString()},n=a.name?a.name.split(" ").map(x=>x[0]).join("").toUpperCase():"?",l=(s.sales||[]).filter(x=>x.customer_id===a.id&&x.status!=="draft").sort((x,k)=>new Date(k.date)-new Date(x.date)),i=s.saleItems||[],r=(s.inquiries||[]).filter(x=>x.customer_id===a.id||x.customer_name===a.name),d=(s.repairs||[]).filter(x=>x.customer_id===a.id||x.customer_name===a.name),o=(s.automations||[]).filter(x=>x.customer_id===a.id),u=s.automationMessages||[],m=(s.communications||[]).filter(x=>x.customer_id===a.id),b=l.reduce((x,k)=>x+(k.total_amount||0),0),y=l.length,w=[...l.map(x=>({type:"sale",date:x.date,data:x,items:i.filter(k=>k.sale_id===x.id)})),...d.map(x=>({type:"repair",date:x.created_at||x.date,data:x})),...r.map(x=>({type:"inquiry",date:x.date||x.created_at,data:x})),...o.map(x=>({type:"automation",date:x.created_at,data:x,messages:u.filter(k=>k.automation_id===x.id)})),...m.map(x=>({type:"communication",date:x.sent_at,data:x}))].sort((x,k)=>new Date(k.date)-new Date(x.date));return`
    ...
    `}function vl(){return Hd()}function yl(){switch(p.groupViewMode){case"create":return Gd();case"detail":return Wd();case"add-members":return zd();default:return`
                <div class="h-full flex items-center justify-center text-slate-300 text-center p-8">
                    <div class="text-center">
            ...
            `}}function Yd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Jd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function kl(e="desktop"){var u,m;const t=window.getCache(),s=p.clientInvoiceId,a=(t.sales||[]).find(b=>b.id===s);if(!a)return`
                ...
                <div class="card p-6 sm:p-8 bg-white text-slate-900 leading-relaxed shadow-sm border border-slate-100">
                    ...
                    ${o.paymentMode?`
                        <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <span class="material-icons-outlined text-sm">${Yd(o.paymentMode)}</span>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest">Paid via ${Jd(o.paymentMode)}</p>
...
`,l+="Powered by RetailerOS";const i=`https://wa.me/${((d=a==null?void 0:a.phone)==null?void 0:d.replace(/\D/g,""))||""}?text=${encodeURIComponent(l)}`;window.open(i,"_blank")};function Ln(e){const t=e==="desktop-secondary",s=e==="desktop-primary";return t?p.clientViewMode==="add"?gn("desktop"):p.clientViewMode==="invoice"?kl("desktop"):p.clientViewMode==="profile"?wl("desktop"):p.clientViewMode==="groups"?yl():`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:s?p.clientViewMode==="groups"?vl():gl():p.clientViewMode==="add"?gn("mobile"):p.clientViewMode==="invoice"?kl("mobile"):p.clientViewMode==="profile"?wl("mobile"):p.clientViewMode==="groups"?p.groupViewMode==="detail"||p.groupViewMode==="create"||p.groupViewMode==="add-members"?yl():vl():gl()}const Ya=(e,t,s=[])=>`
...
`;window.setRepairCustomer=(e,t)=>{p.repairContext={customer_name:e,customer_phone:t},D()};function ep(){const e=document.getElementById("repair-search-input"),t=e?e.value.trim():"",s=window.getCache?window.getCache():{customers:[]},a=t?s.customers.filter(n=>n.name.toLowerCase().includes(t.toLowerCase())||n.phone.includes(t)):[];return`
    ...
    `}function _l(){const t=window.getCache().repairs||[];return`
    ...
    `}function Pn(e){const t={search:{t:"RetailerOS",s:"Repairs Management",txn:null},intake:{t:"Device Intake",s:"Repair Management",txn:"TXN-4920"},status:{t:"Job ID: #REP-2024",s:"Repair Assignment",badge:"ACTIVE"},history:{t:"Job History",s:"Service Records",badge:null}},s={search:ep(),intake:sp(),status:np()};if(e==="desktop-primary")return`
            ...
            <div class="scrolling-content px-8 space-y-8 pb-12">
                ${p.repairTab==="active"?s.search:_l()}
            </div>
        ...
        ${Ja(n.t,n.s,l,!0)}
        <div class="scrolling-content px-8 space-y-8 pb-12">
            ${p.repairTab==="history"?_l():s[p.repairViewMode]}
        </div>
    `}function lp(){return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
             <div class="flex items-center justify-between mb-6">
    ...
    `}function Nn(e){const t=e==="desktop-secondary",s=e==="mobile";if(t)return $l();if(s){const a=window._marketingState||{},n=a.generatedImageUrl||a.isGenerating||a.lastError;return`
            ${Sl()}
            ${n?`
                <div class="px-4 pb-8">
                    ${$l()}
    ...
    `}function qn(e){const t=e==="desktop-secondary";return window.setPromoterViewMode=s=>{p.promoterViewMode=s,D()},t?p.promoterViewMode==="onboarding"?dp():pp():cp()}function up(){return`
    ...
    `}function hp(){const t=(window.getCache?window.getCache():{products:[]}).products||[];return`
         <div class="h-full flex flex-col relative bg-white text-left">
            <!-- Header -->
    ...
    `}function Bn(e){const t=e==="desktop-secondary";return window.setInventoryTab=s=>{p.inventoryTab=s,D()},window.setInventoryMode=s=>{p.inventoryMode=s,D()},t?p.inventoryMode==="inward"?mp():hp():`
        <div class="h-full flex flex-col relative bg-white">
            ${up()}
            ${p.inventoryTab==="brands"?xp():fp()}
        </div>
    ...
    `}function wp(){const e=p.settingsSubView==="add",t=p.settingsActiveRole||"Store Manager";return`
         <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
    ...
    `}function Sp(){var n;const e=p.settingsSubView==="edit",t=window.getCache(),s=localStorage.getItem("retaileros_retailer_id"),a=((n=t.retailers)==null?void 0:n.find(l=>l.id===s))||null;return a?`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
    ...
    `}function $p(){var l;const e=(()=>{var d;const i=window.getCache(),r=localStorage.getItem("retaileros_retailer_id");return((d=i.retailers)==null?void 0:d.find(o=>o.id===r))||{}})(),s=((l=window.getCache().retailerSettings)==null?void 0:l.security)||{},a={otp_on_login:s.otp_on_login??!0,email_verification:s.email_verification??!1,auto_logout_timer:s.auto_logout_timer??"30 min",remember_device:s.remember_device??!0},n=["15 min","30 min","1 hour","4 hours","Never"];return`
    ...
    `}function Fn(e){const t=e==="mobile",s=e==="desktop-secondary";if(window.setSettingsView=a=>{p.settingsView=a,p.settingsSubView=null,D()},window.setSettingsSubView=a=>{p.settingsSubView=a,D()},window.setSettingsRole=a=>{p.settingsActiveRole=a,p.settingsSubView="detail",D()},window.saveNewRole=()=>{const a=document.querySelector('input[placeholder="e.g. Floor Supervisor"]');a&&a.value?(p.settingsActiveRole=a.value,p.settingsSubView="detail",window.toast.success(`Role "${a.value}" created successfully!`),D()):window.toast.warning("Please enter a role name")},window.updateRole=()=>{window.toast.success("Role profile updated successfully!"),window.setSettingsSubView("detail")},s||t&&p.settingsView){if(p.settingsView==="roles")return wp();if(p.settingsView==="accounting")return vp();if(p.settingsView==="ledger")return yp();if(p.settingsView==="ai")return _p();if(p.settingsView==="store")return Sp();if(p.settingsView==="security")return $p();if(p.settingsView==="alerts")return Ep();if(p.settingsView==="taxes")return Ip();if(p.settingsView==="plugins")return Cp();if(p.settingsView==="teams")return Rp();if(p.settingsView==="logs")return Ap();if(p.settingsView==="lang")return Tp();if(p.settingsView==="backup")return Mp();if(p.settingsView==="updates")return Dp();if(p.settingsView==="theme")return Op();if(p.settingsView==="help")return Lp();if(s)return""}return gp(e)}function jp(){return`
        <div class="space-y-4 text-left">
    ...
    `}window.setSchemeViewMode=e=>{p.showSchemeDetails=e==="details",D()};window.setActiveScheme=e=>{p.activeScheme=e,D()};function Pp(){const t=(window.getCache?window.getCache():{schemes:[]}).schemes||[];return`
    ...
    `}function qp(){const e=p.marketplaceTab==="browse";return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
            <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function Bp(){const t=window.getCache().marketplace||[];return`
    ...
    `}function Un(e){if(e==="desktop-secondary"||e==="mobile"&&p.marketplaceViewMode==="add")return Vp(e);const a=p.marketplaceTab==="browse";return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${qp()}
    ...
    `}async function Yp(e){var t;if((t=p.activeInquiry)!=null&&t.id)try{await A.inquiries.updateStatus(p.activeInquiry.id,e),await Q(),window.setInquiryViewMode("list")}catch(s){alert("Update failed: "+s.message)}}window.updateInquiryStatus=Yp;function Jp(){const e=p.activeInquiry;return e?`
    ...
    `:'<div class="p-20 text-center uppercase text-[10px] font-black opacity-30">No inquiry selected</div>'}function Hn(e){return e==="desktop-secondary"||e==="mobile"&&p.inquiryViewMode==="add"?zp():p.inquiryViewMode==="resolve"&&p.activeInquiry?Jp():`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Up()}
    ...
    `}function Kp(){const t=window.getCache().campaigns||[];return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
                    <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
    ...
    `}function Xp(e){const t=p.activeCampaign;return t?`
    ...
    `}function Gn(e){return e==="desktop-secondary"||e==="mobile"&&p.preBookingViewMode==="create"?Qp():p.preBookingViewMode==="details"&&p.activeCampaign?Xp():p.preBookingViewMode==="public"?Zp():Kp()}function eu(){const e=window.getCache(),t=e.automations||[],s=e.automationMessages||[],a=t.filter(i=>i.status==="active").length;t.filter(i=>i.status==="completed").length,s.length;const n=s.filter(i=>i.status==="sent").length,l=s.filter(i=>i.status==="pending").length;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
             <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function Wn(e){const t=e==="mobile",s=e==="desktop-secondary";return window.setAutomationMode=(a,n=null)=>{p.automationViewMode=a,n!==null&&(p.activeAutomationId=n),D()},s?p.automationViewMode==="create"?El():p.automationViewMode==="details"&&p.activeAutomationId?Il(p.activeAutomationId):`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:t&&p.automationViewMode==="create"?El(!0):t&&p.automationViewMode==="details"?Il(p.activeAutomationId,!0):eu()}function tu(){const t=window.getCache().storeOrders||[],s=t.filter(n=>n.order_status==="pending"||n.order_status==="confirmed").length,a=t.filter(n=>n.order_status==="confirmed").length;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
            <div class="flex items-center justify-between mb-6">
                <button type="button" onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
                    <span class="material-icons-outlined">chevron_left</span>
    ...
    `}function nu(){const e=window.getCache(),s=(e.storeListings||[]).find(o=>o.id===p.activeListingId);if(!s)return`<div class="h-full flex items-center justify-center text-slate-300">
            <div class="text-center">
    ...
    `}function lu(e){const t=window.getCache(),s=t.storeOrders||[],a=t.storeOrderItems||[];window._storeOrderFilter=window._storeOrderFilter||"all",window._setOrderFilter=u=>{window._storeOrderFilter=u,window.triggerRender()};const n=window._storeOrderFilter,l=n==="all"?s:s.filter(u=>u.order_status===n),i={all:s.length,pending:s.filter(u=>u.order_status==="pending").length,confirmed:s.filter(u=>u.order_status==="confirmed").length,shipped:s.filter(u=>u.order_status==="shipped").length,delivered:s.filter(u=>u.order_status==="delivered").length,cancelled:s.filter(u=>u.order_status==="cancelled").length},r=u=>{switch(u){case"pending":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-200 text-slate-600">Pending</span>';case"confirmed":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-300 text-slate-700">Confirmed</span>';case"shipped":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-300 text-slate-700">Shipped</span>';case"delivered":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-900 text-white">Delivered</span>';case"cancelled":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-100 text-slate-400">Cancelled</span>';default:return""}},d=u=>u==="paid"?'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-900 text-white">Paid</span>':u==="failed"?'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-100 text-slate-400">Failed</span>':'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-200 text-slate-600">COD</span>';return window._createTestOrder=async()=>{const m=(window.getCache().storeListings||[]).filter(C=>C.status==="active");if(m.length===0){window.toast&&window.toast.error("No active listings to order from");return}const b=m[0],y=`so_${Date.now()}_${Math.random().toString(36).substr(2,6)}`,w=`WEB-${new Date().toISOString().slice(0,10).replace(/-/g,"")}-${String(s.length+1).padStart(4,"0")}`,f=["Aarav Patel","Sneha Gupta","Rohan Mehta","Kavya Sharma","Vikram Singh"],x=["Mumbai","Delhi","Bangalore","Pune","Chennai"],k=f[Math.floor(Math.random()*f.length)],I=x[Math.floor(Math.random()*x.length)];try{const C={id:y,order_number:w,customer_name:k,customer_phone:"98"+Math.floor(1e7+Math.random()*9e7),customer_email:k.split(" ")[0].toLowerCase()+"@gmail.com",shipping_address_line1:Math.floor(100+Math.random()*900)+", Sector "+Math.floor(1+Math.random()*30),shipping_city:I,shipping_state:I==="Mumbai"?"Maharashtra":I==="Delhi"?"Delhi":I==="Bangalore"?"Karnataka":I==="Pune"?"Maharashtra":"Tamil Nadu",shipping_pincode:String(1e5+Math.floor(Math.random()*5e5)),order_date:new Date().toISOString(),total_amount:b.listing_price,order_status:"pending",payment_status:Math.random()>.3?"paid":"pending",payment_mode:Math.random()>.5?"online":"cod"};await A.storeOrders.add(C);const $=`soi_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;await A.storeOrders.addItem({id:$,order_id:y,listing_id:b.id,product_id:b.product_id,product_name:b.product_name,category:b.category,quantity:1,unit_price:b.listing_price,final_price:b.listing_price}),window._db_cache.storeOrders||(window._db_cache.storeOrders=[]),window._db_cache.storeOrders.unshift(C),window._db_cache.storeOrderItems||(window._db_cache.storeOrderItems=[]),window._db_cache.storeOrderItems.push({id:$,order_id:y,listing_id:b.id,product_id:b.product_id,product_name:b.product_name,category:b.category,quantity:1,unit_price:b.listing_price,discount_amount:0,final_price:b.listing_price}),A.activityLogs.add({action:"store",detail:`New online order ${w} from ${k}`,user_name:"System",icon:"shopping_bag",color:"blue"}),window.toast&&window.toast.success(`Test order ${w} created`),window.triggerRender()}catch(C){console.error("Create test order failed:",C),window.toast&&window.toast.error("Failed to create test order")}},`
        ...
        `:""}
    `}function iu(e){switch(e){case"cash":case"cod":return"payments";case"card":return"credit_card";case"upi":return"qr_code";case"online":return"language";default:return"account_balance_wallet"}}function ru(e){switch(e){case"cash":case"cod":return"Cash on Delivery";case"card":return"Card";case"upi":return"UPI";case"online":return"Online Payment";default:return"Payment"}}function Rl(){const e=window.getCache(),t=e.storeOrders||[],s=e.storeOrderItems||[],a=t.find(f=>f.id===p.activeStoreOrderId);if(!a)return`<div class="h-full flex items-center justify-center text-slate-300">
            <div class="text-center">
...
Powered by RetailerOS`,window.open(`https://wa.me/?text=${encodeURIComponent(f)}`,"_blank")},window._printOrder=()=>{window.print()},`
        <div id="order-detail" class="bg-white text-slate-900 leading-relaxed relative h-full flex flex-col print:shadow-none print:border-0">
            ...
            ${r?`
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <span class="material-icons-outlined text-sm">${iu(a.payment_mode)}</span>
                        </div>
                        <div class="text-left">
                            <p class="text-[9px] font-black uppercase tracking-widest text-left">Paid via ${ru(a.payment_mode)}</p>
    ...
    `}function ou(e){const t=window.getCache(),s=t.storeOrders||[],a=t.storeOrderItems||[],n=s.filter(d=>d.order_status==="confirmed"),l=s.filter(d=>d.order_status==="shipped"),i=s.filter(d=>d.order_status==="delivered"),r=(d,o)=>{const u=a.filter(b=>b.order_id===d.id),m=u[0]?u[0].product_name:"Order items";return`
    ...
    `}function zn(e){const t=e==="mobile";if(e==="desktop-secondary"){if(p.myStoreViewMode==="order-detail"&&p.activeStoreOrderId)return Rl();if(p.myStoreViewMode==="add-listing")return Cl();if(p.activeListingId&&p.myStoreTab==="listings")return nu();if(p.myStoreTab==="dashboard"){const l=window.getCache().storeListings||[];return`<div class="h-full flex flex-col p-6 sm:p-8 text-left">
                <div class="text-center border-b border-dashed border-slate-200 pb-6 mb-6">
        ...
        </div>`}if(t){if(p.myStoreViewMode==="order-detail"&&p.activeStoreOrderId)return Rl();if(p.myStoreViewMode==="add-listing")return Cl()}const a=()=>{switch(p.myStoreTab){case"dashboard":return su();case"orders":return lu();case"shipping":return ou();default:return au()}};return`
        <div class="h-full flex flex-col relative bg-white">
            ${tu()}
            ${a()}
        </div>
    `}const Yn={"store-orders":{gradient:"from-blue-500 to-blue-600",bg:"bg-blue-50",text:"text-blue-600",border:"border-blue-100",ring:"ring-blue-500/20",badge:"bg-blue-500",light:"bg-blue-500/10"},"low-stock":{gradient:"from-amber-500 to-orange-500",bg:"bg-amber-50",text:"text-amber-600",border:"border-amber-100",ring:"ring-amber-500/20",badge:"bg-amber-500",light:"bg-amber-500/10"},"draft-sales":{gradient:"from-slate-500 to-slate-600",bg:"bg-slate-50",text:"text-slate-600",border:"border-slate-200",ring:"ring-slate-500/20",badge:"bg-slate-500",light:"bg-slate-500/10"},inquiries:{gradient:"from-violet-500 to-purple-600",bg:"bg-violet-50",text:"text-violet-600",border:"border-violet-100",ring:"ring-violet-500/20",badge:"bg-violet-500",light:"bg-violet-500/10"},repairs:{gradient:"from-emerald-500 to-teal-600",bg:"bg-emerald-50",text:"text-emerald-600",border:"border-emerald-100",ring:"ring-emerald-500/20",badge:"bg-emerald-500",light:"bg-emerald-500/10"},automation:{gradient:"from-cyan-500 to-blue-500",bg:"bg-cyan-50",text:"text-cyan-600",border:"border-cyan-100",ring:"ring-cyan-500/20",badge:"bg-cyan-500",light:"bg-cyan-500/10"},campaigns:{gradient:"from-rose-500 to-pink-600",bg:"bg-rose-50",text:"text-rose-600",border:"border-rose-100",ring:"ring-rose-500/20",badge:"bg-rose-500",light:"bg-rose-500/10"},birthdays:{gradient:"from-pink-400 to-rose-500",bg:"bg-pink-50",text:"text-pink-600",border:"border-pink-100",ring:"ring-pink-500/20",badge:"bg-pink-500",light:"bg-pink-500/10"}},Jn={gradient:"from-slate-500 to-slate-600",bg:"bg-slate-50",text:"text-slate-600",border:"border-slate-200",badge:"bg-slate-500",light:"bg-slate-500/10"};function Kn(){const e=window.getCache(),t=[],s=(e.storeOrders||[]).filter(x=>x.order_status==="pending");s.length>0&&t.push({key:"store-orders",icon:"local_shipping",title:"Pending Orders",subtitle:"Online store orders awaiting action",items:s.map(x=>({id:x.id,primary:`Order #${x.order_number||x.id}`,secondary:x.customer_name||"Walk-in Customer",meta:`₹${Number(x.total_amount||0).toLocaleString()}`,action:()=>{window.setMyStoreTab("orders"),window.setActiveStoreOrder(x.id),window.setApp("mystore")}}))});const a=e.products||[],n=e.inventoryLogs||[],l=a.filter(x=>{const k=n.filter($=>$.product_id===x.id&&$.type==="inward").reduce(($,O)=>$+(parseInt(O.quantity)||0),0),I=n.filter($=>$.product_id===x.id&&$.type==="outward").reduce(($,O)=>$+(parseInt(O.quantity)||0),0),C=k-I;return C<=5&&C>=0}).map(x=>{const k=n.filter(C=>C.product_id===x.id&&C.type==="inward").reduce((C,$)=>C+(parseInt($.quantity)||0),0),I=n.filter(C=>C.product_id===x.id&&C.type==="outward").reduce((C,$)=>C+(parseInt($.quantity)||0),0);return{...x,netStock:k-I}});l.length>0&&t.push({key:"low-stock",icon:"inventory_2",title:"Low Stock",subtitle:"Items running low on inventory",items:l.map(x=>({id:x.id,primary:x.name,secondary:`${x.brand||""} ${x.color||""}`.trim()||"Uncategorized",meta:`${x.netStock} left`,metaWarn:x.netStock<=2,action:()=>{window.setApp("inventory")}}))});const i=(e.sales||[]).filter(x=>x.status==="draft");if(i.length>0){const x=e.saleItems||[];t.push({key:"draft-sales",icon:"edit_note",title:"Incomplete Drafts",subtitle:"Unfinished sales waiting to complete",items:i.map(k=>{const I=x.filter($=>$.sale_id===k.id),C=I[0];return{id:k.id,primary:k.customer_name||`Draft #${k.id}`,secondary:C?`${C.product_name}${I.length>1?` +${I.length-1} more`:""}`:"No items",meta:`₹${Number(k.total||0).toLocaleString()}`,action:()=>{window.setHistoryViewMode("drafts"),window.setHistoryDateFilter("all"),window.setSalesHistoryId(k.id),window.setTab("history"),window.setApp("sales")}}})})}const r=(e.inquiries||[]).filter(x=>x.status==="PENDING");r.length>0&&t.push({key:"inquiries",icon:"help_outline",title:"Unresolved Inquiries",subtitle:"Customer questions needing response",items:r.map(x=>({id:x.id,primary:x.customer_name||"Unknown",secondary:x.product_name||x.description||"General inquiry",meta:new Date(x.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short"}),action:()=>{window.setActiveInquiry(x),window.setInquiryViewMode("resolve"),window.setApp("inquiries")}}))});const d=(e.repairs||[]).filter(x=>x.status==="active");d.length>0&&t.push({key:"repairs",icon:"build",title:"Active Repairs",subtitle:"Devices currently being serviced",items:d.map(x=>({id:x.id,primary:x.device_name||x.device_type||"Device",secondary:x.customer_name||"Walk-in",meta:x.issue||"Repair in progress",action:()=>{window.setActiveRepairJob&&window.setActiveRepairJob(x.id),window.setRepairTab("active"),window.setApp("repairs")}}))});const o=new Date,u=new Date(o.getTime()+7*864e5),m=e.automations||[],b=(e.automationMessages||[]).filter(x=>{if(x.status!=="pending")return!1;const k=new Date(x.scheduled_date);return k>=o&&k<=u}).sort((x,k)=>new Date(x.scheduled_date)-new Date(k.scheduled_date));b.length>0&&t.push({key:"automation",icon:"smart_toy",title:"Scheduled Messages",subtitle:"Automated messages going out this week",iconSymbol:!0,items:b.map(x=>{const k=m.find(Y=>Y.id===x.automation_id),I=new Date(x.scheduled_date),C=I.toDateString()===o.toDateString(),$=I.toDateString()===new Date(Date.now()+864e5).toDateString(),O=C?"Today":$?"Tomorrow":I.toLocaleDateString("en-GB",{day:"2-digit",month:"short"});return{id:x.id,primary:x.title||"Scheduled Message",secondary:(k==null?void 0:k.customer_name)||"Customer",meta:O,action:()=>{window.setActiveAutomation(x.automation_id),window.setAutomationViewMode("details"),window.setApp("automation")}}})});const y=(e.campaigns||[]).filter(x=>{if(!x.start_date||!x.end_date)return x.status==="active";const k=new Date(x.start_date),I=new Date(x.end_date);return o>=k&&o<=I});y.length>0&&t.push({key:"campaigns",icon:"rocket_launch",title:"Live Campaigns",subtitle:"Active pre-booking campaigns",items:y.map(x=>({id:x.id,primary:x.name||x.title||"Campaign",secondary:x.product_name||"Pre-booking",meta:"Active",action:()=>{window.setActiveCampaign(x),window.setPreBookingViewMode("details"),window.setApp("prebooking")}}))});const w=`${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`,f=(e.customers||[]).filter(x=>{if(!x.dob)return!1;const I=(x.dob.includes("T")?x.dob.split("T")[0]:x.dob).split("-");return I.length<3?!1:`${I[1]}-${I[2]}`===w});return f.length>0&&t.push({key:"birthdays",icon:"cake",title:"Birthdays Today",subtitle:"Wish your customers a happy birthday",items:f.map(x=>({id:x.id,primary:x.name,secondary:x.phone||x.email||"",meta:"Birthday",action:()=>{window.setClientMode("profile",x.name,x.id),window.setApp("clients")}}))}),t}function nr(){return Kn().reduce((e,t)=>e+t.items.length,0)}window.getNotificationCount=nr;window._notifExpanded||(window._notifExpanded={});window._toggleNotifGroup=function(e){window._notifExpanded[e]=!window._notifExpanded[e],window.triggerRender()};window._notifActions=[];function cu(e){const t=window._pushNotificationsEnabled!==!1,s=nr();return`
        <header class="px-5 sm:px-8 pt-5 sm:pt-8 pb-3 shrink-0 text-left">
            <div class="flex items-center justify-between mb-4 text-left">
                ...
                <button onclick="window.togglePushNotifications()" class="w-9 h-9 flex items-center justify-center rounded-xl ${t?"bg-slate-900":"bg-slate-100"} transition-all" title="Push Notifications">
                    <span class="material-icons-outlined text-sm ${t?"text-white":"text-slate-400"}">${t?"notifications_active":"notifications_off"}</span>
                </button>
            </div>
            <div class="text-left">
                <h1 class="text-2xl font-black tracking-tight text-slate-900 text-left">Alerts</h1>
                <p class="text-[10px] font-bold text-slate-400 mt-0.5 text-left">${s>0?`${s} item${s!==1?"s":""} need${s===1?"s":""} your attention`:"You're all caught up"}</p>
            </div>
        </header>
    `}function du(e){return e.length===0?"":`
        <div class="flex gap-2.5 overflow-x-auto pb-1 px-5 sm:px-8 -mx-0 no-scrollbar" style="scrollbar-width:none;-ms-overflow-style:none;">
            ${e.map(t=>{const s=Yn[t.key]||Jn;return`
                    <button type="button" onclick="window._toggleNotifGroup('${t.key}');document.getElementById('notif-group-${t.key}')?.scrollIntoView({behavior:'smooth',block:'nearest'})" class="flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl ${s.light} ${s.border} border shrink-0 hover:scale-[1.02] active:scale-[0.98] transition-all">
                        <div class="w-7 h-7 bg-gradient-to-br ${s.gradient} rounded-lg flex items-center justify-center shadow-sm">
                            <span class="${t.iconSymbol?"material-symbols-outlined":"material-icons-outlined"} text-white text-xs">${t.icon}</span>
                        </div>
                        <div class="text-left">
                            <p class="text-[10px] font-black text-slate-900 leading-tight">${t.items.length}</p>
                            <p class="text-[8px] font-bold ${s.text} uppercase tracking-wider leading-tight">${t.title}</p>
                        </div>
                    </button>
                `}).join("")}
        </div>
    `}function pu(e,t){const s=window._notifExpanded[e.key]||!1,a=Yn[e.key]||Jn;return`
        <section id="notif-group-${e.key}" class="text-left">
            <!-- Accordion Header -->
            <button type="button" onclick="window._toggleNotifGroup('${e.key}')" class="w-full flex items-center gap-3 px-4 py-3.5 bg-white border ${s?"border-slate-200 shadow-sm":"border-slate-100"} ${s?"rounded-t-2xl":"rounded-2xl"} hover:border-slate-200 transition-all cursor-pointer group">
                <div class="w-10 h-10 bg-gradient-to-br ${a.gradient} rounded-xl flex items-center justify-center shrink-0 shadow-sm group-hover:shadow-md transition-shadow">
                    <span class="${e.iconSymbol?"material-symbols-outlined":"material-icons-outlined"} text-white text-base">${e.icon}</span>
                </div>
                <div class="flex-1 min-w-0 text-left">
                    <h3 class="text-xs font-black text-slate-900 tracking-tight text-left">${e.title}</h3>
                    <p class="text-[9px] font-bold text-slate-400 text-left">${e.subtitle||""}</p>
                </div>
                <div class="flex items-center gap-2 shrink-0">
                    <span class="min-w-[22px] h-[22px] ${a.badge} text-white rounded-full flex items-center justify-center text-[9px] font-black px-1.5 shadow-sm">${e.items.length}</span>
            ...
            ${s?`
                <div class="bg-white border border-t-0 border-slate-200 rounded-b-2xl overflow-hidden shadow-sm">
                    ${e.items.map((n,l)=>{const i=t+l,r=l===e.items.length-1;return`
                            <button type="button" onclick="window._notifActions[${i}]()" class="w-full px-4 py-3 flex items-center gap-3 hover:${a.bg} transition-all text-left cursor-pointer group/item ${r?"":"border-b border-slate-50"}">
                                <div class="w-9 h-9 ${a.light} rounded-xl flex items-center justify-center shrink-0 group-hover/item:scale-105 transition-transform">
                                    <span class="${e.iconSymbol?"material-symbols-outlined":"material-icons-outlined"} ${a.text} text-sm">${e.icon}</span>
                                </div>
                                <div class="flex-1 min-w-0 text-left">
                                    <h4 class="text-[11px] font-black text-slate-900 tracking-tight truncate text-left">${n.primary}</h4>
                                    <p class="text-[9px] font-bold text-slate-400 truncate text-left">${n.secondary}</p>
                                </div>
                                <div class="flex items-center gap-2 shrink-0">
                                    <span class="text-[9px] font-black ${n.metaWarn?"text-red-500 bg-red-50 px-2 py-0.5 rounded-full":"text-slate-400"} uppercase">${n.meta}</span>
    ...
    `}function xu(){const e=Kn(),t=e.reduce((s,a)=>s+a.items.length,0);return`
        <div class="h-full flex flex-col items-center justify-center text-center p-8">
            <div class="relative mb-5">
                <div class="w-24 h-24 ${t>0?"bg-gradient-to-br from-slate-800 to-slate-950":"bg-gradient-to-br from-emerald-50 to-teal-50"} rounded-3xl flex items-center justify-center shadow-xl ${t>0?"shadow-slate-900/20":"shadow-emerald-500/10"}">
                    <span class="material-icons-outlined text-5xl ${t>0?"text-white":"text-emerald-400"}">${t>0?"notifications_active":"task_alt"}</span>
                </div>
                ${t>0?`
                    <div class="absolute -top-2 -right-2 min-w-[28px] h-7 bg-red-500 text-white rounded-full flex items-center justify-center text-xs font-black px-2 shadow-lg shadow-red-500/40 animate-pulse">${t}</div>
                `:""}
            </div>
            ...
            ${t>0?`
                <div class="space-y-2 w-full max-w-[260px]">
                    ${e.map(s=>{const a=Yn[s.key]||Jn;return`
                            <div class="flex items-center gap-3 px-3.5 py-2.5 ${a.light} rounded-xl border ${a.border}">
                                <div class="w-7 h-7 bg-gradient-to-br ${a.gradient} rounded-lg flex items-center justify-center shrink-0 shadow-sm">
                                    <span class="${s.iconSymbol?"material-symbols-outlined":"material-icons-outlined"} text-white text-[10px]">${s.icon}</span>
                                </div>
    ...
    `}function Qn(e){if(e==="desktop-secondary")return xu();const t=Kn();window._notifActions=[],t.forEach(n=>n.items.forEach(l=>window._notifActions.push(l.action)));let s=0;const a=t.map(n=>{const l=pu(n,s);return s+=n.items.length,l}).join("");return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            ${cu()}
    ...
    `,(t==="error"||e.length>50)&&(n.innerHTML+=`
        ...
        `),qt.innerHTML="",qt.appendChild(n),requestAnimationFrame(()=>{n.classList.remove("opacity-0","translate-y-[-20px]","scale-95"),n.classList.add("opacity-100","translate-y-0","scale-100")}),Ka=setTimeout(()=>{ku(n)},s),n}function ku(e){!e||!e.parentElement||(e.classList.remove("opacity-100","translate-y-0","scale-100"),e.classList.add("opacity-0","translate-y-[-20px]","scale-95"),setTimeout(()=>{e.remove()},300))}function Oa(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const _u={success:(e,t)=>Gs(e,"success",t),error:(e,t)=>Gs(e,"error",t||5e3),warning:(e,t)=>Gs(e,"warning",t||4e3),info:(e,t)=>Gs(e,"info",t)};function Su(e,t,s){const a=document.createElement("div");a.className="fixed inset-0 z-[9998] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4",a.innerHTML=`
    ...
    `,document.body.appendChild(n);const l=n.querySelector("div > div"),i=n.querySelector("#prompt-input");requestAnimationFrame(()=>{l.classList.remove("scale-95","opacity-0"),l.classList.add("scale-100","opacity-100"),i.focus(),i.select()}),i.onkeydown=r=>{if(r.key==="Enter"){const d=i.value.trim();ht(n),d&&s&&s(d)}else r.key==="Escape"&&(ht(n),a&&a())},n.querySelector("#prompt-cancel").onclick=()=>{ht(n),a&&a()},n.querySelector("#prompt-ok").onclick=()=>{const r=i.value.trim();ht(n),r&&s&&s(r)},n.onclick=r=>{r.target===n&&(ht(n),a&&a())}}window.toast=_u;window.showToast=Gs;window.showConfirm=Su;window.showPrompt=$u;function Eu(){return p.currentApp==="sales"?p.currentTab==="new-sale"?Zi():er():p.currentApp==="clients"?Ln("desktop-primary"):p.currentApp==="reports"?jn("desktop-primary"):p.currentApp==="repairs"?Pn("desktop-primary"):p.currentApp==="marketing"?Nn("desktop-primary"):p.currentApp==="promoters"?qn("desktop-primary"):p.currentApp==="inventory"?Bn("desktop-primary"):p.currentApp==="settings"?Fn("desktop-primary"):p.currentApp==="schemes"?Vn("desktop-primary"):p.currentApp==="marketplace"?Un("desktop-primary"):p.currentApp==="inquiries"?Hn("desktop-primary"):p.currentApp==="prebooking"?Gn("desktop-primary"):p.currentApp==="automation"?Wn("desktop-primary"):p.currentApp==="mystore"?zn("desktop-primary"):p.currentApp==="notifications"?Qn("desktop-primary"):'<div class="p-10 flex items-center justify-center h-full text-slate-300 font-bold uppercase tracking-widest">App Module Not Found</div>'}function Iu(){return p.currentApp==="sales"?p.salesMode==="add-customer"?gn("desktop"):sr():p.currentApp==="clients"?Ln("desktop-secondary"):p.currentApp==="reports"?jn("desktop-secondary"):p.currentApp==="repairs"?Pn("desktop-secondary"):p.currentApp==="marketing"?Nn("desktop-secondary"):p.currentApp==="promoters"?qn("desktop-secondary"):p.currentApp==="inventory"?Bn("desktop-secondary"):p.currentApp==="settings"?Fn("desktop-secondary"):p.currentApp==="schemes"?Vn("desktop-secondary"):p.currentApp==="marketplace"?Un("desktop-secondary"):p.currentApp==="inquiries"?Hn("desktop-secondary"):p.currentApp==="prebooking"?Gn("desktop-secondary"):p.currentApp==="automation"?Wn("desktop-secondary"):p.currentApp==="mystore"?zn("desktop-secondary"):p.currentApp==="notifications"?Qn("desktop-secondary"):'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">Select an app to view details</p></div></div>'}function lr(){return Ul("desktop")}function Cu(){return`
    ...
    `}function ir(){if(p.currentApp==="sales"){const t=window.getActiveCart&&window.getActiveCart().length>0,s=p.currentTab==="new-sale"&&t||p.currentTab==="history"&&p.salesHistoryId;return p.showMobileReceipt&&s?`
        ...
        `:""}
        `}let e="";if(p.currentApp==="clients")e=Ln("mobile");else if(p.currentApp==="reports")e=jn("mobile");else if(p.currentApp==="repairs")e=Pn("mobile");else if(p.currentApp==="marketing")e=Nn("mobile");else if(p.currentApp==="promoters")e=qn("mobile");else if(p.currentApp==="inventory")e=Bn("mobile");else if(p.currentApp==="settings")e=Fn("mobile");else if(p.currentApp==="schemes")e=Vn("mobile");else if(p.currentApp==="marketplace")e=Un("mobile");else if(p.currentApp==="inquiries")e=Hn("mobile");else if(p.currentApp==="prebooking")e=Gn("mobile");else if(p.currentApp==="automation")e=Wn("mobile");else if(p.currentApp==="mystore")e=zn("mobile");else if(p.currentApp==="notifications")e=Qn("mobile");else return'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">App Module Not Found</p></div></div>';return`
        <div class="flex flex-col w-full h-full overflow-hidden bg-slate-50 relative">
            ${e}
        </div>
    `}function Ru(){return`
    ...
    `}function rr(){return p.isLoggedIn?p.currentApp==="launcher"?Ul("mobile"):ir():`
            <div class="h-full w-full bg-white">
                ${Vl()}
            </div>
        `}function La(){const e=document.getElementById("app");if(e)try{const t=window.innerWidth;t<768?e.innerHTML=rr():t>=768&&t<1024?e.innerHTML=Ru():e.innerHTML=Cu()}catch(t){console.error(t),e.innerHTML=`< div class="p-4 text-slate-500 font-bold" > Error: ${t.message} <br><small>${t.stack}</small></div>`}}function Au(){const e=window.innerWidth;if(e<768){const t=document.getElementById("app");t&&(t.innerHTML=rr())}else{const t=document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10")||document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative"),s=document.querySelector(".w-\\[30\\%\\].shrink-0.bg-slate-50\\/50.h-full.overflow-hidden.flex.flex-col.relative.dot-grid.border-l.border-slate-200");t&&(t.innerHTML=p.authMode==="register"?Js("desktop-primary"):'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'),s&&e>=1024&&(s.innerHTML=p.authMode==="register"?Js("desktop-secondary"):'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>')}}window.updateAuthContent=Au;Pl(La);Pl(fu);bu();window.addEventListener("resize",()=>{window.innerWidth!==p.viewportWidth&&(p.viewportWidth=window.innerWidth,p.gridCols=window.innerWidth<768?4:3,La())});Q().then(()=>{console.log("Initial data sync complete"),La()}).catch(e=>{console.error("Initial sync failed:",e),La()});
