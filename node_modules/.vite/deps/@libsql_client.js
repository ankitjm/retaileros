  ...
  "node_modules/cross-fetch/dist/browser-ponyfill.js"(exports, module) {
    ...
    (function(globalThis2) {
      var irrelevant = function(exports2) {
        ...
        function Request5(input, options) {
          if (!(this instanceof Request5)) {
            throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');
          }
          options = options || {};
          var body = options.body;
          if (input instanceof Request5) {
            if (input.bodyUsed) {
        ...
        Request5.prototype.clone = function() {
          return new Request5(this, { body: this._bodyInit });
        };
        ...
        function fetch3(input, init) {
          return new Promise(function(resolve, reject) {
            var request = new Request5(input, init);
...
var LibsqlError = class extends Error {
  constructor(message, code, extendedCode, rawCode, cause) {
    ...
    __publicField(this, "extendedCode");
...
var LibsqlBatchError = class extends LibsqlError {
  constructor(message, statementIndex, code, extendedCode, rawCode, cause) {
    ...
    __publicField(this, "statementIndex");
...
var HttpCursor = class extends Cursor {
  ...
  async open(response) {
    ...
    __privateSet(this, _reader2, response.body[Symbol.asyncIterator]());
  ...
  _setClosed(error) {
    ...
    if (__privateGet(this, _reader2) !== void 0) {
      __privateGet(this, _reader2).return();
    }
  }
  /** True if the cursor is closed. */
  get closed() {
...
nextItem_fn = async function(jsonFun, protobufDef) {
  for (; ; ) {
    ...
    const { value, done } = await __privateGet(this, _reader2).next();
...
// node_modules/@libsql/hrana-client/lib-esm/http/stream.js
var _client3, _baseUrl, _jwt, _fetch, _remoteEncryptionKey, _baton, _queue3, _flushing, _cursor2, _closing2, _closeQueued, _closed6, _sqlIdAlloc2, _HttpStream_instances, sendStreamRequest_fn2, pushToQueue_fn2, flushQueue_fn2, flushPipeline_fn, flushCursor_fn, flush_fn, createPipelineRequest_fn, createCursorRequest_fn, createRequest_fn;
var HttpStream = class extends Stream {
  ...
  constructor(client, baseUrl, jwt, customFetch, remoteEncryptionKey) {
    ...
    __privateAdd(this, _remoteEncryptionKey);
    ...
    __privateSet(this, _remoteEncryptionKey, remoteEncryptionKey);
...
_jwt = new WeakMap();
_fetch = new WeakMap();
_remoteEncryptionKey = new WeakMap();
_baton = new WeakMap();
_queue3 = new WeakMap();
...
createRequest_fn = function(url, reqBody, encoding, jsonFun, protobufFun) {
  ...
  if (__privateGet(this, _remoteEncryptionKey) !== void 0) {
    headers.set("x-turso-encryption-key", __privateGet(this, _remoteEncryptionKey));
  }
...
var _url, _jwt2, _fetch2, _remoteEncryptionKey2, _closed7, _streams, _HttpClient_instances, setClosed_fn3;
var HttpClient = class extends Client {
  ...
  constructor(url, jwt, customFetch, remoteEncryptionKey, protocolVersion = 2) {
    ...
    __privateAdd(this, _remoteEncryptionKey2);
    ...
    __privateSet(this, _fetch2, customFetch ?? import_cross_fetch2.fetch);
    __privateSet(this, _remoteEncryptionKey2, remoteEncryptionKey);
  ...
  openStream() {
    ...
    const stream = new HttpStream(this, __privateGet(this, _url), __privateGet(this, _jwt2), __privateGet(this, _fetch2), __privateGet(this, _remoteEncryptionKey2));
...
_jwt2 = new WeakMap();
_fetch2 = new WeakMap();
_remoteEncryptionKey2 = new WeakMap();
...
var WsClient2 = class {
  ...
  async reconnect() {
    try {
      for (const st of Array.from(__privateGet(this, _connState).streamStates)) {
        try {
          st.stream.close();
        } catch {
        }
    ...
    if (__privateGet(this, _futureConnState)) {
      try {
        __privateGet(this, _futureConnState).client.close();
      } catch {
      }
      __privateSet(this, _futureConnState, void 0);
    }
    const next = __privateMethod(this, _WsClient_instances2, openConn_fn).call(this);
    const version2 = await next.client.getVersion();
    next.useSqlCache = version2 >= 2;
    if (next.useSqlCache) {
      next.sqlCache.capacity = sqlCacheCapacity;
    }
    __privateSet(this, _connState, next);
    this.closed = false;
  }
...
var _client5, _url3, _intMode2, _customFetch, _concurrency, _authToken2, _remoteEncryptionKey3, _promiseLimitFunction2;
var HttpClient2 = class {
  ...
  constructor(url, authToken, intMode, customFetch, concurrency, remoteEncryptionKey) {
    ...
    __privateAdd(this, _remoteEncryptionKey3);
    ...
    __privateSet(this, _customFetch, customFetch);
    __privateSet(this, _concurrency, concurrency);
    __privateSet(this, _remoteEncryptionKey3, remoteEncryptionKey);
    __privateSet(this, _client5, openHttp(__privateGet(this, _url3), __privateGet(this, _authToken2), __privateGet(this, _customFetch), remoteEncryptionKey));
    __privateGet(this, _client5).intMode = __privateGet(this, _intMode2);
    this.protocol = "http";
    __privateSet(this, _promiseLimitFunction2, (0, import_promise_limit2.default)(__privateGet(this, _concurrency)));
  }
  async limit(fn) {
  ...
  async reconnect() {
    try {
      ...
      __privateSet(this, _client5, openHttp(__privateGet(this, _url3), __privateGet(this, _authToken2), __privateGet(this, _customFetch), __privateGet(this, _remoteEncryptionKey3)));
      __privateGet(this, _client5).intMode = __privateGet(this, _intMode2);
    }
  }
  get closed() {
...
_remoteEncryptionKey3 = new WeakMap();
